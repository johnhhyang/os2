...
00000378 <join>:
SYSCALL(join)
 378:	b8 1a 00 00 00       	mov    $0x1a,%eax
 37d:	cd 40                	int    $0x40
 37f:	c3                   	ret    
...
00000398 <mutex_lock>:
SYSCALL(mutex_lock)
 398:	b8 1e 00 00 00       	mov    $0x1e,%eax
 39d:	cd 40                	int    $0x40
 39f:	c3                   	ret    

000003a0 <mutex_unlock>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 416:	0f b6 90 84 0c 00 00 	movzbl 0xc84(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 575:	75 27                	jne    59e <printf+0x11f>
          s = "(null)";
 577:	c7 45 f4 60 09 00 00 	movl   $0x960,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 643:	a1 a0 0c 00 00       	mov    0xca0,%eax
...
free(void *ap)
{
 ...
 704:	a3 a0 0c 00 00       	mov    %eax,0xca0
}
 709:	c9                   	leave  
 70a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 757:	e8 d8 fe ff ff       	call   634 <free>
  return freep;
 75c:	a1 a0 0c 00 00       	mov    0xca0,%eax
}
 761:	c9                   	leave  
 762:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 775:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 778:	a1 a0 0c 00 00       	mov    0xca0,%eax
 77d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 780:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 784:	75 23                	jne    7a9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 786:	c7 45 f0 98 0c 00 00 	movl   $0xc98,-0x10(%ebp)
 78d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 790:	a3 a0 0c 00 00       	mov    %eax,0xca0
 795:	a1 a0 0c 00 00       	mov    0xca0,%eax
 79a:	a3 98 0c 00 00       	mov    %eax,0xc98
    base.s.size = 0;
 79f:	c7 05 9c 0c 00 00 00 	movl   $0x0,0xc9c
 7a6:	00 00 00 
  }
 ...
 7fc:	a3 a0 0c 00 00       	mov    %eax,0xca0
      return (void*)(p + 1);
 ...
 807:	eb 38                	jmp    841 <malloc+0xde>
    ...
    if(p == freep)
 809:	a1 a0 0c 00 00       	mov    0xca0,%eax
...
int pthread_create(pthread_t *thread, const pthread_attr_t *attr, void *(*start_routine) (void*), void *arg){
 ...
 84a:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
...
//zzddhhtjzz/xv6/blob/master
 ...
 85c:	25 ff 0f 00 00       	and    $0xfff,%eax
 861:	85 c0                	test   %eax,%eax
 863:	74 15                	je     87a <pthread_create+0x36>
		mystek += 4096 - ((uint)mystek % PAGESIZE);
 865:	8b 45 f4             	mov    -0xc(%ebp),%eax
 868:	89 c2                	mov    %eax,%edx
 86a:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 870:	b8 00 10 00 00       	mov    $0x1000,%eax
 875:	29 d0                	sub    %edx,%eax
...
int pthread_join(pthread_t thread, void **retval){
 ...
 8af:	8d 55 f4             	lea    -0xc(%ebp),%edx
 8b2:	89 54 24 04          	mov    %edx,0x4(%esp)
 8b6:	89 04 24             	mov    %eax,(%esp)
 8b9:	e8 ba fa ff ff       	call   378 <join>
...
int pthread_exit(void *retval){
 ...
 8dc:	e8 9f fa ff ff       	call   380 <texit>
...
int pthread_mutex_init(pthread_mutex_t *mutex, const pthread_mutex_attr_t *attr){
 ...
 8eb:	83 ec 18             	sub    $0x18,%esp
	...
	int mid = mutex_init();
 8ee:	e8 95 fa ff ff       	call   388 <mutex_init>
...
000008fb <pthread_mutex_destroy>:
...
int pthread_mutex_destroy(pthread_mutex_t *mutex){
 ...
 90a:	e8 81 fa ff ff       	call   390 <mutex_destroy>
	return 0;
...
int pthread_mutex_lock(pthread_mutex_t *mutex){
 ...
 925:	e8 6e fa ff ff       	call   398 <mutex_lock>
	return 0;
...
int pthread_mutex_unlock(pthread_mutex_t *mutex){
 ...
 940:	e8 5b fa ff ff       	call   3a0 <mutex_unlock>
	return 0;
