...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     20f:	c7 44 24 04 28 16 00 	movl   $0x1628,0x4(%esp)
     216:	00 
     ...
     286:	e9 ae 00 00 00       	jmp    339 <main+0xd2>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     292:	00 
     293:	c7 04 24 2b 16 00 00 	movl   $0x162b,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2af:	0f b6 05 60 1c 00 00 	movzbl 0x1c60,%eax
     2b6:	3c 63                	cmp    $0x63,%al
     2b8:	75 5a                	jne    314 <main+0xad>
     2ba:	0f b6 05 61 1c 00 00 	movzbl 0x1c61,%eax
     2c1:	3c 64                	cmp    $0x64,%al
     2c3:	75 4f                	jne    314 <main+0xad>
     2c5:	0f b6 05 62 1c 00 00 	movzbl 0x1c62,%eax
     2cc:	3c 20                	cmp    $0x20,%al
     2ce:	75 44                	jne    314 <main+0xad>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     2d0:	c7 04 24 60 1c 00 00 	movl   $0x1c60,(%esp)
     2d7:	e8 ba 0a 00 00       	call   d96 <strlen>
     2dc:	83 e8 01             	sub    $0x1,%eax
     2df:	c6 80 60 1c 00 00 00 	movb   $0x0,0x1c60(%eax)
      if(chdir(buf+3) < 0)
     2e6:	c7 04 24 63 1c 00 00 	movl   $0x1c63,(%esp)
     2ed:	e8 de 0c 00 00       	call   fd0 <chdir>
     2f2:	85 c0                	test   %eax,%eax
     2f4:	79 42                	jns    338 <main+0xd1>
        printf(2, "cannot cd %s\n", buf+3);
     2f6:	c7 44 24 08 63 1c 00 	movl   $0x1c63,0x8(%esp)
     2fd:	00 
     2fe:	c7 44 24 04 33 16 00 	movl   $0x1633,0x4(%esp)
     305:	00 
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     340:	00 
     341:	c7 04 24 60 1c 00 00 	movl   $0x1c60,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     367:	c7 44 24 04 41 16 00 	movl   $0x1641,0x4(%esp)
     36e:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     394:	c7 04 24 45 16 00 00 	movl   $0x1645,(%esp)
     ...
     545:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55e:	c7 04 24 34 1c 00 00 	movl   $0x1c34,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     601:	c7 04 24 34 1c 00 00 	movl   $0x1c34,(%esp)
     ...
     61e:	c7 04 24 3a 1c 00 00 	movl   $0x1c3a,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 34 1c 00 00 	movl   $0x1c34,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 34 1c 00 00 	movl   $0x1c34,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b74:	74 0c                	je     b82 <parseexec+0xb0>
      panic("syntax");
     b76:	c7 04 24 5a 16 00 00 	movl   $0x165a,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba7:	7e 0c                	jle    bb5 <parseexec+0xe3>
      panic("too many args");
     ba9:	c7 04 24 a9 16 00 00 	movl   $0x16a9,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd1:	c7 44 24 08 b7 16 00 	movl   $0x16b7,0x8(%esp)
     bd8:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3e:	8b 04 85 bc 16 00 00 	mov    0x16bc(,%eax,4),%eax
     c45:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    10ae:	0f b6 90 44 1c 00 00 	movzbl 0x1c44(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    120d:	75 27                	jne    1236 <printf+0x11f>
          s = "(null)";
    120f:	c7 45 f4 d4 16 00 00 	movl   $0x16d4,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12db:	a1 cc 1c 00 00       	mov    0x1ccc,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    139c:	a3 cc 1c 00 00       	mov    %eax,0x1ccc
}
    13a1:	c9                   	leave  
    13a2:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    13f4:	a1 cc 1c 00 00       	mov    0x1ccc,%eax
}
    13f9:	c9                   	leave  
    13fa:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1410:	a1 cc 1c 00 00       	mov    0x1ccc,%eax
    1415:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1418:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    141c:	75 23                	jne    1441 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    141e:	c7 45 f0 c4 1c 00 00 	movl   $0x1cc4,-0x10(%ebp)
    1425:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1428:	a3 cc 1c 00 00       	mov    %eax,0x1ccc
    142d:	a1 cc 1c 00 00       	mov    0x1ccc,%eax
    1432:	a3 c4 1c 00 00       	mov    %eax,0x1cc4
    base.s.size = 0;
    1437:	c7 05 c8 1c 00 00 00 	movl   $0x0,0x1cc8
    143e:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1494:	a3 cc 1c 00 00       	mov    %eax,0x1ccc
      return (void*)(p + 1);
    ...
    if(p == freep)
    14a1:	a1 cc 1c 00 00       	mov    0x1ccc,%eax
...
int pthread_create(pthread_t *thread, const pthread_attr_t *attr, void *(*start_routine) (void*), void *arg){
    ...
    14e2:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
...
00001537 <pthread_join>:

int pthread_join(pthread_t thread, void **retval){
    1537:	55                   	push   %ebp
    1538:	89 e5                	mov    %esp,%ebp
    153a:	83 ec 28             	sub    $0x28,%esp

	void *stek;

	join((int)thread.pid, &stek, (void*)retval);
    153d:	8b 45 08             	mov    0x8(%ebp),%eax
    1540:	8b 55 0c             	mov    0xc(%ebp),%edx
    1543:	89 54 24 08          	mov    %edx,0x8(%esp)
    1547:	8d 55 f4             	lea    -0xc(%ebp),%edx
    154a:	89 54 24 04          	mov    %edx,0x4(%esp)
    154e:	89 04 24             	mov    %eax,(%esp)
    1551:	e8 ba fa ff ff       	call   1010 <join>
...
int pthread_exit(void *retval){
    ...
    1574:	e8 9f fa ff ff       	call   1018 <texit>
...
int pthread_mutex_init(pthread_mutex_t *mutex, const pthread_mutex_attr_t *attr){
	...
	int mid = mutex_init();
    1586:	e8 95 fa ff ff       	call   1020 <mutex_init>
...
00001593 <pthread_mutex_destroy>:
...
int pthread_mutex_destroy(pthread_mutex_t *mutex){
    ...
    15a2:	e8 81 fa ff ff       	call   1028 <mutex_destroy>
	return 0;
...
000015ae <pthread_mutex_lock>:


int pthread_mutex_lock(pthread_mutex_t *mutex){
    15ae:	55                   	push   %ebp
    15af:	89 e5                	mov    %esp,%ebp
    15b1:	83 ec 18             	sub    $0x18,%esp

	mutex_lock(mutex->mid);
    15b4:	8b 45 08             	mov    0x8(%ebp),%eax
    15b7:	8b 40 04             	mov    0x4(%eax),%eax
    15ba:	89 04 24             	mov    %eax,(%esp)
    15bd:	e8 6e fa ff ff       	call   1030 <mutex_lock>
	return 0;
