...
8010003a:	c7 44 24 04 6c 8c 10 	movl   $0x80108c6c,0x4(%esp)
80100041:	80 
...
801000bd:	e8 9d 53 00 00       	call   8010545f <acquire>
...
80100104:	e8 b8 53 00 00       	call   801054c1 <release>
        return b;
...
8010011f:	e8 01 4c 00 00       	call   80104d25 <sleep>
      goto loop;
...
8010017c:	e8 40 53 00 00       	call   801054c1 <release>
      return b;
...
80100198:	c7 04 24 73 8c 10 80 	movl   $0x80108c73,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 84 8c 10 80 	movl   $0x80108c84,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 8b 8c 10 80 	movl   $0x80108c8b,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
8010023c:	e8 1e 52 00 00       	call   8010545f <acquire>
...
8010029d:	e8 5f 4b 00 00       	call   80104e01 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
801002a9:	e8 13 52 00 00       	call   801054c1 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 9e 50 00 00       	call   8010545f <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 92 8c 10 80 	movl   $0x80108c92,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 9b 8c 10 80 	movl   $0x80108c9b,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 86 4f 00 00       	call   801054c1 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 a2 8c 10 80 	movl   $0x80108ca2,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 b1 8c 10 80 	movl   $0x80108cb1,(%esp)
...
80100592:	e8 79 4f 00 00       	call   80105510 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 b3 8c 10 80 	movl   $0x80108cb3,(%esp)
...
801006b2:	e8 ca 50 00 00       	call   80105781 <memmove>
    pos -= 80;
...
801006e1:	e8 c8 4f 00 00       	call   801056ae <memset>
  }
...
80100776:	e8 42 6b 00 00       	call   801072bd <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 36 6b 00 00       	call   801072bd <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 2a 6b 00 00       	call   801072bd <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 1d 6b 00 00       	call   801072bd <uartputc>
  cgaputc(c);
...
801007ba:	e8 a0 4c 00 00       	call   8010545f <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 b8 46 00 00       	call   80104ea7 <procdump>
      break;
...
801008f7:	e8 05 45 00 00       	call   80104e01 <wakeup>
        }
      }
      break;
...
8010091e:	e8 9e 4b 00 00       	call   801054c1 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 17 4b 00 00       	call   8010545f <acquire>
  while(n > 0){
...
80100961:	e8 5b 4b 00 00       	call   801054c1 <release>
        ilock(ip);
...
8010098a:	e8 96 43 00 00       	call   80104d25 <sleep>
...
80100a08:	e8 b4 4a 00 00       	call   801054c1 <release>
  ilock(ip);
...
80100a3e:	e8 1c 4a 00 00       	call   8010545f <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 44 4a 00 00       	call   801054c1 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 b7 8c 10 	movl   $0x80108cb7,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100aa2:	e8 97 49 00 00       	call   8010543e <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 bf 8c 10 	movl   $0x80108cbf,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 a0 17 11 80 	movl   $0x801117a0,(%esp)
80100ab6:	e8 83 49 00 00       	call   8010543e <initlock>
...
80100b78:	0f 85 44 03 00 00    	jne    80100ec2 <exec+0x3c6>
  ...
  if((pgdir = setupkvm()) == 0)
80100b7e:	e8 7e 78 00 00       	call   80108401 <setupkvm>
...
80100c17:	e8 b7 7b 00 00       	call   801087d3 <allocuvm>
...
80100c54:	e8 8b 7a 00 00       	call   801086e4 <loaduvm>
...
80100cc4:	e8 0a 7b 00 00       	call   801087d3 <allocuvm>
...
80100ce8:	e8 0a 7d 00 00       	call   801089f7 <clearpteu>
  sp = sz;
...
80100d17:	e8 10 4c 00 00       	call   8010592c <strlen>
...
80100d35:	e8 f2 4b 00 00       	call   8010592c <strlen>
...
80100d5f:	e8 58 7e 00 00       	call   80108bbc <copyout>
...
80100dff:	e8 b8 7d 00 00       	call   80108bbc <copyout>
...
80100e56:	e8 83 4a 00 00       	call   801058de <safestrcpy>
...
80100ea8:	e8 45 76 00 00       	call   801084f2 <switchuvm>
  freevm(oldpgdir);
80100ead:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100eb0:	89 04 24             	mov    %eax,(%esp)
80100eb3:	e8 b1 7a 00 00       	call   80108969 <freevm>
  return 0;
...
80100eea:	e8 7a 7a 00 00       	call   80108969 <freevm>
  if(ip){
...
80100f12:	c7 44 24 04 c5 8c 10 	movl   $0x80108cc5,0x4(%esp)
80100f19:	80 
80100f1a:	c7 04 24 60 18 11 80 	movl   $0x80111860,(%esp)
80100f21:	e8 18 45 00 00       	call   8010543e <initlock>
}
80100f26:	c9                   	leave  
80100f27:	c3                   	ret    
...
80100f35:	e8 25 45 00 00       	call   8010545f <acquire>
...
80100f5e:	e8 5e 45 00 00       	call   801054c1 <release>
      return f;
...
80100f7c:	e8 40 45 00 00       	call   801054c1 <release>
  return 0;
...
80100f95:	e8 c5 44 00 00       	call   8010545f <acquire>
  if(f->ref < 1)
...
80100fa2:	7f 0c                	jg     80100fb0 <filedup+0x28>
    panic("filedup");
80100fa4:	c7 04 24 cc 8c 10 80 	movl   $0x80108ccc,(%esp)
...
80100fc6:	e8 f6 44 00 00       	call   801054c1 <release>
  return f;
...
80100fdd:	e8 7d 44 00 00       	call   8010545f <acquire>
  if(f->ref < 1)
...
80100fea:	7f 0c                	jg     80100ff8 <fileclose+0x28>
    panic("fileclose");
80100fec:	c7 04 24 d4 8c 10 80 	movl   $0x80108cd4,(%esp)
...
80101018:	e8 a4 44 00 00       	call   801054c1 <release>
    return;
...
80101062:	e8 5a 44 00 00       	call   801054c1 <release>
...
801011a1:	eb 0c                	jmp    801011af <fileread+0xba>
  ...
  panic("fileread");
801011a3:	c7 04 24 de 8c 10 80 	movl   $0x80108cde,(%esp)
...
801012af:	c7 04 24 e7 8c 10 80 	movl   $0x80108ce7,(%esp)
...
801012e2:	eb 0c                	jmp    801012f0 <filewrite+0x13f>
  ...
  panic("filewrite");
801012e4:	c7 04 24 f7 8c 10 80 	movl   $0x80108cf7,(%esp)
...
8010132c:	e8 50 44 00 00       	call   80105781 <memmove>
  brelse(bp);
...
80101372:	e8 37 43 00 00       	call   801056ae <memset>
  log_write(bp);
...
801014d4:	0f 82 e1 fe ff ff    	jb     801013bb <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014da:	c7 04 24 01 8d 10 80 	movl   $0x80108d01,(%esp)
...
80101571:	c7 04 24 17 8d 10 80 	movl   $0x80108d17,(%esp)
...
801015c5:	c7 44 24 04 2a 8d 10 	movl   $0x80108d2a,0x4(%esp)
801015cc:	80 
801015cd:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801015d4:	e8 65 3e 00 00       	call   8010543e <initlock>
}
801015d9:	c9                   	leave  
801015da:	c3                   	ret    
...
80101656:	e8 53 40 00 00       	call   801056ae <memset>
      dip->type = type;
...
801016a6:	0f 82 5a ff ff ff    	jb     80101606 <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016ac:	c7 04 24 31 8d 10 80 	movl   $0x80108d31,(%esp)
...
80101753:	e8 29 40 00 00       	call   80105781 <memmove>
  log_write(bp);
...
8010177d:	e8 dd 3c 00 00       	call   8010545f <acquire>
...
801017c7:	e8 f5 3c 00 00       	call   801054c1 <release>
      return ip;
...
801017fa:	c7 04 24 43 8d 10 80 	movl   $0x80108d43,(%esp)
...
80101838:	e8 84 3c 00 00       	call   801054c1 <release>
...
8010184f:	e8 0b 3c 00 00       	call   8010545f <acquire>
  ip->ref++;
...
8010186a:	e8 52 3c 00 00       	call   801054c1 <release>
  return ip;
...
80101888:	7f 0c                	jg     80101896 <ilock+0x22>
    panic("ilock");
8010188a:	c7 04 24 53 8d 10 80 	movl   $0x80108d53,(%esp)
80101891:	e8 a7 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101896:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
8010189d:	e8 bd 3b 00 00       	call   8010545f <acquire>
...
801018b2:	e8 6e 34 00 00       	call   80104d25 <sleep>
...
801018dc:	e8 e0 3b 00 00       	call   801054c1 <release>
...
80101987:	e8 f5 3d 00 00       	call   80105781 <memmove>
    brelse(bp);
...
801019b2:	75 0c                	jne    801019c0 <ilock+0x14c>
      panic("ilock: no type");
801019b4:	c7 04 24 59 8d 10 80 	movl   $0x80108d59,(%esp)
...
801019e3:	7f 0c                	jg     801019f1 <iunlock+0x2f>
    panic("iunlock");
801019e5:	c7 04 24 68 8d 10 80 	movl   $0x80108d68,(%esp)
801019ec:	e8 4c eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019f1:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801019f8:	e8 62 3a 00 00       	call   8010545f <acquire>
  ip->flags &= ~I_BUSY;
...
80101a14:	e8 e8 33 00 00       	call   80104e01 <wakeup>
  release(&icache.lock);
80101a19:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80101a20:	e8 9c 3a 00 00       	call   801054c1 <release>
}
80101a25:	c9                   	leave  
80101a26:	c3                   	ret    
...
80101a34:	e8 26 3a 00 00       	call   8010545f <acquire>
...
80101a70:	74 0c                	je     80101a7e <iput+0x57>
      panic("iput busy");
80101a72:	c7 04 24 70 8d 10 80 	movl   $0x80108d70,(%esp)
...
80101a96:	e8 26 3a 00 00       	call   801054c1 <release>
    itrunc(ip);
...
80101ac1:	e8 99 39 00 00       	call   8010545f <acquire>
    ip->flags = 0;
...
80101ad6:	e8 26 33 00 00       	call   80104e01 <wakeup>
  }
  ip->ref--;
...
80101af1:	e8 cb 39 00 00       	call   801054c1 <release>
}
80101af6:	c9                   	leave  
80101af7:	c3                   	ret    
...
80101c06:	c7 04 24 7a 8d 10 80 	movl   $0x80108d7a,(%esp)
...
80101e9e:	e8 de 38 00 00       	call   80105781 <memmove>
    brelse(bp);
...
80102004:	e8 78 37 00 00       	call   80105781 <memmove>
    log_write(bp);
...
80102086:	e8 9a 37 00 00       	call   80105825 <strncmp>
}
8010208b:	c9                   	leave  
8010208c:	c3                   	ret    
...
801020a0:	c7 04 24 8d 8d 10 80 	movl   $0x80108d8d,(%esp)
...
801020dc:	74 0c                	je     801020ea <dirlookup+0x5d>
      panic("dirlink read");
801020de:	c7 04 24 9f 8d 10 80 	movl   $0x80108d9f,(%esp)
...
801021c0:	74 0c                	je     801021ce <dirlink+0x79>
      panic("dirlink read");
801021c2:	c7 04 24 9f 8d 10 80 	movl   $0x80108d9f,(%esp)
...
80102208:	e8 70 36 00 00       	call   8010587d <strncpy>
  de.inum = inum;
...
80102238:	74 0c                	je     80102246 <dirlink+0xf1>
    panic("dirlink");
8010223a:	c7 04 24 ac 8d 10 80 	movl   $0x80108dac,(%esp)
...
801022c1:	e8 bb 34 00 00       	call   80105781 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022dc:	e8 a0 34 00 00       	call   80105781 <memmove>
    name[len] = 0;
...
80102538:	c7 44 24 04 b4 8d 10 	movl   $0x80108db4,0x4(%esp)
8010253f:	80 
80102540:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
80102547:	e8 f2 2e 00 00       	call   8010543e <initlock>
  picenable(IRQ_IDE);
...
801025e2:	75 0c                	jne    801025f0 <idestart+0x18>
    panic("idestart");
801025e4:	c7 04 24 b8 8d 10 80 	movl   $0x80108db8,(%esp)
...
8010270a:	e8 50 2d 00 00       	call   8010545f <acquire>
  if((b = idequeue) == 0){
...
80102724:	e8 98 2d 00 00       	call   801054c1 <release>
...
80102797:	e8 65 26 00 00       	call   80104e01 <wakeup>
...
801027b9:	e8 03 2d 00 00       	call   801054c1 <release>
}
801027be:	c9                   	leave  
801027bf:	c3                   	ret    
...
801027d2:	c7 04 24 c1 8d 10 80 	movl   $0x80108dc1,(%esp)
...
801027eb:	c7 04 24 d5 8d 10 80 	movl   $0x80108dd5,(%esp)
...
80102876:	e8 aa 24 00 00       	call   80104d25 <sleep>
...
80102892:	e8 2a 2c 00 00       	call   801054c1 <release>
}
80102897:	c9                   	leave  
80102898:	c3                   	ret    
...
80102922:	c7 04 24 08 8e 10 80 	movl   $0x80108e08,(%esp)
...
801029e3:	c7 44 24 04 3a 8e 10 	movl   $0x80108e3a,0x4(%esp)
801029ea:	80 
801029eb:	c7 04 24 40 32 11 80 	movl   $0x80113240,(%esp)
801029f2:	e8 47 2a 00 00       	call   8010543e <initlock>
  kmem.use_lock = 0;
...
80102a84:	81 7d 08 5c a4 11 80 	cmpl   $0x8011a45c,0x8(%ebp)
...
80102a9d:	76 0c                	jbe    80102aab <kfree+0x39>
    panic("kfree");
80102a9f:	c7 04 24 3f 8e 10 80 	movl   $0x80108e3f,(%esp)
...
80102ac1:	e8 e8 2b 00 00       	call   801056ae <memset>
...
80102ad6:	e8 84 29 00 00       	call   8010545f <acquire>
  r = (struct run*)v;
...
80102b04:	e8 b8 29 00 00       	call   801054c1 <release>
}
80102b09:	c9                   	leave  
80102b0a:	c3                   	ret    
...
80102b21:	e8 39 29 00 00       	call   8010545f <acquire>
  r = kmem.freelist;
...
80102b4e:	e8 6e 29 00 00       	call   801054c1 <release>
  return (char*)r;
...
80102ef4:	c7 04 24 48 8e 10 80 	movl   $0x80108e48,(%esp)
...
80103158:	e8 c8 25 00 00       	call   80105725 <memcmp>
...
8010325a:	c7 44 24 04 74 8e 10 	movl   $0x80108e74,0x4(%esp)
80103261:	80 
80103262:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
80103269:	e8 d0 21 00 00       	call   8010543e <initlock>
  readsb(ROOTDEV, &sb);
...
8010331c:	e8 60 24 00 00       	call   80105781 <memmove>
...
8010346e:	e8 ec 1f 00 00       	call   8010545f <acquire>
  while(1){
    if(log.committing){
...
8010348b:	e8 95 18 00 00       	call   80104d25 <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
801034bf:	e8 61 18 00 00       	call   80104d25 <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
801034da:	e8 e2 1f 00 00       	call   801054c1 <release>
      break;
801034df:	90                   	nop
    }
  }
...
801034f6:	e8 64 1f 00 00       	call   8010545f <acquire>
  log.outstanding -= 1;
...
80103511:	c7 04 24 78 8e 10 80 	movl   $0x80108e78,(%esp)
...
80103540:	e8 bc 18 00 00       	call   80104e01 <wakeup>
  }
  release(&log.lock);
80103545:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
8010354c:	e8 70 1f 00 00       	call   801054c1 <release>
...
801035fd:	e8 7f 21 00 00       	call   80105781 <memmove>
...
80103688:	c7 04 24 87 8e 10 80 	movl   $0x80108e87,(%esp)
...
8010369d:	c7 04 24 9d 8e 10 80 	movl   $0x80108e9d,(%esp)
...
80103798:	c7 04 24 b8 8e 10 80 	movl   $0x80108eb8,(%esp)
...
801037b3:	e8 f4 39 00 00       	call   801071ac <uartinit>
  pinit();         // process table
801037b8:	e8 8e 0b 00 00       	call   8010434b <pinit>
  tvinit();        // trap vectors
801037bd:	e8 8d 35 00 00       	call   80106d4f <tvinit>
  binit();         // buffer cache
...
801037df:	e8 ae 34 00 00       	call   80106c92 <timerinit>
...
801037fd:	e8 9f 0c 00 00       	call   801044a1 <userinit>
...
8010380a:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
8010380d:	e8 c3 4c 00 00       	call   801084d5 <switchkvm>
  seginit();
80103812:	e8 4a 46 00 00       	call   80107e61 <seginit>
  lapicinit();
...
80103837:	c7 04 24 cf 8e 10 80 	movl   $0x80108ecf,(%esp)
8010383e:	e8 5e cb ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
80103843:	e8 7b 36 00 00       	call   80106ec3 <idtinit>
...
80103863:	e8 11 13 00 00       	call   80104b79 <scheduler>
...
80103895:	e8 e7 1e 00 00       	call   80105781 <memmove>
...
80103a23:	00 
80103a24:	c7 44 24 04 e0 8e 10 	movl   $0x80108ee0,0x4(%esp)
80103a2b:	80 
80103a2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a2f:	89 04 24             	mov    %eax,(%esp)
80103a32:	e8 ee 1c 00 00       	call   80105725 <memcmp>
...
80103b64:	00 
80103b65:	c7 44 24 04 e5 8e 10 	movl   $0x80108ee5,0x4(%esp)
80103b6c:	80 
80103b6d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b70:	89 04 24             	mov    %eax,(%esp)
80103b73:	e8 ad 1b 00 00       	call   80105725 <memcmp>
...
80103c3e:	8b 04 85 28 8f 10 80 	mov    -0x7fef70d8(,%eax,4),%eax
...
80103c77:	c7 04 24 ea 8e 10 80 	movl   $0x80108eea,(%esp)
...
80103d0a:	c7 04 24 08 8f 10 80 	movl   $0x80108f08,(%esp)
...
8010400f:	c7 44 24 04 3c 8f 10 	movl   $0x80108f3c,0x4(%esp)
80104016:	80 
80104017:	89 04 24             	mov    %eax,(%esp)
8010401a:	e8 1f 14 00 00       	call   8010543e <initlock>
  (*f0)->type = FD_PIPE;
...
801040c7:	e8 93 13 00 00       	call   8010545f <acquire>
  if(writable){
...
801040ea:	e8 12 0d 00 00       	call   80104e01 <wakeup>
...
80104109:	e8 f3 0c 00 00       	call   80104e01 <wakeup>
  }
...
8010412e:	e8 8e 13 00 00       	call   801054c1 <release>
    kfree((char*)p);
...
80104146:	e8 76 13 00 00       	call   801054c1 <release>
}
8010414b:	c9                   	leave  
8010414c:	c3                   	ret    
...
8010415a:	e8 00 13 00 00       	call   8010545f <acquire>
  for(i = 0; i < n; i++){
...
8010418b:	e8 31 13 00 00       	call   801054c1 <release>
        return -1;
...
801041a5:	e8 57 0c 00 00       	call   80104e01 <wakeup>
...
801041bd:	e8 63 0b 00 00       	call   80104d25 <sleep>
...
80104224:	e8 d8 0b 00 00       	call   80104e01 <wakeup>
  release(&p->lock);
80104229:	8b 45 08             	mov    0x8(%ebp),%eax
8010422c:	89 04 24             	mov    %eax,(%esp)
8010422f:	e8 8d 12 00 00       	call   801054c1 <release>
  return n;
...
8010424a:	e8 10 12 00 00       	call   8010545f <acquire>
...
80104264:	e8 58 12 00 00       	call   801054c1 <release>
      return -1;
...
80104286:	e8 9a 0a 00 00       	call   80104d25 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80104316:	e8 e6 0a 00 00       	call   80104e01 <wakeup>
  release(&p->lock);
8010431b:	8b 45 08             	mov    0x8(%ebp),%eax
8010431e:	89 04 24             	mov    %eax,(%esp)
80104321:	e8 9b 11 00 00       	call   801054c1 <release>
  return i;
...
80104351:	c7 44 24 04 44 8f 10 	movl   $0x80108f44,0x4(%esp)
80104358:	80 
80104359:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104360:	e8 d9 10 00 00       	call   8010543e <initlock>
}
80104365:	c9                   	leave  
80104366:	c3                   	ret    
...
80104374:	e8 e6 10 00 00       	call   8010545f <acquire>
...
8010438a:	74 26                	je     801043b2 <allocproc+0x4b>
{
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010438c:	81 45 f4 88 01 00 00 	addl   $0x188,-0xc(%ebp)
80104393:	81 7d f4 b4 9b 11 80 	cmpl   $0x80119bb4,-0xc(%ebp)
8010439a:	72 e6                	jb     80104382 <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
8010439c:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801043a3:	e8 19 11 00 00       	call   801054c1 <release>
  return 0;
801043a8:	b8 00 00 00 00       	mov    $0x0,%eax
801043ad:	e9 ed 00 00 00       	jmp    8010449f <allocproc+0x138>
  char *sp;
...
801043d7:	e8 e5 10 00 00       	call   801054c1 <release>
...
80104410:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  sp -= sizeof *p->tf;
80104413:	83 6d ec 4c          	subl   $0x4c,-0x14(%ebp)
  p->tf = (struct trapframe*)sp;
80104417:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010441a:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010441d:	89 50 18             	mov    %edx,0x18(%eax)
  
  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
80104420:	83 6d ec 04          	subl   $0x4,-0x14(%ebp)
  *(uint*)sp = (uint)trapret;
80104424:	ba 04 6d 10 80       	mov    $0x80106d04,%edx
80104429:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010442c:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
8010442e:	83 6d ec 14          	subl   $0x14,-0x14(%ebp)
  p->context = (struct context*)sp;
80104432:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104435:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104438:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
8010443b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010443e:	8b 40 1c             	mov    0x1c(%eax),%eax
80104441:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80104448:	00 
80104449:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104450:	00 
80104451:	89 04 24             	mov    %eax,(%esp)
80104454:	e8 55 12 00 00       	call   801056ae <memset>
  p->context->eip = (uint)forkret;
80104459:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010445c:	8b 40 1c             	mov    0x1c(%eax),%eax
8010445f:	ba f9 4c 10 80       	mov    $0x80104cf9,%edx
80104464:	89 50 10             	mov    %edx,0x10(%eax)

  // Setup mutex stuff
  int iterate;
  for(iterate = 0; iterate < 32; iterate++){
80104467:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
8010446e:	eb 26                	jmp    80104496 <allocproc+0x12f>
  	p->locks[iterate] = 0;
80104470:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104473:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104476:	83 c2 40             	add    $0x40,%edx
80104479:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80104480:	00 
  	p->flags[iterate] = 0;
80104481:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104484:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104487:	83 c2 20             	add    $0x20,%edx
8010448a:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80104491:	00 
  memset(p->context, 0, sizeof *p->context);
  p->context->eip = (uint)forkret;
  ...
  int iterate;
  for(iterate = 0; iterate < 32; iterate++){
80104492:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104496:	83 7d f0 1f          	cmpl   $0x1f,-0x10(%ebp)
8010449a:	7e d4                	jle    80104470 <allocproc+0x109>
  	p->locks[iterate] = 0;
  	p->flags[iterate] = 0;
  }
...
801044a4:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  extern char _binary_initcode_start[], _binary_initcode_size[];
  
  p = allocproc();
801044a7:	e8 bb fe ff ff       	call   80104367 <allocproc>
801044ac:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
801044af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044b2:	a3 68 c6 10 80       	mov    %eax,0x8010c668
  if((p->pgdir = setupkvm()) == 0)
801044b7:	e8 45 3f 00 00       	call   80108401 <setupkvm>
801044bc:	8b 55 f4             	mov    -0xc(%ebp),%edx
801044bf:	89 42 04             	mov    %eax,0x4(%edx)
801044c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044c5:	8b 40 04             	mov    0x4(%eax),%eax
801044c8:	85 c0                	test   %eax,%eax
801044ca:	75 0c                	jne    801044d8 <userinit+0x37>
    panic("userinit: out of memory?");
801044cc:	c7 04 24 4b 8f 10 80 	movl   $0x80108f4b,(%esp)
801044d3:	e8 65 c0 ff ff       	call   8010053d <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
801044d8:	ba 2c 00 00 00       	mov    $0x2c,%edx
801044dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044e0:	8b 40 04             	mov    0x4(%eax),%eax
801044e3:	89 54 24 08          	mov    %edx,0x8(%esp)
801044e7:	c7 44 24 04 00 c5 10 	movl   $0x8010c500,0x4(%esp)
801044ee:	80 
801044ef:	89 04 24             	mov    %eax,(%esp)
801044f2:	e8 62 41 00 00       	call   80108659 <inituvm>
  p->sz = PGSIZE;
801044f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044fa:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
80104500:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104503:	8b 40 18             	mov    0x18(%eax),%eax
80104506:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
8010450d:	00 
8010450e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104515:	00 
80104516:	89 04 24             	mov    %eax,(%esp)
80104519:	e8 90 11 00 00       	call   801056ae <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010451e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104521:	8b 40 18             	mov    0x18(%eax),%eax
80104524:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
8010452a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010452d:	8b 40 18             	mov    0x18(%eax),%eax
80104530:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
80104536:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104539:	8b 40 18             	mov    0x18(%eax),%eax
8010453c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010453f:	8b 52 18             	mov    0x18(%edx),%edx
80104542:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104546:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
...
8010455a:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
8010455e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104561:	8b 40 18             	mov    0x18(%eax),%eax
80104564:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
8010456b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010456e:	8b 40 18             	mov    0x18(%eax),%eax
80104571:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80104578:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010457b:	8b 40 18             	mov    0x18(%eax),%eax
8010457e:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
80104585:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104588:	83 c0 6c             	add    $0x6c,%eax
8010458b:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104592:	00 
80104593:	c7 44 24 04 64 8f 10 	movl   $0x80108f64,0x4(%esp)
8010459a:	80 
8010459b:	89 04 24             	mov    %eax,(%esp)
8010459e:	e8 3b 13 00 00       	call   801058de <safestrcpy>
  p->cwd = namei("/");
801045a3:	c7 04 24 6d 8f 10 80 	movl   $0x80108f6d,(%esp)
801045aa:	e8 67 de ff ff       	call   80102416 <namei>
801045af:	8b 55 f4             	mov    -0xc(%ebp),%edx
801045b2:	89 42 68             	mov    %eax,0x68(%edx)

  p->state = RUNNABLE;
801045b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045b8:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
}
801045bf:	c9                   	leave  
801045c0:	c3                   	ret    
...
801045cf:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
801045d2:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801045d6:	7e 34                	jle    8010460c <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
801045d8:	8b 45 08             	mov    0x8(%ebp),%eax
801045db:	89 c2                	mov    %eax,%edx
801045dd:	03 55 f4             	add    -0xc(%ebp),%edx
801045e0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045e6:	8b 40 04             	mov    0x4(%eax),%eax
801045e9:	89 54 24 08          	mov    %edx,0x8(%esp)
801045ed:	8b 55 f4             	mov    -0xc(%ebp),%edx
801045f0:	89 54 24 04          	mov    %edx,0x4(%esp)
801045f4:	89 04 24             	mov    %eax,(%esp)
801045f7:	e8 d7 41 00 00       	call   801087d3 <allocuvm>
801045fc:	89 45 f4             	mov    %eax,-0xc(%ebp)
801045ff:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104603:	75 41                	jne    80104646 <growproc+0x85>
      return -1;
80104605:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010460a:	eb 58                	jmp    80104664 <growproc+0xa3>
  } else if(n < 0){
8010460c:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104610:	79 34                	jns    80104646 <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
80104612:	8b 45 08             	mov    0x8(%ebp),%eax
80104615:	89 c2                	mov    %eax,%edx
80104617:	03 55 f4             	add    -0xc(%ebp),%edx
8010461a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104620:	8b 40 04             	mov    0x4(%eax),%eax
80104623:	89 54 24 08          	mov    %edx,0x8(%esp)
80104627:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010462a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010462e:	89 04 24             	mov    %eax,(%esp)
80104631:	e8 77 42 00 00       	call   801088ad <deallocuvm>
80104636:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104639:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010463d:	75 07                	jne    80104646 <growproc+0x85>
      return -1;
8010463f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104644:	eb 1e                	jmp    80104664 <growproc+0xa3>
  }
  proc->sz = sz;
...
8010465a:	e8 93 3e 00 00       	call   801084f2 <switchuvm>
  return 0;
...
8010466c:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
8010466f:	e8 f3 fc ff ff       	call   80104367 <allocproc>
80104674:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104677:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
8010467b:	75 0a                	jne    80104687 <fork+0x21>
    return -1;
8010467d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104682:	e9 52 01 00 00       	jmp    801047d9 <fork+0x173>
...
8010469f:	e8 99 43 00 00       	call   80108a3d <copyuvm>
801046a4:	8b 55 e0             	mov    -0x20(%ebp),%edx
801046a7:	89 42 04             	mov    %eax,0x4(%edx)
801046aa:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046ad:	8b 40 04             	mov    0x4(%eax),%eax
801046b0:	85 c0                	test   %eax,%eax
801046b2:	75 2c                	jne    801046e0 <fork+0x7a>
    kfree(np->kstack);
801046b4:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046b7:	8b 40 08             	mov    0x8(%eax),%eax
801046ba:	89 04 24             	mov    %eax,(%esp)
801046bd:	e8 b0 e3 ff ff       	call   80102a72 <kfree>
    np->kstack = 0;
801046c2:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046c5:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
...
801046db:	e9 f9 00 00 00       	jmp    801047d9 <fork+0x173>
  }
  np->sz = proc->sz;
...
8010471e:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
80104725:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
8010472c:	eb 3d                	jmp    8010476b <fork+0x105>
    if(proc->ofile[i])
8010472e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104734:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104737:	83 c2 08             	add    $0x8,%edx
8010473a:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010473e:	85 c0                	test   %eax,%eax
80104740:	74 25                	je     80104767 <fork+0x101>
...
80104755:	e8 2e c8 ff ff       	call   80100f88 <filedup>
8010475a:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010475d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104760:	83 c1 08             	add    $0x8,%ecx
80104763:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  *np->tf = *proc->tf;
  ...
  for(i = 0; i < NOFILE; i++)
80104767:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
8010476b:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
8010476f:	7e bd                	jle    8010472e <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
80104771:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104777:	8b 40 68             	mov    0x68(%eax),%eax
8010477a:	89 04 24             	mov    %eax,(%esp)
8010477d:	e8 c0 d0 ff ff       	call   80101842 <idup>
80104782:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104785:	89 42 68             	mov    %eax,0x68(%edx)

  safestrcpy(np->name, proc->name, sizeof(proc->name));
80104788:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010478e:	8d 50 6c             	lea    0x6c(%eax),%edx
80104791:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104794:	83 c0 6c             	add    $0x6c,%eax
80104797:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010479e:	00 
8010479f:	89 54 24 04          	mov    %edx,0x4(%esp)
801047a3:	89 04 24             	mov    %eax,(%esp)
801047a6:	e8 33 11 00 00       	call   801058de <safestrcpy>
...
801047b1:	89 45 dc             	mov    %eax,-0x24(%ebp)
  ...
  acquire(&ptable.lock);
801047b4:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801047bb:	e8 9f 0c 00 00       	call   8010545f <acquire>
  np->state = RUNNABLE;
801047c0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047c3:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  release(&ptable.lock);
801047ca:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801047d1:	e8 eb 0c 00 00       	call   801054c1 <release>
  
  return pid;
801047d6:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
801047d9:	83 c4 2c             	add    $0x2c,%esp
801047dc:	5b                   	pop    %ebx
801047dd:	5e                   	pop    %esi
801047de:	5f                   	pop    %edi
801047df:	5d                   	pop    %ebp
...
801047ee:	a1 68 c6 10 80       	mov    0x8010c668,%eax
801047f3:	39 c2                	cmp    %eax,%edx
801047f5:	75 0c                	jne    80104803 <exit+0x22>
    panic("init exiting");
801047f7:	c7 04 24 6f 8f 10 80 	movl   $0x80108f6f,(%esp)
801047fe:	e8 3a bd ff ff       	call   8010053d <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104803:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
8010480a:	eb 44                	jmp    80104850 <exit+0x6f>
    if(proc->ofile[fd]){
8010480c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104812:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104815:	83 c2 08             	add    $0x8,%edx
80104818:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010481c:	85 c0                	test   %eax,%eax
8010481e:	74 2c                	je     8010484c <exit+0x6b>
      fileclose(proc->ofile[fd]);
80104820:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104826:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104829:	83 c2 08             	add    $0x8,%edx
8010482c:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104830:	89 04 24             	mov    %eax,(%esp)
80104833:	e8 98 c7 ff ff       	call   80100fd0 <fileclose>
      proc->ofile[fd] = 0;
80104838:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010483e:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104841:	83 c2 08             	add    $0x8,%edx
80104844:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010484b:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
8010484c:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104850:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104854:	7e b6                	jle    8010480c <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
80104856:	e8 06 ec ff ff       	call   80103461 <begin_op>
  iput(proc->cwd);
8010485b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104861:	8b 40 68             	mov    0x68(%eax),%eax
80104864:	89 04 24             	mov    %eax,(%esp)
80104867:	e8 bb d1 ff ff       	call   80101a27 <iput>
  end_op();
8010486c:	e8 71 ec ff ff       	call   801034e2 <end_op>
  proc->cwd = 0;
80104871:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104877:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
8010487e:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104885:	e8 d5 0b 00 00       	call   8010545f <acquire>

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
8010488a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104890:	8b 40 14             	mov    0x14(%eax),%eax
80104893:	89 04 24             	mov    %eax,(%esp)
80104896:	e8 25 05 00 00       	call   80104dc0 <wakeup1>

  // Pass abandoned children to init.
  // And kill the child threads and free their stacks
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010489b:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
801048a2:	eb 3b                	jmp    801048df <exit+0xfe>
    if(p->parent == proc){
...
801048b2:	75 24                	jne    801048d8 <exit+0xf7>
      p->parent = initproc;
801048b4:	8b 15 68 c6 10 80    	mov    0x8010c668,%edx
...
801048c9:	75 0d                	jne    801048d8 <exit+0xf7>
        wakeup1(initproc);
801048cb:	a1 68 c6 10 80       	mov    0x8010c668,%eax
801048d0:	89 04 24             	mov    %eax,(%esp)
801048d3:	e8 e8 04 00 00       	call   80104dc0 <wakeup1>
  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
  ...
  // And kill the child threads and free their stacks
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048d8:	81 45 f4 88 01 00 00 	addl   $0x188,-0xc(%ebp)
801048df:	81 7d f4 b4 9b 11 80 	cmpl   $0x80119bb4,-0xc(%ebp)
801048e6:	72 bc                	jb     801048a4 <exit+0xc3>
        wakeup1(initproc);
    }
  }   
...
801048ee:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
801048f5:	e8 1b 03 00 00       	call   80104c15 <sched>
  panic("zombie exit");
801048fa:	c7 04 24 7c 8f 10 80 	movl   $0x80108f7c,(%esp)
80104901:	e8 37 bc ff ff       	call   8010053d <panic>
...
80104909:	83 ec 28             	sub    $0x28,%esp
  //cprintf("texit's retval parameter contains [%d]\n", retval);
  struct proc *p;
  int fd;

  if(proc == initproc)
8010490c:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104913:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104918:	39 c2                	cmp    %eax,%edx
8010491a:	75 0c                	jne    80104928 <texit+0x22>
    panic("init exiting");
8010491c:	c7 04 24 6f 8f 10 80 	movl   $0x80108f6f,(%esp)
80104923:	e8 15 bc ff ff       	call   8010053d <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104928:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
8010492f:	eb 44                	jmp    80104975 <texit+0x6f>
    if(proc->ofile[fd]){
...
80104943:	74 2c                	je     80104971 <texit+0x6b>
      fileclose(proc->ofile[fd]);
...
80104958:	e8 73 c6 ff ff       	call   80100fd0 <fileclose>
      proc->ofile[fd] = 0;
8010495d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104963:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104966:	83 c2 08             	add    $0x8,%edx
80104969:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80104970:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104971:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104975:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104979:	7e b6                	jle    80104931 <texit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
8010497b:	e8 e1 ea ff ff       	call   80103461 <begin_op>
  iput(proc->cwd);
80104980:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104986:	8b 40 68             	mov    0x68(%eax),%eax
80104989:	89 04 24             	mov    %eax,(%esp)
8010498c:	e8 96 d0 ff ff       	call   80101a27 <iput>
  end_op();
80104991:	e8 4c eb ff ff       	call   801034e2 <end_op>
  proc->cwd = 0;
80104996:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010499c:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
801049a3:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801049aa:	e8 b0 0a 00 00       	call   8010545f <acquire>
...
801049bb:	e8 00 04 00 00       	call   80104dc0 <wakeup1>

  // Pass abandoned children to init.
  // And kill the child threads and free their stacks
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049c0:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
801049c7:	eb 6b                	jmp    80104a34 <texit+0x12e>
    if(p->parent == proc){
...
801049d7:	75 54                	jne    80104a2d <texit+0x127>
      p->parent = initproc;
801049d9:	8b 15 68 c6 10 80    	mov    0x8010c668,%edx
...
801049e8:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
801049ee:	83 f8 01             	cmp    $0x1,%eax
801049f1:	75 22                	jne    80104a15 <texit+0x10f>
        p->state = UNUSED;
801049f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049f6:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        kfree(p->kstack);
801049fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a00:	8b 40 08             	mov    0x8(%eax),%eax
80104a03:	89 04 24             	mov    %eax,(%esp)
80104a06:	e8 67 e0 ff ff       	call   80102a72 <kfree>
        p->kstack = 0;
...
80104a1b:	83 f8 05             	cmp    $0x5,%eax
80104a1e:	75 0d                	jne    80104a2d <texit+0x127>
        wakeup1(initproc);
80104a20:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104a25:	89 04 24             	mov    %eax,(%esp)
80104a28:	e8 93 03 00 00       	call   80104dc0 <wakeup1>
  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
  ...
  // And kill the child threads and free their stacks
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a2d:	81 45 f4 88 01 00 00 	addl   $0x188,-0xc(%ebp)
80104a34:	81 7d f4 b4 9b 11 80 	cmpl   $0x80119bb4,-0xc(%ebp)
80104a3b:	72 8c                	jb     801049c9 <texit+0xc3>
    }
  }   

  // Jump into the scheduler, never to return.
  // Save the value of retval into proc so join can retrieve it later
  proc->retval = (int)retval;
80104a3d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a43:	8b 55 08             	mov    0x8(%ebp),%edx
80104a46:	89 50 7c             	mov    %edx,0x7c(%eax)
  proc->state = ZOMBIE;
80104a49:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a4f:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104a56:	e8 ba 01 00 00       	call   80104c15 <sched>
  panic("zombie exit");
80104a5b:	c7 04 24 7c 8f 10 80 	movl   $0x80108f7c,(%esp)
80104a62:	e8 d6 ba ff ff       	call   8010053d <panic>
...
80104a6a:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104a6d:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104a74:	e8 e6 09 00 00       	call   8010545f <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104a79:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a80:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104a87:	e9 9d 00 00 00       	jmp    80104b29 <wait+0xc2>
      if(p->parent != proc)
80104a8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a8f:	8b 50 14             	mov    0x14(%eax),%edx
80104a92:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a98:	39 c2                	cmp    %eax,%edx
80104a9a:	0f 85 81 00 00 00    	jne    80104b21 <wait+0xba>
        continue;
      havekids = 1;
80104aa0:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
80104aa7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104aaa:	8b 40 0c             	mov    0xc(%eax),%eax
80104aad:	83 f8 05             	cmp    $0x5,%eax
80104ab0:	75 70                	jne    80104b22 <wait+0xbb>
        // Found one.
        pid = p->pid;
80104ab2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ab5:	8b 40 10             	mov    0x10(%eax),%eax
80104ab8:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
80104abb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104abe:	8b 40 08             	mov    0x8(%eax),%eax
80104ac1:	89 04 24             	mov    %eax,(%esp)
80104ac4:	e8 a9 df ff ff       	call   80102a72 <kfree>
        p->kstack = 0;
...
80104adc:	e8 88 3e 00 00       	call   80108969 <freevm>
        p->state = UNUSED;
80104ae1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ae4:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
80104aeb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104aee:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80104af5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104af8:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
80104aff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b02:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
80104b06:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b09:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80104b10:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104b17:	e8 a5 09 00 00       	call   801054c1 <release>
        return pid;
80104b1c:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104b1f:	eb 56                	jmp    80104b77 <wait+0x110>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104b21:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b22:	81 45 f4 88 01 00 00 	addl   $0x188,-0xc(%ebp)
80104b29:	81 7d f4 b4 9b 11 80 	cmpl   $0x80119bb4,-0xc(%ebp)
80104b30:	0f 82 56 ff ff ff    	jb     80104a8c <wait+0x25>
        return pid;
      }
    }
...
80104b3a:	74 0d                	je     80104b49 <wait+0xe2>
80104b3c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b42:	8b 40 24             	mov    0x24(%eax),%eax
80104b45:	85 c0                	test   %eax,%eax
80104b47:	74 13                	je     80104b5c <wait+0xf5>
      release(&ptable.lock);
80104b49:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104b50:	e8 6c 09 00 00       	call   801054c1 <release>
      return -1;
80104b55:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b5a:	eb 1b                	jmp    80104b77 <wait+0x110>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104b5c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b62:	c7 44 24 04 80 39 11 	movl   $0x80113980,0x4(%esp)
80104b69:	80 
80104b6a:	89 04 24             	mov    %eax,(%esp)
80104b6d:	e8 b3 01 00 00       	call   80104d25 <sleep>
  }
80104b72:	e9 02 ff ff ff       	jmp    80104a79 <wait+0x12>
}
80104b77:	c9                   	leave  
80104b78:	c3                   	ret    
...
80104b7c:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
80104b7f:	e8 c1 f7 ff ff       	call   80104345 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104b84:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104b8b:	e8 cf 08 00 00       	call   8010545f <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b90:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104b97:	eb 62                	jmp    80104bfb <scheduler+0x82>
      if(p->state != RUNNABLE)
80104b99:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b9c:	8b 40 0c             	mov    0xc(%eax),%eax
80104b9f:	83 f8 03             	cmp    $0x3,%eax
80104ba2:	75 4f                	jne    80104bf3 <scheduler+0x7a>
        continue;
...
80104ba7:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80104bad:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bb0:	89 04 24             	mov    %eax,(%esp)
80104bb3:	e8 3a 39 00 00       	call   801084f2 <switchuvm>
      p->state = RUNNING;
80104bb8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bbb:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
...
80104bd2:	83 c2 04             	add    $0x4,%edx
80104bd5:	89 44 24 04          	mov    %eax,0x4(%esp)
80104bd9:	89 14 24             	mov    %edx,(%esp)
80104bdc:	e8 73 0d 00 00       	call   80105954 <swtch>
      switchkvm();
80104be1:	e8 ef 38 00 00       	call   801084d5 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
80104be6:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104bed:	00 00 00 00 
80104bf1:	eb 01                	jmp    80104bf4 <scheduler+0x7b>
...
80104bf3:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104bf4:	81 45 f4 88 01 00 00 	addl   $0x188,-0xc(%ebp)
80104bfb:	81 7d f4 b4 9b 11 80 	cmpl   $0x80119bb4,-0xc(%ebp)
80104c02:	72 95                	jb     80104b99 <scheduler+0x20>
...
80104c0b:	e8 b1 08 00 00       	call   801054c1 <release>

  }
80104c10:	e9 6a ff ff ff       	jmp    80104b7f <scheduler+0x6>
...
80104c1b:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104c22:	e8 56 09 00 00       	call   8010557d <holding>
80104c27:	85 c0                	test   %eax,%eax
80104c29:	75 0c                	jne    80104c37 <sched+0x22>
    panic("sched ptable.lock");
80104c2b:	c7 04 24 88 8f 10 80 	movl   $0x80108f88,(%esp)
80104c32:	e8 06 b9 ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
80104c37:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c3d:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104c43:	83 f8 01             	cmp    $0x1,%eax
80104c46:	74 0c                	je     80104c54 <sched+0x3f>
    panic("sched locks");
80104c48:	c7 04 24 9a 8f 10 80 	movl   $0x80108f9a,(%esp)
...
80104c5d:	83 f8 04             	cmp    $0x4,%eax
80104c60:	75 0c                	jne    80104c6e <sched+0x59>
    panic("sched running");
80104c62:	c7 04 24 a6 8f 10 80 	movl   $0x80108fa6,(%esp)
80104c69:	e8 cf b8 ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
80104c6e:	e8 bd f6 ff ff       	call   80104330 <readeflags>
80104c73:	25 00 02 00 00       	and    $0x200,%eax
80104c78:	85 c0                	test   %eax,%eax
80104c7a:	74 0c                	je     80104c88 <sched+0x73>
    panic("sched interruptible");
80104c7c:	c7 04 24 b4 8f 10 80 	movl   $0x80108fb4,(%esp)
...
80104cb1:	e8 9e 0c 00 00       	call   80105954 <swtch>
  cpu->intena = intena;
...
80104cd4:	e8 86 07 00 00       	call   8010545f <acquire>
  proc->state = RUNNABLE;
80104cd9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cdf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104ce6:	e8 2a ff ff ff       	call   80104c15 <sched>
  release(&ptable.lock);
80104ceb:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104cf2:	e8 ca 07 00 00       	call   801054c1 <release>
}
80104cf7:	c9                   	leave  
80104cf8:	c3                   	ret    
...
80104cfc:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104cff:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104d06:	e8 b6 07 00 00       	call   801054c1 <release>

  if (first) {
80104d0b:	a1 20 c0 10 80       	mov    0x8010c020,%eax
80104d10:	85 c0                	test   %eax,%eax
80104d12:	74 0f                	je     80104d23 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104d14:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
80104d1b:	00 00 00 
    initlog();
80104d1e:	e8 31 e5 ff ff       	call   80103254 <initlog>
  }
...
80104d33:	75 0c                	jne    80104d41 <sleep+0x1c>
    panic("sleep");
80104d35:	c7 04 24 c8 8f 10 80 	movl   $0x80108fc8,(%esp)
80104d3c:	e8 fc b7 ff ff       	call   8010053d <panic>

  if(lk == 0)
80104d41:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104d45:	75 0c                	jne    80104d53 <sleep+0x2e>
    panic("sleep without lk");
80104d47:	c7 04 24 ce 8f 10 80 	movl   $0x80108fce,(%esp)
...
80104d53:	81 7d 0c 80 39 11 80 	cmpl   $0x80113980,0xc(%ebp)
80104d5a:	74 17                	je     80104d73 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104d5c:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104d63:	e8 f7 06 00 00       	call   8010545f <acquire>
    release(lk);
80104d68:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d6b:	89 04 24             	mov    %eax,(%esp)
80104d6e:	e8 4e 07 00 00       	call   801054c1 <release>
  }
...
80104d85:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104d8c:	e8 84 fe ff ff       	call   80104c15 <sched>

  // Tidy up.
  proc->chan = 0;
80104d91:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d97:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104d9e:	81 7d 0c 80 39 11 80 	cmpl   $0x80113980,0xc(%ebp)
80104da5:	74 17                	je     80104dbe <sleep+0x99>
    release(&ptable.lock);
80104da7:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104dae:	e8 0e 07 00 00       	call   801054c1 <release>
    acquire(lk);
80104db3:	8b 45 0c             	mov    0xc(%ebp),%eax
80104db6:	89 04 24             	mov    %eax,(%esp)
80104db9:	e8 a1 06 00 00       	call   8010545f <acquire>
  }
}
80104dbe:	c9                   	leave  
80104dbf:	c3                   	ret    
...
80104dc3:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104dc6:	c7 45 fc b4 39 11 80 	movl   $0x801139b4,-0x4(%ebp)
80104dcd:	eb 27                	jmp    80104df6 <wakeup1+0x36>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104def:	81 45 fc 88 01 00 00 	addl   $0x188,-0x4(%ebp)
80104df6:	81 7d fc b4 9b 11 80 	cmpl   $0x80119bb4,-0x4(%ebp)
80104dfd:	72 d0                	jb     80104dcf <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80104dff:	c9                   	leave  
...
80104e0e:	e8 4c 06 00 00       	call   8010545f <acquire>
  wakeup1(chan);
80104e13:	8b 45 08             	mov    0x8(%ebp),%eax
80104e16:	89 04 24             	mov    %eax,(%esp)
80104e19:	e8 a2 ff ff ff       	call   80104dc0 <wakeup1>
  release(&ptable.lock);
80104e1e:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104e25:	e8 97 06 00 00       	call   801054c1 <release>
}
80104e2a:	c9                   	leave  
80104e2b:	c3                   	ret    
...
80104e2f:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104e32:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104e39:	e8 21 06 00 00       	call   8010545f <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e3e:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104e45:	eb 44                	jmp    80104e8b <kill+0x5f>
    if(p->pid == pid){
80104e47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e4a:	8b 40 10             	mov    0x10(%eax),%eax
80104e4d:	3b 45 08             	cmp    0x8(%ebp),%eax
80104e50:	75 32                	jne    80104e84 <kill+0x58>
      p->killed = 1;
...
80104e65:	75 0a                	jne    80104e71 <kill+0x45>
        p->state = RUNNABLE;
80104e67:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e6a:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104e71:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104e78:	e8 44 06 00 00       	call   801054c1 <release>
      return 0;
80104e7d:	b8 00 00 00 00       	mov    $0x0,%eax
80104e82:	eb 21                	jmp    80104ea5 <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e84:	81 45 f4 88 01 00 00 	addl   $0x188,-0xc(%ebp)
80104e8b:	81 7d f4 b4 9b 11 80 	cmpl   $0x80119bb4,-0xc(%ebp)
80104e92:	72 b3                	jb     80104e47 <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80104e94:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104e9b:	e8 21 06 00 00       	call   801054c1 <release>
  return -1;
...
80104eaa:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104ead:	c7 45 f0 b4 39 11 80 	movl   $0x801139b4,-0x10(%ebp)
80104eb4:	e9 db 00 00 00       	jmp    80104f94 <procdump+0xed>
    if(p->state == UNUSED)
80104eb9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ebc:	8b 40 0c             	mov    0xc(%eax),%eax
80104ebf:	85 c0                	test   %eax,%eax
80104ec1:	0f 84 c5 00 00 00    	je     80104f8c <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104ec7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104eca:	8b 40 0c             	mov    0xc(%eax),%eax
80104ecd:	83 f8 05             	cmp    $0x5,%eax
80104ed0:	77 23                	ja     80104ef5 <procdump+0x4e>
80104ed2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ed5:	8b 40 0c             	mov    0xc(%eax),%eax
80104ed8:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80104edf:	85 c0                	test   %eax,%eax
80104ee1:	74 12                	je     80104ef5 <procdump+0x4e>
      state = states[p->state];
80104ee3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ee6:	8b 40 0c             	mov    0xc(%eax),%eax
80104ee9:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80104ef0:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104ef3:	eb 07                	jmp    80104efc <procdump+0x55>
    else
      state = "???";
80104ef5:	c7 45 ec df 8f 10 80 	movl   $0x80108fdf,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104efc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104eff:	8d 50 6c             	lea    0x6c(%eax),%edx
80104f02:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f05:	8b 40 10             	mov    0x10(%eax),%eax
80104f08:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104f0c:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104f0f:	89 54 24 08          	mov    %edx,0x8(%esp)
80104f13:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f17:	c7 04 24 e3 8f 10 80 	movl   $0x80108fe3,(%esp)
80104f1e:	e8 7e b4 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80104f23:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f26:	8b 40 0c             	mov    0xc(%eax),%eax
80104f29:	83 f8 02             	cmp    $0x2,%eax
80104f2c:	75 50                	jne    80104f7e <procdump+0xd7>
...
80104f3a:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104f3d:	89 54 24 04          	mov    %edx,0x4(%esp)
80104f41:	89 04 24             	mov    %eax,(%esp)
80104f44:	e8 c7 05 00 00       	call   80105510 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104f49:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104f50:	eb 1b                	jmp    80104f6d <procdump+0xc6>
        cprintf(" %p", pc[i]);
80104f52:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f55:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104f59:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f5d:	c7 04 24 ec 8f 10 80 	movl   $0x80108fec,(%esp)
...
80104f71:	7f 0b                	jg     80104f7e <procdump+0xd7>
80104f73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f76:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104f7a:	85 c0                	test   %eax,%eax
80104f7c:	75 d4                	jne    80104f52 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104f7e:	c7 04 24 f0 8f 10 80 	movl   $0x80108ff0,(%esp)
80104f85:	e8 17 b4 ff ff       	call   801003a1 <cprintf>
80104f8a:	eb 01                	jmp    80104f8d <procdump+0xe6>
  char *state;
  uint pc[10];
...
80104f8c:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f8d:	81 45 f0 88 01 00 00 	addl   $0x188,-0x10(%ebp)
80104f94:	81 7d f0 b4 9b 11 80 	cmpl   $0x80119bb4,-0x10(%ebp)
80104f9b:	0f 82 18 ff ff ff    	jb     80104eb9 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104fa9:	83 ec 2c             	sub    $0x2c,%esp
  int i;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0){
80104fac:	e8 b6 f3 ff ff       	call   80104367 <allocproc>
80104fb1:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104fb4:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104fb8:	75 0a                	jne    80104fc4 <clone+0x21>
    return -1;
80104fba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104fbf:	e9 8f 01 00 00       	jmp    80105153 <clone+0x1b0>
}

  // reallocate old process's page table to new process
  np->pgdir = proc->pgdir;  
80104fc4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fca:	8b 50 04             	mov    0x4(%eax),%edx
80104fcd:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104fd0:	89 50 04             	mov    %edx,0x4(%eax)
  // set size of process memory
  np->sz = proc->sz;
80104fd3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fd9:	8b 10                	mov    (%eax),%edx
80104fdb:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104fde:	89 10                	mov    %edx,(%eax)

  // set parent of new process
  if(proc->isthread == 0){
80104fe0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fe6:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104fec:	85 c0                	test   %eax,%eax
80104fee:	75 0f                	jne    80104fff <clone+0x5c>
  	np->parent = proc;
80104ff0:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104ff7:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104ffa:	89 50 14             	mov    %edx,0x14(%eax)
80104ffd:	eb 0f                	jmp    8010500e <clone+0x6b>
  }
  else{
...
8010500b:	89 50 14             	mov    %edx,0x14(%eax)
  }

  // copy the trapframe
  *np->tf = *proc->tf;
8010500e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105011:	8b 50 18             	mov    0x18(%eax),%edx
80105014:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010501a:	8b 40 18             	mov    0x18(%eax),%eax
8010501d:	89 c3                	mov    %eax,%ebx
8010501f:	b8 13 00 00 00       	mov    $0x13,%eax
80105024:	89 d7                	mov    %edx,%edi
80105026:	89 de                	mov    %ebx,%esi
80105028:	89 c1                	mov    %eax,%ecx
8010502a:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
8010502c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010502f:	8b 40 18             	mov    0x18(%eax),%eax
80105032:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  // modified the return ip to the given function parameter
  np->tf->eip = (int)function;
80105039:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010503c:	8b 40 18             	mov    0x18(%eax),%eax
8010503f:	8b 55 08             	mov    0x8(%ebp),%edx
80105042:	89 50 38             	mov    %edx,0x38(%eax)
  // modified the thread indicator's value
  np->isthread = 1;
80105045:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105048:	c7 80 80 00 00 00 01 	movl   $0x1,0x80(%eax)
8010504f:	00 00 00 
  // modified the stack to the given stack parameter 
  np->stack = (int)stack;
80105052:	8b 55 10             	mov    0x10(%ebp),%edx
80105055:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105058:	89 90 84 00 00 00    	mov    %edx,0x84(%eax)
  // move esp to the top of the new stack
...
80105067:	81 c2 fc 0f 00 00    	add    $0xffc,%edx
8010506d:	89 50 44             	mov    %edx,0x44(%eax)
  // push the argument
  *((int *)(np->tf->esp)) = (int)arg; 
80105070:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105073:	8b 40 18             	mov    0x18(%eax),%eax
80105076:	8b 40 44             	mov    0x44(%eax),%eax
80105079:	8b 55 0c             	mov    0xc(%ebp),%edx
8010507c:	89 10                	mov    %edx,(%eax)
...
80105087:	83 e8 04             	sub    $0x4,%eax
8010508a:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
  // modify esp for the return address push
  np->tf->esp -= 4;
80105090:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105093:	8b 40 18             	mov    0x18(%eax),%eax
80105096:	8b 55 e0             	mov    -0x20(%ebp),%edx
80105099:	8b 52 18             	mov    0x18(%edx),%edx
8010509c:	8b 52 44             	mov    0x44(%edx),%edx
8010509f:	83 ea 04             	sub    $0x4,%edx
801050a2:	89 50 44             	mov    %edx,0x44(%eax)

  for(i = 0; i < NOFILE; i++)
801050a5:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801050ac:	eb 3d                	jmp    801050eb <clone+0x148>
    if(proc->ofile[i])
801050ae:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801050b4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801050b7:	83 c2 08             	add    $0x8,%edx
801050ba:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801050be:	85 c0                	test   %eax,%eax
801050c0:	74 25                	je     801050e7 <clone+0x144>
      np->ofile[i] = filedup(proc->ofile[i]);
...
801050d5:	e8 ae be ff ff       	call   80100f88 <filedup>
801050da:	8b 55 e0             	mov    -0x20(%ebp),%edx
801050dd:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801050e0:	83 c1 08             	add    $0x8,%ecx
801050e3:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  // push the return address
  *((int *)(np->tf->esp - 4)) = 0xFFFFFFFF; 
  // modify esp for the return address push
  np->tf->esp -= 4;
  ...
  for(i = 0; i < NOFILE; i++)
801050e7:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
801050eb:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
801050ef:	7e bd                	jle    801050ae <clone+0x10b>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
801050f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801050f7:	8b 40 68             	mov    0x68(%eax),%eax
801050fa:	89 04 24             	mov    %eax,(%esp)
801050fd:	e8 40 c7 ff ff       	call   80101842 <idup>
80105102:	8b 55 e0             	mov    -0x20(%ebp),%edx
80105105:	89 42 68             	mov    %eax,0x68(%edx)

  safestrcpy(np->name, proc->name, sizeof(proc->name));
80105108:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010510e:	8d 50 6c             	lea    0x6c(%eax),%edx
80105111:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105114:	83 c0 6c             	add    $0x6c,%eax
80105117:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010511e:	00 
8010511f:	89 54 24 04          	mov    %edx,0x4(%esp)
80105123:	89 04 24             	mov    %eax,(%esp)
80105126:	e8 b3 07 00 00       	call   801058de <safestrcpy>
 
  //pid = np->pid;

  acquire(&ptable.lock);
8010512b:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105132:	e8 28 03 00 00       	call   8010545f <acquire>
  np->state = RUNNABLE;
80105137:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010513a:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  release(&ptable.lock);
80105141:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105148:	e8 74 03 00 00       	call   801054c1 <release>

  // exit();
  return np->pid;
8010514d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105150:	8b 40 10             	mov    0x10(%eax),%eax
}
80105153:	83 c4 2c             	add    $0x2c,%esp
80105156:	5b                   	pop    %ebx
80105157:	5e                   	pop    %esi
80105158:	5f                   	pop    %edi
80105159:	5d                   	pop    %ebp
...
int
join(int passedPid, void **stack, void **retval)
{
8010515b:	55                   	push   %ebp
8010515c:	89 e5                	mov    %esp,%ebp
8010515e:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int havekids, pid;

  acquire(&ptable.lock);
80105161:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105168:	e8 f2 02 00 00       	call   8010545f <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
8010516d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105174:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
8010517b:	e9 c9 00 00 00       	jmp    80105249 <join+0xee>
      // only wait for the child thread, but not the child process
      if(p->parent != proc || p->isthread != 1 || p->pid != passedPid)
80105180:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105183:	8b 50 14             	mov    0x14(%eax),%edx
80105186:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010518c:	39 c2                	cmp    %eax,%edx
8010518e:	0f 85 ad 00 00 00    	jne    80105241 <join+0xe6>
80105194:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105197:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
8010519d:	83 f8 01             	cmp    $0x1,%eax
801051a0:	0f 85 9b 00 00 00    	jne    80105241 <join+0xe6>
801051a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051a9:	8b 40 10             	mov    0x10(%eax),%eax
801051ac:	3b 45 08             	cmp    0x8(%ebp),%eax
801051af:	0f 85 8c 00 00 00    	jne    80105241 <join+0xe6>
        continue;
      havekids = 1;
...
801051c5:	75 7b                	jne    80105242 <join+0xe7>
        // Found one.
        pid = p->pid;
801051c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051ca:	8b 40 10             	mov    0x10(%eax),%eax
801051cd:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
801051d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051d3:	8b 40 08             	mov    0x8(%eax),%eax
801051d6:	89 04 24             	mov    %eax,(%esp)
801051d9:	e8 94 d8 ff ff       	call   80102a72 <kfree>
        p->kstack = 0;
801051de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051e1:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
        p->state = UNUSED;
801051e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051eb:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
801051f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051f5:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
801051fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051ff:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
80105206:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105209:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
8010520d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105210:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80105217:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
8010521e:	e8 9e 02 00 00       	call   801054c1 <release>
        *(int*)retval = p->retval;
80105223:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105226:	8b 50 7c             	mov    0x7c(%eax),%edx
80105229:	8b 45 10             	mov    0x10(%ebp),%eax
8010522c:	89 10                	mov    %edx,(%eax)
        *(int*)stack = p->stack;
8010522e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105231:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
80105237:	8b 45 0c             	mov    0xc(%ebp),%eax
8010523a:	89 10                	mov    %edx,(%eax)
        return pid;
8010523c:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010523f:	eb 56                	jmp    80105297 <join+0x13c>
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
      // only wait for the child thread, but not the child process
...
80105241:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105242:	81 45 f4 88 01 00 00 	addl   $0x188,-0xc(%ebp)
80105249:	81 7d f4 b4 9b 11 80 	cmpl   $0x80119bb4,-0xc(%ebp)
80105250:	0f 82 2a ff ff ff    	jb     80105180 <join+0x25>
        return pid;
      }
    }
    ...
    if(!havekids || proc->killed){
80105256:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010525a:	74 0d                	je     80105269 <join+0x10e>
8010525c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105262:	8b 40 24             	mov    0x24(%eax),%eax
80105265:	85 c0                	test   %eax,%eax
80105267:	74 13                	je     8010527c <join+0x121>
      release(&ptable.lock);
80105269:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105270:	e8 4c 02 00 00       	call   801054c1 <release>
      return -1;
80105275:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010527a:	eb 1b                	jmp    80105297 <join+0x13c>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
8010527c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105282:	c7 44 24 04 80 39 11 	movl   $0x80113980,0x4(%esp)
80105289:	80 
8010528a:	89 04 24             	mov    %eax,(%esp)
8010528d:	e8 93 fa ff ff       	call   80104d25 <sleep>
  }
80105292:	e9 d6 fe ff ff       	jmp    8010516d <join+0x12>
}
80105297:	c9                   	leave  
80105298:	c3                   	ret    
...
801052a6:	eb 47                	jmp    801052ef <mutex_init+0x56>
		//find an unused mutex
		if(proc->flags[iterate] != 0)
801052a8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052ae:	8b 55 f4             	mov    -0xc(%ebp),%edx
801052b1:	83 c2 20             	add    $0x20,%edx
801052b4:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801052b8:	85 c0                	test   %eax,%eax
801052ba:	74 06                	je     801052c2 <mutex_init+0x29>
...
801052c0:	eb 2d                	jmp    801052ef <mutex_init+0x56>
		//find an unused mutex
		if(proc->flags[iterate] != 0)
			continue;
...
801052c8:	8b 55 f4             	mov    -0xc(%ebp),%edx
801052cb:	83 c2 20             	add    $0x20,%edx
801052ce:	c7 44 90 08 01 00 00 	movl   $0x1,0x8(%eax,%edx,4)
801052d5:	00 
...
801052df:	83 c2 40             	add    $0x40,%edx
801052e2:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801052e9:	00 
		//return the mutex id
		return iterate;
801052ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052ed:	eb 17                	jmp    80105306 <mutex_init+0x6d>
...
int mutex_init(void)
{
	int iterate;
	for(iterate = 0; iterate < 32; iterate++){
801052ef:	83 7d f4 1f          	cmpl   $0x1f,-0xc(%ebp)
801052f3:	7e b3                	jle    801052a8 <mutex_init+0xf>
		proc->locks[iterate] = 0;
		//return the mutex id
		return iterate;
	}
...
801052f5:	c7 04 24 f4 8f 10 80 	movl   $0x80108ff4,(%esp)
801052fc:	e8 a0 b0 ff ff       	call   801003a1 <cprintf>
	return 0;
...
80105314:	83 c2 20             	add    $0x20,%edx
80105317:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010531e:	00 
	return 0;
...
80105332:	8b 55 08             	mov    0x8(%ebp),%edx
80105335:	83 c2 20             	add    $0x20,%edx
80105338:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010533c:	85 c0                	test   %eax,%eax
8010533e:	75 0c                	jne    8010534c <mutex_lock+0x26>
		panic("user is using uninitialized mutex for lock\n");
80105340:	c7 04 24 30 90 10 80 	movl   $0x80109030,(%esp)
80105347:	e8 f1 b1 ff ff       	call   8010053d <panic>

	for(;;){

		if(proc->locks[mutex_id] != 0)
8010534c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105352:	8b 55 08             	mov    0x8(%ebp),%edx
80105355:	83 c2 40             	add    $0x40,%edx
80105358:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010535c:	85 c0                	test   %eax,%eax
8010535e:	74 18                	je     80105378 <mutex_lock+0x52>
			sleep(proc, &ptable.lock);
80105360:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105366:	c7 44 24 04 80 39 11 	movl   $0x80113980,0x4(%esp)
8010536d:	80 
8010536e:	89 04 24             	mov    %eax,(%esp)
80105371:	e8 af f9 ff ff       	call   80104d25 <sleep>
		else{
			proc->locks[mutex_id] = 1;
			return 1;
		}
	}
80105376:	eb d4                	jmp    8010534c <mutex_lock+0x26>
	for(;;){
...
80105381:	83 c2 40             	add    $0x40,%edx
80105384:	c7 44 90 08 01 00 00 	movl   $0x1,0x8(%eax,%edx,4)
8010538b:	00 
			return 1;
8010538c:	b8 01 00 00 00       	mov    $0x1,%eax
		}
	}
...
801053a2:	83 c2 20             	add    $0x20,%edx
801053a5:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801053a9:	85 c0                	test   %eax,%eax
801053ab:	75 0c                	jne    801053b9 <mutex_unlock+0x26>
		panic("user is using uninitalized mutex for unlock\n");
801053ad:	c7 04 24 5c 90 10 80 	movl   $0x8010905c,(%esp)
801053b4:	e8 84 b1 ff ff       	call   8010053d <panic>

	if(proc->locks[mutex_id] == 1){
801053b9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053bf:	8b 55 08             	mov    0x8(%ebp),%edx
801053c2:	83 c2 40             	add    $0x40,%edx
801053c5:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801053c9:	83 f8 01             	cmp    $0x1,%eax
801053cc:	75 22                	jne    801053f0 <mutex_unlock+0x5d>
		wakeup1(proc);
801053ce:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053d4:	89 04 24             	mov    %eax,(%esp)
801053d7:	e8 e4 f9 ff ff       	call   80104dc0 <wakeup1>
		proc->locks[mutex_id] = 0;
801053dc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053e2:	8b 55 08             	mov    0x8(%ebp),%edx
801053e5:	83 c2 40             	add    $0x40,%edx
...
801053ff:	9c                   	pushf  
80105400:	5b                   	pop    %ebx
80105401:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
8010542b:	89 d8                	mov    %ebx,%eax
8010542d:	f0 87 02             	lock xchg %eax,(%edx)
80105430:	89 c3                	mov    %eax,%ebx
80105432:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
...
80105465:	e8 3d 01 00 00       	call   801055a7 <pushcli>
  if(holding(lk))
8010546a:	8b 45 08             	mov    0x8(%ebp),%eax
8010546d:	89 04 24             	mov    %eax,(%esp)
80105470:	e8 08 01 00 00       	call   8010557d <holding>
80105475:	85 c0                	test   %eax,%eax
80105477:	74 0c                	je     80105485 <acquire+0x26>
    panic("acquire");
80105479:	c7 04 24 b3 90 10 80 	movl   $0x801090b3,(%esp)
...
80105489:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105490:	00 
80105491:	89 04 24             	mov    %eax,(%esp)
80105494:	e8 80 ff ff ff       	call   80105419 <xchg>
80105499:	85 c0                	test   %eax,%eax
8010549b:	75 e9                	jne    80105486 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
8010549d:	8b 45 08             	mov    0x8(%ebp),%eax
801054a0:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801054a7:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
801054aa:	8b 45 08             	mov    0x8(%ebp),%eax
801054ad:	83 c0 0c             	add    $0xc,%eax
801054b0:	89 44 24 04          	mov    %eax,0x4(%esp)
801054b4:	8d 45 08             	lea    0x8(%ebp),%eax
801054b7:	89 04 24             	mov    %eax,(%esp)
801054ba:	e8 51 00 00 00       	call   80105510 <getcallerpcs>
}
801054bf:	c9                   	leave  
801054c0:	c3                   	ret    
...
801054cd:	e8 ab 00 00 00       	call   8010557d <holding>
801054d2:	85 c0                	test   %eax,%eax
801054d4:	75 0c                	jne    801054e2 <release+0x21>
    panic("release");
801054d6:	c7 04 24 bb 90 10 80 	movl   $0x801090bb,(%esp)
801054dd:	e8 5b b0 ff ff       	call   8010053d <panic>
...
801054f9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105500:	00 
80105501:	89 04 24             	mov    %eax,(%esp)
80105504:	e8 10 ff ff ff       	call   80105419 <xchg>

  popcli();
80105509:	e8 e1 00 00 00       	call   801055ef <popcli>
}
8010550e:	c9                   	leave  
8010550f:	c3                   	ret    

80105510 <getcallerpcs>:
...
80105519:	83 e8 08             	sub    $0x8,%eax
8010551c:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
8010551f:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80105526:	eb 32                	jmp    8010555a <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105528:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
8010552c:	74 47                	je     80105575 <getcallerpcs+0x65>
8010552e:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105535:	76 3e                	jbe    80105575 <getcallerpcs+0x65>
80105537:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
8010553b:	74 38                	je     80105575 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
8010553d:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105540:	c1 e0 02             	shl    $0x2,%eax
80105543:	03 45 0c             	add    0xc(%ebp),%eax
80105546:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105549:	8b 52 04             	mov    0x4(%edx),%edx
...
8010555a:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
8010555e:	7e c8                	jle    80105528 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105560:	eb 13                	jmp    80105575 <getcallerpcs+0x65>
    pcs[i] = 0;
80105562:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105565:	c1 e0 02             	shl    $0x2,%eax
80105568:	03 45 0c             	add    0xc(%ebp),%eax
8010556b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
...
80105575:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105579:	7e e7                	jle    80105562 <getcallerpcs+0x52>
    pcs[i] = 0;
}
8010557b:	c9                   	leave  
8010557c:	c3                   	ret    
...
80105587:	74 17                	je     801055a0 <holding+0x23>
80105589:	8b 45 08             	mov    0x8(%ebp),%eax
8010558c:	8b 50 08             	mov    0x8(%eax),%edx
8010558f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105595:	39 c2                	cmp    %eax,%edx
80105597:	75 07                	jne    801055a0 <holding+0x23>
80105599:	b8 01 00 00 00       	mov    $0x1,%eax
8010559e:	eb 05                	jmp    801055a5 <holding+0x28>
...
801055aa:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
801055ad:	e8 46 fe ff ff       	call   801053f8 <readeflags>
801055b2:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
801055b5:	e8 53 fe ff ff       	call   8010540d <cli>
  if(cpu->ncli++ == 0)
801055ba:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801055c0:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801055c6:	85 d2                	test   %edx,%edx
801055c8:	0f 94 c1             	sete   %cl
801055cb:	83 c2 01             	add    $0x1,%edx
801055ce:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801055d4:	84 c9                	test   %cl,%cl
801055d6:	74 15                	je     801055ed <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
801055d8:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801055de:	8b 55 fc             	mov    -0x4(%ebp),%edx
801055e1:	81 e2 00 02 00 00    	and    $0x200,%edx
801055e7:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
801055ed:	c9                   	leave  
801055ee:	c3                   	ret    
...
801055f2:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
801055f5:	e8 fe fd ff ff       	call   801053f8 <readeflags>
801055fa:	25 00 02 00 00       	and    $0x200,%eax
801055ff:	85 c0                	test   %eax,%eax
80105601:	74 0c                	je     8010560f <popcli+0x20>
    panic("popcli - interruptible");
80105603:	c7 04 24 c3 90 10 80 	movl   $0x801090c3,(%esp)
8010560a:	e8 2e af ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
8010560f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105615:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010561b:	83 ea 01             	sub    $0x1,%edx
8010561e:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105624:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010562a:	85 c0                	test   %eax,%eax
8010562c:	79 0c                	jns    8010563a <popcli+0x4b>
    panic("popcli");
8010562e:	c7 04 24 da 90 10 80 	movl   $0x801090da,(%esp)
80105635:	e8 03 af ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
8010563a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105640:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105646:	85 c0                	test   %eax,%eax
80105648:	75 15                	jne    8010565f <popcli+0x70>
8010564a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105650:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80105656:	85 c0                	test   %eax,%eax
80105658:	74 05                	je     8010565f <popcli+0x70>
    sti();
8010565a:	e8 b4 fd ff ff       	call   80105413 <sti>
}
8010565f:	c9                   	leave  
80105660:	c3                   	ret    
80105661:	00 00                	add    %al,(%eax)
	...
...
80105669:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010566c:	8b 55 10             	mov    0x10(%ebp),%edx
8010566f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105672:	89 cb                	mov    %ecx,%ebx
80105674:	89 df                	mov    %ebx,%edi
80105676:	89 d1                	mov    %edx,%ecx
80105678:	fc                   	cld    
80105679:	f3 aa                	rep stos %al,%es:(%edi)
8010567b:	89 ca                	mov    %ecx,%edx
8010567d:	89 fb                	mov    %edi,%ebx
8010567f:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
8010568e:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105691:	8b 55 10             	mov    0x10(%ebp),%edx
80105694:	8b 45 0c             	mov    0xc(%ebp),%eax
80105697:	89 cb                	mov    %ecx,%ebx
80105699:	89 df                	mov    %ebx,%edi
8010569b:	89 d1                	mov    %edx,%ecx
8010569d:	fc                   	cld    
8010569e:	f3 ab                	rep stos %eax,%es:(%edi)
801056a0:	89 ca                	mov    %ecx,%edx
801056a2:	89 fb                	mov    %edi,%ebx
801056a4:	89 5d 08             	mov    %ebx,0x8(%ebp)
801056a7:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
801056b7:	83 e0 03             	and    $0x3,%eax
801056ba:	85 c0                	test   %eax,%eax
801056bc:	75 49                	jne    80105707 <memset+0x59>
801056be:	8b 45 10             	mov    0x10(%ebp),%eax
801056c1:	83 e0 03             	and    $0x3,%eax
801056c4:	85 c0                	test   %eax,%eax
801056c6:	75 3f                	jne    80105707 <memset+0x59>
    c &= 0xFF;
801056c8:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
801056cf:	8b 45 10             	mov    0x10(%ebp),%eax
801056d2:	c1 e8 02             	shr    $0x2,%eax
801056d5:	89 c2                	mov    %eax,%edx
801056d7:	8b 45 0c             	mov    0xc(%ebp),%eax
801056da:	89 c1                	mov    %eax,%ecx
801056dc:	c1 e1 18             	shl    $0x18,%ecx
801056df:	8b 45 0c             	mov    0xc(%ebp),%eax
801056e2:	c1 e0 10             	shl    $0x10,%eax
801056e5:	09 c1                	or     %eax,%ecx
801056e7:	8b 45 0c             	mov    0xc(%ebp),%eax
801056ea:	c1 e0 08             	shl    $0x8,%eax
801056ed:	09 c8                	or     %ecx,%eax
801056ef:	0b 45 0c             	or     0xc(%ebp),%eax
801056f2:	89 54 24 08          	mov    %edx,0x8(%esp)
801056f6:	89 44 24 04          	mov    %eax,0x4(%esp)
801056fa:	8b 45 08             	mov    0x8(%ebp),%eax
801056fd:	89 04 24             	mov    %eax,(%esp)
80105700:	e8 84 ff ff ff       	call   80105689 <stosl>
80105705:	eb 19                	jmp    80105720 <memset+0x72>
  } else
    stosb(dst, c, n);
...
8010571b:	e8 44 ff ff ff       	call   80105664 <stosb>
  return dst;
...
80105734:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105737:	eb 32                	jmp    8010576b <memcmp+0x46>
    if(*s1 != *s2)
...
80105747:	74 1a                	je     80105763 <memcmp+0x3e>
      return *s1 - *s2;
80105749:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010574c:	0f b6 00             	movzbl (%eax),%eax
8010574f:	0f b6 d0             	movzbl %al,%edx
80105752:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105755:	0f b6 00             	movzbl (%eax),%eax
80105758:	0f b6 c0             	movzbl %al,%eax
8010575b:	89 d1                	mov    %edx,%ecx
8010575d:	29 c1                	sub    %eax,%ecx
8010575f:	89 c8                	mov    %ecx,%eax
80105761:	eb 1c                	jmp    8010577f <memcmp+0x5a>
    s1++, s2++;
80105763:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
...
8010576f:	0f 95 c0             	setne  %al
80105772:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105776:	84 c0                	test   %al,%al
80105778:	75 bf                	jne    80105739 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105790:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
80105793:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105796:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105799:	73 54                	jae    801057ef <memmove+0x6e>
8010579b:	8b 45 10             	mov    0x10(%ebp),%eax
8010579e:	8b 55 fc             	mov    -0x4(%ebp),%edx
801057a1:	01 d0                	add    %edx,%eax
801057a3:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801057a6:	76 47                	jbe    801057ef <memmove+0x6e>
    s += n;
801057a8:	8b 45 10             	mov    0x10(%ebp),%eax
801057ab:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801057ae:	8b 45 10             	mov    0x10(%ebp),%eax
801057b1:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801057b4:	eb 13                	jmp    801057c9 <memmove+0x48>
      *--d = *--s;
801057b6:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
801057ba:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
801057be:	8b 45 fc             	mov    -0x4(%ebp),%eax
801057c1:	0f b6 10             	movzbl (%eax),%edx
801057c4:	8b 45 f8             	mov    -0x8(%ebp),%eax
801057c7:	88 10                	mov    %dl,(%eax)
  ...
  if(s < d && s + n > d){
    ...
    d += n;
    while(n-- > 0)
801057c9:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801057cd:	0f 95 c0             	setne  %al
801057d0:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801057d4:	84 c0                	test   %al,%al
801057d6:	75 de                	jne    801057b6 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801057d8:	eb 25                	jmp    801057ff <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
801057e3:	88 10                	mov    %dl,(%eax)
801057e5:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801057e9:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801057ed:	eb 01                	jmp    801057f0 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
801057f7:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801057fb:	84 c0                	test   %al,%al
801057fd:	75 db                	jne    801057da <memmove+0x59>
      *d++ = *s++;
...
8010581e:	e8 5e ff ff ff       	call   80105781 <memmove>
}
80105823:	c9                   	leave  
80105824:	c3                   	ret    
...
80105826:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105828:	eb 0c                	jmp    80105836 <strncmp+0x11>
    n--, p++, q++;
8010582a:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010582e:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105832:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
{
  while(n > 0 && *p && *p == *q)
80105836:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010583a:	74 1a                	je     80105856 <strncmp+0x31>
8010583c:	8b 45 08             	mov    0x8(%ebp),%eax
8010583f:	0f b6 00             	movzbl (%eax),%eax
80105842:	84 c0                	test   %al,%al
80105844:	74 10                	je     80105856 <strncmp+0x31>
80105846:	8b 45 08             	mov    0x8(%ebp),%eax
80105849:	0f b6 10             	movzbl (%eax),%edx
8010584c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010584f:	0f b6 00             	movzbl (%eax),%eax
80105852:	38 c2                	cmp    %al,%dl
80105854:	74 d4                	je     8010582a <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
80105856:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010585a:	75 07                	jne    80105863 <strncmp+0x3e>
    return 0;
8010585c:	b8 00 00 00 00       	mov    $0x0,%eax
80105861:	eb 18                	jmp    8010587b <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
80105863:	8b 45 08             	mov    0x8(%ebp),%eax
80105866:	0f b6 00             	movzbl (%eax),%eax
80105869:	0f b6 d0             	movzbl %al,%edx
8010586c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010586f:	0f b6 00             	movzbl (%eax),%eax
80105872:	0f b6 c0             	movzbl %al,%eax
80105875:	89 d1                	mov    %edx,%ecx
...
80105880:	83 ec 10             	sub    $0x10,%esp
  char *os;
  
  os = s;
80105883:	8b 45 08             	mov    0x8(%ebp),%eax
80105886:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
80105889:	90                   	nop
8010588a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010588e:	0f 9f c0             	setg   %al
80105891:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105895:	84 c0                	test   %al,%al
80105897:	74 30                	je     801058c9 <strncpy+0x4c>
80105899:	8b 45 0c             	mov    0xc(%ebp),%eax
8010589c:	0f b6 10             	movzbl (%eax),%edx
...
801058ac:	0f 95 c0             	setne  %al
801058af:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801058b3:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
801058b7:	84 c0                	test   %al,%al
801058b9:	75 cf                	jne    8010588a <strncpy+0xd>
    ;
  while(n-- > 0)
801058bb:	eb 0c                	jmp    801058c9 <strncpy+0x4c>
    *s++ = 0;
801058bd:	8b 45 08             	mov    0x8(%ebp),%eax
801058c0:	c6 00 00             	movb   $0x0,(%eax)
801058c3:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801058c7:	eb 01                	jmp    801058ca <strncpy+0x4d>
  char *os;
...
801058d7:	75 e4                	jne    801058bd <strncpy+0x40>
    *s++ = 0;
  return os;
...
801058e7:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
801058ea:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801058ee:	7f 05                	jg     801058f5 <safestrcpy+0x17>
    return os;
801058f0:	8b 45 fc             	mov    -0x4(%ebp),%eax
801058f3:	eb 35                	jmp    8010592a <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
801058f5:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801058f9:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801058fd:	7e 22                	jle    80105921 <safestrcpy+0x43>
801058ff:	8b 45 0c             	mov    0xc(%ebp),%eax
80105902:	0f b6 10             	movzbl (%eax),%edx
...
80105912:	0f 95 c0             	setne  %al
80105915:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105919:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010591d:	84 c0                	test   %al,%al
8010591f:	75 d4                	jne    801058f5 <safestrcpy+0x17>
    ;
  *s = 0;
80105921:	8b 45 08             	mov    0x8(%ebp),%eax
80105924:	c6 00 00             	movb   $0x0,(%eax)
  return os;
80105927:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
8010592a:	c9                   	leave  
8010592b:	c3                   	ret    
...
80105939:	eb 04                	jmp    8010593f <strlen+0x13>
8010593b:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010593f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105942:	03 45 08             	add    0x8(%ebp),%eax
80105945:	0f b6 00             	movzbl (%eax),%eax
80105948:	84 c0                	test   %al,%al
8010594a:	75 ef                	jne    8010593b <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
80105954:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105958:	8b 54 24 08          	mov    0x8(%esp),%edx
...
8010595f:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80105960:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105962:	89 d4                	mov    %edx,%esp
...
8010597a:	76 12                	jbe    8010598e <fetchint+0x22>
8010597c:	8b 45 08             	mov    0x8(%ebp),%eax
8010597f:	8d 50 04             	lea    0x4(%eax),%edx
80105982:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105988:	8b 00                	mov    (%eax),%eax
8010598a:	39 c2                	cmp    %eax,%edx
8010598c:	76 07                	jbe    80105995 <fetchint+0x29>
    return -1;
8010598e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105993:	eb 0f                	jmp    801059a4 <fetchint+0x38>
  *ip = *(int*)(addr);
80105995:	8b 45 08             	mov    0x8(%ebp),%eax
80105998:	8b 10                	mov    (%eax),%edx
8010599a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010599d:	89 10                	mov    %edx,(%eax)
  return 0;
...
801059b4:	3b 45 08             	cmp    0x8(%ebp),%eax
801059b7:	77 07                	ja     801059c0 <fetchstr+0x1a>
    return -1;
801059b9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059be:	eb 48                	jmp    80105a08 <fetchstr+0x62>
  *pp = (char*)addr;
801059c0:	8b 55 08             	mov    0x8(%ebp),%edx
801059c3:	8b 45 0c             	mov    0xc(%ebp),%eax
801059c6:	89 10                	mov    %edx,(%eax)
  ep = (char*)proc->sz;
801059c8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059ce:	8b 00                	mov    (%eax),%eax
801059d0:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
801059d3:	8b 45 0c             	mov    0xc(%ebp),%eax
801059d6:	8b 00                	mov    (%eax),%eax
801059d8:	89 45 fc             	mov    %eax,-0x4(%ebp)
801059db:	eb 1e                	jmp    801059fb <fetchstr+0x55>
    if(*s == 0)
801059dd:	8b 45 fc             	mov    -0x4(%ebp),%eax
801059e0:	0f b6 00             	movzbl (%eax),%eax
801059e3:	84 c0                	test   %al,%al
801059e5:	75 10                	jne    801059f7 <fetchstr+0x51>
      return s - *pp;
...
801059f5:	eb 11                	jmp    80105a08 <fetchstr+0x62>
...
801059fe:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105a01:	72 da                	jb     801059dd <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105a19:	8b 50 44             	mov    0x44(%eax),%edx
80105a1c:	8b 45 08             	mov    0x8(%ebp),%eax
80105a1f:	c1 e0 02             	shl    $0x2,%eax
80105a22:	01 d0                	add    %edx,%eax
80105a24:	8d 50 04             	lea    0x4(%eax),%edx
80105a27:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a2a:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a2e:	89 14 24             	mov    %edx,(%esp)
80105a31:	e8 36 ff ff ff       	call   8010596c <fetchint>
}
80105a36:	c9                   	leave  
80105a37:	c3                   	ret    
...
80105a9d:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
80105aa0:	8d 45 fc             	lea    -0x4(%ebp),%eax
80105aa3:	89 44 24 04          	mov    %eax,0x4(%esp)
80105aa7:	8b 45 08             	mov    0x8(%ebp),%eax
80105aaa:	89 04 24             	mov    %eax,(%esp)
80105aad:	e8 58 ff ff ff       	call   80105a0a <argint>
80105ab2:	85 c0                	test   %eax,%eax
80105ab4:	79 07                	jns    80105abd <argstr+0x23>
    return -1;
80105ab6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105abb:	eb 12                	jmp    80105acf <argstr+0x35>
  return fetchstr(addr, pp);
80105abd:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105ac0:	8b 55 0c             	mov    0xc(%ebp),%edx
80105ac3:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ac7:	89 04 24             	mov    %eax,(%esp)
80105aca:	e8 d7 fe ff ff       	call   801059a6 <fetchstr>
}
80105acf:	c9                   	leave  
80105ad0:	c3                   	ret    
...
80105ad5:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105ad8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ade:	8b 40 18             	mov    0x18(%eax),%eax
80105ae1:	8b 40 1c             	mov    0x1c(%eax),%eax
80105ae4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105ae7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105aeb:	7e 30                	jle    80105b1d <syscall+0x4c>
80105aed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105af0:	83 f8 1f             	cmp    $0x1f,%eax
80105af3:	77 28                	ja     80105b1d <syscall+0x4c>
80105af5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105af8:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105aff:	85 c0                	test   %eax,%eax
80105b01:	74 1a                	je     80105b1d <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
80105b03:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b09:	8b 58 18             	mov    0x18(%eax),%ebx
80105b0c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b0f:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105b16:	ff d0                	call   *%eax
80105b18:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105b1b:	eb 3d                	jmp    80105b5a <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105b1d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b23:	8d 48 6c             	lea    0x6c(%eax),%ecx
...
80105b32:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105b36:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105b3a:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b3e:	c7 04 24 e1 90 10 80 	movl   $0x801090e1,(%esp)
80105b45:	e8 57 a8 ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105b4a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b50:	8b 40 18             	mov    0x18(%eax),%eax
80105b53:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105b5a:	83 c4 24             	add    $0x24,%esp
80105b5d:	5b                   	pop    %ebx
80105b5e:	5d                   	pop    %ebp
80105b5f:	c3                   	ret    
...
80105b63:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
...
80105b73:	e8 92 fe ff ff       	call   80105a0a <argint>
80105b78:	85 c0                	test   %eax,%eax
80105b7a:	79 07                	jns    80105b83 <argfd+0x23>
    return -1;
80105b7c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b81:	eb 50                	jmp    80105bd3 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105b83:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b86:	85 c0                	test   %eax,%eax
80105b88:	78 21                	js     80105bab <argfd+0x4b>
80105b8a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b8d:	83 f8 0f             	cmp    $0xf,%eax
80105b90:	7f 19                	jg     80105bab <argfd+0x4b>
80105b92:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b98:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105b9b:	83 c2 08             	add    $0x8,%edx
80105b9e:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105ba2:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ba5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ba9:	75 07                	jne    80105bb2 <argfd+0x52>
    return -1;
80105bab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bb0:	eb 21                	jmp    80105bd3 <argfd+0x73>
  if(pfd)
80105bb2:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105bb6:	74 08                	je     80105bc0 <argfd+0x60>
    *pfd = fd;
80105bb8:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105bbb:	8b 45 0c             	mov    0xc(%ebp),%eax
80105bbe:	89 10                	mov    %edx,(%eax)
  if(pf)
80105bc0:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105bc4:	74 08                	je     80105bce <argfd+0x6e>
    *pf = f;
...
80105bd8:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105bdb:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105be2:	eb 30                	jmp    80105c14 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105be4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105bea:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105bed:	83 c2 08             	add    $0x8,%edx
80105bf0:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105bf4:	85 c0                	test   %eax,%eax
80105bf6:	75 18                	jne    80105c10 <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105bf8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105bfe:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105c01:	8d 4a 08             	lea    0x8(%edx),%ecx
80105c04:	8b 55 08             	mov    0x8(%ebp),%edx
80105c07:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105c0b:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105c0e:	eb 0f                	jmp    80105c1f <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105c10:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105c14:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105c18:	7e ca                	jle    80105be4 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105c24:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
...
80105c94:	e8 c7 fe ff ff       	call   80105b60 <argfd>
80105c99:	85 c0                	test   %eax,%eax
80105c9b:	78 35                	js     80105cd2 <sys_read+0x5a>
80105c9d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105ca0:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ca4:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105cab:	e8 5a fd ff ff       	call   80105a0a <argint>
80105cb0:	85 c0                	test   %eax,%eax
80105cb2:	78 1e                	js     80105cd2 <sys_read+0x5a>
...
80105cc9:	e8 6a fd ff ff       	call   80105a38 <argptr>
80105cce:	85 c0                	test   %eax,%eax
80105cd0:	79 07                	jns    80105cd9 <sys_read+0x61>
    return -1;
80105cd2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cd7:	eb 19                	jmp    80105cf2 <sys_read+0x7a>
...
80105ced:	e8 03 b4 ff ff       	call   801010f5 <fileread>
}
80105cf2:	c9                   	leave  
80105cf3:	c3                   	ret    
...
80105d01:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105d08:	00 
80105d09:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d10:	e8 4b fe ff ff       	call   80105b60 <argfd>
80105d15:	85 c0                	test   %eax,%eax
80105d17:	78 35                	js     80105d4e <sys_write+0x5a>
80105d19:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105d1c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d20:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105d27:	e8 de fc ff ff       	call   80105a0a <argint>
80105d2c:	85 c0                	test   %eax,%eax
80105d2e:	78 1e                	js     80105d4e <sys_write+0x5a>
80105d30:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d33:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d37:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105d3a:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d3e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105d45:	e8 ee fc ff ff       	call   80105a38 <argptr>
80105d4a:	85 c0                	test   %eax,%eax
80105d4c:	79 07                	jns    80105d55 <sys_write+0x61>
    return -1;
80105d4e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d53:	eb 19                	jmp    80105d6e <sys_write+0x7a>
  return filewrite(f, p, n);
80105d55:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105d58:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105d5b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d5e:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105d62:	89 54 24 04          	mov    %edx,0x4(%esp)
80105d66:	89 04 24             	mov    %eax,(%esp)
80105d69:	e8 43 b4 ff ff       	call   801011b1 <filewrite>
}
80105d6e:	c9                   	leave  
80105d6f:	c3                   	ret    
...
80105d84:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d8b:	e8 d0 fd ff ff       	call   80105b60 <argfd>
80105d90:	85 c0                	test   %eax,%eax
80105d92:	79 07                	jns    80105d9b <sys_close+0x2b>
    return -1;
80105d94:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d99:	eb 24                	jmp    80105dbf <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105d9b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105da1:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105da4:	83 c2 08             	add    $0x8,%edx
80105da7:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105dae:	00 
  fileclose(f);
80105daf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105db2:	89 04 24             	mov    %eax,(%esp)
80105db5:	e8 16 b2 ff ff       	call   80100fd0 <fileclose>
  return 0;
...
80105dce:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105dd5:	00 
80105dd6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ddd:	e8 7e fd ff ff       	call   80105b60 <argfd>
80105de2:	85 c0                	test   %eax,%eax
80105de4:	78 1f                	js     80105e05 <sys_fstat+0x44>
80105de6:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105ded:	00 
80105dee:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105df1:	89 44 24 04          	mov    %eax,0x4(%esp)
80105df5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105dfc:	e8 37 fc ff ff       	call   80105a38 <argptr>
80105e01:	85 c0                	test   %eax,%eax
80105e03:	79 07                	jns    80105e0c <sys_fstat+0x4b>
    return -1;
80105e05:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e0a:	eb 12                	jmp    80105e1e <sys_fstat+0x5d>
  return filestat(f, st);
80105e0c:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105e0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e12:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e16:	89 04 24             	mov    %eax,(%esp)
80105e19:	e8 88 b2 ff ff       	call   801010a6 <filestat>
}
80105e1e:	c9                   	leave  
80105e1f:	c3                   	ret    
...
80105e34:	e8 61 fc ff ff       	call   80105a9a <argstr>
80105e39:	85 c0                	test   %eax,%eax
80105e3b:	78 17                	js     80105e54 <sys_link+0x34>
80105e3d:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105e40:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105e4b:	e8 4a fc ff ff       	call   80105a9a <argstr>
80105e50:	85 c0                	test   %eax,%eax
80105e52:	79 0a                	jns    80105e5e <sys_link+0x3e>
    return -1;
80105e54:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e59:	e9 41 01 00 00       	jmp    80105f9f <sys_link+0x17f>

  begin_op();
80105e5e:	e8 fe d5 ff ff       	call   80103461 <begin_op>
  if((ip = namei(old)) == 0){
80105e63:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105e66:	89 04 24             	mov    %eax,(%esp)
80105e69:	e8 a8 c5 ff ff       	call   80102416 <namei>
80105e6e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e71:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e75:	75 0f                	jne    80105e86 <sys_link+0x66>
    end_op();
80105e77:	e8 66 d6 ff ff       	call   801034e2 <end_op>
    return -1;
80105e7c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e81:	e9 19 01 00 00       	jmp    80105f9f <sys_link+0x17f>
  }

  ilock(ip);
80105e86:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e89:	89 04 24             	mov    %eax,(%esp)
80105e8c:	e8 e3 b9 ff ff       	call   80101874 <ilock>
  if(ip->type == T_DIR){
80105e91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e94:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105e98:	66 83 f8 01          	cmp    $0x1,%ax
80105e9c:	75 1a                	jne    80105eb8 <sys_link+0x98>
    iunlockput(ip);
80105e9e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ea1:	89 04 24             	mov    %eax,(%esp)
80105ea4:	e8 4f bc ff ff       	call   80101af8 <iunlockput>
    end_op();
80105ea9:	e8 34 d6 ff ff       	call   801034e2 <end_op>
    return -1;
80105eae:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105eb3:	e9 e7 00 00 00       	jmp    80105f9f <sys_link+0x17f>
  }
...
80105ecf:	e8 e4 b7 ff ff       	call   801016b8 <iupdate>
  iunlock(ip);
80105ed4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ed7:	89 04 24             	mov    %eax,(%esp)
80105eda:	e8 e3 ba ff ff       	call   801019c2 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105edf:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105ee2:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105ee5:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ee9:	89 04 24             	mov    %eax,(%esp)
80105eec:	e8 47 c5 ff ff       	call   80102438 <nameiparent>
80105ef1:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ef4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ef8:	74 68                	je     80105f62 <sys_link+0x142>
    goto bad;
  ilock(dp);
80105efa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105efd:	89 04 24             	mov    %eax,(%esp)
80105f00:	e8 6f b9 ff ff       	call   80101874 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105f05:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f08:	8b 10                	mov    (%eax),%edx
80105f0a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f0d:	8b 00                	mov    (%eax),%eax
80105f0f:	39 c2                	cmp    %eax,%edx
80105f11:	75 20                	jne    80105f33 <sys_link+0x113>
80105f13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f16:	8b 40 04             	mov    0x4(%eax),%eax
80105f19:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f1d:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105f20:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f24:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f27:	89 04 24             	mov    %eax,(%esp)
80105f2a:	e8 26 c2 ff ff       	call   80102155 <dirlink>
80105f2f:	85 c0                	test   %eax,%eax
80105f31:	79 0d                	jns    80105f40 <sys_link+0x120>
    iunlockput(dp);
80105f33:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f36:	89 04 24             	mov    %eax,(%esp)
80105f39:	e8 ba bb ff ff       	call   80101af8 <iunlockput>
    goto bad;
80105f3e:	eb 23                	jmp    80105f63 <sys_link+0x143>
  }
  iunlockput(dp);
80105f40:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f43:	89 04 24             	mov    %eax,(%esp)
80105f46:	e8 ad bb ff ff       	call   80101af8 <iunlockput>
  iput(ip);
80105f4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f4e:	89 04 24             	mov    %eax,(%esp)
80105f51:	e8 d1 ba ff ff       	call   80101a27 <iput>

  end_op();
80105f56:	e8 87 d5 ff ff       	call   801034e2 <end_op>

  return 0;
80105f5b:	b8 00 00 00 00       	mov    $0x0,%eax
80105f60:	eb 3d                	jmp    80105f9f <sys_link+0x17f>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
80105f69:	e8 06 b9 ff ff       	call   80101874 <ilock>
  ip->nlink--;
80105f6e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f71:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f75:	8d 50 ff             	lea    -0x1(%eax),%edx
80105f78:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f7b:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105f7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f82:	89 04 24             	mov    %eax,(%esp)
80105f85:	e8 2e b7 ff ff       	call   801016b8 <iupdate>
  iunlockput(ip);
80105f8a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f8d:	89 04 24             	mov    %eax,(%esp)
80105f90:	e8 63 bb ff ff       	call   80101af8 <iunlockput>
  end_op();
80105f95:	e8 48 d5 ff ff       	call   801034e2 <end_op>
  return -1;
...
80105fa7:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105fae:	eb 4b                	jmp    80105ffb <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105fb0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fb3:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105fba:	00 
...
80105fcc:	e8 99 bd ff ff       	call   80101d6a <readi>
80105fd1:	83 f8 10             	cmp    $0x10,%eax
80105fd4:	74 0c                	je     80105fe2 <isdirempty+0x41>
      panic("isdirempty: readi");
80105fd6:	c7 04 24 fd 90 10 80 	movl   $0x801090fd,(%esp)
80105fdd:	e8 5b a5 ff ff       	call   8010053d <panic>
    if(de.inum != 0)
80105fe2:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105fe6:	66 85 c0             	test   %ax,%ax
80105fe9:	74 07                	je     80105ff2 <isdirempty+0x51>
      return 0;
80105feb:	b8 00 00 00 00       	mov    $0x0,%eax
80105ff0:	eb 1b                	jmp    8010600d <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105ff5:	83 c0 10             	add    $0x10,%eax
80105ff8:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ffb:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105ffe:	8b 45 08             	mov    0x8(%ebp),%eax
80106001:	8b 40 18             	mov    0x18(%eax),%eax
80106004:	39 c2                	cmp    %eax,%edx
80106006:	72 a8                	jb     80105fb0 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
80106008:	b8 01 00 00 00       	mov    $0x1,%eax
}
8010600d:	c9                   	leave  
8010600e:	c3                   	ret    
...
80106012:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
...
8010601c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106023:	e8 72 fa ff ff       	call   80105a9a <argstr>
80106028:	85 c0                	test   %eax,%eax
8010602a:	79 0a                	jns    80106036 <sys_unlink+0x27>
    return -1;
8010602c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106031:	e9 af 01 00 00       	jmp    801061e5 <sys_unlink+0x1d6>

  begin_op();
80106036:	e8 26 d4 ff ff       	call   80103461 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
8010603b:	8b 45 cc             	mov    -0x34(%ebp),%eax
8010603e:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80106041:	89 54 24 04          	mov    %edx,0x4(%esp)
80106045:	89 04 24             	mov    %eax,(%esp)
80106048:	e8 eb c3 ff ff       	call   80102438 <nameiparent>
8010604d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106050:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106054:	75 0f                	jne    80106065 <sys_unlink+0x56>
    end_op();
80106056:	e8 87 d4 ff ff       	call   801034e2 <end_op>
    return -1;
8010605b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106060:	e9 80 01 00 00       	jmp    801061e5 <sys_unlink+0x1d6>
  }

  ilock(dp);
80106065:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106068:	89 04 24             	mov    %eax,(%esp)
8010606b:	e8 04 b8 ff ff       	call   80101874 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80106070:	c7 44 24 04 0f 91 10 	movl   $0x8010910f,0x4(%esp)
80106077:	80 
80106078:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010607b:	89 04 24             	mov    %eax,(%esp)
8010607e:	e8 e8 bf ff ff       	call   8010206b <namecmp>
80106083:	85 c0                	test   %eax,%eax
80106085:	0f 84 45 01 00 00    	je     801061d0 <sys_unlink+0x1c1>
8010608b:	c7 44 24 04 11 91 10 	movl   $0x80109111,0x4(%esp)
80106092:	80 
80106093:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106096:	89 04 24             	mov    %eax,(%esp)
80106099:	e8 cd bf ff ff       	call   8010206b <namecmp>
8010609e:	85 c0                	test   %eax,%eax
801060a0:	0f 84 2a 01 00 00    	je     801061d0 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
801060a6:	8d 45 c8             	lea    -0x38(%ebp),%eax
801060a9:	89 44 24 08          	mov    %eax,0x8(%esp)
801060ad:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801060b0:	89 44 24 04          	mov    %eax,0x4(%esp)
801060b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060b7:	89 04 24             	mov    %eax,(%esp)
801060ba:	e8 ce bf ff ff       	call   8010208d <dirlookup>
801060bf:	89 45 f0             	mov    %eax,-0x10(%ebp)
801060c2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060c6:	0f 84 03 01 00 00    	je     801061cf <sys_unlink+0x1c0>
    goto bad;
  ilock(ip);
801060cc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060cf:	89 04 24             	mov    %eax,(%esp)
801060d2:	e8 9d b7 ff ff       	call   80101874 <ilock>

  if(ip->nlink < 1)
801060d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060da:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801060de:	66 85 c0             	test   %ax,%ax
801060e1:	7f 0c                	jg     801060ef <sys_unlink+0xe0>
    panic("unlink: nlink < 1");
801060e3:	c7 04 24 14 91 10 80 	movl   $0x80109114,(%esp)
801060ea:	e8 4e a4 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
801060ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060f2:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801060f6:	66 83 f8 01          	cmp    $0x1,%ax
801060fa:	75 1f                	jne    8010611b <sys_unlink+0x10c>
801060fc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060ff:	89 04 24             	mov    %eax,(%esp)
80106102:	e8 9a fe ff ff       	call   80105fa1 <isdirempty>
80106107:	85 c0                	test   %eax,%eax
80106109:	75 10                	jne    8010611b <sys_unlink+0x10c>
    iunlockput(ip);
8010610b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010610e:	89 04 24             	mov    %eax,(%esp)
80106111:	e8 e2 b9 ff ff       	call   80101af8 <iunlockput>
    goto bad;
80106116:	e9 b5 00 00 00       	jmp    801061d0 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
8010611b:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80106122:	00 
80106123:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010612a:	00 
8010612b:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010612e:	89 04 24             	mov    %eax,(%esp)
80106131:	e8 78 f5 ff ff       	call   801056ae <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106136:	8b 45 c8             	mov    -0x38(%ebp),%eax
80106139:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80106140:	00 
...
80106152:	e8 7e bd ff ff       	call   80101ed5 <writei>
80106157:	83 f8 10             	cmp    $0x10,%eax
8010615a:	74 0c                	je     80106168 <sys_unlink+0x159>
    panic("unlink: writei");
8010615c:	c7 04 24 26 91 10 80 	movl   $0x80109126,(%esp)
80106163:	e8 d5 a3 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80106168:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010616b:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010616f:	66 83 f8 01          	cmp    $0x1,%ax
80106173:	75 1c                	jne    80106191 <sys_unlink+0x182>
    dp->nlink--;
80106175:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106178:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010617c:	8d 50 ff             	lea    -0x1(%eax),%edx
8010617f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106182:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106186:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106189:	89 04 24             	mov    %eax,(%esp)
8010618c:	e8 27 b5 ff ff       	call   801016b8 <iupdate>
  }
  iunlockput(dp);
80106191:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106194:	89 04 24             	mov    %eax,(%esp)
80106197:	e8 5c b9 ff ff       	call   80101af8 <iunlockput>

  ip->nlink--;
8010619c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010619f:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801061a3:	8d 50 ff             	lea    -0x1(%eax),%edx
801061a6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061a9:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801061ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061b0:	89 04 24             	mov    %eax,(%esp)
801061b3:	e8 00 b5 ff ff       	call   801016b8 <iupdate>
  iunlockput(ip);
801061b8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061bb:	89 04 24             	mov    %eax,(%esp)
801061be:	e8 35 b9 ff ff       	call   80101af8 <iunlockput>

  end_op();
801061c3:	e8 1a d3 ff ff       	call   801034e2 <end_op>

  return 0;
801061c8:	b8 00 00 00 00       	mov    $0x0,%eax
801061cd:	eb 16                	jmp    801061e5 <sys_unlink+0x1d6>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
801061d6:	e8 1d b9 ff ff       	call   80101af8 <iunlockput>
  end_op();
801061db:	e8 02 d3 ff ff       	call   801034e2 <end_op>
  return -1;
...
801061ea:	83 ec 48             	sub    $0x48,%esp
801061ed:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801061f0:	8b 55 10             	mov    0x10(%ebp),%edx
801061f3:	8b 45 14             	mov    0x14(%ebp),%eax
801061f6:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
801061fa:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
801061fe:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
801062ab:	e8 2b b3 ff ff       	call   801015db <ialloc>
801062b0:	89 45 f0             	mov    %eax,-0x10(%ebp)
801062b3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801062b7:	75 0c                	jne    801062c5 <create+0xde>
    panic("create: ialloc");
801062b9:	c7 04 24 35 91 10 80 	movl   $0x80109135,(%esp)
801062c0:	e8 78 a2 ff ff       	call   8010053d <panic>

  ilock(ip);
801062c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062c8:	89 04 24             	mov    %eax,(%esp)
801062cb:	e8 a4 b5 ff ff       	call   80101874 <ilock>
  ip->major = major;
801062d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062d3:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
801062d7:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
801062db:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062de:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
801062e2:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
801062e6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062e9:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
801062ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062f2:	89 04 24             	mov    %eax,(%esp)
801062f5:	e8 be b3 ff ff       	call   801016b8 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
801062fa:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
801062ff:	75 6a                	jne    8010636b <create+0x184>
    dp->nlink++;  // for ".."
80106301:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106304:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106308:	8d 50 01             	lea    0x1(%eax),%edx
...
80106318:	e8 9b b3 ff ff       	call   801016b8 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010631d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106320:	8b 40 04             	mov    0x4(%eax),%eax
80106323:	89 44 24 08          	mov    %eax,0x8(%esp)
80106327:	c7 44 24 04 0f 91 10 	movl   $0x8010910f,0x4(%esp)
8010632e:	80 
8010632f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106332:	89 04 24             	mov    %eax,(%esp)
80106335:	e8 1b be ff ff       	call   80102155 <dirlink>
8010633a:	85 c0                	test   %eax,%eax
8010633c:	78 21                	js     8010635f <create+0x178>
8010633e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106341:	8b 40 04             	mov    0x4(%eax),%eax
80106344:	89 44 24 08          	mov    %eax,0x8(%esp)
80106348:	c7 44 24 04 11 91 10 	movl   $0x80109111,0x4(%esp)
8010634f:	80 
80106350:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106353:	89 04 24             	mov    %eax,(%esp)
80106356:	e8 fa bd ff ff       	call   80102155 <dirlink>
8010635b:	85 c0                	test   %eax,%eax
8010635d:	79 0c                	jns    8010636b <create+0x184>
      panic("create dots");
8010635f:	c7 04 24 44 91 10 80 	movl   $0x80109144,(%esp)
80106366:	e8 d2 a1 ff ff       	call   8010053d <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
8010636b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010636e:	8b 40 04             	mov    0x4(%eax),%eax
80106371:	89 44 24 08          	mov    %eax,0x8(%esp)
80106375:	8d 45 de             	lea    -0x22(%ebp),%eax
80106378:	89 44 24 04          	mov    %eax,0x4(%esp)
8010637c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010637f:	89 04 24             	mov    %eax,(%esp)
80106382:	e8 ce bd ff ff       	call   80102155 <dirlink>
80106387:	85 c0                	test   %eax,%eax
80106389:	79 0c                	jns    80106397 <create+0x1b0>
    panic("create: dirlink");
8010638b:	c7 04 24 50 91 10 80 	movl   $0x80109150,(%esp)
80106392:	e8 a6 a1 ff ff       	call   8010053d <panic>

  iunlockput(dp);
80106397:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010639a:	89 04 24             	mov    %eax,(%esp)
8010639d:	e8 56 b7 ff ff       	call   80101af8 <iunlockput>
...
801063aa:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
801063bb:	e8 da f6 ff ff       	call   80105a9a <argstr>
801063c0:	85 c0                	test   %eax,%eax
801063c2:	78 17                	js     801063db <sys_open+0x34>
801063c4:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801063c7:	89 44 24 04          	mov    %eax,0x4(%esp)
801063cb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801063d2:	e8 33 f6 ff ff       	call   80105a0a <argint>
801063d7:	85 c0                	test   %eax,%eax
801063d9:	79 0a                	jns    801063e5 <sys_open+0x3e>
    return -1;
801063db:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063e0:	e9 5a 01 00 00       	jmp    8010653f <sys_open+0x198>

  begin_op();
801063e5:	e8 77 d0 ff ff       	call   80103461 <begin_op>

  if(omode & O_CREATE){
801063ea:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801063ed:	25 00 02 00 00       	and    $0x200,%eax
801063f2:	85 c0                	test   %eax,%eax
801063f4:	74 3b                	je     80106431 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
801063f6:	8b 45 e8             	mov    -0x18(%ebp),%eax
801063f9:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106400:	00 
80106401:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106408:	00 
80106409:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80106410:	00 
80106411:	89 04 24             	mov    %eax,(%esp)
80106414:	e8 ce fd ff ff       	call   801061e7 <create>
80106419:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
8010641c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106420:	75 6b                	jne    8010648d <sys_open+0xe6>
      end_op();
80106422:	e8 bb d0 ff ff       	call   801034e2 <end_op>
      return -1;
80106427:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010642c:	e9 0e 01 00 00       	jmp    8010653f <sys_open+0x198>
    }
  } else {
    if((ip = namei(path)) == 0){
80106431:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106434:	89 04 24             	mov    %eax,(%esp)
80106437:	e8 da bf ff ff       	call   80102416 <namei>
8010643c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010643f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106443:	75 0f                	jne    80106454 <sys_open+0xad>
      end_op();
80106445:	e8 98 d0 ff ff       	call   801034e2 <end_op>
      return -1;
8010644a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010644f:	e9 eb 00 00 00       	jmp    8010653f <sys_open+0x198>
    }
    ilock(ip);
80106454:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106457:	89 04 24             	mov    %eax,(%esp)
8010645a:	e8 15 b4 ff ff       	call   80101874 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010645f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106462:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106466:	66 83 f8 01          	cmp    $0x1,%ax
8010646a:	75 21                	jne    8010648d <sys_open+0xe6>
8010646c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010646f:	85 c0                	test   %eax,%eax
80106471:	74 1a                	je     8010648d <sys_open+0xe6>
      iunlockput(ip);
80106473:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106476:	89 04 24             	mov    %eax,(%esp)
80106479:	e8 7a b6 ff ff       	call   80101af8 <iunlockput>
      end_op();
8010647e:	e8 5f d0 ff ff       	call   801034e2 <end_op>
      return -1;
80106483:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106488:	e9 b2 00 00 00       	jmp    8010653f <sys_open+0x198>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
8010648d:	e8 96 aa ff ff       	call   80100f28 <filealloc>
80106492:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106495:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106499:	74 14                	je     801064af <sys_open+0x108>
8010649b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010649e:	89 04 24             	mov    %eax,(%esp)
801064a1:	e8 2f f7 ff ff       	call   80105bd5 <fdalloc>
801064a6:	89 45 ec             	mov    %eax,-0x14(%ebp)
801064a9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801064ad:	79 28                	jns    801064d7 <sys_open+0x130>
    if(f)
801064af:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801064b3:	74 0b                	je     801064c0 <sys_open+0x119>
      fileclose(f);
801064b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064b8:	89 04 24             	mov    %eax,(%esp)
801064bb:	e8 10 ab ff ff       	call   80100fd0 <fileclose>
    iunlockput(ip);
801064c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064c3:	89 04 24             	mov    %eax,(%esp)
801064c6:	e8 2d b6 ff ff       	call   80101af8 <iunlockput>
    end_op();
801064cb:	e8 12 d0 ff ff       	call   801034e2 <end_op>
    return -1;
801064d0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064d5:	eb 68                	jmp    8010653f <sys_open+0x198>
  }
  iunlock(ip);
801064d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064da:	89 04 24             	mov    %eax,(%esp)
801064dd:	e8 e0 b4 ff ff       	call   801019c2 <iunlock>
  end_op();
801064e2:	e8 fb cf ff ff       	call   801034e2 <end_op>
...
8010650b:	0f 94 c2             	sete   %dl
8010650e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106511:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80106514:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106517:	83 e0 01             	and    $0x1,%eax
8010651a:	84 c0                	test   %al,%al
8010651c:	75 0a                	jne    80106528 <sys_open+0x181>
8010651e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106521:	83 e0 02             	and    $0x2,%eax
80106524:	85 c0                	test   %eax,%eax
80106526:	74 07                	je     8010652f <sys_open+0x188>
80106528:	b8 01 00 00 00       	mov    $0x1,%eax
8010652d:	eb 05                	jmp    80106534 <sys_open+0x18d>
8010652f:	b8 00 00 00 00       	mov    $0x0,%eax
80106534:	89 c2                	mov    %eax,%edx
80106536:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106539:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
8010653c:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
8010653f:	c9                   	leave  
80106540:	c3                   	ret    
...
80106544:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106547:	e8 15 cf ff ff       	call   80103461 <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
8010654c:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010654f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106553:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010655a:	e8 3b f5 ff ff       	call   80105a9a <argstr>
8010655f:	85 c0                	test   %eax,%eax
80106561:	78 2c                	js     8010658f <sys_mkdir+0x4e>
80106563:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106566:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
8010656d:	00 
8010656e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106575:	00 
80106576:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010657d:	00 
8010657e:	89 04 24             	mov    %eax,(%esp)
80106581:	e8 61 fc ff ff       	call   801061e7 <create>
80106586:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106589:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010658d:	75 0c                	jne    8010659b <sys_mkdir+0x5a>
    end_op();
8010658f:	e8 4e cf ff ff       	call   801034e2 <end_op>
    return -1;
80106594:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106599:	eb 15                	jmp    801065b0 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
8010659b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010659e:	89 04 24             	mov    %eax,(%esp)
801065a1:	e8 52 b5 ff ff       	call   80101af8 <iunlockput>
  end_op();
801065a6:	e8 37 cf ff ff       	call   801034e2 <end_op>
  return 0;
...
801065b5:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_op();
801065b8:	e8 a4 ce ff ff       	call   80103461 <begin_op>
  if((len=argstr(0, &path)) < 0 ||
801065bd:	8d 45 ec             	lea    -0x14(%ebp),%eax
801065c0:	89 44 24 04          	mov    %eax,0x4(%esp)
801065c4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801065cb:	e8 ca f4 ff ff       	call   80105a9a <argstr>
801065d0:	89 45 f4             	mov    %eax,-0xc(%ebp)
801065d3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801065d7:	78 5e                	js     80106637 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
801065d9:	8d 45 e8             	lea    -0x18(%ebp),%eax
801065dc:	89 44 24 04          	mov    %eax,0x4(%esp)
801065e0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801065e7:	e8 1e f4 ff ff       	call   80105a0a <argint>
  char *path;
  int len;
  int major, minor;
...
801065ee:	78 47                	js     80106637 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801065f0:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801065f3:	89 44 24 04          	mov    %eax,0x4(%esp)
801065f7:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801065fe:	e8 07 f4 ff ff       	call   80105a0a <argint>
  int len;
  int major, minor;
...
80106605:	78 30                	js     80106637 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80106607:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010660a:	0f bf c8             	movswl %ax,%ecx
8010660d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106610:	0f bf d0             	movswl %ax,%edx
80106613:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106616:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010661a:	89 54 24 08          	mov    %edx,0x8(%esp)
8010661e:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106625:	00 
80106626:	89 04 24             	mov    %eax,(%esp)
80106629:	e8 b9 fb ff ff       	call   801061e7 <create>
8010662e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106631:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106635:	75 0c                	jne    80106643 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80106637:	e8 a6 ce ff ff       	call   801034e2 <end_op>
    return -1;
8010663c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106641:	eb 15                	jmp    80106658 <sys_mknod+0xa6>
  }
  iunlockput(ip);
80106643:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106646:	89 04 24             	mov    %eax,(%esp)
80106649:	e8 aa b4 ff ff       	call   80101af8 <iunlockput>
  end_op();
8010664e:	e8 8f ce ff ff       	call   801034e2 <end_op>
  return 0;
80106653:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106658:	c9                   	leave  
80106659:	c3                   	ret    
...
8010665d:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_op();
80106660:	e8 fc cd ff ff       	call   80103461 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80106665:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106668:	89 44 24 04          	mov    %eax,0x4(%esp)
8010666c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106673:	e8 22 f4 ff ff       	call   80105a9a <argstr>
80106678:	85 c0                	test   %eax,%eax
8010667a:	78 14                	js     80106690 <sys_chdir+0x36>
8010667c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010667f:	89 04 24             	mov    %eax,(%esp)
80106682:	e8 8f bd ff ff       	call   80102416 <namei>
80106687:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010668a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010668e:	75 0c                	jne    8010669c <sys_chdir+0x42>
    end_op();
80106690:	e8 4d ce ff ff       	call   801034e2 <end_op>
    return -1;
80106695:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010669a:	eb 61                	jmp    801066fd <sys_chdir+0xa3>
  }
  ilock(ip);
8010669c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010669f:	89 04 24             	mov    %eax,(%esp)
801066a2:	e8 cd b1 ff ff       	call   80101874 <ilock>
  if(ip->type != T_DIR){
801066a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066aa:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801066ae:	66 83 f8 01          	cmp    $0x1,%ax
801066b2:	74 17                	je     801066cb <sys_chdir+0x71>
    iunlockput(ip);
801066b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066b7:	89 04 24             	mov    %eax,(%esp)
801066ba:	e8 39 b4 ff ff       	call   80101af8 <iunlockput>
    end_op();
801066bf:	e8 1e ce ff ff       	call   801034e2 <end_op>
    return -1;
801066c4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066c9:	eb 32                	jmp    801066fd <sys_chdir+0xa3>
  }
  iunlock(ip);
801066cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066ce:	89 04 24             	mov    %eax,(%esp)
801066d1:	e8 ec b2 ff ff       	call   801019c2 <iunlock>
  iput(proc->cwd);
801066d6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066dc:	8b 40 68             	mov    0x68(%eax),%eax
801066df:	89 04 24             	mov    %eax,(%esp)
801066e2:	e8 40 b3 ff ff       	call   80101a27 <iput>
  end_op();
801066e7:	e8 f6 cd ff ff       	call   801034e2 <end_op>
  proc->cwd = ip;
801066ec:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066f2:	8b 55 f4             	mov    -0xc(%ebp),%edx
801066f5:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
...
80106702:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106716:	e8 7f f3 ff ff       	call   80105a9a <argstr>
8010671b:	85 c0                	test   %eax,%eax
8010671d:	78 1a                	js     80106739 <sys_exec+0x3a>
8010671f:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106725:	89 44 24 04          	mov    %eax,0x4(%esp)
80106729:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106730:	e8 d5 f2 ff ff       	call   80105a0a <argint>
80106735:	85 c0                	test   %eax,%eax
80106737:	79 0a                	jns    80106743 <sys_exec+0x44>
    return -1;
80106739:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010673e:	e9 cc 00 00 00       	jmp    8010680f <sys_exec+0x110>
  }
  memset(argv, 0, sizeof(argv));
80106743:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
8010674a:	00 
8010674b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106752:	00 
80106753:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106759:	89 04 24             	mov    %eax,(%esp)
8010675c:	e8 4d ef ff ff       	call   801056ae <memset>
  for(i=0;; i++){
80106761:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80106768:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010676b:	83 f8 1f             	cmp    $0x1f,%eax
8010676e:	76 0a                	jbe    8010677a <sys_exec+0x7b>
      return -1;
80106770:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106775:	e9 95 00 00 00       	jmp    8010680f <sys_exec+0x110>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
8010677a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010677d:	c1 e0 02             	shl    $0x2,%eax
80106780:	89 c2                	mov    %eax,%edx
80106782:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106788:	01 c2                	add    %eax,%edx
8010678a:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106790:	89 44 24 04          	mov    %eax,0x4(%esp)
80106794:	89 14 24             	mov    %edx,(%esp)
80106797:	e8 d0 f1 ff ff       	call   8010596c <fetchint>
8010679c:	85 c0                	test   %eax,%eax
8010679e:	79 07                	jns    801067a7 <sys_exec+0xa8>
      return -1;
801067a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067a5:	eb 68                	jmp    8010680f <sys_exec+0x110>
    if(uarg == 0){
801067a7:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801067ad:	85 c0                	test   %eax,%eax
801067af:	75 26                	jne    801067d7 <sys_exec+0xd8>
      argv[i] = 0;
801067b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067b4:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
...
801067c3:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
801067c9:	89 54 24 04          	mov    %edx,0x4(%esp)
801067cd:	89 04 24             	mov    %eax,(%esp)
801067d0:	e8 27 a3 ff ff       	call   80100afc <exec>
801067d5:	eb 38                	jmp    8010680f <sys_exec+0x110>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
801067da:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801067e1:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801067e7:	01 c2                	add    %eax,%edx
801067e9:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801067ef:	89 54 24 04          	mov    %edx,0x4(%esp)
801067f3:	89 04 24             	mov    %eax,(%esp)
801067f6:	e8 ab f1 ff ff       	call   801059a6 <fetchstr>
801067fb:	85 c0                	test   %eax,%eax
801067fd:	79 07                	jns    80106806 <sys_exec+0x107>
      return -1;
801067ff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106804:	eb 09                	jmp    8010680f <sys_exec+0x110>
...
8010680a:	e9 59 ff ff ff       	jmp    80106768 <sys_exec+0x69>
  return exec(path, argv);
}
8010680f:	c9                   	leave  
80106810:	c3                   	ret    
...
80106814:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106817:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
8010681e:	00 
8010681f:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106822:	89 44 24 04          	mov    %eax,0x4(%esp)
80106826:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010682d:	e8 06 f2 ff ff       	call   80105a38 <argptr>
80106832:	85 c0                	test   %eax,%eax
80106834:	79 0a                	jns    80106840 <sys_pipe+0x2f>
    return -1;
80106836:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010683b:	e9 9b 00 00 00       	jmp    801068db <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106840:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106843:	89 44 24 04          	mov    %eax,0x4(%esp)
80106847:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010684a:	89 04 24             	mov    %eax,(%esp)
8010684d:	e8 26 d7 ff ff       	call   80103f78 <pipealloc>
80106852:	85 c0                	test   %eax,%eax
80106854:	79 07                	jns    8010685d <sys_pipe+0x4c>
    return -1;
80106856:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010685b:	eb 7e                	jmp    801068db <sys_pipe+0xca>
  fd0 = -1;
...
8010686a:	e8 66 f3 ff ff       	call   80105bd5 <fdalloc>
8010686f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106872:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106876:	78 14                	js     8010688c <sys_pipe+0x7b>
80106878:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010687b:	89 04 24             	mov    %eax,(%esp)
8010687e:	e8 52 f3 ff ff       	call   80105bd5 <fdalloc>
80106883:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106886:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010688a:	79 37                	jns    801068c3 <sys_pipe+0xb2>
    if(fd0 >= 0)
8010688c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106890:	78 14                	js     801068a6 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106892:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106898:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010689b:	83 c2 08             	add    $0x8,%edx
8010689e:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801068a5:	00 
    fileclose(rf);
801068a6:	8b 45 e8             	mov    -0x18(%ebp),%eax
801068a9:	89 04 24             	mov    %eax,(%esp)
801068ac:	e8 1f a7 ff ff       	call   80100fd0 <fileclose>
    fileclose(wf);
801068b1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801068b4:	89 04 24             	mov    %eax,(%esp)
801068b7:	e8 14 a7 ff ff       	call   80100fd0 <fileclose>
    return -1;
801068bc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068c1:	eb 18                	jmp    801068db <sys_pipe+0xca>
  }
  fd[0] = fd0;
801068c3:	8b 45 ec             	mov    -0x14(%ebp),%eax
801068c6:	8b 55 f4             	mov    -0xc(%ebp),%edx
801068c9:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
801068cb:	8b 45 ec             	mov    -0x14(%ebp),%eax
801068ce:	8d 50 04             	lea    0x4(%eax),%edx
801068d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068d4:	89 02                	mov    %eax,(%edx)
  return 0;
801068d6:	b8 00 00 00 00       	mov    $0x0,%eax
}
801068db:	c9                   	leave  
801068dc:	c3                   	ret    
801068dd:	00 00                	add    %al,(%eax)
	...
...
801068e6:	8b 55 08             	mov    0x8(%ebp),%edx
801068e9:	8b 45 0c             	mov    0xc(%ebp),%eax
801068ec:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801068f0:	66 89 45 f8          	mov    %ax,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801068f4:	0f b7 45 f8          	movzwl -0x8(%ebp),%eax
801068f8:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
801068fc:	66 ef                	out    %ax,(%dx)
}
801068fe:	c9                   	leave  
801068ff:	c3                   	ret    
...
80106903:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106906:	e8 5b dd ff ff       	call   80104666 <fork>
}
8010690b:	c9                   	leave  
8010690c:	c3                   	ret    
...
80106910:	83 ec 08             	sub    $0x8,%esp
  exit();
80106913:	e8 c9 de ff ff       	call   801047e1 <exit>
  return 0;  // not reached
80106918:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010691d:	c9                   	leave  
8010691e:	c3                   	ret    
...
80106922:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106925:	e8 3d e1 ff ff       	call   80104a67 <wait>
}
8010692a:	c9                   	leave  
8010692b:	c3                   	ret    
...
8010692f:	83 ec 28             	sub    $0x28,%esp
  int pid;

  if(argint(0, &pid) < 0)
80106932:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106935:	89 44 24 04          	mov    %eax,0x4(%esp)
80106939:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106940:	e8 c5 f0 ff ff       	call   80105a0a <argint>
80106945:	85 c0                	test   %eax,%eax
80106947:	79 07                	jns    80106950 <sys_kill+0x24>
    return -1;
80106949:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010694e:	eb 0b                	jmp    8010695b <sys_kill+0x2f>
  return kill(pid);
80106950:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106953:	89 04 24             	mov    %eax,(%esp)
80106956:	e8 d1 e4 ff ff       	call   80104e2c <kill>
}
8010695b:	c9                   	leave  
8010695c:	c3                   	ret    
...
80106966:	8b 40 10             	mov    0x10(%eax),%eax
}
80106969:	5d                   	pop    %ebp
8010696a:	c3                   	ret    
...
8010696e:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;
...
8010697f:	e8 86 f0 ff ff       	call   80105a0a <argint>
80106984:	85 c0                	test   %eax,%eax
80106986:	79 07                	jns    8010698f <sys_sbrk+0x24>
    return -1;
80106988:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010698d:	eb 24                	jmp    801069b3 <sys_sbrk+0x48>
  addr = proc->sz;
8010698f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106995:	8b 00                	mov    (%eax),%eax
80106997:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
8010699a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010699d:	89 04 24             	mov    %eax,(%esp)
801069a0:	e8 1c dc ff ff       	call   801045c1 <growproc>
801069a5:	85 c0                	test   %eax,%eax
801069a7:	79 07                	jns    801069b0 <sys_sbrk+0x45>
    return -1;
801069a9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069ae:	eb 03                	jmp    801069b3 <sys_sbrk+0x48>
  return addr;
...
801069b8:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
801069bb:	8d 45 f0             	lea    -0x10(%ebp),%eax
801069be:	89 44 24 04          	mov    %eax,0x4(%esp)
801069c2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069c9:	e8 3c f0 ff ff       	call   80105a0a <argint>
801069ce:	85 c0                	test   %eax,%eax
801069d0:	79 07                	jns    801069d9 <sys_sleep+0x24>
    return -1;
801069d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069d7:	eb 6c                	jmp    80106a45 <sys_sleep+0x90>
  acquire(&tickslock);
801069d9:	c7 04 24 c0 9b 11 80 	movl   $0x80119bc0,(%esp)
801069e0:	e8 7a ea ff ff       	call   8010545f <acquire>
  ticks0 = ticks;
801069e5:	a1 00 a4 11 80       	mov    0x8011a400,%eax
801069ea:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801069ed:	eb 34                	jmp    80106a23 <sys_sleep+0x6e>
    if(proc->killed){
801069ef:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069f5:	8b 40 24             	mov    0x24(%eax),%eax
801069f8:	85 c0                	test   %eax,%eax
801069fa:	74 13                	je     80106a0f <sys_sleep+0x5a>
      release(&tickslock);
801069fc:	c7 04 24 c0 9b 11 80 	movl   $0x80119bc0,(%esp)
80106a03:	e8 b9 ea ff ff       	call   801054c1 <release>
      return -1;
80106a08:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a0d:	eb 36                	jmp    80106a45 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106a0f:	c7 44 24 04 c0 9b 11 	movl   $0x80119bc0,0x4(%esp)
80106a16:	80 
80106a17:	c7 04 24 00 a4 11 80 	movl   $0x8011a400,(%esp)
80106a1e:	e8 02 e3 ff ff       	call   80104d25 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106a23:	a1 00 a4 11 80       	mov    0x8011a400,%eax
80106a28:	89 c2                	mov    %eax,%edx
80106a2a:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106a2d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a30:	39 c2                	cmp    %eax,%edx
80106a32:	72 bb                	jb     801069ef <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106a34:	c7 04 24 c0 9b 11 80 	movl   $0x80119bc0,(%esp)
80106a3b:	e8 81 ea ff ff       	call   801054c1 <release>
  return 0;
...
80106a4a:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106a4d:	c7 04 24 c0 9b 11 80 	movl   $0x80119bc0,(%esp)
80106a54:	e8 06 ea ff ff       	call   8010545f <acquire>
  xticks = ticks;
80106a59:	a1 00 a4 11 80       	mov    0x8011a400,%eax
80106a5e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106a61:	c7 04 24 c0 9b 11 80 	movl   $0x80119bc0,(%esp)
80106a68:	e8 54 ea ff ff       	call   801054c1 <release>
  return xticks;
...
80106a75:	83 ec 18             	sub    $0x18,%esp
  char *p = "Shutdown";
80106a78:	c7 45 fc 60 91 10 80 	movl   $0x80109160,-0x4(%ebp)
  for( ; *p; p++)
80106a7f:	eb 18                	jmp    80106a99 <sys_halt+0x27>
    outw(0xB004, 0x2000);
80106a81:	c7 44 24 04 00 20 00 	movl   $0x2000,0x4(%esp)
80106a88:	00 
80106a89:	c7 04 24 04 b0 00 00 	movl   $0xb004,(%esp)
80106a90:	e8 4b fe ff ff       	call   801068e0 <outw>
// and: https://github.com/t3rm1n4l/pintos/blob/master/devices/shutdown.c
int
sys_halt(void)
{
  char *p = "Shutdown";
  for( ; *p; p++)
80106a95:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80106a99:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106a9c:	0f b6 00             	movzbl (%eax),%eax
80106a9f:	84 c0                	test   %al,%al
80106aa1:	75 de                	jne    80106a81 <sys_halt+0xf>
    outw(0xB004, 0x2000);
  return 0;
...
80106abe:	e8 47 ef ff ff       	call   80105a0a <argint>
80106ac3:	85 c0                	test   %eax,%eax
80106ac5:	78 2e                	js     80106af5 <sys_clone+0x4b>
80106ac7:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106aca:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ace:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106ad5:	e8 30 ef ff ff       	call   80105a0a <argint>
80106ada:	85 c0                	test   %eax,%eax
80106adc:	78 17                	js     80106af5 <sys_clone+0x4b>
80106ade:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106ae1:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ae5:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106aec:	e8 19 ef ff ff       	call   80105a0a <argint>
80106af1:	85 c0                	test   %eax,%eax
80106af3:	79 07                	jns    80106afc <sys_clone+0x52>
  return -1;
80106af5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106afa:	eb 1d                	jmp    80106b19 <sys_clone+0x6f>
}

return clone((void*)myFunction, (void*)myArgument, (void*)myStack);
80106afc:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106aff:	89 c1                	mov    %eax,%ecx
80106b01:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b04:	89 c2                	mov    %eax,%edx
80106b06:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b09:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106b0d:	89 54 24 04          	mov    %edx,0x4(%esp)
80106b11:	89 04 24             	mov    %eax,(%esp)
80106b14:	e8 8a e4 ff ff       	call   80104fa3 <clone>
...
80106b21:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106b24:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b28:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106b2f:	e8 d6 ee ff ff       	call   80105a0a <argint>
80106b34:	85 c0                	test   %eax,%eax
80106b36:	78 2e                	js     80106b66 <sys_join+0x4b>
80106b38:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106b3b:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b3f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106b46:	e8 bf ee ff ff       	call   80105a0a <argint>
80106b4b:	85 c0                	test   %eax,%eax
80106b4d:	78 17                	js     80106b66 <sys_join+0x4b>
80106b4f:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106b52:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b56:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106b5d:	e8 a8 ee ff ff       	call   80105a0a <argint>
80106b62:	85 c0                	test   %eax,%eax
80106b64:	74 07                	je     80106b6d <sys_join+0x52>
  return -1;
80106b66:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b6b:	eb 1d                	jmp    80106b8a <sys_join+0x6f>
}

return join((int)myPid, (void**)myStack, (void**)myRetval);
80106b6d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106b70:	89 c1                	mov    %eax,%ecx
80106b72:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b75:	89 c2                	mov    %eax,%edx
80106b77:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b7a:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106b7e:	89 54 24 04          	mov    %edx,0x4(%esp)
80106b82:	89 04 24             	mov    %eax,(%esp)
80106b85:	e8 d1 e5 ff ff       	call   8010515b <join>
...
mutex_init();
80106bc3:	e8 d1 e6 ff ff       	call   80105299 <mutex_init>
return 0;
...
80106bd2:	83 ec 28             	sub    $0x28,%esp
  int myMutexID;
...
80106be3:	e8 22 ee ff ff       	call   80105a0a <argint>
80106be8:	85 c0                	test   %eax,%eax
80106bea:	79 07                	jns    80106bf3 <sys_mutex_destroy+0x24>
    return -1;
80106bec:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bf1:	eb 10                	jmp    80106c03 <sys_mutex_destroy+0x34>

  mutex_destroy((int)myMutexID);
80106bf3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bf6:	89 04 24             	mov    %eax,(%esp)
80106bf9:	e8 0a e7 ff ff       	call   80105308 <mutex_destroy>
  return 0;
...
80106c08:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &myMutexID) < 0)
80106c0b:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106c0e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c12:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106c19:	e8 ec ed ff ff       	call   80105a0a <argint>
80106c1e:	85 c0                	test   %eax,%eax
80106c20:	79 07                	jns    80106c29 <sys_mutex_lock+0x24>
    return -1;
80106c22:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c27:	eb 10                	jmp    80106c39 <sys_mutex_lock+0x34>

  mutex_lock((int)myMutexID);
80106c29:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c2c:	89 04 24             	mov    %eax,(%esp)
80106c2f:	e8 f2 e6 ff ff       	call   80105326 <mutex_lock>
  return 0;
...
80106c48:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106c4f:	e8 b6 ed ff ff       	call   80105a0a <argint>
80106c54:	85 c0                	test   %eax,%eax
80106c56:	79 07                	jns    80106c5f <sys_mutex_unlock+0x24>
    return -1;
80106c58:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c5d:	eb 10                	jmp    80106c6f <sys_mutex_unlock+0x34>

  mutex_unlock((int)myMutexID);
80106c5f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c62:	89 04 24             	mov    %eax,(%esp)
80106c65:	e8 29 e7 ff ff       	call   80105393 <mutex_unlock>
  return 0;
80106c6a:	b8 00 00 00 00       	mov    $0x0,%eax
80106c6f:	c9                   	leave  
80106c70:	c3                   	ret    
...
80106c7a:	8b 55 08             	mov    0x8(%ebp),%edx
80106c7d:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c80:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106c84:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106c87:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106c8b:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106c8f:	ee                   	out    %al,(%dx)
}
80106c90:	c9                   	leave  
80106c91:	c3                   	ret    
...
80106c98:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106c9f:	00 
80106ca0:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106ca7:	e8 c8 ff ff ff       	call   80106c74 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106cac:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106cb3:	00 
80106cb4:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106cbb:	e8 b4 ff ff ff       	call   80106c74 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106cc0:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106cc7:	00 
80106cc8:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106ccf:	e8 a0 ff ff ff       	call   80106c74 <outb>
  picenable(IRQ_TIMER);
80106cd4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106cdb:	e8 21 d1 ff ff       	call   80103e01 <picenable>
}
80106ce0:	c9                   	leave  
80106ce1:	c3                   	ret    
	...
...
80106ce5:	06                   	push   %es
  pushl %fs
80106ce6:	0f a0                	push   %fs
  pushl %gs
80106ce8:	0f a8                	push   %gs
  pushal
80106cea:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106ceb:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106cef:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106cf1:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106cf3:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106cf7:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106cf9:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106cfb:	54                   	push   %esp
  call trap
80106cfc:	e8 de 01 00 00       	call   80106edf <trap>
  addl $4, %esp
...
80106d04:	61                   	popa   
  popl %gs
80106d05:	0f a9                	pop    %gs
  popl %fs
80106d07:	0f a1                	pop    %fs
  popl %es
80106d09:	07                   	pop    %es
  popl %ds
80106d0a:	1f                   	pop    %ds
...
80106d13:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80106d16:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d19:	83 e8 01             	sub    $0x1,%eax
80106d1c:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106d20:	8b 45 08             	mov    0x8(%ebp),%eax
80106d23:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106d27:	8b 45 08             	mov    0x8(%ebp),%eax
80106d2a:	c1 e8 10             	shr    $0x10,%eax
80106d2d:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106d31:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106d34:	0f 01 18             	lidtl  (%eax)
}
80106d37:	c9                   	leave  
80106d38:	c3                   	ret    
...
80106d3c:	53                   	push   %ebx
80106d3d:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106d40:	0f 20 d3             	mov    %cr2,%ebx
80106d43:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106d46:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106d52:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106d55:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106d5c:	e9 c3 00 00 00       	jmp    80106e24 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106d61:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d64:	8b 04 85 c0 c0 10 80 	mov    -0x7fef3f40(,%eax,4),%eax
80106d6b:	89 c2                	mov    %eax,%edx
80106d6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d70:	66 89 14 c5 00 9c 11 	mov    %dx,-0x7fee6400(,%eax,8)
80106d77:	80 
80106d78:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d7b:	66 c7 04 c5 02 9c 11 	movw   $0x8,-0x7fee63fe(,%eax,8)
80106d82:	80 08 00 
80106d85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d88:	0f b6 14 c5 04 9c 11 	movzbl -0x7fee63fc(,%eax,8),%edx
80106d8f:	80 
80106d90:	83 e2 e0             	and    $0xffffffe0,%edx
80106d93:	88 14 c5 04 9c 11 80 	mov    %dl,-0x7fee63fc(,%eax,8)
80106d9a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d9d:	0f b6 14 c5 04 9c 11 	movzbl -0x7fee63fc(,%eax,8),%edx
80106da4:	80 
80106da5:	83 e2 1f             	and    $0x1f,%edx
80106da8:	88 14 c5 04 9c 11 80 	mov    %dl,-0x7fee63fc(,%eax,8)
80106daf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106db2:	0f b6 14 c5 05 9c 11 	movzbl -0x7fee63fb(,%eax,8),%edx
80106db9:	80 
80106dba:	83 e2 f0             	and    $0xfffffff0,%edx
80106dbd:	83 ca 0e             	or     $0xe,%edx
80106dc0:	88 14 c5 05 9c 11 80 	mov    %dl,-0x7fee63fb(,%eax,8)
80106dc7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106dca:	0f b6 14 c5 05 9c 11 	movzbl -0x7fee63fb(,%eax,8),%edx
80106dd1:	80 
80106dd2:	83 e2 ef             	and    $0xffffffef,%edx
80106dd5:	88 14 c5 05 9c 11 80 	mov    %dl,-0x7fee63fb(,%eax,8)
80106ddc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ddf:	0f b6 14 c5 05 9c 11 	movzbl -0x7fee63fb(,%eax,8),%edx
80106de6:	80 
80106de7:	83 e2 9f             	and    $0xffffff9f,%edx
80106dea:	88 14 c5 05 9c 11 80 	mov    %dl,-0x7fee63fb(,%eax,8)
80106df1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106df4:	0f b6 14 c5 05 9c 11 	movzbl -0x7fee63fb(,%eax,8),%edx
80106dfb:	80 
80106dfc:	83 ca 80             	or     $0xffffff80,%edx
80106dff:	88 14 c5 05 9c 11 80 	mov    %dl,-0x7fee63fb(,%eax,8)
80106e06:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e09:	8b 04 85 c0 c0 10 80 	mov    -0x7fef3f40(,%eax,4),%eax
80106e10:	c1 e8 10             	shr    $0x10,%eax
80106e13:	89 c2                	mov    %eax,%edx
80106e15:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e18:	66 89 14 c5 06 9c 11 	mov    %dx,-0x7fee63fa(,%eax,8)
80106e1f:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106e20:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106e24:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106e2b:	0f 8e 30 ff ff ff    	jle    80106d61 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106e31:	a1 c0 c1 10 80       	mov    0x8010c1c0,%eax
80106e36:	66 a3 00 9e 11 80    	mov    %ax,0x80119e00
80106e3c:	66 c7 05 02 9e 11 80 	movw   $0x8,0x80119e02
80106e43:	08 00 
80106e45:	0f b6 05 04 9e 11 80 	movzbl 0x80119e04,%eax
80106e4c:	83 e0 e0             	and    $0xffffffe0,%eax
80106e4f:	a2 04 9e 11 80       	mov    %al,0x80119e04
80106e54:	0f b6 05 04 9e 11 80 	movzbl 0x80119e04,%eax
80106e5b:	83 e0 1f             	and    $0x1f,%eax
80106e5e:	a2 04 9e 11 80       	mov    %al,0x80119e04
80106e63:	0f b6 05 05 9e 11 80 	movzbl 0x80119e05,%eax
80106e6a:	83 c8 0f             	or     $0xf,%eax
80106e6d:	a2 05 9e 11 80       	mov    %al,0x80119e05
80106e72:	0f b6 05 05 9e 11 80 	movzbl 0x80119e05,%eax
80106e79:	83 e0 ef             	and    $0xffffffef,%eax
80106e7c:	a2 05 9e 11 80       	mov    %al,0x80119e05
80106e81:	0f b6 05 05 9e 11 80 	movzbl 0x80119e05,%eax
80106e88:	83 c8 60             	or     $0x60,%eax
80106e8b:	a2 05 9e 11 80       	mov    %al,0x80119e05
80106e90:	0f b6 05 05 9e 11 80 	movzbl 0x80119e05,%eax
80106e97:	83 c8 80             	or     $0xffffff80,%eax
80106e9a:	a2 05 9e 11 80       	mov    %al,0x80119e05
80106e9f:	a1 c0 c1 10 80       	mov    0x8010c1c0,%eax
80106ea4:	c1 e8 10             	shr    $0x10,%eax
80106ea7:	66 a3 06 9e 11 80    	mov    %ax,0x80119e06
  
  initlock(&tickslock, "time");
80106ead:	c7 44 24 04 6c 91 10 	movl   $0x8010916c,0x4(%esp)
80106eb4:	80 
80106eb5:	c7 04 24 c0 9b 11 80 	movl   $0x80119bc0,(%esp)
80106ebc:	e8 7d e5 ff ff       	call   8010543e <initlock>
}
80106ec1:	c9                   	leave  
80106ec2:	c3                   	ret    
...
80106ec6:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106ec9:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106ed0:	00 
80106ed1:	c7 04 24 00 9c 11 80 	movl   $0x80119c00,(%esp)
80106ed8:	e8 33 fe ff ff       	call   80106d10 <lidt>
}
80106edd:	c9                   	leave  
80106ede:	c3                   	ret    
...
80106efe:	74 05                	je     80106f05 <trap+0x26>
      exit();
80106f00:	e8 dc d8 ff ff       	call   801047e1 <exit>
    proc->tf = tf;
80106f05:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f0b:	8b 55 08             	mov    0x8(%ebp),%edx
80106f0e:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106f11:	e8 bb eb ff ff       	call   80105ad1 <syscall>
    if(proc->killed)
80106f16:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f1c:	8b 40 24             	mov    0x24(%eax),%eax
80106f1f:	85 c0                	test   %eax,%eax
80106f21:	0f 84 34 02 00 00    	je     8010715b <trap+0x27c>
      exit();
80106f27:	e8 b5 d8 ff ff       	call   801047e1 <exit>
    return;
80106f2c:	e9 2a 02 00 00       	jmp    8010715b <trap+0x27c>
  }

  switch(tf->trapno){
80106f31:	8b 45 08             	mov    0x8(%ebp),%eax
80106f34:	8b 40 30             	mov    0x30(%eax),%eax
80106f37:	83 e8 20             	sub    $0x20,%eax
80106f3a:	83 f8 1f             	cmp    $0x1f,%eax
80106f3d:	0f 87 bc 00 00 00    	ja     80106fff <trap+0x120>
80106f43:	8b 04 85 14 92 10 80 	mov    -0x7fef6dec(,%eax,4),%eax
80106f4a:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106f4c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106f52:	0f b6 00             	movzbl (%eax),%eax
80106f55:	84 c0                	test   %al,%al
80106f57:	75 31                	jne    80106f8a <trap+0xab>
      acquire(&tickslock);
80106f59:	c7 04 24 c0 9b 11 80 	movl   $0x80119bc0,(%esp)
80106f60:	e8 fa e4 ff ff       	call   8010545f <acquire>
      ticks++;
80106f65:	a1 00 a4 11 80       	mov    0x8011a400,%eax
80106f6a:	83 c0 01             	add    $0x1,%eax
80106f6d:	a3 00 a4 11 80       	mov    %eax,0x8011a400
      wakeup(&ticks);
80106f72:	c7 04 24 00 a4 11 80 	movl   $0x8011a400,(%esp)
80106f79:	e8 83 de ff ff       	call   80104e01 <wakeup>
      release(&tickslock);
80106f7e:	c7 04 24 c0 9b 11 80 	movl   $0x80119bc0,(%esp)
80106f85:	e8 37 e5 ff ff       	call   801054c1 <release>
    }
    lapiceoi();
80106f8a:	e8 90 bf ff ff       	call   80102f1f <lapiceoi>
    break;
80106f8f:	e9 41 01 00 00       	jmp    801070d5 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106f94:	e8 64 b7 ff ff       	call   801026fd <ideintr>
    lapiceoi();
80106f99:	e8 81 bf ff ff       	call   80102f1f <lapiceoi>
    break;
80106f9e:	e9 32 01 00 00       	jmp    801070d5 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106fa3:	e8 2b bd ff ff       	call   80102cd3 <kbdintr>
    lapiceoi();
80106fa8:	e8 72 bf ff ff       	call   80102f1f <lapiceoi>
    break;
80106fad:	e9 23 01 00 00       	jmp    801070d5 <trap+0x1f6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106fb2:	e8 a9 03 00 00       	call   80107360 <uartintr>
    lapiceoi();
80106fb7:	e8 63 bf ff ff       	call   80102f1f <lapiceoi>
    break;
80106fbc:	e9 14 01 00 00       	jmp    801070d5 <trap+0x1f6>
  case T_IRQ0 + 7:
...
80106fc1:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106fc4:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80106fc7:	8b 45 08             	mov    0x8(%ebp),%eax
80106fca:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106fce:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106fd1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106fd7:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
...
80106fdd:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106fe1:	89 54 24 08          	mov    %edx,0x8(%esp)
80106fe5:	89 44 24 04          	mov    %eax,0x4(%esp)
80106fe9:	c7 04 24 74 91 10 80 	movl   $0x80109174,(%esp)
80106ff0:	e8 ac 93 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106ff5:	e8 25 bf ff ff       	call   80102f1f <lapiceoi>
    break;
80106ffa:	e9 d6 00 00 00       	jmp    801070d5 <trap+0x1f6>
...
80107007:	74 11                	je     8010701a <trap+0x13b>
80107009:	8b 45 08             	mov    0x8(%ebp),%eax
8010700c:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107010:	0f b7 c0             	movzwl %ax,%eax
80107013:	83 e0 03             	and    $0x3,%eax
80107016:	85 c0                	test   %eax,%eax
80107018:	75 46                	jne    80107060 <trap+0x181>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010701a:	e8 1a fd ff ff       	call   80106d39 <rcr2>
              tf->trapno, cpu->id, tf->eip, rcr2());
8010701f:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107022:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107025:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010702c:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010702f:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107032:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107035:	8b 52 30             	mov    0x30(%edx),%edx
80107038:	89 44 24 10          	mov    %eax,0x10(%esp)
8010703c:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80107040:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107044:	89 54 24 04          	mov    %edx,0x4(%esp)
80107048:	c7 04 24 98 91 10 80 	movl   $0x80109198,(%esp)
8010704f:	e8 4d 93 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80107054:	c7 04 24 ca 91 10 80 	movl   $0x801091ca,(%esp)
8010705b:	e8 dd 94 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107060:	e8 d4 fc ff ff       	call   80106d39 <rcr2>
...
80107067:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010706a:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
...
80107073:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107076:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107079:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010707c:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010707f:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107082:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107085:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010708b:	83 c0 6c             	add    $0x6c,%eax
8010708e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107091:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107097:	8b 40 10             	mov    0x10(%eax),%eax
8010709a:	89 54 24 1c          	mov    %edx,0x1c(%esp)
8010709e:	89 7c 24 18          	mov    %edi,0x18(%esp)
801070a2:	89 74 24 14          	mov    %esi,0x14(%esp)
801070a6:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801070aa:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801070ae:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801070b1:	89 54 24 08          	mov    %edx,0x8(%esp)
801070b5:	89 44 24 04          	mov    %eax,0x4(%esp)
801070b9:	c7 04 24 d0 91 10 80 	movl   $0x801091d0,(%esp)
801070c0:	e8 dc 92 ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
801070c5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801070cb:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801070d2:	eb 01                	jmp    801070d5 <trap+0x1f6>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
801070dd:	74 24                	je     80107103 <trap+0x224>
801070df:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801070e5:	8b 40 24             	mov    0x24(%eax),%eax
801070e8:	85 c0                	test   %eax,%eax
801070ea:	74 17                	je     80107103 <trap+0x224>
801070ec:	8b 45 08             	mov    0x8(%ebp),%eax
801070ef:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801070f3:	0f b7 c0             	movzwl %ax,%eax
801070f6:	83 e0 03             	and    $0x3,%eax
801070f9:	83 f8 03             	cmp    $0x3,%eax
801070fc:	75 05                	jne    80107103 <trap+0x224>
    exit();
801070fe:	e8 de d6 ff ff       	call   801047e1 <exit>
...
8010710b:	74 1e                	je     8010712b <trap+0x24c>
8010710d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107113:	8b 40 0c             	mov    0xc(%eax),%eax
80107116:	83 f8 04             	cmp    $0x4,%eax
80107119:	75 10                	jne    8010712b <trap+0x24c>
8010711b:	8b 45 08             	mov    0x8(%ebp),%eax
8010711e:	8b 40 30             	mov    0x30(%eax),%eax
80107121:	83 f8 20             	cmp    $0x20,%eax
80107124:	75 05                	jne    8010712b <trap+0x24c>
    yield();
80107126:	e8 9c db ff ff       	call   80104cc7 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
8010712b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107131:	85 c0                	test   %eax,%eax
80107133:	74 27                	je     8010715c <trap+0x27d>
80107135:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010713b:	8b 40 24             	mov    0x24(%eax),%eax
8010713e:	85 c0                	test   %eax,%eax
80107140:	74 1a                	je     8010715c <trap+0x27d>
80107142:	8b 45 08             	mov    0x8(%ebp),%eax
80107145:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107149:	0f b7 c0             	movzwl %ax,%eax
8010714c:	83 e0 03             	and    $0x3,%eax
8010714f:	83 f8 03             	cmp    $0x3,%eax
80107152:	75 08                	jne    8010715c <trap+0x27d>
    exit();
80107154:	e8 88 d6 ff ff       	call   801047e1 <exit>
80107159:	eb 01                	jmp    8010715c <trap+0x27d>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
8010715c:	83 c4 3c             	add    $0x3c,%esp
8010715f:	5b                   	pop    %ebx
80107160:	5e                   	pop    %esi
80107161:	5f                   	pop    %edi
80107162:	5d                   	pop    %ebp
...
80107168:	83 ec 14             	sub    $0x14,%esp
8010716b:	8b 45 08             	mov    0x8(%ebp),%eax
8010716e:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80107172:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80107176:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
8010717a:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
8010717e:	ec                   	in     (%dx),%al
8010717f:	89 c3                	mov    %eax,%ebx
80107181:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80107184:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80107188:	83 c4 14             	add    $0x14,%esp
8010718b:	5b                   	pop    %ebx
8010718c:	5d                   	pop    %ebp
8010718d:	c3                   	ret    
...
80107194:	8b 55 08             	mov    0x8(%ebp),%edx
80107197:	8b 45 0c             	mov    0xc(%ebp),%eax
8010719a:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010719e:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801071a1:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801071a5:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
801071a9:	ee                   	out    %al,(%dx)
}
801071aa:	c9                   	leave  
801071ab:	c3                   	ret    
...
uartinit(void)
{
801071ac:	55                   	push   %ebp
801071ad:	89 e5                	mov    %esp,%ebp
801071af:	83 ec 28             	sub    $0x28,%esp
  char *p;
...
801071b9:	00 
801071ba:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801071c1:	e8 c8 ff ff ff       	call   8010718e <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
801071c6:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
801071cd:	00 
801071ce:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801071d5:	e8 b4 ff ff ff       	call   8010718e <outb>
  outb(COM1+0, 115200/9600);
801071da:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801071e1:	00 
801071e2:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801071e9:	e8 a0 ff ff ff       	call   8010718e <outb>
  outb(COM1+1, 0);
801071ee:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801071f5:	00 
801071f6:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801071fd:	e8 8c ff ff ff       	call   8010718e <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80107202:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80107209:	00 
8010720a:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107211:	e8 78 ff ff ff       	call   8010718e <outb>
  outb(COM1+4, 0);
80107216:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010721d:	00 
8010721e:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80107225:	e8 64 ff ff ff       	call   8010718e <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
8010722a:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107231:	00 
80107232:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107239:	e8 50 ff ff ff       	call   8010718e <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
8010723e:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107245:	e8 1a ff ff ff       	call   80107164 <inb>
8010724a:	3c ff                	cmp    $0xff,%al
8010724c:	74 6c                	je     801072ba <uartinit+0x10e>
    return;
  uart = 1;
8010724e:	c7 05 6c c6 10 80 01 	movl   $0x1,0x8010c66c
80107255:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107258:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010725f:	e8 00 ff ff ff       	call   80107164 <inb>
  inb(COM1+0);
80107264:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010726b:	e8 f4 fe ff ff       	call   80107164 <inb>
  picenable(IRQ_COM1);
80107270:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107277:	e8 85 cb ff ff       	call   80103e01 <picenable>
  ioapicenable(IRQ_COM1, 0);
8010727c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107283:	00 
80107284:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010728b:	e8 f2 b6 ff ff       	call   80102982 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107290:	c7 45 f4 94 92 10 80 	movl   $0x80109294,-0xc(%ebp)
80107297:	eb 15                	jmp    801072ae <uartinit+0x102>
    uartputc(*p);
80107299:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010729c:	0f b6 00             	movzbl (%eax),%eax
8010729f:	0f be c0             	movsbl %al,%eax
801072a2:	89 04 24             	mov    %eax,(%esp)
801072a5:	e8 13 00 00 00       	call   801072bd <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801072aa:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801072ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801072b1:	0f b6 00             	movzbl (%eax),%eax
801072b4:	84 c0                	test   %al,%al
801072b6:	75 e1                	jne    80107299 <uartinit+0xed>
801072b8:	eb 01                	jmp    801072bb <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
801072c0:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
801072c3:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
801072c8:	85 c0                	test   %eax,%eax
801072ca:	74 4d                	je     80107319 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801072cc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801072d3:	eb 10                	jmp    801072e5 <uartputc+0x28>
    microdelay(10);
801072d5:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801072dc:	e8 63 bc ff ff       	call   80102f44 <microdelay>
{
  int i;
...
801072e9:	7f 16                	jg     80107301 <uartputc+0x44>
801072eb:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801072f2:	e8 6d fe ff ff       	call   80107164 <inb>
801072f7:	0f b6 c0             	movzbl %al,%eax
801072fa:	83 e0 20             	and    $0x20,%eax
801072fd:	85 c0                	test   %eax,%eax
801072ff:	74 d4                	je     801072d5 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
80107301:	8b 45 08             	mov    0x8(%ebp),%eax
80107304:	0f b6 c0             	movzbl %al,%eax
80107307:	89 44 24 04          	mov    %eax,0x4(%esp)
8010730b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107312:	e8 77 fe ff ff       	call   8010718e <outb>
80107317:	eb 01                	jmp    8010731a <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
8010731f:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80107322:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
80107327:	85 c0                	test   %eax,%eax
80107329:	75 07                	jne    80107332 <uartgetc+0x16>
    return -1;
8010732b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107330:	eb 2c                	jmp    8010735e <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80107332:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107339:	e8 26 fe ff ff       	call   80107164 <inb>
8010733e:	0f b6 c0             	movzbl %al,%eax
80107341:	83 e0 01             	and    $0x1,%eax
80107344:	85 c0                	test   %eax,%eax
80107346:	75 07                	jne    8010734f <uartgetc+0x33>
    return -1;
80107348:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010734d:	eb 0f                	jmp    8010735e <uartgetc+0x42>
  return inb(COM1+0);
8010734f:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107356:	e8 09 fe ff ff       	call   80107164 <inb>
...
80107366:	c7 04 24 1c 73 10 80 	movl   $0x8010731c,(%esp)
8010736d:	e8 3b 94 ff ff       	call   801007ad <consoleintr>
}
80107372:	c9                   	leave  
80107373:	c3                   	ret    
...
80107376:	6a 00                	push   $0x0
  jmp alltraps
80107378:	e9 67 f9 ff ff       	jmp    80106ce4 <alltraps>
...
8010737f:	6a 01                	push   $0x1
  jmp alltraps
80107381:	e9 5e f9 ff ff       	jmp    80106ce4 <alltraps>
...
80107388:	6a 02                	push   $0x2
  jmp alltraps
8010738a:	e9 55 f9 ff ff       	jmp    80106ce4 <alltraps>
...
8010738f:	6a 00                	push   $0x0
  pushl $3
80107391:	6a 03                	push   $0x3
  jmp alltraps
80107393:	e9 4c f9 ff ff       	jmp    80106ce4 <alltraps>
...
80107398:	6a 00                	push   $0x0
  pushl $4
8010739a:	6a 04                	push   $0x4
  jmp alltraps
8010739c:	e9 43 f9 ff ff       	jmp    80106ce4 <alltraps>
...
801073a1:	6a 00                	push   $0x0
  pushl $5
801073a3:	6a 05                	push   $0x5
  jmp alltraps
801073a5:	e9 3a f9 ff ff       	jmp    80106ce4 <alltraps>
...
801073ac:	6a 06                	push   $0x6
  jmp alltraps
801073ae:	e9 31 f9 ff ff       	jmp    80106ce4 <alltraps>
...
801073b3:	6a 00                	push   $0x0
  pushl $7
801073b5:	6a 07                	push   $0x7
  jmp alltraps
801073b7:	e9 28 f9 ff ff       	jmp    80106ce4 <alltraps>

801073bc <vector8>:
.globl vector8
vector8:
  pushl $8
801073bc:	6a 08                	push   $0x8
  jmp alltraps
801073be:	e9 21 f9 ff ff       	jmp    80106ce4 <alltraps>
...
801073c3:	6a 00                	push   $0x0
  pushl $9
801073c5:	6a 09                	push   $0x9
  jmp alltraps
801073c7:	e9 18 f9 ff ff       	jmp    80106ce4 <alltraps>

801073cc <vector10>:
.globl vector10
vector10:
  pushl $10
801073cc:	6a 0a                	push   $0xa
  jmp alltraps
801073ce:	e9 11 f9 ff ff       	jmp    80106ce4 <alltraps>

801073d3 <vector11>:
.globl vector11
vector11:
  pushl $11
801073d3:	6a 0b                	push   $0xb
  jmp alltraps
801073d5:	e9 0a f9 ff ff       	jmp    80106ce4 <alltraps>

801073da <vector12>:
.globl vector12
vector12:
  pushl $12
801073da:	6a 0c                	push   $0xc
  jmp alltraps
801073dc:	e9 03 f9 ff ff       	jmp    80106ce4 <alltraps>

801073e1 <vector13>:
.globl vector13
vector13:
  pushl $13
801073e1:	6a 0d                	push   $0xd
  jmp alltraps
801073e3:	e9 fc f8 ff ff       	jmp    80106ce4 <alltraps>

801073e8 <vector14>:
.globl vector14
vector14:
  pushl $14
801073e8:	6a 0e                	push   $0xe
  jmp alltraps
801073ea:	e9 f5 f8 ff ff       	jmp    80106ce4 <alltraps>
...
801073ef:	6a 00                	push   $0x0
  pushl $15
801073f1:	6a 0f                	push   $0xf
  jmp alltraps
801073f3:	e9 ec f8 ff ff       	jmp    80106ce4 <alltraps>
...
801073f8:	6a 00                	push   $0x0
  pushl $16
801073fa:	6a 10                	push   $0x10
  jmp alltraps
801073fc:	e9 e3 f8 ff ff       	jmp    80106ce4 <alltraps>

80107401 <vector17>:
.globl vector17
vector17:
  pushl $17
80107401:	6a 11                	push   $0x11
  jmp alltraps
80107403:	e9 dc f8 ff ff       	jmp    80106ce4 <alltraps>
...
80107408:	6a 00                	push   $0x0
  pushl $18
8010740a:	6a 12                	push   $0x12
  jmp alltraps
8010740c:	e9 d3 f8 ff ff       	jmp    80106ce4 <alltraps>
...
80107411:	6a 00                	push   $0x0
  pushl $19
80107413:	6a 13                	push   $0x13
  jmp alltraps
80107415:	e9 ca f8 ff ff       	jmp    80106ce4 <alltraps>
...
8010741a:	6a 00                	push   $0x0
  pushl $20
8010741c:	6a 14                	push   $0x14
  jmp alltraps
8010741e:	e9 c1 f8 ff ff       	jmp    80106ce4 <alltraps>
...
80107423:	6a 00                	push   $0x0
  pushl $21
80107425:	6a 15                	push   $0x15
  jmp alltraps
80107427:	e9 b8 f8 ff ff       	jmp    80106ce4 <alltraps>
...
8010742c:	6a 00                	push   $0x0
  pushl $22
8010742e:	6a 16                	push   $0x16
  jmp alltraps
80107430:	e9 af f8 ff ff       	jmp    80106ce4 <alltraps>
...
80107435:	6a 00                	push   $0x0
  pushl $23
80107437:	6a 17                	push   $0x17
  jmp alltraps
80107439:	e9 a6 f8 ff ff       	jmp    80106ce4 <alltraps>
...
8010743e:	6a 00                	push   $0x0
  pushl $24
80107440:	6a 18                	push   $0x18
  jmp alltraps
80107442:	e9 9d f8 ff ff       	jmp    80106ce4 <alltraps>
...
80107447:	6a 00                	push   $0x0
  pushl $25
80107449:	6a 19                	push   $0x19
  jmp alltraps
8010744b:	e9 94 f8 ff ff       	jmp    80106ce4 <alltraps>
...
80107450:	6a 00                	push   $0x0
  pushl $26
80107452:	6a 1a                	push   $0x1a
  jmp alltraps
80107454:	e9 8b f8 ff ff       	jmp    80106ce4 <alltraps>
...
80107459:	6a 00                	push   $0x0
  pushl $27
8010745b:	6a 1b                	push   $0x1b
  jmp alltraps
8010745d:	e9 82 f8 ff ff       	jmp    80106ce4 <alltraps>
...
80107462:	6a 00                	push   $0x0
  pushl $28
80107464:	6a 1c                	push   $0x1c
  jmp alltraps
80107466:	e9 79 f8 ff ff       	jmp    80106ce4 <alltraps>
...
8010746b:	6a 00                	push   $0x0
  pushl $29
8010746d:	6a 1d                	push   $0x1d
  jmp alltraps
8010746f:	e9 70 f8 ff ff       	jmp    80106ce4 <alltraps>
...
80107474:	6a 00                	push   $0x0
  pushl $30
80107476:	6a 1e                	push   $0x1e
  jmp alltraps
80107478:	e9 67 f8 ff ff       	jmp    80106ce4 <alltraps>
...
8010747d:	6a 00                	push   $0x0
  pushl $31
8010747f:	6a 1f                	push   $0x1f
  jmp alltraps
80107481:	e9 5e f8 ff ff       	jmp    80106ce4 <alltraps>
...
80107486:	6a 00                	push   $0x0
  pushl $32
80107488:	6a 20                	push   $0x20
  jmp alltraps
8010748a:	e9 55 f8 ff ff       	jmp    80106ce4 <alltraps>
...
8010748f:	6a 00                	push   $0x0
  pushl $33
80107491:	6a 21                	push   $0x21
  jmp alltraps
80107493:	e9 4c f8 ff ff       	jmp    80106ce4 <alltraps>
...
80107498:	6a 00                	push   $0x0
  pushl $34
8010749a:	6a 22                	push   $0x22
  jmp alltraps
8010749c:	e9 43 f8 ff ff       	jmp    80106ce4 <alltraps>
...
801074a1:	6a 00                	push   $0x0
  pushl $35
801074a3:	6a 23                	push   $0x23
  jmp alltraps
801074a5:	e9 3a f8 ff ff       	jmp    80106ce4 <alltraps>
...
801074aa:	6a 00                	push   $0x0
  pushl $36
801074ac:	6a 24                	push   $0x24
  jmp alltraps
801074ae:	e9 31 f8 ff ff       	jmp    80106ce4 <alltraps>
...
801074b3:	6a 00                	push   $0x0
  pushl $37
801074b5:	6a 25                	push   $0x25
  jmp alltraps
801074b7:	e9 28 f8 ff ff       	jmp    80106ce4 <alltraps>
...
801074bc:	6a 00                	push   $0x0
  pushl $38
801074be:	6a 26                	push   $0x26
  jmp alltraps
801074c0:	e9 1f f8 ff ff       	jmp    80106ce4 <alltraps>
...
801074c5:	6a 00                	push   $0x0
  pushl $39
801074c7:	6a 27                	push   $0x27
  jmp alltraps
801074c9:	e9 16 f8 ff ff       	jmp    80106ce4 <alltraps>
...
801074ce:	6a 00                	push   $0x0
  pushl $40
801074d0:	6a 28                	push   $0x28
  jmp alltraps
801074d2:	e9 0d f8 ff ff       	jmp    80106ce4 <alltraps>
...
801074d7:	6a 00                	push   $0x0
  pushl $41
801074d9:	6a 29                	push   $0x29
  jmp alltraps
801074db:	e9 04 f8 ff ff       	jmp    80106ce4 <alltraps>
...
801074e0:	6a 00                	push   $0x0
  pushl $42
801074e2:	6a 2a                	push   $0x2a
  jmp alltraps
801074e4:	e9 fb f7 ff ff       	jmp    80106ce4 <alltraps>
...
801074e9:	6a 00                	push   $0x0
  pushl $43
801074eb:	6a 2b                	push   $0x2b
  jmp alltraps
801074ed:	e9 f2 f7 ff ff       	jmp    80106ce4 <alltraps>
...
801074f2:	6a 00                	push   $0x0
  pushl $44
801074f4:	6a 2c                	push   $0x2c
  jmp alltraps
801074f6:	e9 e9 f7 ff ff       	jmp    80106ce4 <alltraps>
...
801074fb:	6a 00                	push   $0x0
  pushl $45
801074fd:	6a 2d                	push   $0x2d
  jmp alltraps
801074ff:	e9 e0 f7 ff ff       	jmp    80106ce4 <alltraps>
...
80107504:	6a 00                	push   $0x0
  pushl $46
80107506:	6a 2e                	push   $0x2e
  jmp alltraps
80107508:	e9 d7 f7 ff ff       	jmp    80106ce4 <alltraps>
...
8010750d:	6a 00                	push   $0x0
  pushl $47
8010750f:	6a 2f                	push   $0x2f
  jmp alltraps
80107511:	e9 ce f7 ff ff       	jmp    80106ce4 <alltraps>
...
80107518:	6a 30                	push   $0x30
  jmp alltraps
8010751a:	e9 c5 f7 ff ff       	jmp    80106ce4 <alltraps>
...
8010751f:	6a 00                	push   $0x0
  pushl $49
80107521:	6a 31                	push   $0x31
  jmp alltraps
80107523:	e9 bc f7 ff ff       	jmp    80106ce4 <alltraps>
...
80107528:	6a 00                	push   $0x0
  pushl $50
8010752a:	6a 32                	push   $0x32
  jmp alltraps
8010752c:	e9 b3 f7 ff ff       	jmp    80106ce4 <alltraps>
...
80107531:	6a 00                	push   $0x0
  pushl $51
80107533:	6a 33                	push   $0x33
  jmp alltraps
80107535:	e9 aa f7 ff ff       	jmp    80106ce4 <alltraps>
...
8010753a:	6a 00                	push   $0x0
  pushl $52
8010753c:	6a 34                	push   $0x34
  jmp alltraps
8010753e:	e9 a1 f7 ff ff       	jmp    80106ce4 <alltraps>
...
80107543:	6a 00                	push   $0x0
  pushl $53
80107545:	6a 35                	push   $0x35
  jmp alltraps
80107547:	e9 98 f7 ff ff       	jmp    80106ce4 <alltraps>
...
8010754c:	6a 00                	push   $0x0
  pushl $54
8010754e:	6a 36                	push   $0x36
  jmp alltraps
80107550:	e9 8f f7 ff ff       	jmp    80106ce4 <alltraps>
...
80107555:	6a 00                	push   $0x0
  pushl $55
80107557:	6a 37                	push   $0x37
  jmp alltraps
80107559:	e9 86 f7 ff ff       	jmp    80106ce4 <alltraps>
...
8010755e:	6a 00                	push   $0x0
  pushl $56
80107560:	6a 38                	push   $0x38
  jmp alltraps
80107562:	e9 7d f7 ff ff       	jmp    80106ce4 <alltraps>
...
80107567:	6a 00                	push   $0x0
  pushl $57
80107569:	6a 39                	push   $0x39
  jmp alltraps
8010756b:	e9 74 f7 ff ff       	jmp    80106ce4 <alltraps>
...
80107570:	6a 00                	push   $0x0
  pushl $58
80107572:	6a 3a                	push   $0x3a
  jmp alltraps
80107574:	e9 6b f7 ff ff       	jmp    80106ce4 <alltraps>
...
80107579:	6a 00                	push   $0x0
  pushl $59
8010757b:	6a 3b                	push   $0x3b
  jmp alltraps
8010757d:	e9 62 f7 ff ff       	jmp    80106ce4 <alltraps>
...
80107582:	6a 00                	push   $0x0
  pushl $60
80107584:	6a 3c                	push   $0x3c
  jmp alltraps
80107586:	e9 59 f7 ff ff       	jmp    80106ce4 <alltraps>
...
8010758b:	6a 00                	push   $0x0
  pushl $61
8010758d:	6a 3d                	push   $0x3d
  jmp alltraps
8010758f:	e9 50 f7 ff ff       	jmp    80106ce4 <alltraps>
...
80107594:	6a 00                	push   $0x0
  pushl $62
80107596:	6a 3e                	push   $0x3e
  jmp alltraps
80107598:	e9 47 f7 ff ff       	jmp    80106ce4 <alltraps>
...
8010759d:	6a 00                	push   $0x0
  pushl $63
8010759f:	6a 3f                	push   $0x3f
  jmp alltraps
801075a1:	e9 3e f7 ff ff       	jmp    80106ce4 <alltraps>
...
801075a6:	6a 00                	push   $0x0
  pushl $64
801075a8:	6a 40                	push   $0x40
  jmp alltraps
801075aa:	e9 35 f7 ff ff       	jmp    80106ce4 <alltraps>
...
801075af:	6a 00                	push   $0x0
  pushl $65
801075b1:	6a 41                	push   $0x41
  jmp alltraps
801075b3:	e9 2c f7 ff ff       	jmp    80106ce4 <alltraps>
...
801075b8:	6a 00                	push   $0x0
  pushl $66
801075ba:	6a 42                	push   $0x42
  jmp alltraps
801075bc:	e9 23 f7 ff ff       	jmp    80106ce4 <alltraps>
...
801075c1:	6a 00                	push   $0x0
  pushl $67
801075c3:	6a 43                	push   $0x43
  jmp alltraps
801075c5:	e9 1a f7 ff ff       	jmp    80106ce4 <alltraps>
...
801075ca:	6a 00                	push   $0x0
  pushl $68
801075cc:	6a 44                	push   $0x44
  jmp alltraps
801075ce:	e9 11 f7 ff ff       	jmp    80106ce4 <alltraps>
...
801075d3:	6a 00                	push   $0x0
  pushl $69
801075d5:	6a 45                	push   $0x45
  jmp alltraps
801075d7:	e9 08 f7 ff ff       	jmp    80106ce4 <alltraps>
...
801075dc:	6a 00                	push   $0x0
  pushl $70
801075de:	6a 46                	push   $0x46
  jmp alltraps
801075e0:	e9 ff f6 ff ff       	jmp    80106ce4 <alltraps>
...
801075e5:	6a 00                	push   $0x0
  pushl $71
801075e7:	6a 47                	push   $0x47
  jmp alltraps
801075e9:	e9 f6 f6 ff ff       	jmp    80106ce4 <alltraps>
...
801075ee:	6a 00                	push   $0x0
  pushl $72
801075f0:	6a 48                	push   $0x48
  jmp alltraps
801075f2:	e9 ed f6 ff ff       	jmp    80106ce4 <alltraps>
...
801075f7:	6a 00                	push   $0x0
  pushl $73
801075f9:	6a 49                	push   $0x49
  jmp alltraps
801075fb:	e9 e4 f6 ff ff       	jmp    80106ce4 <alltraps>
...
80107600:	6a 00                	push   $0x0
  pushl $74
80107602:	6a 4a                	push   $0x4a
  jmp alltraps
80107604:	e9 db f6 ff ff       	jmp    80106ce4 <alltraps>
...
80107609:	6a 00                	push   $0x0
  pushl $75
8010760b:	6a 4b                	push   $0x4b
  jmp alltraps
8010760d:	e9 d2 f6 ff ff       	jmp    80106ce4 <alltraps>
...
80107612:	6a 00                	push   $0x0
  pushl $76
80107614:	6a 4c                	push   $0x4c
  jmp alltraps
80107616:	e9 c9 f6 ff ff       	jmp    80106ce4 <alltraps>
...
8010761b:	6a 00                	push   $0x0
  pushl $77
8010761d:	6a 4d                	push   $0x4d
  jmp alltraps
8010761f:	e9 c0 f6 ff ff       	jmp    80106ce4 <alltraps>
...
80107624:	6a 00                	push   $0x0
  pushl $78
80107626:	6a 4e                	push   $0x4e
  jmp alltraps
80107628:	e9 b7 f6 ff ff       	jmp    80106ce4 <alltraps>
...
8010762d:	6a 00                	push   $0x0
  pushl $79
8010762f:	6a 4f                	push   $0x4f
  jmp alltraps
80107631:	e9 ae f6 ff ff       	jmp    80106ce4 <alltraps>
...
80107636:	6a 00                	push   $0x0
  pushl $80
80107638:	6a 50                	push   $0x50
  jmp alltraps
8010763a:	e9 a5 f6 ff ff       	jmp    80106ce4 <alltraps>
...
8010763f:	6a 00                	push   $0x0
  pushl $81
80107641:	6a 51                	push   $0x51
  jmp alltraps
80107643:	e9 9c f6 ff ff       	jmp    80106ce4 <alltraps>
...
80107648:	6a 00                	push   $0x0
  pushl $82
8010764a:	6a 52                	push   $0x52
  jmp alltraps
8010764c:	e9 93 f6 ff ff       	jmp    80106ce4 <alltraps>
...
80107651:	6a 00                	push   $0x0
  pushl $83
80107653:	6a 53                	push   $0x53
  jmp alltraps
80107655:	e9 8a f6 ff ff       	jmp    80106ce4 <alltraps>
...
8010765a:	6a 00                	push   $0x0
  pushl $84
8010765c:	6a 54                	push   $0x54
  jmp alltraps
8010765e:	e9 81 f6 ff ff       	jmp    80106ce4 <alltraps>
...
80107663:	6a 00                	push   $0x0
  pushl $85
80107665:	6a 55                	push   $0x55
  jmp alltraps
80107667:	e9 78 f6 ff ff       	jmp    80106ce4 <alltraps>
...
8010766c:	6a 00                	push   $0x0
  pushl $86
8010766e:	6a 56                	push   $0x56
  jmp alltraps
80107670:	e9 6f f6 ff ff       	jmp    80106ce4 <alltraps>
...
80107675:	6a 00                	push   $0x0
  pushl $87
80107677:	6a 57                	push   $0x57
  jmp alltraps
80107679:	e9 66 f6 ff ff       	jmp    80106ce4 <alltraps>
...
8010767e:	6a 00                	push   $0x0
  pushl $88
80107680:	6a 58                	push   $0x58
  jmp alltraps
80107682:	e9 5d f6 ff ff       	jmp    80106ce4 <alltraps>
...
80107687:	6a 00                	push   $0x0
  pushl $89
80107689:	6a 59                	push   $0x59
  jmp alltraps
8010768b:	e9 54 f6 ff ff       	jmp    80106ce4 <alltraps>
...
80107690:	6a 00                	push   $0x0
  pushl $90
80107692:	6a 5a                	push   $0x5a
  jmp alltraps
80107694:	e9 4b f6 ff ff       	jmp    80106ce4 <alltraps>
...
80107699:	6a 00                	push   $0x0
  pushl $91
8010769b:	6a 5b                	push   $0x5b
  jmp alltraps
8010769d:	e9 42 f6 ff ff       	jmp    80106ce4 <alltraps>
...
801076a2:	6a 00                	push   $0x0
  pushl $92
801076a4:	6a 5c                	push   $0x5c
  jmp alltraps
801076a6:	e9 39 f6 ff ff       	jmp    80106ce4 <alltraps>
...
801076ab:	6a 00                	push   $0x0
  pushl $93
801076ad:	6a 5d                	push   $0x5d
  jmp alltraps
801076af:	e9 30 f6 ff ff       	jmp    80106ce4 <alltraps>
...
801076b4:	6a 00                	push   $0x0
  pushl $94
801076b6:	6a 5e                	push   $0x5e
  jmp alltraps
801076b8:	e9 27 f6 ff ff       	jmp    80106ce4 <alltraps>
...
801076bd:	6a 00                	push   $0x0
  pushl $95
801076bf:	6a 5f                	push   $0x5f
  jmp alltraps
801076c1:	e9 1e f6 ff ff       	jmp    80106ce4 <alltraps>
...
801076c6:	6a 00                	push   $0x0
  pushl $96
801076c8:	6a 60                	push   $0x60
  jmp alltraps
801076ca:	e9 15 f6 ff ff       	jmp    80106ce4 <alltraps>
...
801076cf:	6a 00                	push   $0x0
  pushl $97
801076d1:	6a 61                	push   $0x61
  jmp alltraps
801076d3:	e9 0c f6 ff ff       	jmp    80106ce4 <alltraps>
...
801076d8:	6a 00                	push   $0x0
  pushl $98
801076da:	6a 62                	push   $0x62
  jmp alltraps
801076dc:	e9 03 f6 ff ff       	jmp    80106ce4 <alltraps>
...
801076e1:	6a 00                	push   $0x0
  pushl $99
801076e3:	6a 63                	push   $0x63
  jmp alltraps
801076e5:	e9 fa f5 ff ff       	jmp    80106ce4 <alltraps>
...
801076ea:	6a 00                	push   $0x0
  pushl $100
801076ec:	6a 64                	push   $0x64
  jmp alltraps
801076ee:	e9 f1 f5 ff ff       	jmp    80106ce4 <alltraps>
...
801076f3:	6a 00                	push   $0x0
  pushl $101
801076f5:	6a 65                	push   $0x65
  jmp alltraps
801076f7:	e9 e8 f5 ff ff       	jmp    80106ce4 <alltraps>
...
801076fc:	6a 00                	push   $0x0
  pushl $102
801076fe:	6a 66                	push   $0x66
  jmp alltraps
80107700:	e9 df f5 ff ff       	jmp    80106ce4 <alltraps>
...
80107705:	6a 00                	push   $0x0
  pushl $103
80107707:	6a 67                	push   $0x67
  jmp alltraps
80107709:	e9 d6 f5 ff ff       	jmp    80106ce4 <alltraps>
...
8010770e:	6a 00                	push   $0x0
  pushl $104
80107710:	6a 68                	push   $0x68
  jmp alltraps
80107712:	e9 cd f5 ff ff       	jmp    80106ce4 <alltraps>
...
80107717:	6a 00                	push   $0x0
  pushl $105
80107719:	6a 69                	push   $0x69
  jmp alltraps
8010771b:	e9 c4 f5 ff ff       	jmp    80106ce4 <alltraps>
...
80107720:	6a 00                	push   $0x0
  pushl $106
80107722:	6a 6a                	push   $0x6a
  jmp alltraps
80107724:	e9 bb f5 ff ff       	jmp    80106ce4 <alltraps>
...
80107729:	6a 00                	push   $0x0
  pushl $107
8010772b:	6a 6b                	push   $0x6b
  jmp alltraps
8010772d:	e9 b2 f5 ff ff       	jmp    80106ce4 <alltraps>
...
80107732:	6a 00                	push   $0x0
  pushl $108
80107734:	6a 6c                	push   $0x6c
  jmp alltraps
80107736:	e9 a9 f5 ff ff       	jmp    80106ce4 <alltraps>
...
8010773b:	6a 00                	push   $0x0
  pushl $109
8010773d:	6a 6d                	push   $0x6d
  jmp alltraps
8010773f:	e9 a0 f5 ff ff       	jmp    80106ce4 <alltraps>
...
80107744:	6a 00                	push   $0x0
  pushl $110
80107746:	6a 6e                	push   $0x6e
  jmp alltraps
80107748:	e9 97 f5 ff ff       	jmp    80106ce4 <alltraps>
...
8010774d:	6a 00                	push   $0x0
  pushl $111
8010774f:	6a 6f                	push   $0x6f
  jmp alltraps
80107751:	e9 8e f5 ff ff       	jmp    80106ce4 <alltraps>
...
80107756:	6a 00                	push   $0x0
  pushl $112
80107758:	6a 70                	push   $0x70
  jmp alltraps
8010775a:	e9 85 f5 ff ff       	jmp    80106ce4 <alltraps>
...
8010775f:	6a 00                	push   $0x0
  pushl $113
80107761:	6a 71                	push   $0x71
  jmp alltraps
80107763:	e9 7c f5 ff ff       	jmp    80106ce4 <alltraps>
...
80107768:	6a 00                	push   $0x0
  pushl $114
8010776a:	6a 72                	push   $0x72
  jmp alltraps
8010776c:	e9 73 f5 ff ff       	jmp    80106ce4 <alltraps>
...
80107771:	6a 00                	push   $0x0
  pushl $115
80107773:	6a 73                	push   $0x73
  jmp alltraps
80107775:	e9 6a f5 ff ff       	jmp    80106ce4 <alltraps>
...
8010777a:	6a 00                	push   $0x0
  pushl $116
8010777c:	6a 74                	push   $0x74
  jmp alltraps
8010777e:	e9 61 f5 ff ff       	jmp    80106ce4 <alltraps>
...
80107783:	6a 00                	push   $0x0
  pushl $117
80107785:	6a 75                	push   $0x75
  jmp alltraps
80107787:	e9 58 f5 ff ff       	jmp    80106ce4 <alltraps>
...
8010778c:	6a 00                	push   $0x0
  pushl $118
8010778e:	6a 76                	push   $0x76
  jmp alltraps
80107790:	e9 4f f5 ff ff       	jmp    80106ce4 <alltraps>
...
80107795:	6a 00                	push   $0x0
  pushl $119
80107797:	6a 77                	push   $0x77
  jmp alltraps
80107799:	e9 46 f5 ff ff       	jmp    80106ce4 <alltraps>
...
8010779e:	6a 00                	push   $0x0
  pushl $120
801077a0:	6a 78                	push   $0x78
  jmp alltraps
801077a2:	e9 3d f5 ff ff       	jmp    80106ce4 <alltraps>
...
801077a7:	6a 00                	push   $0x0
  pushl $121
801077a9:	6a 79                	push   $0x79
  jmp alltraps
801077ab:	e9 34 f5 ff ff       	jmp    80106ce4 <alltraps>
...
801077b0:	6a 00                	push   $0x0
  pushl $122
801077b2:	6a 7a                	push   $0x7a
  jmp alltraps
801077b4:	e9 2b f5 ff ff       	jmp    80106ce4 <alltraps>
...
801077b9:	6a 00                	push   $0x0
  pushl $123
801077bb:	6a 7b                	push   $0x7b
  jmp alltraps
801077bd:	e9 22 f5 ff ff       	jmp    80106ce4 <alltraps>
...
801077c2:	6a 00                	push   $0x0
  pushl $124
801077c4:	6a 7c                	push   $0x7c
  jmp alltraps
801077c6:	e9 19 f5 ff ff       	jmp    80106ce4 <alltraps>
...
801077cb:	6a 00                	push   $0x0
  pushl $125
801077cd:	6a 7d                	push   $0x7d
  jmp alltraps
801077cf:	e9 10 f5 ff ff       	jmp    80106ce4 <alltraps>
...
801077d4:	6a 00                	push   $0x0
  pushl $126
801077d6:	6a 7e                	push   $0x7e
  jmp alltraps
801077d8:	e9 07 f5 ff ff       	jmp    80106ce4 <alltraps>
...
801077dd:	6a 00                	push   $0x0
  pushl $127
801077df:	6a 7f                	push   $0x7f
  jmp alltraps
801077e1:	e9 fe f4 ff ff       	jmp    80106ce4 <alltraps>
...
801077e6:	6a 00                	push   $0x0
  pushl $128
801077e8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801077ed:	e9 f2 f4 ff ff       	jmp    80106ce4 <alltraps>
...
801077f2:	6a 00                	push   $0x0
  pushl $129
801077f4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801077f9:	e9 e6 f4 ff ff       	jmp    80106ce4 <alltraps>
...
801077fe:	6a 00                	push   $0x0
  pushl $130
80107800:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107805:	e9 da f4 ff ff       	jmp    80106ce4 <alltraps>
...
8010780a:	6a 00                	push   $0x0
  pushl $131
8010780c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107811:	e9 ce f4 ff ff       	jmp    80106ce4 <alltraps>
...
80107816:	6a 00                	push   $0x0
  pushl $132
80107818:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010781d:	e9 c2 f4 ff ff       	jmp    80106ce4 <alltraps>
...
80107822:	6a 00                	push   $0x0
  pushl $133
80107824:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107829:	e9 b6 f4 ff ff       	jmp    80106ce4 <alltraps>
...
8010782e:	6a 00                	push   $0x0
  pushl $134
80107830:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107835:	e9 aa f4 ff ff       	jmp    80106ce4 <alltraps>
...
8010783a:	6a 00                	push   $0x0
  pushl $135
8010783c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107841:	e9 9e f4 ff ff       	jmp    80106ce4 <alltraps>
...
80107846:	6a 00                	push   $0x0
  pushl $136
80107848:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010784d:	e9 92 f4 ff ff       	jmp    80106ce4 <alltraps>
...
80107852:	6a 00                	push   $0x0
  pushl $137
80107854:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107859:	e9 86 f4 ff ff       	jmp    80106ce4 <alltraps>
...
8010785e:	6a 00                	push   $0x0
  pushl $138
80107860:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107865:	e9 7a f4 ff ff       	jmp    80106ce4 <alltraps>
...
8010786a:	6a 00                	push   $0x0
  pushl $139
8010786c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107871:	e9 6e f4 ff ff       	jmp    80106ce4 <alltraps>
...
80107876:	6a 00                	push   $0x0
  pushl $140
80107878:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010787d:	e9 62 f4 ff ff       	jmp    80106ce4 <alltraps>
...
80107882:	6a 00                	push   $0x0
  pushl $141
80107884:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107889:	e9 56 f4 ff ff       	jmp    80106ce4 <alltraps>
...
8010788e:	6a 00                	push   $0x0
  pushl $142
80107890:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107895:	e9 4a f4 ff ff       	jmp    80106ce4 <alltraps>
...
8010789a:	6a 00                	push   $0x0
  pushl $143
8010789c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801078a1:	e9 3e f4 ff ff       	jmp    80106ce4 <alltraps>
...
801078a6:	6a 00                	push   $0x0
  pushl $144
801078a8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801078ad:	e9 32 f4 ff ff       	jmp    80106ce4 <alltraps>
...
801078b2:	6a 00                	push   $0x0
  pushl $145
801078b4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801078b9:	e9 26 f4 ff ff       	jmp    80106ce4 <alltraps>
...
801078be:	6a 00                	push   $0x0
  pushl $146
801078c0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801078c5:	e9 1a f4 ff ff       	jmp    80106ce4 <alltraps>
...
801078ca:	6a 00                	push   $0x0
  pushl $147
801078cc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801078d1:	e9 0e f4 ff ff       	jmp    80106ce4 <alltraps>
...
801078d6:	6a 00                	push   $0x0
  pushl $148
801078d8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801078dd:	e9 02 f4 ff ff       	jmp    80106ce4 <alltraps>
...
801078e2:	6a 00                	push   $0x0
  pushl $149
801078e4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801078e9:	e9 f6 f3 ff ff       	jmp    80106ce4 <alltraps>
...
801078ee:	6a 00                	push   $0x0
  pushl $150
801078f0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801078f5:	e9 ea f3 ff ff       	jmp    80106ce4 <alltraps>
...
801078fa:	6a 00                	push   $0x0
  pushl $151
801078fc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107901:	e9 de f3 ff ff       	jmp    80106ce4 <alltraps>
...
80107906:	6a 00                	push   $0x0
  pushl $152
80107908:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010790d:	e9 d2 f3 ff ff       	jmp    80106ce4 <alltraps>
...
80107912:	6a 00                	push   $0x0
  pushl $153
80107914:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107919:	e9 c6 f3 ff ff       	jmp    80106ce4 <alltraps>
...
8010791e:	6a 00                	push   $0x0
  pushl $154
80107920:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107925:	e9 ba f3 ff ff       	jmp    80106ce4 <alltraps>
...
8010792a:	6a 00                	push   $0x0
  pushl $155
8010792c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107931:	e9 ae f3 ff ff       	jmp    80106ce4 <alltraps>
...
80107936:	6a 00                	push   $0x0
  pushl $156
80107938:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010793d:	e9 a2 f3 ff ff       	jmp    80106ce4 <alltraps>
...
80107942:	6a 00                	push   $0x0
  pushl $157
80107944:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107949:	e9 96 f3 ff ff       	jmp    80106ce4 <alltraps>
...
8010794e:	6a 00                	push   $0x0
  pushl $158
80107950:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107955:	e9 8a f3 ff ff       	jmp    80106ce4 <alltraps>
...
8010795a:	6a 00                	push   $0x0
  pushl $159
8010795c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107961:	e9 7e f3 ff ff       	jmp    80106ce4 <alltraps>
...
80107966:	6a 00                	push   $0x0
  pushl $160
80107968:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010796d:	e9 72 f3 ff ff       	jmp    80106ce4 <alltraps>
...
80107972:	6a 00                	push   $0x0
  pushl $161
80107974:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107979:	e9 66 f3 ff ff       	jmp    80106ce4 <alltraps>
...
8010797e:	6a 00                	push   $0x0
  pushl $162
80107980:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107985:	e9 5a f3 ff ff       	jmp    80106ce4 <alltraps>
...
8010798a:	6a 00                	push   $0x0
  pushl $163
8010798c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107991:	e9 4e f3 ff ff       	jmp    80106ce4 <alltraps>
...
80107996:	6a 00                	push   $0x0
  pushl $164
80107998:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010799d:	e9 42 f3 ff ff       	jmp    80106ce4 <alltraps>
...
801079a2:	6a 00                	push   $0x0
  pushl $165
801079a4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801079a9:	e9 36 f3 ff ff       	jmp    80106ce4 <alltraps>
...
801079ae:	6a 00                	push   $0x0
  pushl $166
801079b0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801079b5:	e9 2a f3 ff ff       	jmp    80106ce4 <alltraps>
...
801079ba:	6a 00                	push   $0x0
  pushl $167
801079bc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801079c1:	e9 1e f3 ff ff       	jmp    80106ce4 <alltraps>
...
801079c6:	6a 00                	push   $0x0
  pushl $168
801079c8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801079cd:	e9 12 f3 ff ff       	jmp    80106ce4 <alltraps>
...
801079d2:	6a 00                	push   $0x0
  pushl $169
801079d4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801079d9:	e9 06 f3 ff ff       	jmp    80106ce4 <alltraps>
...
801079de:	6a 00                	push   $0x0
  pushl $170
801079e0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801079e5:	e9 fa f2 ff ff       	jmp    80106ce4 <alltraps>
...
801079ea:	6a 00                	push   $0x0
  pushl $171
801079ec:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801079f1:	e9 ee f2 ff ff       	jmp    80106ce4 <alltraps>
...
801079f6:	6a 00                	push   $0x0
  pushl $172
801079f8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801079fd:	e9 e2 f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a02:	6a 00                	push   $0x0
  pushl $173
80107a04:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107a09:	e9 d6 f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a0e:	6a 00                	push   $0x0
  pushl $174
80107a10:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107a15:	e9 ca f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a1a:	6a 00                	push   $0x0
  pushl $175
80107a1c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107a21:	e9 be f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a26:	6a 00                	push   $0x0
  pushl $176
80107a28:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107a2d:	e9 b2 f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a32:	6a 00                	push   $0x0
  pushl $177
80107a34:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107a39:	e9 a6 f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a3e:	6a 00                	push   $0x0
  pushl $178
80107a40:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107a45:	e9 9a f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a4a:	6a 00                	push   $0x0
  pushl $179
80107a4c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107a51:	e9 8e f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a56:	6a 00                	push   $0x0
  pushl $180
80107a58:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107a5d:	e9 82 f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a62:	6a 00                	push   $0x0
  pushl $181
80107a64:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107a69:	e9 76 f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a6e:	6a 00                	push   $0x0
  pushl $182
80107a70:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107a75:	e9 6a f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a7a:	6a 00                	push   $0x0
  pushl $183
80107a7c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107a81:	e9 5e f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a86:	6a 00                	push   $0x0
  pushl $184
80107a88:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107a8d:	e9 52 f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a92:	6a 00                	push   $0x0
  pushl $185
80107a94:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107a99:	e9 46 f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107a9e:	6a 00                	push   $0x0
  pushl $186
80107aa0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107aa5:	e9 3a f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107aaa:	6a 00                	push   $0x0
  pushl $187
80107aac:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107ab1:	e9 2e f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107ab6:	6a 00                	push   $0x0
  pushl $188
80107ab8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107abd:	e9 22 f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107ac2:	6a 00                	push   $0x0
  pushl $189
80107ac4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107ac9:	e9 16 f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107ace:	6a 00                	push   $0x0
  pushl $190
80107ad0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107ad5:	e9 0a f2 ff ff       	jmp    80106ce4 <alltraps>
...
80107ada:	6a 00                	push   $0x0
  pushl $191
80107adc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107ae1:	e9 fe f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107ae6:	6a 00                	push   $0x0
  pushl $192
80107ae8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107aed:	e9 f2 f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107af2:	6a 00                	push   $0x0
  pushl $193
80107af4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107af9:	e9 e6 f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107afe:	6a 00                	push   $0x0
  pushl $194
80107b00:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107b05:	e9 da f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b0a:	6a 00                	push   $0x0
  pushl $195
80107b0c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107b11:	e9 ce f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b16:	6a 00                	push   $0x0
  pushl $196
80107b18:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107b1d:	e9 c2 f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b22:	6a 00                	push   $0x0
  pushl $197
80107b24:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107b29:	e9 b6 f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b2e:	6a 00                	push   $0x0
  pushl $198
80107b30:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107b35:	e9 aa f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b3a:	6a 00                	push   $0x0
  pushl $199
80107b3c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107b41:	e9 9e f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b46:	6a 00                	push   $0x0
  pushl $200
80107b48:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107b4d:	e9 92 f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b52:	6a 00                	push   $0x0
  pushl $201
80107b54:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107b59:	e9 86 f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b5e:	6a 00                	push   $0x0
  pushl $202
80107b60:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107b65:	e9 7a f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b6a:	6a 00                	push   $0x0
  pushl $203
80107b6c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107b71:	e9 6e f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b76:	6a 00                	push   $0x0
  pushl $204
80107b78:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107b7d:	e9 62 f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b82:	6a 00                	push   $0x0
  pushl $205
80107b84:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107b89:	e9 56 f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b8e:	6a 00                	push   $0x0
  pushl $206
80107b90:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107b95:	e9 4a f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107b9a:	6a 00                	push   $0x0
  pushl $207
80107b9c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107ba1:	e9 3e f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107ba6:	6a 00                	push   $0x0
  pushl $208
80107ba8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107bad:	e9 32 f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107bb2:	6a 00                	push   $0x0
  pushl $209
80107bb4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107bb9:	e9 26 f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107bbe:	6a 00                	push   $0x0
  pushl $210
80107bc0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107bc5:	e9 1a f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107bca:	6a 00                	push   $0x0
  pushl $211
80107bcc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107bd1:	e9 0e f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107bd6:	6a 00                	push   $0x0
  pushl $212
80107bd8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107bdd:	e9 02 f1 ff ff       	jmp    80106ce4 <alltraps>
...
80107be2:	6a 00                	push   $0x0
  pushl $213
80107be4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107be9:	e9 f6 f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107bee:	6a 00                	push   $0x0
  pushl $214
80107bf0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107bf5:	e9 ea f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107bfa:	6a 00                	push   $0x0
  pushl $215
80107bfc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107c01:	e9 de f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c06:	6a 00                	push   $0x0
  pushl $216
80107c08:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107c0d:	e9 d2 f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c12:	6a 00                	push   $0x0
  pushl $217
80107c14:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107c19:	e9 c6 f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c1e:	6a 00                	push   $0x0
  pushl $218
80107c20:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107c25:	e9 ba f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c2a:	6a 00                	push   $0x0
  pushl $219
80107c2c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107c31:	e9 ae f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c36:	6a 00                	push   $0x0
  pushl $220
80107c38:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107c3d:	e9 a2 f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c42:	6a 00                	push   $0x0
  pushl $221
80107c44:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107c49:	e9 96 f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c4e:	6a 00                	push   $0x0
  pushl $222
80107c50:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107c55:	e9 8a f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c5a:	6a 00                	push   $0x0
  pushl $223
80107c5c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107c61:	e9 7e f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c66:	6a 00                	push   $0x0
  pushl $224
80107c68:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107c6d:	e9 72 f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c72:	6a 00                	push   $0x0
  pushl $225
80107c74:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107c79:	e9 66 f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c7e:	6a 00                	push   $0x0
  pushl $226
80107c80:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107c85:	e9 5a f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c8a:	6a 00                	push   $0x0
  pushl $227
80107c8c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107c91:	e9 4e f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107c96:	6a 00                	push   $0x0
  pushl $228
80107c98:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107c9d:	e9 42 f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107ca2:	6a 00                	push   $0x0
  pushl $229
80107ca4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107ca9:	e9 36 f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107cae:	6a 00                	push   $0x0
  pushl $230
80107cb0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107cb5:	e9 2a f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107cba:	6a 00                	push   $0x0
  pushl $231
80107cbc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107cc1:	e9 1e f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107cc6:	6a 00                	push   $0x0
  pushl $232
80107cc8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107ccd:	e9 12 f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107cd2:	6a 00                	push   $0x0
  pushl $233
80107cd4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107cd9:	e9 06 f0 ff ff       	jmp    80106ce4 <alltraps>
...
80107cde:	6a 00                	push   $0x0
  pushl $234
80107ce0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107ce5:	e9 fa ef ff ff       	jmp    80106ce4 <alltraps>
...
80107cea:	6a 00                	push   $0x0
  pushl $235
80107cec:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107cf1:	e9 ee ef ff ff       	jmp    80106ce4 <alltraps>
...
80107cf6:	6a 00                	push   $0x0
  pushl $236
80107cf8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107cfd:	e9 e2 ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d02:	6a 00                	push   $0x0
  pushl $237
80107d04:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107d09:	e9 d6 ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d0e:	6a 00                	push   $0x0
  pushl $238
80107d10:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107d15:	e9 ca ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d1a:	6a 00                	push   $0x0
  pushl $239
80107d1c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107d21:	e9 be ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d26:	6a 00                	push   $0x0
  pushl $240
80107d28:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107d2d:	e9 b2 ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d32:	6a 00                	push   $0x0
  pushl $241
80107d34:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107d39:	e9 a6 ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d3e:	6a 00                	push   $0x0
  pushl $242
80107d40:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107d45:	e9 9a ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d4a:	6a 00                	push   $0x0
  pushl $243
80107d4c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107d51:	e9 8e ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d56:	6a 00                	push   $0x0
  pushl $244
80107d58:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107d5d:	e9 82 ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d62:	6a 00                	push   $0x0
  pushl $245
80107d64:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107d69:	e9 76 ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d6e:	6a 00                	push   $0x0
  pushl $246
80107d70:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107d75:	e9 6a ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d7a:	6a 00                	push   $0x0
  pushl $247
80107d7c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107d81:	e9 5e ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d86:	6a 00                	push   $0x0
  pushl $248
80107d88:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107d8d:	e9 52 ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d92:	6a 00                	push   $0x0
  pushl $249
80107d94:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107d99:	e9 46 ef ff ff       	jmp    80106ce4 <alltraps>
...
80107d9e:	6a 00                	push   $0x0
  pushl $250
80107da0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107da5:	e9 3a ef ff ff       	jmp    80106ce4 <alltraps>
...
80107daa:	6a 00                	push   $0x0
  pushl $251
80107dac:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107db1:	e9 2e ef ff ff       	jmp    80106ce4 <alltraps>
...
80107db6:	6a 00                	push   $0x0
  pushl $252
80107db8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107dbd:	e9 22 ef ff ff       	jmp    80106ce4 <alltraps>
...
80107dc2:	6a 00                	push   $0x0
  pushl $253
80107dc4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107dc9:	e9 16 ef ff ff       	jmp    80106ce4 <alltraps>
...
80107dce:	6a 00                	push   $0x0
  pushl $254
80107dd0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107dd5:	e9 0a ef ff ff       	jmp    80106ce4 <alltraps>
...
80107dda:	6a 00                	push   $0x0
  pushl $255
80107ddc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107de1:	e9 fe ee ff ff       	jmp    80106ce4 <alltraps>
	...
...
80107deb:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107dee:	8b 45 0c             	mov    0xc(%ebp),%eax
80107df1:	83 e8 01             	sub    $0x1,%eax
80107df4:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107df8:	8b 45 08             	mov    0x8(%ebp),%eax
80107dfb:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107dff:	8b 45 08             	mov    0x8(%ebp),%eax
80107e02:	c1 e8 10             	shr    $0x10,%eax
80107e05:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107e09:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107e0c:	0f 01 10             	lgdtl  (%eax)
}
80107e0f:	c9                   	leave  
80107e10:	c3                   	ret    
...
80107e30:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107e34:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107e38:	8e e8                	mov    %eax,%gs
}
80107e3a:	c9                   	leave  
80107e3b:	c3                   	ret    
...
80107e4a:	8b 45 08             	mov    0x8(%ebp),%eax
...
80107e65:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107e68:	e8 56 b0 ff ff       	call   80102ec3 <cpunum>
80107e6d:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107e73:	05 80 33 11 80       	add    $0x80113380,%eax
80107e78:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107e7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e7e:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107e84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e87:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107e8d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e90:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107e94:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e97:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107e9b:	83 e2 f0             	and    $0xfffffff0,%edx
80107e9e:	83 ca 0a             	or     $0xa,%edx
80107ea1:	88 50 7d             	mov    %dl,0x7d(%eax)
80107ea4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ea7:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107eab:	83 ca 10             	or     $0x10,%edx
80107eae:	88 50 7d             	mov    %dl,0x7d(%eax)
80107eb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eb4:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107eb8:	83 e2 9f             	and    $0xffffff9f,%edx
80107ebb:	88 50 7d             	mov    %dl,0x7d(%eax)
80107ebe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ec1:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107ec5:	83 ca 80             	or     $0xffffff80,%edx
80107ec8:	88 50 7d             	mov    %dl,0x7d(%eax)
80107ecb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ece:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107ed2:	83 ca 0f             	or     $0xf,%edx
80107ed5:	88 50 7e             	mov    %dl,0x7e(%eax)
80107ed8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107edb:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107edf:	83 e2 ef             	and    $0xffffffef,%edx
80107ee2:	88 50 7e             	mov    %dl,0x7e(%eax)
80107ee5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ee8:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
...
80107f68:	83 e2 9f             	and    $0xffffff9f,%edx
...
80107f7b:	83 ca 80             	or     $0xffffff80,%edx
80107f7e:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107f84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f87:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107f8e:	83 ca 0f             	or     $0xf,%edx
...
80107fa1:	83 e2 ef             	and    $0xffffffef,%edx
...
80107fb4:	83 e2 df             	and    $0xffffffdf,%edx
...
80107fc7:	83 ca 40             	or     $0x40,%edx
80107fca:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107fd0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fd3:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107fda:	83 ca 80             	or     $0xffffff80,%edx
80107fdd:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107fe3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fe6:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107fed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ff0:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107ff7:	ff ff 
80107ff9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ffc:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80108003:	00 00 
80108005:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108008:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
8010800f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108012:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108019:	83 e2 f0             	and    $0xfffffff0,%edx
8010801c:	83 ca 0a             	or     $0xa,%edx
...
8010807b:	83 e2 ef             	and    $0xffffffef,%edx
...
8010808e:	83 e2 df             	and    $0xffffffdf,%edx
...
8010812f:	83 ca 80             	or     $0xffffff80,%edx
80108132:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108138:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010813b:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108142:	83 ca 0f             	or     $0xf,%edx
...
80108168:	83 e2 df             	and    $0xffffffdf,%edx
...
8010817b:	83 ca 40             	or     $0x40,%edx
8010817e:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108184:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108187:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010818e:	83 ca 80             	or     $0xffffff80,%edx
80108191:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108197:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819a:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801081a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081a4:	05 b4 00 00 00       	add    $0xb4,%eax
801081a9:	89 c3                	mov    %eax,%ebx
801081ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081ae:	05 b4 00 00 00       	add    $0xb4,%eax
801081b3:	c1 e8 10             	shr    $0x10,%eax
801081b6:	89 c1                	mov    %eax,%ecx
801081b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081bb:	05 b4 00 00 00       	add    $0xb4,%eax
801081c0:	c1 e8 18             	shr    $0x18,%eax
801081c3:	89 c2                	mov    %eax,%edx
801081c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081c8:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
801081cf:	00 00 
801081d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081d4:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
801081db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081de:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
801081e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081e7:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801081ee:	83 e1 f0             	and    $0xfffffff0,%ecx
801081f1:	83 c9 02             	or     $0x2,%ecx
801081f4:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801081fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081fd:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108204:	83 c9 10             	or     $0x10,%ecx
80108207:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010820d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108210:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108217:	83 e1 9f             	and    $0xffffff9f,%ecx
8010821a:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108220:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108223:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
8010822a:	83 c9 80             	or     $0xffffff80,%ecx
8010822d:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108233:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108236:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010823d:	83 e1 f0             	and    $0xfffffff0,%ecx
80108240:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108246:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108249:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108250:	83 e1 ef             	and    $0xffffffef,%ecx
80108253:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108259:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010825c:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108263:	83 e1 df             	and    $0xffffffdf,%ecx
80108266:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010826c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010826f:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108276:	83 c9 40             	or     $0x40,%ecx
80108279:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010827f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108282:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108289:	83 c9 80             	or     $0xffffff80,%ecx
8010828c:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108292:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108295:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
8010829b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010829e:	83 c0 70             	add    $0x70,%eax
801082a1:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
801082a8:	00 
801082a9:	89 04 24             	mov    %eax,(%esp)
801082ac:	e8 37 fb ff ff       	call   80107de8 <lgdt>
  loadgs(SEG_KCPU << 3);
801082b1:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
801082b8:	e8 6a fb ff ff       	call   80107e27 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
801082bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082c0:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
801082c6:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801082cd:	00 00 00 00 
}
801082d1:	83 c4 24             	add    $0x24,%esp
801082d4:	5b                   	pop    %ebx
801082d5:	5d                   	pop    %ebp
801082d6:	c3                   	ret    
...
801082da:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801082dd:	8b 45 0c             	mov    0xc(%ebp),%eax
801082e0:	c1 e8 16             	shr    $0x16,%eax
801082e3:	c1 e0 02             	shl    $0x2,%eax
801082e6:	03 45 08             	add    0x8(%ebp),%eax
801082e9:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
801082ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801082ef:	8b 00                	mov    (%eax),%eax
801082f1:	83 e0 01             	and    $0x1,%eax
801082f4:	84 c0                	test   %al,%al
801082f6:	74 17                	je     8010830f <walkpgdir+0x38>
...
80108305:	e8 4a fb ff ff       	call   80107e54 <p2v>
8010830a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010830d:	eb 4b                	jmp    8010835a <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
8010830f:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80108313:	74 0e                	je     80108323 <walkpgdir+0x4c>
80108315:	e8 f1 a7 ff ff       	call   80102b0b <kalloc>
8010831a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010831d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108321:	75 07                	jne    8010832a <walkpgdir+0x53>
      return 0;
80108323:	b8 00 00 00 00       	mov    $0x0,%eax
80108328:	eb 41                	jmp    8010836b <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
8010832a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108331:	00 
80108332:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108339:	00 
8010833a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010833d:	89 04 24             	mov    %eax,(%esp)
80108340:	e8 69 d3 ff ff       	call   801056ae <memset>
...
8010834b:	e8 f7 fa ff ff       	call   80107e47 <v2p>
80108350:	89 c2                	mov    %eax,%edx
80108352:	83 ca 07             	or     $0x7,%edx
80108355:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108358:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
8010835a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010835d:	c1 e8 0c             	shr    $0xc,%eax
80108360:	25 ff 03 00 00       	and    $0x3ff,%eax
80108365:	c1 e0 02             	shl    $0x2,%eax
80108368:	03 45 f4             	add    -0xc(%ebp),%eax
}
8010836b:	c9                   	leave  
8010836c:	c3                   	ret    
...
80108370:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
80108381:	03 45 10             	add    0x10(%ebp),%eax
80108384:	83 e8 01             	sub    $0x1,%eax
80108387:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010838c:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010838f:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80108396:	00 
...
801083a4:	e8 2e ff ff ff       	call   801082d7 <walkpgdir>
801083a9:	89 45 ec             	mov    %eax,-0x14(%ebp)
801083ac:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801083b0:	75 07                	jne    801083b9 <mappages+0x4c>
      return -1;
801083b2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801083b7:	eb 46                	jmp    801083ff <mappages+0x92>
    if(*pte & PTE_P)
801083b9:	8b 45 ec             	mov    -0x14(%ebp),%eax
801083bc:	8b 00                	mov    (%eax),%eax
801083be:	83 e0 01             	and    $0x1,%eax
801083c1:	84 c0                	test   %al,%al
801083c3:	74 0c                	je     801083d1 <mappages+0x64>
      panic("remap");
801083c5:	c7 04 24 9c 92 10 80 	movl   $0x8010929c,(%esp)
801083cc:	e8 6c 81 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
801083d1:	8b 45 18             	mov    0x18(%ebp),%eax
801083d4:	0b 45 14             	or     0x14(%ebp),%eax
801083d7:	89 c2                	mov    %eax,%edx
801083d9:	83 ca 01             	or     $0x1,%edx
801083dc:	8b 45 ec             	mov    -0x14(%ebp),%eax
801083df:	89 10                	mov    %edx,(%eax)
    if(a == last)
801083e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083e4:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801083e7:	74 10                	je     801083f9 <mappages+0x8c>
      break;
    a += PGSIZE;
...
801083f7:	eb 96                	jmp    8010838f <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
801083f9:	90                   	nop
  ...
  return 0;
801083fa:	b8 00 00 00 00       	mov    $0x0,%eax
}
801083ff:	c9                   	leave  
80108400:	c3                   	ret    
...
80108405:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80108408:	e8 fe a6 ff ff       	call   80102b0b <kalloc>
8010840d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108410:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108414:	75 0a                	jne    80108420 <setupkvm+0x1f>
    return 0;
80108416:	b8 00 00 00 00       	mov    $0x0,%eax
8010841b:	e9 98 00 00 00       	jmp    801084b8 <setupkvm+0xb7>
...
80108436:	e8 73 d2 ff ff       	call   801056ae <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
8010843b:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108442:	e8 0d fa ff ff       	call   80107e54 <p2v>
80108447:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
8010844c:	76 0c                	jbe    8010845a <setupkvm+0x59>
    panic("PHYSTOP too high");
8010844e:	c7 04 24 a2 92 10 80 	movl   $0x801092a2,(%esp)
80108455:	e8 e3 80 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010845a:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
80108461:	eb 49                	jmp    801084ac <setupkvm+0xab>
...
80108463:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108466:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80108469:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
8010846c:	8b 50 04             	mov    0x4(%eax),%edx
8010846f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108472:	8b 58 08             	mov    0x8(%eax),%ebx
80108475:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108478:	8b 40 04             	mov    0x4(%eax),%eax
8010847b:	29 c3                	sub    %eax,%ebx
8010847d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108480:	8b 00                	mov    (%eax),%eax
80108482:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80108486:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010848a:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010848e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108492:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108495:	89 04 24             	mov    %eax,(%esp)
80108498:	e8 d0 fe ff ff       	call   8010836d <mappages>
8010849d:	85 c0                	test   %eax,%eax
8010849f:	79 07                	jns    801084a8 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
801084a1:	b8 00 00 00 00       	mov    $0x0,%eax
801084a6:	eb 10                	jmp    801084b8 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801084a8:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
801084ac:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
801084b3:	72 ae                	jb     80108463 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
801084b8:	83 c4 34             	add    $0x34,%esp
801084bb:	5b                   	pop    %ebx
801084bc:	5d                   	pop    %ebp
801084bd:	c3                   	ret    
...
801084c1:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801084c4:	e8 38 ff ff ff       	call   80108401 <setupkvm>
801084c9:	a3 58 a4 11 80       	mov    %eax,0x8011a458
  switchkvm();
801084ce:	e8 02 00 00 00       	call   801084d5 <switchkvm>
}
801084d3:	c9                   	leave  
801084d4:	c3                   	ret    
...
801084d8:	83 ec 04             	sub    $0x4,%esp
  lcr3(v2p(kpgdir));   // switch to the kernel page table
801084db:	a1 58 a4 11 80       	mov    0x8011a458,%eax
801084e0:	89 04 24             	mov    %eax,(%esp)
801084e3:	e8 5f f9 ff ff       	call   80107e47 <v2p>
801084e8:	89 04 24             	mov    %eax,(%esp)
801084eb:	e8 4c f9 ff ff       	call   80107e3c <lcr3>
}
801084f0:	c9                   	leave  
801084f1:	c3                   	ret    
...
801084f6:	83 ec 14             	sub    $0x14,%esp
  pushcli();
801084f9:	e8 a9 d0 ff ff       	call   801055a7 <pushcli>
...
8010850e:	89 d3                	mov    %edx,%ebx
80108510:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108517:	83 c2 08             	add    $0x8,%edx
8010851a:	c1 ea 10             	shr    $0x10,%edx
8010851d:	89 d1                	mov    %edx,%ecx
8010851f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108526:	83 c2 08             	add    $0x8,%edx
80108529:	c1 ea 18             	shr    $0x18,%edx
8010852c:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80108533:	67 00 
80108535:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
8010853c:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80108542:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108549:	83 e1 f0             	and    $0xfffffff0,%ecx
8010854c:	83 c9 09             	or     $0x9,%ecx
8010854f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108555:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010855c:	83 c9 10             	or     $0x10,%ecx
8010855f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108565:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010856c:	83 e1 9f             	and    $0xffffff9f,%ecx
8010856f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108575:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010857c:	83 c9 80             	or     $0xffffff80,%ecx
8010857f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108585:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010858c:	83 e1 f0             	and    $0xfffffff0,%ecx
8010858f:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108595:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010859c:	83 e1 ef             	and    $0xffffffef,%ecx
8010859f:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801085a5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801085ac:	83 e1 df             	and    $0xffffffdf,%ecx
801085af:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801085b5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801085bc:	83 c9 40             	or     $0x40,%ecx
801085bf:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801085c5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801085cc:	83 e1 7f             	and    $0x7f,%ecx
801085cf:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801085d5:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801085db:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801085e1:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
801085e8:	83 e2 ef             	and    $0xffffffef,%edx
801085eb:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
801085f1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801085f7:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
801085fd:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108603:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010860a:	8b 52 08             	mov    0x8(%edx),%edx
8010860d:	81 c2 00 10 00 00    	add    $0x1000,%edx
80108613:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80108616:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
8010861d:	e8 ef f7 ff ff       	call   80107e11 <ltr>
  if(p->pgdir == 0)
80108622:	8b 45 08             	mov    0x8(%ebp),%eax
80108625:	8b 40 04             	mov    0x4(%eax),%eax
80108628:	85 c0                	test   %eax,%eax
8010862a:	75 0c                	jne    80108638 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
8010862c:	c7 04 24 b3 92 10 80 	movl   $0x801092b3,(%esp)
80108633:	e8 05 7f ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80108638:	8b 45 08             	mov    0x8(%ebp),%eax
8010863b:	8b 40 04             	mov    0x4(%eax),%eax
8010863e:	89 04 24             	mov    %eax,(%esp)
80108641:	e8 01 f8 ff ff       	call   80107e47 <v2p>
80108646:	89 04 24             	mov    %eax,(%esp)
80108649:	e8 ee f7 ff ff       	call   80107e3c <lcr3>
  popcli();
8010864e:	e8 9c cf ff ff       	call   801055ef <popcli>
}
80108653:	83 c4 14             	add    $0x14,%esp
80108656:	5b                   	pop    %ebx
80108657:	5d                   	pop    %ebp
80108658:	c3                   	ret    
...
8010865c:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
8010865f:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80108666:	76 0c                	jbe    80108674 <inituvm+0x1b>
    panic("inituvm: more than a page");
80108668:	c7 04 24 c7 92 10 80 	movl   $0x801092c7,(%esp)
8010866f:	e8 c9 7e ff ff       	call   8010053d <panic>
  mem = kalloc();
80108674:	e8 92 a4 ff ff       	call   80102b0b <kalloc>
80108679:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
8010867c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108683:	00 
80108684:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010868b:	00 
8010868c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010868f:	89 04 24             	mov    %eax,(%esp)
80108692:	e8 17 d0 ff ff       	call   801056ae <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108697:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010869a:	89 04 24             	mov    %eax,(%esp)
8010869d:	e8 a5 f7 ff ff       	call   80107e47 <v2p>
801086a2:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801086a9:	00 
801086aa:	89 44 24 0c          	mov    %eax,0xc(%esp)
801086ae:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801086b5:	00 
801086b6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801086bd:	00 
801086be:	8b 45 08             	mov    0x8(%ebp),%eax
801086c1:	89 04 24             	mov    %eax,(%esp)
801086c4:	e8 a4 fc ff ff       	call   8010836d <mappages>
  memmove(mem, init, sz);
801086c9:	8b 45 10             	mov    0x10(%ebp),%eax
801086cc:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801086dd:	e8 9f d0 ff ff       	call   80105781 <memmove>
}
801086e2:	c9                   	leave  
801086e3:	c3                   	ret    
...
801086e8:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;
...
801086f5:	74 0c                	je     80108703 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
801086f7:	c7 04 24 e4 92 10 80 	movl   $0x801092e4,(%esp)
801086fe:	e8 3a 7e ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108703:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010870a:	e9 ad 00 00 00       	jmp    801087bc <loaduvm+0xd8>
...
8010871e:	00 
8010871f:	89 44 24 04          	mov    %eax,0x4(%esp)
80108723:	8b 45 08             	mov    0x8(%ebp),%eax
80108726:	89 04 24             	mov    %eax,(%esp)
80108729:	e8 a9 fb ff ff       	call   801082d7 <walkpgdir>
8010872e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108731:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108735:	75 0c                	jne    80108743 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108737:	c7 04 24 07 93 10 80 	movl   $0x80109307,(%esp)
...
80108753:	8b 55 18             	mov    0x18(%ebp),%edx
80108756:	89 d1                	mov    %edx,%ecx
80108758:	29 c1                	sub    %eax,%ecx
8010875a:	89 c8                	mov    %ecx,%eax
8010875c:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108761:	77 11                	ja     80108774 <loaduvm+0x90>
      n = sz - i;
80108763:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108766:	8b 55 18             	mov    0x18(%ebp),%edx
80108769:	89 d1                	mov    %edx,%ecx
8010876b:	29 c1                	sub    %eax,%ecx
8010876d:	89 c8                	mov    %ecx,%eax
8010876f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108772:	eb 07                	jmp    8010877b <loaduvm+0x97>
    else
      n = PGSIZE;
80108774:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
8010877b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010877e:	8b 55 14             	mov    0x14(%ebp),%edx
80108781:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108784:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108787:	89 04 24             	mov    %eax,(%esp)
8010878a:	e8 c5 f6 ff ff       	call   80107e54 <p2v>
8010878f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108792:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108796:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010879a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010879e:	8b 45 10             	mov    0x10(%ebp),%eax
801087a1:	89 04 24             	mov    %eax,(%esp)
801087a4:	e8 c1 95 ff ff       	call   80101d6a <readi>
801087a9:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801087ac:	74 07                	je     801087b5 <loaduvm+0xd1>
      return -1;
801087ae:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801087b3:	eb 18                	jmp    801087cd <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801087b5:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801087bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087bf:	3b 45 18             	cmp    0x18(%ebp),%eax
801087c2:	0f 82 47 ff ff ff    	jb     8010870f <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
  ...
  return 0;
801087c8:	b8 00 00 00 00       	mov    $0x0,%eax
}
801087cd:	83 c4 24             	add    $0x24,%esp
801087d0:	5b                   	pop    %ebx
801087d1:	5d                   	pop    %ebp
801087d2:	c3                   	ret    
...
801087d6:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
801087de:	79 0a                	jns    801087ea <allocuvm+0x17>
    return 0;
801087e0:	b8 00 00 00 00       	mov    $0x0,%eax
801087e5:	e9 c1 00 00 00       	jmp    801088ab <allocuvm+0xd8>
  if(newsz < oldsz)
801087ea:	8b 45 10             	mov    0x10(%ebp),%eax
801087ed:	3b 45 0c             	cmp    0xc(%ebp),%eax
801087f0:	73 08                	jae    801087fa <allocuvm+0x27>
    return oldsz;
801087f2:	8b 45 0c             	mov    0xc(%ebp),%eax
801087f5:	e9 b1 00 00 00       	jmp    801088ab <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
801087fa:	8b 45 0c             	mov    0xc(%ebp),%eax
801087fd:	05 ff 0f 00 00       	add    $0xfff,%eax
80108802:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108807:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
8010880a:	e9 8d 00 00 00       	jmp    8010889c <allocuvm+0xc9>
    mem = kalloc();
8010880f:	e8 f7 a2 ff ff       	call   80102b0b <kalloc>
80108814:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108817:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010881b:	75 2c                	jne    80108849 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
8010881d:	c7 04 24 25 93 10 80 	movl   $0x80109325,(%esp)
80108824:	e8 78 7b ff ff       	call   801003a1 <cprintf>
...
8010883d:	e8 6b 00 00 00       	call   801088ad <deallocuvm>
      return 0;
80108842:	b8 00 00 00 00       	mov    $0x0,%eax
80108847:	eb 62                	jmp    801088ab <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108849:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108850:	00 
80108851:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108858:	00 
80108859:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010885c:	89 04 24             	mov    %eax,(%esp)
8010885f:	e8 4a ce ff ff       	call   801056ae <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108864:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108867:	89 04 24             	mov    %eax,(%esp)
8010886a:	e8 d8 f5 ff ff       	call   80107e47 <v2p>
8010886f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108872:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108879:	00 
8010887a:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010887e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108885:	00 
80108886:	89 54 24 04          	mov    %edx,0x4(%esp)
8010888a:	8b 45 08             	mov    0x8(%ebp),%eax
8010888d:	89 04 24             	mov    %eax,(%esp)
80108890:	e8 d8 fa ff ff       	call   8010836d <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80108895:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010889c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010889f:	3b 45 10             	cmp    0x10(%ebp),%eax
801088a2:	0f 82 67 ff ff ff    	jb     8010880f <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
  ...
  return newsz;
801088a8:	8b 45 10             	mov    0x10(%ebp),%eax
}
801088ab:	c9                   	leave  
801088ac:	c3                   	ret    
...
801088b0:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
801088b3:	8b 45 10             	mov    0x10(%ebp),%eax
801088b6:	3b 45 0c             	cmp    0xc(%ebp),%eax
801088b9:	72 08                	jb     801088c3 <deallocuvm+0x16>
    return oldsz;
801088bb:	8b 45 0c             	mov    0xc(%ebp),%eax
801088be:	e9 a4 00 00 00       	jmp    80108967 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
801088c3:	8b 45 10             	mov    0x10(%ebp),%eax
801088c6:	05 ff 0f 00 00       	add    $0xfff,%eax
801088cb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801088d0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801088d3:	e9 80 00 00 00       	jmp    80108958 <deallocuvm+0xab>
...
801088ed:	e8 e5 f9 ff ff       	call   801082d7 <walkpgdir>
801088f2:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801088f5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801088f9:	75 09                	jne    80108904 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801088fb:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108902:	eb 4d                	jmp    80108951 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108904:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108907:	8b 00                	mov    (%eax),%eax
80108909:	83 e0 01             	and    $0x1,%eax
8010890c:	84 c0                	test   %al,%al
8010890e:	74 41                	je     80108951 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
...
8010891a:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
8010891d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108921:	75 0c                	jne    8010892f <deallocuvm+0x82>
        panic("kfree");
80108923:	c7 04 24 3d 93 10 80 	movl   $0x8010933d,(%esp)
8010892a:	e8 0e 7c ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
8010892f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108932:	89 04 24             	mov    %eax,(%esp)
80108935:	e8 1a f5 ff ff       	call   80107e54 <p2v>
8010893a:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
8010893d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108940:	89 04 24             	mov    %eax,(%esp)
80108943:	e8 2a a1 ff ff       	call   80102a72 <kfree>
      *pte = 0;
80108948:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010894b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80108951:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108958:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010895b:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010895e:	0f 82 74 ff ff ff    	jb     801088d8 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
  ...
  return newsz;
80108964:	8b 45 10             	mov    0x10(%ebp),%eax
}
80108967:	c9                   	leave  
80108968:	c3                   	ret    
...
8010896c:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
8010896f:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108973:	75 0c                	jne    80108981 <freevm+0x18>
    panic("freevm: no pgdir");
80108975:	c7 04 24 43 93 10 80 	movl   $0x80109343,(%esp)
8010897c:	e8 bc 7b ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108981:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108988:	00 
80108989:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108990:	80 
80108991:	8b 45 08             	mov    0x8(%ebp),%eax
80108994:	89 04 24             	mov    %eax,(%esp)
80108997:	e8 11 ff ff ff       	call   801088ad <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
8010899c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801089a3:	eb 3c                	jmp    801089e1 <freevm+0x78>
    if(pgdir[i] & PTE_P){
801089a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089a8:	c1 e0 02             	shl    $0x2,%eax
801089ab:	03 45 08             	add    0x8(%ebp),%eax
801089ae:	8b 00                	mov    (%eax),%eax
801089b0:	83 e0 01             	and    $0x1,%eax
801089b3:	84 c0                	test   %al,%al
801089b5:	74 26                	je     801089dd <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
801089b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089ba:	c1 e0 02             	shl    $0x2,%eax
801089bd:	03 45 08             	add    0x8(%ebp),%eax
801089c0:	8b 00                	mov    (%eax),%eax
801089c2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801089c7:	89 04 24             	mov    %eax,(%esp)
801089ca:	e8 85 f4 ff ff       	call   80107e54 <p2v>
801089cf:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
801089d2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089d5:	89 04 24             	mov    %eax,(%esp)
801089d8:	e8 95 a0 ff ff       	call   80102a72 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801089dd:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801089e1:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801089e8:	76 bb                	jbe    801089a5 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801089f0:	e8 7d a0 ff ff       	call   80102a72 <kfree>
}
801089f5:	c9                   	leave  
801089f6:	c3                   	ret    
...
801089fa:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801089fd:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108a04:	00 
...
80108a12:	e8 c0 f8 ff ff       	call   801082d7 <walkpgdir>
80108a17:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108a1a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108a1e:	75 0c                	jne    80108a2c <clearpteu+0x35>
    panic("clearpteu");
80108a20:	c7 04 24 54 93 10 80 	movl   $0x80109354,(%esp)
80108a27:	e8 11 7b ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
80108a2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a2f:	8b 00                	mov    (%eax),%eax
80108a31:	89 c2                	mov    %eax,%edx
80108a33:	83 e2 fb             	and    $0xfffffffb,%edx
...
80108a41:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108a44:	e8 b8 f9 ff ff       	call   80108401 <setupkvm>
80108a49:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108a4c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108a50:	75 0a                	jne    80108a5c <copyuvm+0x1f>
    return 0;
80108a52:	b8 00 00 00 00       	mov    $0x0,%eax
80108a57:	e9 fd 00 00 00       	jmp    80108b59 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108a5c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108a63:	e9 cc 00 00 00       	jmp    80108b34 <copyuvm+0xf7>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108a68:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a6b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108a72:	00 
80108a73:	89 44 24 04          	mov    %eax,0x4(%esp)
80108a77:	8b 45 08             	mov    0x8(%ebp),%eax
80108a7a:	89 04 24             	mov    %eax,(%esp)
80108a7d:	e8 55 f8 ff ff       	call   801082d7 <walkpgdir>
80108a82:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108a85:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108a89:	75 0c                	jne    80108a97 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108a8b:	c7 04 24 5e 93 10 80 	movl   $0x8010935e,(%esp)
80108a92:	e8 a6 7a ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
80108a97:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a9a:	8b 00                	mov    (%eax),%eax
80108a9c:	83 e0 01             	and    $0x1,%eax
80108a9f:	85 c0                	test   %eax,%eax
80108aa1:	75 0c                	jne    80108aaf <copyuvm+0x72>
      panic("copyuvm: page not present");
80108aa3:	c7 04 24 78 93 10 80 	movl   $0x80109378,(%esp)
80108aaa:	e8 8e 7a ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
...
80108ac6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108ac9:	e8 3d a0 ff ff       	call   80102b0b <kalloc>
80108ace:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108ad1:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108ad5:	74 6e                	je     80108b45 <copyuvm+0x108>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108ad7:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108ada:	89 04 24             	mov    %eax,(%esp)
80108add:	e8 72 f3 ff ff       	call   80107e54 <p2v>
80108ae2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108ae9:	00 
80108aea:	89 44 24 04          	mov    %eax,0x4(%esp)
80108aee:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108af1:	89 04 24             	mov    %eax,(%esp)
80108af4:	e8 88 cc ff ff       	call   80105781 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108af9:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108afc:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108aff:	89 04 24             	mov    %eax,(%esp)
80108b02:	e8 40 f3 ff ff       	call   80107e47 <v2p>
80108b07:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108b0a:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108b0e:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108b12:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108b19:	00 
80108b1a:	89 54 24 04          	mov    %edx,0x4(%esp)
80108b1e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b21:	89 04 24             	mov    %eax,(%esp)
80108b24:	e8 44 f8 ff ff       	call   8010836d <mappages>
80108b29:	85 c0                	test   %eax,%eax
80108b2b:	78 1b                	js     80108b48 <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108b2d:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108b34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b37:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108b3a:	0f 82 28 ff ff ff    	jb     80108a68 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108b43:	eb 14                	jmp    80108b59 <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108b45:	90                   	nop
80108b46:	eb 01                	jmp    80108b49 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
80108b48:	90                   	nop
...
80108b4f:	e8 15 fe ff ff       	call   80108969 <freevm>
  return 0;
80108b54:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108b59:	83 c4 44             	add    $0x44,%esp
80108b5c:	5b                   	pop    %ebx
80108b5d:	5d                   	pop    %ebp
80108b5e:	c3                   	ret    
...
80108b62:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108b65:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108b6c:	00 
80108b6d:	8b 45 0c             	mov    0xc(%ebp),%eax
80108b70:	89 44 24 04          	mov    %eax,0x4(%esp)
80108b74:	8b 45 08             	mov    0x8(%ebp),%eax
80108b77:	89 04 24             	mov    %eax,(%esp)
80108b7a:	e8 58 f7 ff ff       	call   801082d7 <walkpgdir>
80108b7f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108b82:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b85:	8b 00                	mov    (%eax),%eax
80108b87:	83 e0 01             	and    $0x1,%eax
80108b8a:	85 c0                	test   %eax,%eax
80108b8c:	75 07                	jne    80108b95 <uva2ka+0x36>
    return 0;
80108b8e:	b8 00 00 00 00       	mov    $0x0,%eax
80108b93:	eb 25                	jmp    80108bba <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108b95:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b98:	8b 00                	mov    (%eax),%eax
80108b9a:	83 e0 04             	and    $0x4,%eax
80108b9d:	85 c0                	test   %eax,%eax
80108b9f:	75 07                	jne    80108ba8 <uva2ka+0x49>
    return 0;
80108ba1:	b8 00 00 00 00       	mov    $0x0,%eax
80108ba6:	eb 12                	jmp    80108bba <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
80108ba8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bab:	8b 00                	mov    (%eax),%eax
80108bad:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108bb2:	89 04 24             	mov    %eax,(%esp)
80108bb5:	e8 9a f2 ff ff       	call   80107e54 <p2v>
}
80108bba:	c9                   	leave  
80108bbb:	c3                   	ret    
...
80108bbf:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
80108bc2:	8b 45 10             	mov    0x10(%ebp),%eax
80108bc5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108bc8:	e9 8b 00 00 00       	jmp    80108c58 <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
80108bcd:	8b 45 0c             	mov    0xc(%ebp),%eax
80108bd0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108bd5:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
80108be5:	e8 75 ff ff ff       	call   80108b5f <uva2ka>
80108bea:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108bed:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108bf1:	75 07                	jne    80108bfa <copyout+0x3e>
      return -1;
80108bf3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108bf8:	eb 6d                	jmp    80108c67 <copyout+0xab>
    n = PGSIZE - (va - va0);
80108bfa:	8b 45 0c             	mov    0xc(%ebp),%eax
80108bfd:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108c00:	89 d1                	mov    %edx,%ecx
80108c02:	29 c1                	sub    %eax,%ecx
80108c04:	89 c8                	mov    %ecx,%eax
...
80108c14:	76 06                	jbe    80108c1c <copyout+0x60>
      n = len;
...
80108c22:	89 d1                	mov    %edx,%ecx
80108c24:	29 c1                	sub    %eax,%ecx
80108c26:	89 c8                	mov    %ecx,%eax
80108c28:	03 45 e8             	add    -0x18(%ebp),%eax
80108c2b:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108c2e:	89 54 24 08          	mov    %edx,0x8(%esp)
80108c32:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108c35:	89 54 24 04          	mov    %edx,0x4(%esp)
80108c39:	89 04 24             	mov    %eax,(%esp)
80108c3c:	e8 40 cb ff ff       	call   80105781 <memmove>
    len -= n;
80108c41:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108c44:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108c47:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108c4a:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108c4d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108c50:	05 00 10 00 00       	add    $0x1000,%eax
80108c55:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108c58:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108c5c:	0f 85 6b ff ff ff    	jne    80108bcd <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
