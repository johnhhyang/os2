...
8010003a:	c7 44 24 04 3c 8a 10 	movl   $0x80108a3c,0x4(%esp)
80100041:	80 
...
8010011f:	e8 03 4f 00 00       	call   80105027 <sleep>
      goto loop;
...
80100198:	c7 04 24 43 8a 10 80 	movl   $0x80108a43,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 54 8a 10 80 	movl   $0x80108a54,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 5b 8a 10 80 	movl   $0x80108a5b,(%esp)
...
8010029d:	e8 61 4e 00 00       	call   80105103 <wakeup>
...
801003bc:	e8 4e 4f 00 00       	call   8010530f <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 62 8a 10 80 	movl   $0x80108a62,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 6b 8a 10 80 	movl   $0x80108a6b,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 36 4e 00 00       	call   80105371 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 72 8a 10 80 	movl   $0x80108a72,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 81 8a 10 80 	movl   $0x80108a81,(%esp)
...
80100592:	e8 29 4e 00 00       	call   801053c0 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 83 8a 10 80 	movl   $0x80108a83,(%esp)
...
801006b2:	e8 7a 4f 00 00       	call   80105631 <memmove>
    pos -= 80;
...
80100776:	e8 12 69 00 00       	call   8010708d <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 06 69 00 00       	call   8010708d <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 fa 68 00 00       	call   8010708d <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 ed 68 00 00       	call   8010708d <uartputc>
  cgaputc(c);
...
801007ba:	e8 50 4b 00 00       	call   8010530f <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 ba 49 00 00       	call   801051a9 <procdump>
      break;
...
801008f7:	e8 07 48 00 00       	call   80105103 <wakeup>
        }
      }
      break;
...
8010091e:	e8 4e 4a 00 00       	call   80105371 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 c7 49 00 00       	call   8010530f <acquire>
  while(n > 0){
...
80100961:	e8 0b 4a 00 00       	call   80105371 <release>
        ilock(ip);
...
8010098a:	e8 98 46 00 00       	call   80105027 <sleep>
...
80100a08:	e8 64 49 00 00       	call   80105371 <release>
  ilock(ip);
...
80100a3e:	e8 cc 48 00 00       	call   8010530f <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 f4 48 00 00       	call   80105371 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 87 8a 10 	movl   $0x80108a87,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100aa2:	e8 47 48 00 00       	call   801052ee <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 8f 8a 10 	movl   $0x80108a8f,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 a0 17 11 80 	movl   $0x801117a0,(%esp)
80100ab6:	e8 33 48 00 00       	call   801052ee <initlock>
...
80100b78:	0f 85 44 03 00 00    	jne    80100ec2 <exec+0x3c6>
  ...
  if((pgdir = setupkvm()) == 0)
80100b7e:	e8 4e 76 00 00       	call   801081d1 <setupkvm>
...
80100c17:	e8 87 79 00 00       	call   801085a3 <allocuvm>
...
80100c54:	e8 5b 78 00 00       	call   801084b4 <loaduvm>
...
80100cc4:	e8 da 78 00 00       	call   801085a3 <allocuvm>
...
80100ce8:	e8 da 7a 00 00       	call   801087c7 <clearpteu>
  sp = sz;
...
80100d17:	e8 c0 4a 00 00       	call   801057dc <strlen>
...
80100d35:	e8 a2 4a 00 00       	call   801057dc <strlen>
...
80100d5f:	e8 28 7c 00 00       	call   8010898c <copyout>
...
80100dff:	e8 88 7b 00 00       	call   8010898c <copyout>
...
80100e56:	e8 33 49 00 00       	call   8010578e <safestrcpy>
...
80100ea8:	e8 15 74 00 00       	call   801082c2 <switchuvm>
  freevm(oldpgdir);
80100ead:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100eb0:	89 04 24             	mov    %eax,(%esp)
80100eb3:	e8 81 78 00 00       	call   80108739 <freevm>
  return 0;
...
80100eea:	e8 4a 78 00 00       	call   80108739 <freevm>
  if(ip){
...
80100f12:	c7 44 24 04 95 8a 10 	movl   $0x80108a95,0x4(%esp)
80100f19:	80 
80100f1a:	c7 04 24 60 18 11 80 	movl   $0x80111860,(%esp)
80100f21:	e8 c8 43 00 00       	call   801052ee <initlock>
}
80100f26:	c9                   	leave  
80100f27:	c3                   	ret    
...
80100f35:	e8 d5 43 00 00       	call   8010530f <acquire>
...
80100f5e:	e8 0e 44 00 00       	call   80105371 <release>
      return f;
...
80100f7c:	e8 f0 43 00 00       	call   80105371 <release>
  return 0;
...
80100f95:	e8 75 43 00 00       	call   8010530f <acquire>
  if(f->ref < 1)
...
80100fa2:	7f 0c                	jg     80100fb0 <filedup+0x28>
    panic("filedup");
80100fa4:	c7 04 24 9c 8a 10 80 	movl   $0x80108a9c,(%esp)
...
80100fc6:	e8 a6 43 00 00       	call   80105371 <release>
  return f;
...
80100fdd:	e8 2d 43 00 00       	call   8010530f <acquire>
  if(f->ref < 1)
...
80100fea:	7f 0c                	jg     80100ff8 <fileclose+0x28>
    panic("fileclose");
80100fec:	c7 04 24 a4 8a 10 80 	movl   $0x80108aa4,(%esp)
...
80101018:	e8 54 43 00 00       	call   80105371 <release>
    return;
...
80101062:	e8 0a 43 00 00       	call   80105371 <release>
...
801011a1:	eb 0c                	jmp    801011af <fileread+0xba>
  ...
  panic("fileread");
801011a3:	c7 04 24 ae 8a 10 80 	movl   $0x80108aae,(%esp)
...
801012af:	c7 04 24 b7 8a 10 80 	movl   $0x80108ab7,(%esp)
...
801012e2:	eb 0c                	jmp    801012f0 <filewrite+0x13f>
  ...
  panic("filewrite");
801012e4:	c7 04 24 c7 8a 10 80 	movl   $0x80108ac7,(%esp)
...
8010132c:	e8 00 43 00 00       	call   80105631 <memmove>
  brelse(bp);
...
80101372:	e8 e7 41 00 00       	call   8010555e <memset>
  log_write(bp);
...
801014d4:	0f 82 e1 fe ff ff    	jb     801013bb <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014da:	c7 04 24 d1 8a 10 80 	movl   $0x80108ad1,(%esp)
...
80101571:	c7 04 24 e7 8a 10 80 	movl   $0x80108ae7,(%esp)
...
801015c5:	c7 44 24 04 fa 8a 10 	movl   $0x80108afa,0x4(%esp)
801015cc:	80 
801015cd:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801015d4:	e8 15 3d 00 00       	call   801052ee <initlock>
}
801015d9:	c9                   	leave  
801015da:	c3                   	ret    
...
80101656:	e8 03 3f 00 00       	call   8010555e <memset>
      dip->type = type;
...
801016a6:	0f 82 5a ff ff ff    	jb     80101606 <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016ac:	c7 04 24 01 8b 10 80 	movl   $0x80108b01,(%esp)
...
80101753:	e8 d9 3e 00 00       	call   80105631 <memmove>
  log_write(bp);
...
8010177d:	e8 8d 3b 00 00       	call   8010530f <acquire>
...
801017c7:	e8 a5 3b 00 00       	call   80105371 <release>
      return ip;
...
801017fa:	c7 04 24 13 8b 10 80 	movl   $0x80108b13,(%esp)
...
80101838:	e8 34 3b 00 00       	call   80105371 <release>
...
8010184f:	e8 bb 3a 00 00       	call   8010530f <acquire>
  ip->ref++;
...
8010186a:	e8 02 3b 00 00       	call   80105371 <release>
  return ip;
...
80101888:	7f 0c                	jg     80101896 <ilock+0x22>
    panic("ilock");
8010188a:	c7 04 24 23 8b 10 80 	movl   $0x80108b23,(%esp)
80101891:	e8 a7 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101896:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
8010189d:	e8 6d 3a 00 00       	call   8010530f <acquire>
...
801018b2:	e8 70 37 00 00       	call   80105027 <sleep>
...
801018dc:	e8 90 3a 00 00       	call   80105371 <release>
...
80101987:	e8 a5 3c 00 00       	call   80105631 <memmove>
    brelse(bp);
...
801019b2:	75 0c                	jne    801019c0 <ilock+0x14c>
      panic("ilock: no type");
801019b4:	c7 04 24 29 8b 10 80 	movl   $0x80108b29,(%esp)
...
801019e3:	7f 0c                	jg     801019f1 <iunlock+0x2f>
    panic("iunlock");
801019e5:	c7 04 24 38 8b 10 80 	movl   $0x80108b38,(%esp)
801019ec:	e8 4c eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019f1:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801019f8:	e8 12 39 00 00       	call   8010530f <acquire>
  ip->flags &= ~I_BUSY;
...
80101a14:	e8 ea 36 00 00       	call   80105103 <wakeup>
  release(&icache.lock);
80101a19:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80101a20:	e8 4c 39 00 00       	call   80105371 <release>
}
80101a25:	c9                   	leave  
80101a26:	c3                   	ret    
...
80101a34:	e8 d6 38 00 00       	call   8010530f <acquire>
...
80101a70:	74 0c                	je     80101a7e <iput+0x57>
      panic("iput busy");
80101a72:	c7 04 24 40 8b 10 80 	movl   $0x80108b40,(%esp)
...
80101a96:	e8 d6 38 00 00       	call   80105371 <release>
    itrunc(ip);
...
80101ac1:	e8 49 38 00 00       	call   8010530f <acquire>
    ip->flags = 0;
...
80101ad6:	e8 28 36 00 00       	call   80105103 <wakeup>
  }
  ip->ref--;
...
80101af1:	e8 7b 38 00 00       	call   80105371 <release>
}
80101af6:	c9                   	leave  
80101af7:	c3                   	ret    
...
80101c06:	c7 04 24 4a 8b 10 80 	movl   $0x80108b4a,(%esp)
...
80101e9e:	e8 8e 37 00 00       	call   80105631 <memmove>
    brelse(bp);
...
80102004:	e8 28 36 00 00       	call   80105631 <memmove>
    log_write(bp);
...
80102086:	e8 4a 36 00 00       	call   801056d5 <strncmp>
}
8010208b:	c9                   	leave  
8010208c:	c3                   	ret    
...
801020a0:	c7 04 24 5d 8b 10 80 	movl   $0x80108b5d,(%esp)
...
801020dc:	74 0c                	je     801020ea <dirlookup+0x5d>
      panic("dirlink read");
801020de:	c7 04 24 6f 8b 10 80 	movl   $0x80108b6f,(%esp)
...
801021c0:	74 0c                	je     801021ce <dirlink+0x79>
      panic("dirlink read");
801021c2:	c7 04 24 6f 8b 10 80 	movl   $0x80108b6f,(%esp)
...
80102208:	e8 20 35 00 00       	call   8010572d <strncpy>
  de.inum = inum;
...
80102238:	74 0c                	je     80102246 <dirlink+0xf1>
    panic("dirlink");
8010223a:	c7 04 24 7c 8b 10 80 	movl   $0x80108b7c,(%esp)
...
801022c1:	e8 6b 33 00 00       	call   80105631 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022dc:	e8 50 33 00 00       	call   80105631 <memmove>
    name[len] = 0;
...
80102538:	c7 44 24 04 84 8b 10 	movl   $0x80108b84,0x4(%esp)
8010253f:	80 
80102540:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
80102547:	e8 a2 2d 00 00       	call   801052ee <initlock>
  picenable(IRQ_IDE);
...
801025e2:	75 0c                	jne    801025f0 <idestart+0x18>
    panic("idestart");
801025e4:	c7 04 24 88 8b 10 80 	movl   $0x80108b88,(%esp)
...
8010270a:	e8 00 2c 00 00       	call   8010530f <acquire>
  if((b = idequeue) == 0){
...
80102724:	e8 48 2c 00 00       	call   80105371 <release>
...
80102797:	e8 67 29 00 00       	call   80105103 <wakeup>
...
801027b9:	e8 b3 2b 00 00       	call   80105371 <release>
}
801027be:	c9                   	leave  
801027bf:	c3                   	ret    
...
801027d2:	c7 04 24 91 8b 10 80 	movl   $0x80108b91,(%esp)
...
801027eb:	c7 04 24 a5 8b 10 80 	movl   $0x80108ba5,(%esp)
...
80102876:	e8 ac 27 00 00       	call   80105027 <sleep>
...
80102892:	e8 da 2a 00 00       	call   80105371 <release>
}
80102897:	c9                   	leave  
80102898:	c3                   	ret    
...
80102922:	c7 04 24 d8 8b 10 80 	movl   $0x80108bd8,(%esp)
...
801029e3:	c7 44 24 04 0a 8c 10 	movl   $0x80108c0a,0x4(%esp)
801029ea:	80 
801029eb:	c7 04 24 40 32 11 80 	movl   $0x80113240,(%esp)
801029f2:	e8 f7 28 00 00       	call   801052ee <initlock>
  kmem.use_lock = 0;
...
80102a9d:	76 0c                	jbe    80102aab <kfree+0x39>
    panic("kfree");
80102a9f:	c7 04 24 0f 8c 10 80 	movl   $0x80108c0f,(%esp)
...
80102ac1:	e8 98 2a 00 00       	call   8010555e <memset>
...
80102ad6:	e8 34 28 00 00       	call   8010530f <acquire>
  r = (struct run*)v;
...
80102b04:	e8 68 28 00 00       	call   80105371 <release>
}
80102b09:	c9                   	leave  
80102b0a:	c3                   	ret    
...
80102b21:	e8 e9 27 00 00       	call   8010530f <acquire>
  r = kmem.freelist;
...
80102b4e:	e8 1e 28 00 00       	call   80105371 <release>
  return (char*)r;
...
80102ef4:	c7 04 24 18 8c 10 80 	movl   $0x80108c18,(%esp)
...
80103158:	e8 78 24 00 00       	call   801055d5 <memcmp>
...
8010325a:	c7 44 24 04 44 8c 10 	movl   $0x80108c44,0x4(%esp)
80103261:	80 
80103262:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
80103269:	e8 80 20 00 00       	call   801052ee <initlock>
  readsb(ROOTDEV, &sb);
...
8010331c:	e8 10 23 00 00       	call   80105631 <memmove>
...
8010346e:	e8 9c 1e 00 00       	call   8010530f <acquire>
  while(1){
    if(log.committing){
...
8010348b:	e8 97 1b 00 00       	call   80105027 <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
801034bf:	e8 63 1b 00 00       	call   80105027 <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
801034da:	e8 92 1e 00 00       	call   80105371 <release>
      break;
801034df:	90                   	nop
    }
  }
...
801034f6:	e8 14 1e 00 00       	call   8010530f <acquire>
  log.outstanding -= 1;
...
80103511:	c7 04 24 48 8c 10 80 	movl   $0x80108c48,(%esp)
...
80103540:	e8 be 1b 00 00       	call   80105103 <wakeup>
  }
  release(&log.lock);
80103545:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
8010354c:	e8 20 1e 00 00       	call   80105371 <release>
...
801035fd:	e8 2f 20 00 00       	call   80105631 <memmove>
...
80103688:	c7 04 24 57 8c 10 80 	movl   $0x80108c57,(%esp)
...
8010369d:	c7 04 24 6d 8c 10 80 	movl   $0x80108c6d,(%esp)
...
80103798:	c7 04 24 88 8c 10 80 	movl   $0x80108c88,(%esp)
...
801037b3:	e8 c4 37 00 00       	call   80106f7c <uartinit>
  pinit();         // process table
801037b8:	e8 8e 0b 00 00       	call   8010434b <pinit>
  tvinit();        // trap vectors
801037bd:	e8 5d 33 00 00       	call   80106b1f <tvinit>
  binit();         // buffer cache
...
801037df:	e8 7e 32 00 00       	call   80106a62 <timerinit>
...
8010380a:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
8010380d:	e8 93 4a 00 00       	call   801082a5 <switchkvm>
  seginit();
80103812:	e8 1a 44 00 00       	call   80107c31 <seginit>
  lapicinit();
...
80103837:	c7 04 24 9f 8c 10 80 	movl   $0x80108c9f,(%esp)
8010383e:	e8 5e cb ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
80103843:	e8 4b 34 00 00       	call   80106c93 <idtinit>
...
80103863:	e8 13 16 00 00       	call   80104e7b <scheduler>
...
80103895:	e8 97 1d 00 00       	call   80105631 <memmove>
...
80103a23:	00 
80103a24:	c7 44 24 04 b0 8c 10 	movl   $0x80108cb0,0x4(%esp)
80103a2b:	80 
80103a2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a2f:	89 04 24             	mov    %eax,(%esp)
80103a32:	e8 9e 1b 00 00       	call   801055d5 <memcmp>
...
80103b64:	00 
80103b65:	c7 44 24 04 b5 8c 10 	movl   $0x80108cb5,0x4(%esp)
80103b6c:	80 
80103b6d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b70:	89 04 24             	mov    %eax,(%esp)
80103b73:	e8 5d 1a 00 00       	call   801055d5 <memcmp>
...
80103c3e:	8b 04 85 f8 8c 10 80 	mov    -0x7fef7308(,%eax,4),%eax
...
80103c77:	c7 04 24 ba 8c 10 80 	movl   $0x80108cba,(%esp)
...
80103d0a:	c7 04 24 d8 8c 10 80 	movl   $0x80108cd8,(%esp)
...
8010400f:	c7 44 24 04 0c 8d 10 	movl   $0x80108d0c,0x4(%esp)
80104016:	80 
80104017:	89 04 24             	mov    %eax,(%esp)
8010401a:	e8 cf 12 00 00       	call   801052ee <initlock>
  (*f0)->type = FD_PIPE;
...
801040c7:	e8 43 12 00 00       	call   8010530f <acquire>
  if(writable){
...
801040ea:	e8 14 10 00 00       	call   80105103 <wakeup>
...
80104109:	e8 f5 0f 00 00       	call   80105103 <wakeup>
  }
...
8010412e:	e8 3e 12 00 00       	call   80105371 <release>
    kfree((char*)p);
...
80104146:	e8 26 12 00 00       	call   80105371 <release>
}
8010414b:	c9                   	leave  
8010414c:	c3                   	ret    
...
8010415a:	e8 b0 11 00 00       	call   8010530f <acquire>
  for(i = 0; i < n; i++){
...
8010418b:	e8 e1 11 00 00       	call   80105371 <release>
        return -1;
...
801041a5:	e8 59 0f 00 00       	call   80105103 <wakeup>
...
801041bd:	e8 65 0e 00 00       	call   80105027 <sleep>
...
80104224:	e8 da 0e 00 00       	call   80105103 <wakeup>
  release(&p->lock);
80104229:	8b 45 08             	mov    0x8(%ebp),%eax
8010422c:	89 04 24             	mov    %eax,(%esp)
8010422f:	e8 3d 11 00 00       	call   80105371 <release>
  return n;
...
8010424a:	e8 c0 10 00 00       	call   8010530f <acquire>
...
80104264:	e8 08 11 00 00       	call   80105371 <release>
      return -1;
...
80104286:	e8 9c 0d 00 00       	call   80105027 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80104316:	e8 e8 0d 00 00       	call   80105103 <wakeup>
  release(&p->lock);
8010431b:	8b 45 08             	mov    0x8(%ebp),%eax
8010431e:	89 04 24             	mov    %eax,(%esp)
80104321:	e8 4b 10 00 00       	call   80105371 <release>
  return i;
...
80104351:	c7 44 24 04 14 8d 10 	movl   $0x80108d14,0x4(%esp)
80104358:	80 
80104359:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104360:	e8 89 0f 00 00       	call   801052ee <initlock>
}
80104365:	c9                   	leave  
80104366:	c3                   	ret    
...
80104374:	e8 96 0f 00 00       	call   8010530f <acquire>
...
801043a3:	e8 c9 0f 00 00       	call   80105371 <release>
  return 0;
...
801043d7:	e8 95 0f 00 00       	call   80105371 <release>
...
80104421:	ba d4 6a 10 80       	mov    $0x80106ad4,%edx
...
80104451:	e8 08 11 00 00       	call   8010555e <memset>
  p->context->eip = (uint)forkret;
80104456:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104459:	8b 40 1c             	mov    0x1c(%eax),%eax
8010445c:	ba fb 4f 10 80       	mov    $0x80104ffb,%edx
...
8010447f:	e8 4d 3d 00 00       	call   801081d1 <setupkvm>
...
80104494:	c7 04 24 1b 8d 10 80 	movl   $0x80108d1b,(%esp)
...
801044ba:	e8 6a 3f 00 00       	call   80108429 <inituvm>
  p->sz = PGSIZE;
...
801044e1:	e8 78 10 00 00       	call   8010555e <memset>
...
8010455a:	00 
8010455b:	c7 44 24 04 34 8d 10 	movl   $0x80108d34,0x4(%esp)
80104562:	80 
80104563:	89 04 24             	mov    %eax,(%esp)
80104566:	e8 23 12 00 00       	call   8010578e <safestrcpy>
  p->cwd = namei("/");
8010456b:	c7 04 24 3d 8d 10 80 	movl   $0x80108d3d,(%esp)
...
801045bf:	e8 df 3f 00 00       	call   801085a3 <allocuvm>
...
801045f9:	e8 7f 40 00 00       	call   8010867d <deallocuvm>
...
80104622:	e8 9b 3c 00 00       	call   801082c2 <switchuvm>
  return 0;
...
80104637:	c7 04 24 40 8d 10 80 	movl   $0x80108d40,(%esp)
...
80104673:	e8 95 41 00 00       	call   8010880d <copyuvm>
...
8010477a:	e8 0f 10 00 00       	call   8010578e <safestrcpy>
...
8010478f:	e8 7b 0b 00 00       	call   8010530f <acquire>
  np->state = RUNNABLE;
...
801047a5:	e8 c7 0b 00 00       	call   80105371 <release>
...
80104932:	e8 57 0e 00 00       	call   8010578e <safestrcpy>
...
80104947:	e8 c3 09 00 00       	call   8010530f <acquire>
  np->state = RUNNABLE;
...
8010495d:	e8 0f 0a 00 00       	call   80105371 <release>
...
80104981:	75 0c                	jne    8010498f <exit+0x22>
    panic("init exiting");
80104983:	c7 04 24 60 8d 10 80 	movl   $0x80108d60,(%esp)
...
80104a11:	e8 f9 08 00 00       	call   8010530f <acquire>
...
80104a22:	e8 9b 06 00 00       	call   801050c2 <wakeup1>
...
80104a8c:	e8 31 06 00 00       	call   801050c2 <wakeup1>
...
80104aa7:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104aae:	e8 64 04 00 00       	call   80104f17 <sched>
  panic("zombie exit");
80104ab3:	c7 04 24 6d 8d 10 80 	movl   $0x80108d6d,(%esp)
...
80104ad3:	75 0c                	jne    80104ae1 <texit+0x22>
    panic("init exiting");
80104ad5:	c7 04 24 60 8d 10 80 	movl   $0x80108d60,(%esp)
...
80104b63:	e8 a7 07 00 00       	call   8010530f <acquire>
...
80104b74:	e8 49 05 00 00       	call   801050c2 <wakeup1>
...
80104bde:	e8 df 04 00 00       	call   801050c2 <wakeup1>
...
80104bf9:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104c00:	e8 12 03 00 00       	call   80104f17 <sched>
  panic("zombie exit");
80104c05:	c7 04 24 6d 8d 10 80 	movl   $0x80108d6d,(%esp)
...
80104c1e:	e8 ec 06 00 00       	call   8010530f <acquire>
  for(;;){
...
80104c86:	e8 ae 3a 00 00       	call   80108739 <freevm>
        p->state = UNUSED;
...
80104cc1:	e8 ab 06 00 00       	call   80105371 <release>
        return pid;
...
80104cfa:	e8 72 06 00 00       	call   80105371 <release>
      return -1;
...
80104d17:	e8 0b 03 00 00       	call   80105027 <sleep>
  }
...
80104d30:	e8 da 05 00 00       	call   8010530f <acquire>
  for(;;){
...
80104d43:	e9 c9 00 00 00       	jmp    80104e11 <join+0xee>
...
80104d56:	0f 85 ad 00 00 00    	jne    80104e09 <join+0xe6>
80104d5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d5f:	8b 40 7c             	mov    0x7c(%eax),%eax
80104d62:	83 f8 01             	cmp    $0x1,%eax
80104d65:	0f 85 9e 00 00 00    	jne    80104e09 <join+0xe6>
...
80104d77:	0f 84 8c 00 00 00    	je     80104e09 <join+0xe6>
        continue;
      havekids = 1;
...
80104d8d:	75 7b                	jne    80104e0a <join+0xe7>
        // Found one, free its stack, make unused, etc
        pid = p->pid;
80104d8f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d92:	8b 40 10             	mov    0x10(%eax),%eax
80104d95:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
80104d98:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d9b:	8b 40 08             	mov    0x8(%eax),%eax
80104d9e:	89 04 24             	mov    %eax,(%esp)
80104da1:	e8 cc dc ff ff       	call   80102a72 <kfree>
        p->kstack = 0;
80104da6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104da9:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
        p->state = UNUSED;
80104db0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104db3:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
80104dba:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dbd:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80104dc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dc7:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
80104dce:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dd1:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
80104dd5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dd8:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80104ddf:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104de6:	e8 86 05 00 00       	call   80105371 <release>

        //copy address of return value into retval parameter
        *(int*)retval = pid;
80104deb:	8b 45 10             	mov    0x10(%ebp),%eax
80104dee:	8b 55 ec             	mov    -0x14(%ebp),%edx
...
80104df9:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80104dff:	8b 45 0c             	mov    0xc(%ebp),%eax
80104e02:	89 10                	mov    %edx,(%eax)
        return pid;
80104e04:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104e07:	eb 70                	jmp    80104e79 <join+0x156>
    havekids = 0;
    //iterate through the ptable to find zombies
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
      // only wait for the child thread, but not the child process of the pid given
...
80104e09:	90                   	nop
  ...
  for(;;){
    ...
    //iterate through the ptable to find zombies
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e0a:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104e11:	81 7d f4 b4 5a 11 80 	cmpl   $0x80115ab4,-0xc(%ebp)
80104e18:	0f 82 2a ff ff ff    	jb     80104d48 <join+0x25>
        return pid;
      }
    }
    ...
    if(!havekids || proc->killed){
80104e1e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104e22:	74 0d                	je     80104e31 <join+0x10e>
80104e24:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e2a:	8b 40 24             	mov    0x24(%eax),%eax
80104e2d:	85 c0                	test   %eax,%eax
80104e2f:	74 2d                	je     80104e5e <join+0x13b>
      release(&ptable.lock);
...
80104e40:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
      //copy address of user stack into parameter
      *(int*)stack = proc->stack;
80104e46:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e4c:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80104e52:	8b 45 0c             	mov    0xc(%ebp),%eax
80104e55:	89 10                	mov    %edx,(%eax)
      return -1;
80104e57:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e5c:	eb 1b                	jmp    80104e79 <join+0x156>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104e5e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e64:	c7 44 24 04 80 39 11 	movl   $0x80113980,0x4(%esp)
80104e6b:	80 
80104e6c:	89 04 24             	mov    %eax,(%esp)
80104e6f:	e8 b3 01 00 00       	call   80105027 <sleep>

  }
80104e74:	e9 bc fe ff ff       	jmp    80104d35 <join+0x12>
}
80104e79:	c9                   	leave  
80104e7a:	c3                   	ret    
...
80104e7e:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
80104e81:	e8 bf f4 ff ff       	call   80104345 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104e86:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104e8d:	e8 7d 04 00 00       	call   8010530f <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e92:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104e99:	eb 62                	jmp    80104efd <scheduler+0x82>
      if(p->state != RUNNABLE)
80104e9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e9e:	8b 40 0c             	mov    0xc(%eax),%eax
80104ea1:	83 f8 03             	cmp    $0x3,%eax
80104ea4:	75 4f                	jne    80104ef5 <scheduler+0x7a>
        continue;
...
80104ea9:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80104eaf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104eb2:	89 04 24             	mov    %eax,(%esp)
80104eb5:	e8 08 34 00 00       	call   801082c2 <switchuvm>
      p->state = RUNNING;
80104eba:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ebd:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
80104ec4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104eca:	8b 40 1c             	mov    0x1c(%eax),%eax
80104ecd:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104ed4:	83 c2 04             	add    $0x4,%edx
80104ed7:	89 44 24 04          	mov    %eax,0x4(%esp)
80104edb:	89 14 24             	mov    %edx,(%esp)
80104ede:	e8 21 09 00 00       	call   80105804 <swtch>
      switchkvm();
80104ee3:	e8 bd 33 00 00       	call   801082a5 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
80104ee8:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104eef:	00 00 00 00 
80104ef3:	eb 01                	jmp    80104ef6 <scheduler+0x7b>
...
80104ef5:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104ef6:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104efd:	81 7d f4 b4 5a 11 80 	cmpl   $0x80115ab4,-0xc(%ebp)
80104f04:	72 95                	jb     80104e9b <scheduler+0x20>
    ...
    release(&ptable.lock);
80104f06:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104f0d:	e8 5f 04 00 00       	call   80105371 <release>

  }
80104f12:	e9 6a ff ff ff       	jmp    80104e81 <scheduler+0x6>
...
80104f1d:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104f24:	e8 04 05 00 00       	call   8010542d <holding>
80104f29:	85 c0                	test   %eax,%eax
80104f2b:	75 0c                	jne    80104f39 <sched+0x22>
    panic("sched ptable.lock");
80104f2d:	c7 04 24 79 8d 10 80 	movl   $0x80108d79,(%esp)
80104f34:	e8 04 b6 ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
80104f39:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f3f:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104f45:	83 f8 01             	cmp    $0x1,%eax
80104f48:	74 0c                	je     80104f56 <sched+0x3f>
    panic("sched locks");
80104f4a:	c7 04 24 8b 8d 10 80 	movl   $0x80108d8b,(%esp)
80104f51:	e8 e7 b5 ff ff       	call   8010053d <panic>
  if(proc->state == RUNNING)
80104f56:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f5c:	8b 40 0c             	mov    0xc(%eax),%eax
80104f5f:	83 f8 04             	cmp    $0x4,%eax
80104f62:	75 0c                	jne    80104f70 <sched+0x59>
    panic("sched running");
80104f64:	c7 04 24 97 8d 10 80 	movl   $0x80108d97,(%esp)
80104f6b:	e8 cd b5 ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
80104f70:	e8 bb f3 ff ff       	call   80104330 <readeflags>
80104f75:	25 00 02 00 00       	and    $0x200,%eax
80104f7a:	85 c0                	test   %eax,%eax
80104f7c:	74 0c                	je     80104f8a <sched+0x73>
    panic("sched interruptible");
80104f7e:	c7 04 24 a5 8d 10 80 	movl   $0x80108da5,(%esp)
80104f85:	e8 b3 b5 ff ff       	call   8010053d <panic>
  intena = cpu->intena;
...
80104f99:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f9f:	8b 40 04             	mov    0x4(%eax),%eax
80104fa2:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104fa9:	83 c2 1c             	add    $0x1c,%edx
80104fac:	89 44 24 04          	mov    %eax,0x4(%esp)
80104fb0:	89 14 24             	mov    %edx,(%esp)
80104fb3:	e8 4c 08 00 00       	call   80105804 <swtch>
  cpu->intena = intena;
80104fb8:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104fbe:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104fc1:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104fc7:	c9                   	leave  
80104fc8:	c3                   	ret    
...
80104fd6:	e8 34 03 00 00       	call   8010530f <acquire>
  proc->state = RUNNABLE;
80104fdb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fe1:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104fe8:	e8 2a ff ff ff       	call   80104f17 <sched>
  release(&ptable.lock);
80104fed:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ff4:	e8 78 03 00 00       	call   80105371 <release>
}
80104ff9:	c9                   	leave  
80104ffa:	c3                   	ret    
...
80104ffe:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80105001:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105008:	e8 64 03 00 00       	call   80105371 <release>

  if (first) {
8010500d:	a1 20 c0 10 80       	mov    0x8010c020,%eax
80105012:	85 c0                	test   %eax,%eax
80105014:	74 0f                	je     80105025 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80105016:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
8010501d:	00 00 00 
    initlog();
80105020:	e8 2f e2 ff ff       	call   80103254 <initlog>
  }
...
80105035:	75 0c                	jne    80105043 <sleep+0x1c>
    panic("sleep");
80105037:	c7 04 24 b9 8d 10 80 	movl   $0x80108db9,(%esp)
8010503e:	e8 fa b4 ff ff       	call   8010053d <panic>

  if(lk == 0)
80105043:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105047:	75 0c                	jne    80105055 <sleep+0x2e>
    panic("sleep without lk");
80105049:	c7 04 24 bf 8d 10 80 	movl   $0x80108dbf,(%esp)
80105050:	e8 e8 b4 ff ff       	call   8010053d <panic>
...
80105055:	81 7d 0c 80 39 11 80 	cmpl   $0x80113980,0xc(%ebp)
8010505c:	74 17                	je     80105075 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
8010505e:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105065:	e8 a5 02 00 00       	call   8010530f <acquire>
    release(lk);
8010506a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010506d:	89 04 24             	mov    %eax,(%esp)
80105070:	e8 fc 02 00 00       	call   80105371 <release>
  }

  // Go to sleep.
  proc->chan = chan;
80105075:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010507b:	8b 55 08             	mov    0x8(%ebp),%edx
8010507e:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80105081:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105087:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
8010508e:	e8 84 fe ff ff       	call   80104f17 <sched>

  // Tidy up.
  proc->chan = 0;
80105093:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105099:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
801050a0:	81 7d 0c 80 39 11 80 	cmpl   $0x80113980,0xc(%ebp)
801050a7:	74 17                	je     801050c0 <sleep+0x99>
    release(&ptable.lock);
801050a9:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801050b0:	e8 bc 02 00 00       	call   80105371 <release>
    acquire(lk);
801050b5:	8b 45 0c             	mov    0xc(%ebp),%eax
801050b8:	89 04 24             	mov    %eax,(%esp)
801050bb:	e8 4f 02 00 00       	call   8010530f <acquire>
  }
}
801050c0:	c9                   	leave  
801050c1:	c3                   	ret    
...
801050c5:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801050c8:	c7 45 fc b4 39 11 80 	movl   $0x801139b4,-0x4(%ebp)
801050cf:	eb 27                	jmp    801050f8 <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
801050d1:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050d4:	8b 40 0c             	mov    0xc(%eax),%eax
801050d7:	83 f8 02             	cmp    $0x2,%eax
801050da:	75 15                	jne    801050f1 <wakeup1+0x2f>
801050dc:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050df:	8b 40 20             	mov    0x20(%eax),%eax
801050e2:	3b 45 08             	cmp    0x8(%ebp),%eax
801050e5:	75 0a                	jne    801050f1 <wakeup1+0x2f>
      p->state = RUNNABLE;
801050e7:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050ea:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801050f1:	81 45 fc 84 00 00 00 	addl   $0x84,-0x4(%ebp)
801050f8:	81 7d fc b4 5a 11 80 	cmpl   $0x80115ab4,-0x4(%ebp)
801050ff:	72 d0                	jb     801050d1 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80105101:	c9                   	leave  
...
80105110:	e8 fa 01 00 00       	call   8010530f <acquire>
  wakeup1(chan);
80105115:	8b 45 08             	mov    0x8(%ebp),%eax
80105118:	89 04 24             	mov    %eax,(%esp)
8010511b:	e8 a2 ff ff ff       	call   801050c2 <wakeup1>
  release(&ptable.lock);
80105120:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105127:	e8 45 02 00 00       	call   80105371 <release>
}
8010512c:	c9                   	leave  
8010512d:	c3                   	ret    
...
80105131:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80105134:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
8010513b:	e8 cf 01 00 00       	call   8010530f <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105140:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80105147:	eb 44                	jmp    8010518d <kill+0x5f>
    if(p->pid == pid){
80105149:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010514c:	8b 40 10             	mov    0x10(%eax),%eax
8010514f:	3b 45 08             	cmp    0x8(%ebp),%eax
80105152:	75 32                	jne    80105186 <kill+0x58>
      p->killed = 1;
80105154:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105157:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
8010515e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105161:	8b 40 0c             	mov    0xc(%eax),%eax
80105164:	83 f8 02             	cmp    $0x2,%eax
80105167:	75 0a                	jne    80105173 <kill+0x45>
        p->state = RUNNABLE;
80105169:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010516c:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80105173:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
8010517a:	e8 f2 01 00 00       	call   80105371 <release>
      return 0;
8010517f:	b8 00 00 00 00       	mov    $0x0,%eax
80105184:	eb 21                	jmp    801051a7 <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105186:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
8010518d:	81 7d f4 b4 5a 11 80 	cmpl   $0x80115ab4,-0xc(%ebp)
80105194:	72 b3                	jb     80105149 <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80105196:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
8010519d:	e8 cf 01 00 00       	call   80105371 <release>
  return -1;
...
801051ac:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801051af:	c7 45 f0 b4 39 11 80 	movl   $0x801139b4,-0x10(%ebp)
801051b6:	e9 db 00 00 00       	jmp    80105296 <procdump+0xed>
    if(p->state == UNUSED)
801051bb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801051be:	8b 40 0c             	mov    0xc(%eax),%eax
801051c1:	85 c0                	test   %eax,%eax
801051c3:	0f 84 c5 00 00 00    	je     8010528e <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801051c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801051cc:	8b 40 0c             	mov    0xc(%eax),%eax
801051cf:	83 f8 05             	cmp    $0x5,%eax
801051d2:	77 23                	ja     801051f7 <procdump+0x4e>
801051d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801051d7:	8b 40 0c             	mov    0xc(%eax),%eax
801051da:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
801051e1:	85 c0                	test   %eax,%eax
801051e3:	74 12                	je     801051f7 <procdump+0x4e>
      state = states[p->state];
801051e5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801051e8:	8b 40 0c             	mov    0xc(%eax),%eax
801051eb:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
801051f2:	89 45 ec             	mov    %eax,-0x14(%ebp)
801051f5:	eb 07                	jmp    801051fe <procdump+0x55>
    else
      state = "???";
801051f7:	c7 45 ec d0 8d 10 80 	movl   $0x80108dd0,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
801051fe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105201:	8d 50 6c             	lea    0x6c(%eax),%edx
80105204:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105207:	8b 40 10             	mov    0x10(%eax),%eax
8010520a:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010520e:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105211:	89 54 24 08          	mov    %edx,0x8(%esp)
80105215:	89 44 24 04          	mov    %eax,0x4(%esp)
80105219:	c7 04 24 d4 8d 10 80 	movl   $0x80108dd4,(%esp)
80105220:	e8 7c b1 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80105225:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105228:	8b 40 0c             	mov    0xc(%eax),%eax
8010522b:	83 f8 02             	cmp    $0x2,%eax
8010522e:	75 50                	jne    80105280 <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80105230:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105233:	8b 40 1c             	mov    0x1c(%eax),%eax
80105236:	8b 40 0c             	mov    0xc(%eax),%eax
80105239:	83 c0 08             	add    $0x8,%eax
8010523c:	8d 55 c4             	lea    -0x3c(%ebp),%edx
8010523f:	89 54 24 04          	mov    %edx,0x4(%esp)
80105243:	89 04 24             	mov    %eax,(%esp)
80105246:	e8 75 01 00 00       	call   801053c0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
8010524b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80105252:	eb 1b                	jmp    8010526f <procdump+0xc6>
        cprintf(" %p", pc[i]);
80105254:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105257:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
8010525b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010525f:	c7 04 24 dd 8d 10 80 	movl   $0x80108ddd,(%esp)
80105266:	e8 36 b1 ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
8010526b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010526f:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80105273:	7f 0b                	jg     80105280 <procdump+0xd7>
80105275:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105278:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
8010527c:	85 c0                	test   %eax,%eax
8010527e:	75 d4                	jne    80105254 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80105280:	c7 04 24 e1 8d 10 80 	movl   $0x80108de1,(%esp)
80105287:	e8 15 b1 ff ff       	call   801003a1 <cprintf>
8010528c:	eb 01                	jmp    8010528f <procdump+0xe6>
  char *state;
  uint pc[10];
...
8010528e:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010528f:	81 45 f0 84 00 00 00 	addl   $0x84,-0x10(%ebp)
80105296:	81 7d f0 b4 5a 11 80 	cmpl   $0x80115ab4,-0x10(%ebp)
8010529d:	0f 82 18 ff ff ff    	jb     801051bb <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
801052af:	9c                   	pushf  
801052b0:	5b                   	pop    %ebx
801052b1:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
801052e2:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
801052e5:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80105315:	e8 3d 01 00 00       	call   80105457 <pushcli>
  if(holding(lk))
8010531a:	8b 45 08             	mov    0x8(%ebp),%eax
8010531d:	89 04 24             	mov    %eax,(%esp)
80105320:	e8 08 01 00 00       	call   8010542d <holding>
80105325:	85 c0                	test   %eax,%eax
80105327:	74 0c                	je     80105335 <acquire+0x26>
    panic("acquire");
80105329:	c7 04 24 0d 8e 10 80 	movl   $0x80108e0d,(%esp)
...
80105344:	e8 80 ff ff ff       	call   801052c9 <xchg>
...
8010537d:	e8 ab 00 00 00       	call   8010542d <holding>
80105382:	85 c0                	test   %eax,%eax
80105384:	75 0c                	jne    80105392 <release+0x21>
    panic("release");
80105386:	c7 04 24 15 8e 10 80 	movl   $0x80108e15,(%esp)
8010538d:	e8 ab b1 ff ff       	call   8010053d <panic>
...
801053b4:	e8 10 ff ff ff       	call   801052c9 <xchg>

  popcli();
801053b9:	e8 e1 00 00 00       	call   8010549f <popcli>
}
801053be:	c9                   	leave  
801053bf:	c3                   	ret    
...
801053d6:	eb 32                	jmp    8010540a <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801053d8:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
801053dc:	74 47                	je     80105425 <getcallerpcs+0x65>
801053de:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
801053e5:	76 3e                	jbe    80105425 <getcallerpcs+0x65>
801053e7:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
801053eb:	74 38                	je     80105425 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
801053ed:	8b 45 f8             	mov    -0x8(%ebp),%eax
801053f0:	c1 e0 02             	shl    $0x2,%eax
801053f3:	03 45 0c             	add    0xc(%ebp),%eax
801053f6:	8b 55 fc             	mov    -0x4(%ebp),%edx
801053f9:	8b 52 04             	mov    0x4(%edx),%edx
801053fc:	89 10                	mov    %edx,(%eax)
...
8010540e:	7e c8                	jle    801053d8 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105410:	eb 13                	jmp    80105425 <getcallerpcs+0x65>
    pcs[i] = 0;
80105412:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105415:	c1 e0 02             	shl    $0x2,%eax
80105418:	03 45 0c             	add    0xc(%ebp),%eax
...
80105429:	7e e7                	jle    80105412 <getcallerpcs+0x52>
    pcs[i] = 0;
}
8010542b:	c9                   	leave  
8010542c:	c3                   	ret    
...
80105437:	74 17                	je     80105450 <holding+0x23>
80105439:	8b 45 08             	mov    0x8(%ebp),%eax
8010543c:	8b 50 08             	mov    0x8(%eax),%edx
8010543f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105445:	39 c2                	cmp    %eax,%edx
80105447:	75 07                	jne    80105450 <holding+0x23>
80105449:	b8 01 00 00 00       	mov    $0x1,%eax
8010544e:	eb 05                	jmp    80105455 <holding+0x28>
...
8010545a:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
8010545d:	e8 46 fe ff ff       	call   801052a8 <readeflags>
80105462:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105465:	e8 53 fe ff ff       	call   801052bd <cli>
  if(cpu->ncli++ == 0)
8010546a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105470:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80105476:	85 d2                	test   %edx,%edx
80105478:	0f 94 c1             	sete   %cl
8010547b:	83 c2 01             	add    $0x1,%edx
8010547e:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105484:	84 c9                	test   %cl,%cl
80105486:	74 15                	je     8010549d <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80105488:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010548e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105491:	81 e2 00 02 00 00    	and    $0x200,%edx
80105497:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
8010549d:	c9                   	leave  
8010549e:	c3                   	ret    
...
801054a2:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
801054a5:	e8 fe fd ff ff       	call   801052a8 <readeflags>
801054aa:	25 00 02 00 00       	and    $0x200,%eax
801054af:	85 c0                	test   %eax,%eax
801054b1:	74 0c                	je     801054bf <popcli+0x20>
    panic("popcli - interruptible");
801054b3:	c7 04 24 1d 8e 10 80 	movl   $0x80108e1d,(%esp)
801054ba:	e8 7e b0 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
801054bf:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801054c5:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801054cb:	83 ea 01             	sub    $0x1,%edx
801054ce:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801054d4:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801054da:	85 c0                	test   %eax,%eax
801054dc:	79 0c                	jns    801054ea <popcli+0x4b>
    panic("popcli");
801054de:	c7 04 24 34 8e 10 80 	movl   $0x80108e34,(%esp)
801054e5:	e8 53 b0 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
801054ea:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801054f0:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801054f6:	85 c0                	test   %eax,%eax
801054f8:	75 15                	jne    8010550f <popcli+0x70>
801054fa:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105500:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80105506:	85 c0                	test   %eax,%eax
80105508:	74 05                	je     8010550f <popcli+0x70>
    sti();
8010550a:	e8 b4 fd ff ff       	call   801052c3 <sti>
}
8010550f:	c9                   	leave  
80105510:	c3                   	ret    
80105511:	00 00                	add    %al,(%eax)
	...
...
8010558c:	c1 e1 18             	shl    $0x18,%ecx
...
801055e4:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801055e7:	eb 32                	jmp    8010561b <memcmp+0x46>
    if(*s1 != *s2)
...
801055f7:	74 1a                	je     80105613 <memcmp+0x3e>
      return *s1 - *s2;
...
8010560b:	89 d1                	mov    %edx,%ecx
8010560d:	29 c1                	sub    %eax,%ecx
8010560f:	89 c8                	mov    %ecx,%eax
80105611:	eb 1c                	jmp    8010562f <memcmp+0x5a>
    s1++, s2++;
80105613:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105617:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
  ...
  s2 = v2;
  while(n-- > 0){
8010561b:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010561f:	0f 95 c0             	setne  %al
80105622:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105626:	84 c0                	test   %al,%al
80105628:	75 bf                	jne    801055e9 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105649:	73 54                	jae    8010569f <memmove+0x6e>
8010564b:	8b 45 10             	mov    0x10(%ebp),%eax
8010564e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105651:	01 d0                	add    %edx,%eax
80105653:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105656:	76 47                	jbe    8010569f <memmove+0x6e>
    s += n;
80105658:	8b 45 10             	mov    0x10(%ebp),%eax
8010565b:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
8010565e:	8b 45 10             	mov    0x10(%ebp),%eax
80105661:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105664:	eb 13                	jmp    80105679 <memmove+0x48>
      *--d = *--s;
80105666:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
8010566a:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
...
8010567d:	0f 95 c0             	setne  %al
80105680:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105684:	84 c0                	test   %al,%al
80105686:	75 de                	jne    80105666 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105688:	eb 25                	jmp    801056af <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
8010568d:	0f b6 10             	movzbl (%eax),%edx
80105690:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105693:	88 10                	mov    %dl,(%eax)
80105695:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105699:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010569d:	eb 01                	jmp    801056a0 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
801056a4:	0f 95 c0             	setne  %al
801056a7:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801056ab:	84 c0                	test   %al,%al
801056ad:	75 db                	jne    8010568a <memmove+0x59>
      *d++ = *s++;
...
801056ce:	e8 5e ff ff ff       	call   80105631 <memmove>
}
801056d3:	c9                   	leave  
801056d4:	c3                   	ret    
...
80105711:	eb 18                	jmp    8010572b <strncmp+0x56>
...
80105725:	89 d1                	mov    %edx,%ecx
80105727:	29 c1                	sub    %eax,%ecx
80105729:	89 c8                	mov    %ecx,%eax
}
8010572b:	5d                   	pop    %ebp
8010572c:	c3                   	ret    
...
80105747:	74 30                	je     80105779 <strncpy+0x4c>
80105749:	8b 45 0c             	mov    0xc(%ebp),%eax
8010574c:	0f b6 10             	movzbl (%eax),%edx
8010574f:	8b 45 08             	mov    0x8(%ebp),%eax
80105752:	88 10                	mov    %dl,(%eax)
80105754:	8b 45 08             	mov    0x8(%ebp),%eax
80105757:	0f b6 00             	movzbl (%eax),%eax
8010575a:	84 c0                	test   %al,%al
8010575c:	0f 95 c0             	setne  %al
8010575f:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105763:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105767:	84 c0                	test   %al,%al
80105769:	75 cf                	jne    8010573a <strncpy+0xd>
    ;
  while(n-- > 0)
8010576b:	eb 0c                	jmp    80105779 <strncpy+0x4c>
    *s++ = 0;
8010576d:	8b 45 08             	mov    0x8(%ebp),%eax
80105770:	c6 00 00             	movb   $0x0,(%eax)
80105773:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105777:	eb 01                	jmp    8010577a <strncpy+0x4d>
  char *os;
...
8010577e:	0f 9f c0             	setg   %al
80105781:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105785:	84 c0                	test   %al,%al
80105787:	75 e4                	jne    8010576d <strncpy+0x40>
    *s++ = 0;
  return os;
...
80105797:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
8010579a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010579e:	7f 05                	jg     801057a5 <safestrcpy+0x17>
    return os;
801057a0:	8b 45 fc             	mov    -0x4(%ebp),%eax
801057a3:	eb 35                	jmp    801057da <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
801057a5:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801057a9:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801057ad:	7e 22                	jle    801057d1 <safestrcpy+0x43>
801057af:	8b 45 0c             	mov    0xc(%ebp),%eax
801057b2:	0f b6 10             	movzbl (%eax),%edx
801057b5:	8b 45 08             	mov    0x8(%ebp),%eax
801057b8:	88 10                	mov    %dl,(%eax)
801057ba:	8b 45 08             	mov    0x8(%ebp),%eax
801057bd:	0f b6 00             	movzbl (%eax),%eax
801057c0:	84 c0                	test   %al,%al
801057c2:	0f 95 c0             	setne  %al
801057c5:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801057c9:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
801057cd:	84 c0                	test   %al,%al
801057cf:	75 d4                	jne    801057a5 <safestrcpy+0x17>
    ;
  *s = 0;
801057d1:	8b 45 08             	mov    0x8(%ebp),%eax
801057d4:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
801057df:	83 ec 10             	sub    $0x10,%esp
  int n;

  for(n = 0; s[n]; n++)
801057e2:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801057e9:	eb 04                	jmp    801057ef <strlen+0x13>
801057eb:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801057ef:	8b 45 fc             	mov    -0x4(%ebp),%eax
801057f2:	03 45 08             	add    0x8(%ebp),%eax
801057f5:	0f b6 00             	movzbl (%eax),%eax
801057f8:	84 c0                	test   %al,%al
801057fa:	75 ef                	jne    801057eb <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
80105804:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105808:	8b 54 24 08          	mov    0x8(%esp),%edx
...
8010580f:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80105810:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105812:	89 d4                	mov    %edx,%esp
...
80105827:	3b 45 08             	cmp    0x8(%ebp),%eax
8010582a:	76 12                	jbe    8010583e <fetchint+0x22>
8010582c:	8b 45 08             	mov    0x8(%ebp),%eax
8010582f:	8d 50 04             	lea    0x4(%eax),%edx
80105832:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105838:	8b 00                	mov    (%eax),%eax
8010583a:	39 c2                	cmp    %eax,%edx
8010583c:	76 07                	jbe    80105845 <fetchint+0x29>
    return -1;
8010583e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105843:	eb 0f                	jmp    80105854 <fetchint+0x38>
  *ip = *(int*)(addr);
80105845:	8b 45 08             	mov    0x8(%ebp),%eax
80105848:	8b 10                	mov    (%eax),%edx
8010584a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010584d:	89 10                	mov    %edx,(%eax)
  return 0;
8010584f:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105854:	5d                   	pop    %ebp
80105855:	c3                   	ret    
...
80105864:	3b 45 08             	cmp    0x8(%ebp),%eax
80105867:	77 07                	ja     80105870 <fetchstr+0x1a>
    return -1;
80105869:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010586e:	eb 48                	jmp    801058b8 <fetchstr+0x62>
  *pp = (char*)addr;
80105870:	8b 55 08             	mov    0x8(%ebp),%edx
80105873:	8b 45 0c             	mov    0xc(%ebp),%eax
80105876:	89 10                	mov    %edx,(%eax)
  ep = (char*)proc->sz;
...
801058a5:	eb 11                	jmp    801058b8 <fetchstr+0x62>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
801058a7:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801058ab:	8b 45 fc             	mov    -0x4(%ebp),%eax
801058ae:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801058b1:	72 da                	jb     8010588d <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
801058c9:	8b 50 44             	mov    0x44(%eax),%edx
801058cc:	8b 45 08             	mov    0x8(%ebp),%eax
801058cf:	c1 e0 02             	shl    $0x2,%eax
801058d2:	01 d0                	add    %edx,%eax
801058d4:	8d 50 04             	lea    0x4(%eax),%edx
801058d7:	8b 45 0c             	mov    0xc(%ebp),%eax
801058da:	89 44 24 04          	mov    %eax,0x4(%esp)
801058de:	89 14 24             	mov    %edx,(%esp)
801058e1:	e8 36 ff ff ff       	call   8010581c <fetchint>
}
801058e6:	c9                   	leave  
801058e7:	c3                   	ret    
...
8010594d:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
80105950:	8d 45 fc             	lea    -0x4(%ebp),%eax
80105953:	89 44 24 04          	mov    %eax,0x4(%esp)
80105957:	8b 45 08             	mov    0x8(%ebp),%eax
8010595a:	89 04 24             	mov    %eax,(%esp)
8010595d:	e8 58 ff ff ff       	call   801058ba <argint>
80105962:	85 c0                	test   %eax,%eax
80105964:	79 07                	jns    8010596d <argstr+0x23>
    return -1;
80105966:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010596b:	eb 12                	jmp    8010597f <argstr+0x35>
  return fetchstr(addr, pp);
8010596d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105970:	8b 55 0c             	mov    0xc(%ebp),%edx
80105973:	89 54 24 04          	mov    %edx,0x4(%esp)
80105977:	89 04 24             	mov    %eax,(%esp)
8010597a:	e8 d7 fe ff ff       	call   80105856 <fetchstr>
}
8010597f:	c9                   	leave  
80105980:	c3                   	ret    
...
80105985:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105988:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010598e:	8b 40 18             	mov    0x18(%eax),%eax
80105991:	8b 40 1c             	mov    0x1c(%eax),%eax
80105994:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105997:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010599b:	7e 30                	jle    801059cd <syscall+0x4c>
8010599d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059a0:	83 f8 1b             	cmp    $0x1b,%eax
801059a3:	77 28                	ja     801059cd <syscall+0x4c>
801059a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059a8:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
801059af:	85 c0                	test   %eax,%eax
801059b1:	74 1a                	je     801059cd <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
801059b3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059b9:	8b 58 18             	mov    0x18(%eax),%ebx
801059bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059bf:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
801059c6:	ff d0                	call   *%eax
801059c8:	89 43 1c             	mov    %eax,0x1c(%ebx)
801059cb:	eb 3d                	jmp    80105a0a <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801059cd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059d3:	8d 48 6c             	lea    0x6c(%eax),%ecx
...
801059e2:	89 54 24 0c          	mov    %edx,0xc(%esp)
801059e6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801059ea:	89 44 24 04          	mov    %eax,0x4(%esp)
801059ee:	c7 04 24 3b 8e 10 80 	movl   $0x80108e3b,(%esp)
801059f5:	e8 a7 a9 ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
801059fa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a00:	8b 40 18             	mov    0x18(%eax),%eax
80105a03:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105a0a:	83 c4 24             	add    $0x24,%esp
80105a0d:	5b                   	pop    %ebx
80105a0e:	5d                   	pop    %ebp
80105a0f:	c3                   	ret    
...
80105a23:	e8 92 fe ff ff       	call   801058ba <argint>
...
80105b1e:	e8 65 b4 ff ff       	call   80100f88 <filedup>
  return fd;
...
80105b5b:	e8 5a fd ff ff       	call   801058ba <argint>
...
80105b79:	e8 6a fd ff ff       	call   801058e8 <argptr>
...
80105b9d:	e8 53 b5 ff ff       	call   801010f5 <fileread>
}
80105ba2:	c9                   	leave  
80105ba3:	c3                   	ret    
...
80105bd7:	e8 de fc ff ff       	call   801058ba <argint>
...
80105bf5:	e8 ee fc ff ff       	call   801058e8 <argptr>
...
80105c19:	e8 93 b5 ff ff       	call   801011b1 <filewrite>
}
80105c1e:	c9                   	leave  
80105c1f:	c3                   	ret    
...
80105c65:	e8 66 b3 ff ff       	call   80100fd0 <fileclose>
  return 0;
...
80105cac:	e8 37 fc ff ff       	call   801058e8 <argptr>
...
80105cc9:	e8 d8 b3 ff ff       	call   801010a6 <filestat>
}
80105cce:	c9                   	leave  
80105ccf:	c3                   	ret    
...
80105ce4:	e8 61 fc ff ff       	call   8010594a <argstr>
...
80105d7f:	e8 34 b9 ff ff       	call   801016b8 <iupdate>
  iunlock(ip);
80105d84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d87:	89 04 24             	mov    %eax,(%esp)
80105d8a:	e8 33 bc ff ff       	call   801019c2 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105d8f:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105d92:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105d95:	89 54 24 04          	mov    %edx,0x4(%esp)
80105d99:	89 04 24             	mov    %eax,(%esp)
80105d9c:	e8 97 c6 ff ff       	call   80102438 <nameiparent>
80105da1:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105da4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105da8:	74 68                	je     80105e12 <sys_link+0x142>
    goto bad;
  ilock(dp);
80105daa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dad:	89 04 24             	mov    %eax,(%esp)
80105db0:	e8 bf ba ff ff       	call   80101874 <ilock>
...
80105dc1:	75 20                	jne    80105de3 <sys_link+0x113>
...
80105dd0:	89 44 24 04          	mov    %eax,0x4(%esp)
80105dd4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dd7:	89 04 24             	mov    %eax,(%esp)
80105dda:	e8 76 c3 ff ff       	call   80102155 <dirlink>
80105ddf:	85 c0                	test   %eax,%eax
80105de1:	79 0d                	jns    80105df0 <sys_link+0x120>
    iunlockput(dp);
80105de3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105de6:	89 04 24             	mov    %eax,(%esp)
80105de9:	e8 0a bd ff ff       	call   80101af8 <iunlockput>
    goto bad;
80105dee:	eb 23                	jmp    80105e13 <sys_link+0x143>
  }
  iunlockput(dp);
80105df0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105df3:	89 04 24             	mov    %eax,(%esp)
80105df6:	e8 fd bc ff ff       	call   80101af8 <iunlockput>
  iput(ip);
80105dfb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dfe:	89 04 24             	mov    %eax,(%esp)
80105e01:	e8 21 bc ff ff       	call   80101a27 <iput>

  end_op();
80105e06:	e8 d7 d6 ff ff       	call   801034e2 <end_op>

  return 0;
80105e0b:	b8 00 00 00 00       	mov    $0x0,%eax
80105e10:	eb 3d                	jmp    80105e4f <sys_link+0x17f>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
80105e21:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105e25:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105e57:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105e5e:	eb 4b                	jmp    80105eab <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105e60:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e63:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105e6a:	00 
80105e6b:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e6f:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105e72:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e76:	8b 45 08             	mov    0x8(%ebp),%eax
80105e79:	89 04 24             	mov    %eax,(%esp)
80105e7c:	e8 e9 be ff ff       	call   80101d6a <readi>
80105e81:	83 f8 10             	cmp    $0x10,%eax
80105e84:	74 0c                	je     80105e92 <isdirempty+0x41>
      panic("isdirempty: readi");
80105e86:	c7 04 24 57 8e 10 80 	movl   $0x80108e57,(%esp)
80105e8d:	e8 ab a6 ff ff       	call   8010053d <panic>
    if(de.inum != 0)
80105e92:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105e96:	66 85 c0             	test   %ax,%ax
80105e99:	74 07                	je     80105ea2 <isdirempty+0x51>
      return 0;
80105e9b:	b8 00 00 00 00       	mov    $0x0,%eax
80105ea0:	eb 1b                	jmp    80105ebd <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105eab:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105eae:	8b 45 08             	mov    0x8(%ebp),%eax
80105eb1:	8b 40 18             	mov    0x18(%eax),%eax
80105eb4:	39 c2                	cmp    %eax,%edx
80105eb6:	72 a8                	jb     80105e60 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
80105ec2:	83 ec 48             	sub    $0x48,%esp
  ...
  if(argstr(0, &path) < 0)
80105ec5:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105ec8:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ecc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ed3:	e8 72 fa ff ff       	call   8010594a <argstr>
80105ed8:	85 c0                	test   %eax,%eax
80105eda:	79 0a                	jns    80105ee6 <sys_unlink+0x27>
    return -1;
80105edc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ee1:	e9 af 01 00 00       	jmp    80106095 <sys_unlink+0x1d6>

  begin_op();
80105ee6:	e8 76 d5 ff ff       	call   80103461 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105eeb:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105eee:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105ef1:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ef5:	89 04 24             	mov    %eax,(%esp)
80105ef8:	e8 3b c5 ff ff       	call   80102438 <nameiparent>
80105efd:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f00:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f04:	75 0f                	jne    80105f15 <sys_unlink+0x56>
    end_op();
80105f06:	e8 d7 d5 ff ff       	call   801034e2 <end_op>
    return -1;
80105f0b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f10:	e9 80 01 00 00       	jmp    80106095 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105f15:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f18:	89 04 24             	mov    %eax,(%esp)
80105f1b:	e8 54 b9 ff ff       	call   80101874 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105f20:	c7 44 24 04 69 8e 10 	movl   $0x80108e69,0x4(%esp)
80105f27:	80 
80105f28:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105f2b:	89 04 24             	mov    %eax,(%esp)
80105f2e:	e8 38 c1 ff ff       	call   8010206b <namecmp>
80105f33:	85 c0                	test   %eax,%eax
80105f35:	0f 84 45 01 00 00    	je     80106080 <sys_unlink+0x1c1>
80105f3b:	c7 44 24 04 6b 8e 10 	movl   $0x80108e6b,0x4(%esp)
80105f42:	80 
80105f43:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105f46:	89 04 24             	mov    %eax,(%esp)
80105f49:	e8 1d c1 ff ff       	call   8010206b <namecmp>
80105f4e:	85 c0                	test   %eax,%eax
80105f50:	0f 84 2a 01 00 00    	je     80106080 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105f56:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105f59:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f5d:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105f60:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f67:	89 04 24             	mov    %eax,(%esp)
80105f6a:	e8 1e c1 ff ff       	call   8010208d <dirlookup>
80105f6f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f72:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f76:	0f 84 03 01 00 00    	je     8010607f <sys_unlink+0x1c0>
    goto bad;
  ilock(ip);
80105f7c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f7f:	89 04 24             	mov    %eax,(%esp)
80105f82:	e8 ed b8 ff ff       	call   80101874 <ilock>

  if(ip->nlink < 1)
80105f87:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f8a:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f8e:	66 85 c0             	test   %ax,%ax
80105f91:	7f 0c                	jg     80105f9f <sys_unlink+0xe0>
    panic("unlink: nlink < 1");
80105f93:	c7 04 24 6e 8e 10 80 	movl   $0x80108e6e,(%esp)
80105f9a:	e8 9e a5 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105f9f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fa2:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105fa6:	66 83 f8 01          	cmp    $0x1,%ax
80105faa:	75 1f                	jne    80105fcb <sys_unlink+0x10c>
80105fac:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105faf:	89 04 24             	mov    %eax,(%esp)
80105fb2:	e8 9a fe ff ff       	call   80105e51 <isdirempty>
80105fb7:	85 c0                	test   %eax,%eax
80105fb9:	75 10                	jne    80105fcb <sys_unlink+0x10c>
    iunlockput(ip);
80105fbb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fbe:	89 04 24             	mov    %eax,(%esp)
80105fc1:	e8 32 bb ff ff       	call   80101af8 <iunlockput>
    goto bad;
80105fc6:	e9 b5 00 00 00       	jmp    80106080 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105fcb:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105fd2:	00 
80105fd3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105fda:	00 
80105fdb:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105fde:	89 04 24             	mov    %eax,(%esp)
80105fe1:	e8 78 f5 ff ff       	call   8010555e <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105fe6:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105fe9:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105ff0:	00 
80105ff1:	89 44 24 08          	mov    %eax,0x8(%esp)
80105ff5:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105ff8:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ffc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fff:	89 04 24             	mov    %eax,(%esp)
80106002:	e8 ce be ff ff       	call   80101ed5 <writei>
80106007:	83 f8 10             	cmp    $0x10,%eax
8010600a:	74 0c                	je     80106018 <sys_unlink+0x159>
    panic("unlink: writei");
8010600c:	c7 04 24 80 8e 10 80 	movl   $0x80108e80,(%esp)
80106013:	e8 25 a5 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80106018:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010601b:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010601f:	66 83 f8 01          	cmp    $0x1,%ax
80106023:	75 1c                	jne    80106041 <sys_unlink+0x182>
    dp->nlink--;
80106025:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106028:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010602c:	8d 50 ff             	lea    -0x1(%eax),%edx
8010602f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106032:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106036:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106039:	89 04 24             	mov    %eax,(%esp)
8010603c:	e8 77 b6 ff ff       	call   801016b8 <iupdate>
  }
  iunlockput(dp);
80106041:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106044:	89 04 24             	mov    %eax,(%esp)
80106047:	e8 ac ba ff ff       	call   80101af8 <iunlockput>

  ip->nlink--;
8010604c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010604f:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106053:	8d 50 ff             	lea    -0x1(%eax),%edx
80106056:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106059:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
8010605d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106060:	89 04 24             	mov    %eax,(%esp)
80106063:	e8 50 b6 ff ff       	call   801016b8 <iupdate>
  iunlockput(ip);
80106068:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010606b:	89 04 24             	mov    %eax,(%esp)
8010606e:	e8 85 ba ff ff       	call   80101af8 <iunlockput>
...
8010607d:	eb 16                	jmp    80106095 <sys_unlink+0x1d6>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
8010609a:	83 ec 48             	sub    $0x48,%esp
8010609d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801060a0:	8b 55 10             	mov    0x10(%ebp),%edx
801060a3:	8b 45 14             	mov    0x14(%ebp),%eax
801060a6:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
801060aa:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
801060ae:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
801060bf:	e8 74 c3 ff ff       	call   80102438 <nameiparent>
801060c4:	89 45 f4             	mov    %eax,-0xc(%ebp)
801060c7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801060cb:	75 0a                	jne    801060d7 <create+0x40>
    return 0;
801060cd:	b8 00 00 00 00       	mov    $0x0,%eax
801060d2:	e9 7e 01 00 00       	jmp    80106255 <create+0x1be>
  ilock(dp);
801060d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060da:	89 04 24             	mov    %eax,(%esp)
801060dd:	e8 92 b7 ff ff       	call   80101874 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801060e2:	8d 45 ec             	lea    -0x14(%ebp),%eax
801060e5:	89 44 24 08          	mov    %eax,0x8(%esp)
801060e9:	8d 45 de             	lea    -0x22(%ebp),%eax
801060ec:	89 44 24 04          	mov    %eax,0x4(%esp)
801060f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060f3:	89 04 24             	mov    %eax,(%esp)
801060f6:	e8 92 bf ff ff       	call   8010208d <dirlookup>
801060fb:	89 45 f0             	mov    %eax,-0x10(%ebp)
801060fe:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106102:	74 47                	je     8010614b <create+0xb4>
    iunlockput(dp);
80106104:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106107:	89 04 24             	mov    %eax,(%esp)
8010610a:	e8 e9 b9 ff ff       	call   80101af8 <iunlockput>
    ilock(ip);
8010610f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106112:	89 04 24             	mov    %eax,(%esp)
80106115:	e8 5a b7 ff ff       	call   80101874 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010611a:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
8010611f:	75 15                	jne    80106136 <create+0x9f>
80106121:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106124:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106128:	66 83 f8 02          	cmp    $0x2,%ax
8010612c:	75 08                	jne    80106136 <create+0x9f>
      return ip;
8010612e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106131:	e9 1f 01 00 00       	jmp    80106255 <create+0x1be>
    iunlockput(ip);
80106136:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106139:	89 04 24             	mov    %eax,(%esp)
8010613c:	e8 b7 b9 ff ff       	call   80101af8 <iunlockput>
    return 0;
80106141:	b8 00 00 00 00       	mov    $0x0,%eax
80106146:	e9 0a 01 00 00       	jmp    80106255 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
8010614b:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
...
8010615b:	e8 7b b4 ff ff       	call   801015db <ialloc>
80106160:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106163:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106167:	75 0c                	jne    80106175 <create+0xde>
    panic("create: ialloc");
80106169:	c7 04 24 8f 8e 10 80 	movl   $0x80108e8f,(%esp)
80106170:	e8 c8 a3 ff ff       	call   8010053d <panic>

  ilock(ip);
80106175:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106178:	89 04 24             	mov    %eax,(%esp)
8010617b:	e8 f4 b6 ff ff       	call   80101874 <ilock>
  ip->major = major;
80106180:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106183:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80106187:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
8010618b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010618e:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80106192:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80106196:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106199:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
8010619f:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061a2:	89 04 24             	mov    %eax,(%esp)
801061a5:	e8 0e b5 ff ff       	call   801016b8 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
801061aa:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
801061af:	75 6a                	jne    8010621b <create+0x184>
    dp->nlink++;  // for ".."
801061b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061b4:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801061b8:	8d 50 01             	lea    0x1(%eax),%edx
...
801061c8:	e8 eb b4 ff ff       	call   801016b8 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801061cd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061d0:	8b 40 04             	mov    0x4(%eax),%eax
801061d3:	89 44 24 08          	mov    %eax,0x8(%esp)
801061d7:	c7 44 24 04 69 8e 10 	movl   $0x80108e69,0x4(%esp)
801061de:	80 
801061df:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061e2:	89 04 24             	mov    %eax,(%esp)
801061e5:	e8 6b bf ff ff       	call   80102155 <dirlink>
801061ea:	85 c0                	test   %eax,%eax
801061ec:	78 21                	js     8010620f <create+0x178>
801061ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061f1:	8b 40 04             	mov    0x4(%eax),%eax
801061f4:	89 44 24 08          	mov    %eax,0x8(%esp)
801061f8:	c7 44 24 04 6b 8e 10 	movl   $0x80108e6b,0x4(%esp)
801061ff:	80 
80106200:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106203:	89 04 24             	mov    %eax,(%esp)
80106206:	e8 4a bf ff ff       	call   80102155 <dirlink>
8010620b:	85 c0                	test   %eax,%eax
8010620d:	79 0c                	jns    8010621b <create+0x184>
      panic("create dots");
8010620f:	c7 04 24 9e 8e 10 80 	movl   $0x80108e9e,(%esp)
80106216:	e8 22 a3 ff ff       	call   8010053d <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
8010621b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010621e:	8b 40 04             	mov    0x4(%eax),%eax
80106221:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80106232:	e8 1e bf ff ff       	call   80102155 <dirlink>
80106237:	85 c0                	test   %eax,%eax
80106239:	79 0c                	jns    80106247 <create+0x1b0>
    panic("create: dirlink");
8010623b:	c7 04 24 aa 8e 10 80 	movl   $0x80108eaa,(%esp)
80106242:	e8 f6 a2 ff ff       	call   8010053d <panic>

  iunlockput(dp);
80106247:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010624a:	89 04 24             	mov    %eax,(%esp)
8010624d:	e8 a6 b8 ff ff       	call   80101af8 <iunlockput>
...
8010625a:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
8010625d:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106260:	89 44 24 04          	mov    %eax,0x4(%esp)
80106264:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010626b:	e8 da f6 ff ff       	call   8010594a <argstr>
80106270:	85 c0                	test   %eax,%eax
80106272:	78 17                	js     8010628b <sys_open+0x34>
80106274:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106277:	89 44 24 04          	mov    %eax,0x4(%esp)
8010627b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106282:	e8 33 f6 ff ff       	call   801058ba <argint>
80106287:	85 c0                	test   %eax,%eax
80106289:	79 0a                	jns    80106295 <sys_open+0x3e>
    return -1;
8010628b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106290:	e9 5a 01 00 00       	jmp    801063ef <sys_open+0x198>

  begin_op();
80106295:	e8 c7 d1 ff ff       	call   80103461 <begin_op>

  if(omode & O_CREATE){
8010629a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010629d:	25 00 02 00 00       	and    $0x200,%eax
801062a2:	85 c0                	test   %eax,%eax
801062a4:	74 3b                	je     801062e1 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
801062a6:	8b 45 e8             	mov    -0x18(%ebp),%eax
801062a9:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801062b0:	00 
801062b1:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801062b8:	00 
801062b9:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
801062c0:	00 
801062c1:	89 04 24             	mov    %eax,(%esp)
801062c4:	e8 ce fd ff ff       	call   80106097 <create>
801062c9:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
801062cc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062d0:	75 6b                	jne    8010633d <sys_open+0xe6>
      end_op();
801062d2:	e8 0b d2 ff ff       	call   801034e2 <end_op>
      return -1;
801062d7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062dc:	e9 0e 01 00 00       	jmp    801063ef <sys_open+0x198>
    }
  } else {
    if((ip = namei(path)) == 0){
801062e1:	8b 45 e8             	mov    -0x18(%ebp),%eax
801062e4:	89 04 24             	mov    %eax,(%esp)
801062e7:	e8 2a c1 ff ff       	call   80102416 <namei>
801062ec:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062ef:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062f3:	75 0f                	jne    80106304 <sys_open+0xad>
      end_op();
801062f5:	e8 e8 d1 ff ff       	call   801034e2 <end_op>
      return -1;
801062fa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062ff:	e9 eb 00 00 00       	jmp    801063ef <sys_open+0x198>
    }
    ilock(ip);
80106304:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106307:	89 04 24             	mov    %eax,(%esp)
8010630a:	e8 65 b5 ff ff       	call   80101874 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010630f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106312:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106316:	66 83 f8 01          	cmp    $0x1,%ax
8010631a:	75 21                	jne    8010633d <sys_open+0xe6>
8010631c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010631f:	85 c0                	test   %eax,%eax
80106321:	74 1a                	je     8010633d <sys_open+0xe6>
      iunlockput(ip);
80106323:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106326:	89 04 24             	mov    %eax,(%esp)
80106329:	e8 ca b7 ff ff       	call   80101af8 <iunlockput>
      end_op();
8010632e:	e8 af d1 ff ff       	call   801034e2 <end_op>
      return -1;
80106333:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106338:	e9 b2 00 00 00       	jmp    801063ef <sys_open+0x198>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
8010633d:	e8 e6 ab ff ff       	call   80100f28 <filealloc>
80106342:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106345:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106349:	74 14                	je     8010635f <sys_open+0x108>
8010634b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010634e:	89 04 24             	mov    %eax,(%esp)
80106351:	e8 2f f7 ff ff       	call   80105a85 <fdalloc>
80106356:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106359:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010635d:	79 28                	jns    80106387 <sys_open+0x130>
    if(f)
8010635f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106363:	74 0b                	je     80106370 <sys_open+0x119>
      fileclose(f);
80106365:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106368:	89 04 24             	mov    %eax,(%esp)
8010636b:	e8 60 ac ff ff       	call   80100fd0 <fileclose>
    iunlockput(ip);
80106370:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106373:	89 04 24             	mov    %eax,(%esp)
80106376:	e8 7d b7 ff ff       	call   80101af8 <iunlockput>
    end_op();
8010637b:	e8 62 d1 ff ff       	call   801034e2 <end_op>
    return -1;
80106380:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106385:	eb 68                	jmp    801063ef <sys_open+0x198>
  }
  iunlock(ip);
80106387:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010638a:	89 04 24             	mov    %eax,(%esp)
8010638d:	e8 30 b6 ff ff       	call   801019c2 <iunlock>
  end_op();
80106392:	e8 4b d1 ff ff       	call   801034e2 <end_op>
...
801063bb:	0f 94 c2             	sete   %dl
801063be:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063c1:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801063c4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801063c7:	83 e0 01             	and    $0x1,%eax
801063ca:	84 c0                	test   %al,%al
801063cc:	75 0a                	jne    801063d8 <sys_open+0x181>
801063ce:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801063d1:	83 e0 02             	and    $0x2,%eax
801063d4:	85 c0                	test   %eax,%eax
801063d6:	74 07                	je     801063df <sys_open+0x188>
801063d8:	b8 01 00 00 00       	mov    $0x1,%eax
801063dd:	eb 05                	jmp    801063e4 <sys_open+0x18d>
801063df:	b8 00 00 00 00       	mov    $0x0,%eax
801063e4:	89 c2                	mov    %eax,%edx
801063e6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063e9:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
801063f4:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801063f7:	e8 65 d0 ff ff       	call   80103461 <begin_op>
...
8010640a:	e8 3b f5 ff ff       	call   8010594a <argstr>
8010640f:	85 c0                	test   %eax,%eax
80106411:	78 2c                	js     8010643f <sys_mkdir+0x4e>
...
80106425:	00 
80106426:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010642d:	00 
8010642e:	89 04 24             	mov    %eax,(%esp)
80106431:	e8 61 fc ff ff       	call   80106097 <create>
80106436:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106439:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010643d:	75 0c                	jne    8010644b <sys_mkdir+0x5a>
    end_op();
8010643f:	e8 9e d0 ff ff       	call   801034e2 <end_op>
    return -1;
80106444:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106449:	eb 15                	jmp    80106460 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
8010644b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010644e:	89 04 24             	mov    %eax,(%esp)
80106451:	e8 a2 b6 ff ff       	call   80101af8 <iunlockput>
  end_op();
80106456:	e8 87 d0 ff ff       	call   801034e2 <end_op>
  return 0;
...
80106465:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_op();
80106468:	e8 f4 cf ff ff       	call   80103461 <begin_op>
  if((len=argstr(0, &path)) < 0 ||
8010646d:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106470:	89 44 24 04          	mov    %eax,0x4(%esp)
80106474:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010647b:	e8 ca f4 ff ff       	call   8010594a <argstr>
80106480:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106483:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106487:	78 5e                	js     801064e7 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80106489:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010648c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106490:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106497:	e8 1e f4 ff ff       	call   801058ba <argint>
  char *path;
  int len;
  int major, minor;
...
8010649e:	78 47                	js     801064e7 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801064a0:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801064a3:	89 44 24 04          	mov    %eax,0x4(%esp)
801064a7:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801064ae:	e8 07 f4 ff ff       	call   801058ba <argint>
  int len;
  int major, minor;
...
801064b5:	78 30                	js     801064e7 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
...
801064c3:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801064c6:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801064ca:	89 54 24 08          	mov    %edx,0x8(%esp)
801064ce:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801064d5:	00 
801064d6:	89 04 24             	mov    %eax,(%esp)
801064d9:	e8 b9 fb ff ff       	call   80106097 <create>
801064de:	89 45 f0             	mov    %eax,-0x10(%ebp)
801064e1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801064e5:	75 0c                	jne    801064f3 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
801064e7:	e8 f6 cf ff ff       	call   801034e2 <end_op>
    return -1;
801064ec:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064f1:	eb 15                	jmp    80106508 <sys_mknod+0xa6>
  }
  iunlockput(ip);
801064f3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064f6:	89 04 24             	mov    %eax,(%esp)
801064f9:	e8 fa b5 ff ff       	call   80101af8 <iunlockput>
  end_op();
801064fe:	e8 df cf ff ff       	call   801034e2 <end_op>
  return 0;
...
8010650d:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106510:	e8 4c cf ff ff       	call   80103461 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80106515:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106518:	89 44 24 04          	mov    %eax,0x4(%esp)
8010651c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106523:	e8 22 f4 ff ff       	call   8010594a <argstr>
80106528:	85 c0                	test   %eax,%eax
8010652a:	78 14                	js     80106540 <sys_chdir+0x36>
8010652c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010652f:	89 04 24             	mov    %eax,(%esp)
80106532:	e8 df be ff ff       	call   80102416 <namei>
80106537:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010653a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010653e:	75 0c                	jne    8010654c <sys_chdir+0x42>
    end_op();
80106540:	e8 9d cf ff ff       	call   801034e2 <end_op>
    return -1;
80106545:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010654a:	eb 61                	jmp    801065ad <sys_chdir+0xa3>
  }
  ilock(ip);
8010654c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010654f:	89 04 24             	mov    %eax,(%esp)
80106552:	e8 1d b3 ff ff       	call   80101874 <ilock>
  if(ip->type != T_DIR){
80106557:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010655a:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010655e:	66 83 f8 01          	cmp    $0x1,%ax
80106562:	74 17                	je     8010657b <sys_chdir+0x71>
    iunlockput(ip);
80106564:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106567:	89 04 24             	mov    %eax,(%esp)
8010656a:	e8 89 b5 ff ff       	call   80101af8 <iunlockput>
    end_op();
8010656f:	e8 6e cf ff ff       	call   801034e2 <end_op>
    return -1;
80106574:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106579:	eb 32                	jmp    801065ad <sys_chdir+0xa3>
  }
  iunlock(ip);
8010657b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010657e:	89 04 24             	mov    %eax,(%esp)
80106581:	e8 3c b4 ff ff       	call   801019c2 <iunlock>
  iput(proc->cwd);
80106586:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010658c:	8b 40 68             	mov    0x68(%eax),%eax
8010658f:	89 04 24             	mov    %eax,(%esp)
80106592:	e8 90 b4 ff ff       	call   80101a27 <iput>
  end_op();
80106597:	e8 46 cf ff ff       	call   801034e2 <end_op>
  proc->cwd = ip;
...
801065b2:	81 ec a8 00 00 00    	sub    $0xa8,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
801065b8:	8d 45 f0             	lea    -0x10(%ebp),%eax
801065bb:	89 44 24 04          	mov    %eax,0x4(%esp)
801065bf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801065c6:	e8 7f f3 ff ff       	call   8010594a <argstr>
801065cb:	85 c0                	test   %eax,%eax
801065cd:	78 1a                	js     801065e9 <sys_exec+0x3a>
801065cf:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
801065d5:	89 44 24 04          	mov    %eax,0x4(%esp)
801065d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801065e0:	e8 d5 f2 ff ff       	call   801058ba <argint>
801065e5:	85 c0                	test   %eax,%eax
801065e7:	79 0a                	jns    801065f3 <sys_exec+0x44>
    return -1;
801065e9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065ee:	e9 cc 00 00 00       	jmp    801066bf <sys_exec+0x110>
  }
  memset(argv, 0, sizeof(argv));
801065f3:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801065fa:	00 
801065fb:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106602:	00 
80106603:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106609:	89 04 24             	mov    %eax,(%esp)
8010660c:	e8 4d ef ff ff       	call   8010555e <memset>
  for(i=0;; i++){
80106611:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80106618:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010661b:	83 f8 1f             	cmp    $0x1f,%eax
8010661e:	76 0a                	jbe    8010662a <sys_exec+0x7b>
      return -1;
80106620:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106625:	e9 95 00 00 00       	jmp    801066bf <sys_exec+0x110>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
8010662a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010662d:	c1 e0 02             	shl    $0x2,%eax
80106630:	89 c2                	mov    %eax,%edx
80106632:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106638:	01 c2                	add    %eax,%edx
8010663a:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106640:	89 44 24 04          	mov    %eax,0x4(%esp)
80106644:	89 14 24             	mov    %edx,(%esp)
80106647:	e8 d0 f1 ff ff       	call   8010581c <fetchint>
8010664c:	85 c0                	test   %eax,%eax
8010664e:	79 07                	jns    80106657 <sys_exec+0xa8>
      return -1;
80106650:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106655:	eb 68                	jmp    801066bf <sys_exec+0x110>
    if(uarg == 0){
80106657:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010665d:	85 c0                	test   %eax,%eax
8010665f:	75 26                	jne    80106687 <sys_exec+0xd8>
      argv[i] = 0;
80106661:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106664:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
8010666b:	00 00 00 00 
      break;
8010666f:	90                   	nop
    }
...
80106673:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106679:	89 54 24 04          	mov    %edx,0x4(%esp)
8010667d:	89 04 24             	mov    %eax,(%esp)
80106680:	e8 77 a4 ff ff       	call   80100afc <exec>
80106685:	eb 38                	jmp    801066bf <sys_exec+0x110>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
8010668a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80106691:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106697:	01 c2                	add    %eax,%edx
80106699:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010669f:	89 54 24 04          	mov    %edx,0x4(%esp)
801066a3:	89 04 24             	mov    %eax,(%esp)
801066a6:	e8 ab f1 ff ff       	call   80105856 <fetchstr>
801066ab:	85 c0                	test   %eax,%eax
801066ad:	79 07                	jns    801066b6 <sys_exec+0x107>
      return -1;
801066af:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066b4:	eb 09                	jmp    801066bf <sys_exec+0x110>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
801066b6:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
801066ba:	e9 59 ff ff ff       	jmp    80106618 <sys_exec+0x69>
  return exec(path, argv);
}
801066bf:	c9                   	leave  
801066c0:	c3                   	ret    
...
801066c4:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801066c7:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801066ce:	00 
801066cf:	8d 45 ec             	lea    -0x14(%ebp),%eax
801066d2:	89 44 24 04          	mov    %eax,0x4(%esp)
801066d6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801066dd:	e8 06 f2 ff ff       	call   801058e8 <argptr>
801066e2:	85 c0                	test   %eax,%eax
801066e4:	79 0a                	jns    801066f0 <sys_pipe+0x2f>
    return -1;
801066e6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066eb:	e9 9b 00 00 00       	jmp    8010678b <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
801066f0:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801066f3:	89 44 24 04          	mov    %eax,0x4(%esp)
801066f7:	8d 45 e8             	lea    -0x18(%ebp),%eax
801066fa:	89 04 24             	mov    %eax,(%esp)
801066fd:	e8 76 d8 ff ff       	call   80103f78 <pipealloc>
80106702:	85 c0                	test   %eax,%eax
80106704:	79 07                	jns    8010670d <sys_pipe+0x4c>
    return -1;
80106706:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010670b:	eb 7e                	jmp    8010678b <sys_pipe+0xca>
  fd0 = -1;
8010670d:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106714:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106717:	89 04 24             	mov    %eax,(%esp)
8010671a:	e8 66 f3 ff ff       	call   80105a85 <fdalloc>
8010671f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106722:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106726:	78 14                	js     8010673c <sys_pipe+0x7b>
80106728:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010672b:	89 04 24             	mov    %eax,(%esp)
8010672e:	e8 52 f3 ff ff       	call   80105a85 <fdalloc>
80106733:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106736:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010673a:	79 37                	jns    80106773 <sys_pipe+0xb2>
    if(fd0 >= 0)
8010673c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106740:	78 14                	js     80106756 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106742:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106748:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010674b:	83 c2 08             	add    $0x8,%edx
8010674e:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106755:	00 
    fileclose(rf);
80106756:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106759:	89 04 24             	mov    %eax,(%esp)
8010675c:	e8 6f a8 ff ff       	call   80100fd0 <fileclose>
    fileclose(wf);
80106761:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106764:	89 04 24             	mov    %eax,(%esp)
80106767:	e8 64 a8 ff ff       	call   80100fd0 <fileclose>
    return -1;
8010676c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106771:	eb 18                	jmp    8010678b <sys_pipe+0xca>
  }
  fd[0] = fd0;
...
8010677e:	8d 50 04             	lea    0x4(%eax),%edx
...
801067a0:	66 89 45 f8          	mov    %ax,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801067a4:	0f b7 45 f8          	movzwl -0x8(%ebp),%eax
801067a8:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
801067ac:	66 ef                	out    %ax,(%dx)
}
801067ae:	c9                   	leave  
801067af:	c3                   	ret    
...
801067b3:	83 ec 08             	sub    $0x8,%esp
  return fork();
801067b6:	e8 73 de ff ff       	call   8010462e <fork>
}
801067bb:	c9                   	leave  
801067bc:	c3                   	ret    
...
801067c0:	83 ec 08             	sub    $0x8,%esp
  exit();
801067c3:	e8 a5 e1 ff ff       	call   8010496d <exit>
...
801067d2:	83 ec 08             	sub    $0x8,%esp
  return wait();
801067d5:	e8 37 e4 ff ff       	call   80104c11 <wait>
}
801067da:	c9                   	leave  
801067db:	c3                   	ret    
...
801067df:	83 ec 28             	sub    $0x28,%esp
  int pid;

  if(argint(0, &pid) < 0)
801067e2:	8d 45 f4             	lea    -0xc(%ebp),%eax
801067e5:	89 44 24 04          	mov    %eax,0x4(%esp)
801067e9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801067f0:	e8 c5 f0 ff ff       	call   801058ba <argint>
801067f5:	85 c0                	test   %eax,%eax
801067f7:	79 07                	jns    80106800 <sys_kill+0x24>
    return -1;
801067f9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067fe:	eb 0b                	jmp    8010680b <sys_kill+0x2f>
  return kill(pid);
80106800:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106803:	89 04 24             	mov    %eax,(%esp)
80106806:	e8 23 e9 ff ff       	call   8010512e <kill>
}
8010680b:	c9                   	leave  
8010680c:	c3                   	ret    
...
8010681e:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;
...
8010682f:	e8 86 f0 ff ff       	call   801058ba <argint>
80106834:	85 c0                	test   %eax,%eax
80106836:	79 07                	jns    8010683f <sys_sbrk+0x24>
    return -1;
80106838:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010683d:	eb 24                	jmp    80106863 <sys_sbrk+0x48>
  addr = proc->sz;
8010683f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106845:	8b 00                	mov    (%eax),%eax
80106847:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
8010684a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010684d:	89 04 24             	mov    %eax,(%esp)
80106850:	e8 34 dd ff ff       	call   80104589 <growproc>
80106855:	85 c0                	test   %eax,%eax
80106857:	79 07                	jns    80106860 <sys_sbrk+0x45>
    return -1;
80106859:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010685e:	eb 03                	jmp    80106863 <sys_sbrk+0x48>
  return addr;
...
80106879:	e8 3c f0 ff ff       	call   801058ba <argint>
8010687e:	85 c0                	test   %eax,%eax
80106880:	79 07                	jns    80106889 <sys_sleep+0x24>
    return -1;
80106882:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106887:	eb 6c                	jmp    801068f5 <sys_sleep+0x90>
  acquire(&tickslock);
80106889:	c7 04 24 c0 5a 11 80 	movl   $0x80115ac0,(%esp)
80106890:	e8 7a ea ff ff       	call   8010530f <acquire>
  ticks0 = ticks;
80106895:	a1 00 63 11 80       	mov    0x80116300,%eax
8010689a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
8010689d:	eb 34                	jmp    801068d3 <sys_sleep+0x6e>
    if(proc->killed){
8010689f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068a5:	8b 40 24             	mov    0x24(%eax),%eax
801068a8:	85 c0                	test   %eax,%eax
801068aa:	74 13                	je     801068bf <sys_sleep+0x5a>
      release(&tickslock);
801068ac:	c7 04 24 c0 5a 11 80 	movl   $0x80115ac0,(%esp)
801068b3:	e8 b9 ea ff ff       	call   80105371 <release>
      return -1;
801068b8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068bd:	eb 36                	jmp    801068f5 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801068bf:	c7 44 24 04 c0 5a 11 	movl   $0x80115ac0,0x4(%esp)
801068c6:	80 
801068c7:	c7 04 24 00 63 11 80 	movl   $0x80116300,(%esp)
801068ce:	e8 54 e7 ff ff       	call   80105027 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801068d3:	a1 00 63 11 80       	mov    0x80116300,%eax
801068d8:	89 c2                	mov    %eax,%edx
801068da:	2b 55 f4             	sub    -0xc(%ebp),%edx
801068dd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068e0:	39 c2                	cmp    %eax,%edx
801068e2:	72 bb                	jb     8010689f <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
801068e4:	c7 04 24 c0 5a 11 80 	movl   $0x80115ac0,(%esp)
801068eb:	e8 81 ea ff ff       	call   80105371 <release>
  return 0;
...
801068fa:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801068fd:	c7 04 24 c0 5a 11 80 	movl   $0x80115ac0,(%esp)
80106904:	e8 06 ea ff ff       	call   8010530f <acquire>
  xticks = ticks;
80106909:	a1 00 63 11 80       	mov    0x80116300,%eax
8010690e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106911:	c7 04 24 c0 5a 11 80 	movl   $0x80115ac0,(%esp)
80106918:	e8 54 ea ff ff       	call   80105371 <release>
  return xticks;
...
80106925:	83 ec 18             	sub    $0x18,%esp
  char *p = "Shutdown";
80106928:	c7 45 fc ba 8e 10 80 	movl   $0x80108eba,-0x4(%ebp)
  for( ; *p; p++)
8010692f:	eb 18                	jmp    80106949 <sys_halt+0x27>
    outw(0xB004, 0x2000);
80106931:	c7 44 24 04 00 20 00 	movl   $0x2000,0x4(%esp)
80106938:	00 
80106939:	c7 04 24 04 b0 00 00 	movl   $0xb004,(%esp)
80106940:	e8 4b fe ff ff       	call   80106790 <outw>
// and: https://github.com/t3rm1n4l/pintos/blob/master/devices/shutdown.c
int
sys_halt(void)
{
  char *p = "Shutdown";
  for( ; *p; p++)
80106945:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80106949:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010694c:	0f b6 00             	movzbl (%eax),%eax
8010694f:	84 c0                	test   %al,%al
80106951:	75 de                	jne    80106931 <sys_halt+0xf>
    outw(0xB004, 0x2000);
  return 0;
...
8010696e:	e8 47 ef ff ff       	call   801058ba <argint>
80106973:	85 c0                	test   %eax,%eax
80106975:	78 2e                	js     801069a5 <sys_clone+0x4b>
80106977:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010697a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010697e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106985:	e8 30 ef ff ff       	call   801058ba <argint>
8010698a:	85 c0                	test   %eax,%eax
8010698c:	78 17                	js     801069a5 <sys_clone+0x4b>
8010698e:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106991:	89 44 24 04          	mov    %eax,0x4(%esp)
80106995:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010699c:	e8 19 ef ff ff       	call   801058ba <argint>
801069a1:	85 c0                	test   %eax,%eax
801069a3:	79 07                	jns    801069ac <sys_clone+0x52>
  return -1;
801069a5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069aa:	eb 1d                	jmp    801069c9 <sys_clone+0x6f>
}

return clone((void*)myFunction, (void*)myArgument, (void*)myStack);
801069ac:	8b 45 ec             	mov    -0x14(%ebp),%eax
801069af:	89 c1                	mov    %eax,%ecx
801069b1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801069b4:	89 c2                	mov    %eax,%edx
801069b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069b9:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801069bd:	89 54 24 04          	mov    %edx,0x4(%esp)
801069c1:	89 04 24             	mov    %eax,(%esp)
801069c4:	e8 ec dd ff ff       	call   801047b5 <clone>
...
801069d1:	8d 45 f4             	lea    -0xc(%ebp),%eax
801069d4:	89 44 24 04          	mov    %eax,0x4(%esp)
801069d8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069df:	e8 d6 ee ff ff       	call   801058ba <argint>
801069e4:	85 c0                	test   %eax,%eax
801069e6:	78 2e                	js     80106a16 <sys_join+0x4b>
801069e8:	8d 45 f0             	lea    -0x10(%ebp),%eax
801069eb:	89 44 24 04          	mov    %eax,0x4(%esp)
801069ef:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801069f6:	e8 bf ee ff ff       	call   801058ba <argint>
801069fb:	85 c0                	test   %eax,%eax
801069fd:	78 17                	js     80106a16 <sys_join+0x4b>
801069ff:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106a02:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a06:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106a0d:	e8 a8 ee ff ff       	call   801058ba <argint>
80106a12:	85 c0                	test   %eax,%eax
80106a14:	74 07                	je     80106a1d <sys_join+0x52>
  return -1;
80106a16:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a1b:	eb 1d                	jmp    80106a3a <sys_join+0x6f>
}

return join((int)myPid, (void**)myStack, (void**)myRetval);
80106a1d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106a20:	89 c1                	mov    %eax,%ecx
80106a22:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a25:	89 c2                	mov    %eax,%edx
80106a27:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a2a:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106a2e:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a32:	89 04 24             	mov    %eax,(%esp)
80106a35:	e8 e9 e2 ff ff       	call   80104d23 <join>
...
80106a50:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106a54:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106a57:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106a5b:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106a5f:	ee                   	out    %al,(%dx)
}
80106a60:	c9                   	leave  
80106a61:	c3                   	ret    
...
80106a68:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106a6f:	00 
80106a70:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106a77:	e8 c8 ff ff ff       	call   80106a44 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106a7c:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106a83:	00 
80106a84:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106a8b:	e8 b4 ff ff ff       	call   80106a44 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106a90:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106a97:	00 
80106a98:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106a9f:	e8 a0 ff ff ff       	call   80106a44 <outb>
  picenable(IRQ_TIMER);
80106aa4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106aab:	e8 51 d3 ff ff       	call   80103e01 <picenable>
}
80106ab0:	c9                   	leave  
80106ab1:	c3                   	ret    
	...
...
80106ab5:	06                   	push   %es
  pushl %fs
80106ab6:	0f a0                	push   %fs
  pushl %gs
80106ab8:	0f a8                	push   %gs
  pushal
80106aba:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106abb:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106abf:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106ac1:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106ac3:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106ac7:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106ac9:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106acb:	54                   	push   %esp
  call trap
80106acc:	e8 de 01 00 00       	call   80106caf <trap>
  addl $4, %esp
80106ad1:	83 c4 04             	add    $0x4,%esp
...
80106ad4:	61                   	popa   
  popl %gs
80106ad5:	0f a9                	pop    %gs
  popl %fs
80106ad7:	0f a1                	pop    %fs
  popl %es
80106ad9:	07                   	pop    %es
  popl %ds
80106ada:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80106adb:	83 c4 08             	add    $0x8,%esp
  iret
80106ade:	cf                   	iret   
	...
...
80106b0d:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106b10:	0f 20 d3             	mov    %cr2,%ebx
80106b13:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106b16:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106b2c:	e9 c3 00 00 00       	jmp    80106bf4 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106b31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b34:	8b 04 85 b0 c0 10 80 	mov    -0x7fef3f50(,%eax,4),%eax
80106b3b:	89 c2                	mov    %eax,%edx
80106b3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b40:	66 89 14 c5 00 5b 11 	mov    %dx,-0x7feea500(,%eax,8)
80106b47:	80 
80106b48:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b4b:	66 c7 04 c5 02 5b 11 	movw   $0x8,-0x7feea4fe(,%eax,8)
80106b52:	80 08 00 
80106b55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b58:	0f b6 14 c5 04 5b 11 	movzbl -0x7feea4fc(,%eax,8),%edx
80106b5f:	80 
80106b60:	83 e2 e0             	and    $0xffffffe0,%edx
80106b63:	88 14 c5 04 5b 11 80 	mov    %dl,-0x7feea4fc(,%eax,8)
80106b6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b6d:	0f b6 14 c5 04 5b 11 	movzbl -0x7feea4fc(,%eax,8),%edx
80106b74:	80 
80106b75:	83 e2 1f             	and    $0x1f,%edx
80106b78:	88 14 c5 04 5b 11 80 	mov    %dl,-0x7feea4fc(,%eax,8)
80106b7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b82:	0f b6 14 c5 05 5b 11 	movzbl -0x7feea4fb(,%eax,8),%edx
80106b89:	80 
80106b8a:	83 e2 f0             	and    $0xfffffff0,%edx
80106b8d:	83 ca 0e             	or     $0xe,%edx
80106b90:	88 14 c5 05 5b 11 80 	mov    %dl,-0x7feea4fb(,%eax,8)
80106b97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b9a:	0f b6 14 c5 05 5b 11 	movzbl -0x7feea4fb(,%eax,8),%edx
80106ba1:	80 
80106ba2:	83 e2 ef             	and    $0xffffffef,%edx
80106ba5:	88 14 c5 05 5b 11 80 	mov    %dl,-0x7feea4fb(,%eax,8)
80106bac:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106baf:	0f b6 14 c5 05 5b 11 	movzbl -0x7feea4fb(,%eax,8),%edx
80106bb6:	80 
80106bb7:	83 e2 9f             	and    $0xffffff9f,%edx
80106bba:	88 14 c5 05 5b 11 80 	mov    %dl,-0x7feea4fb(,%eax,8)
80106bc1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bc4:	0f b6 14 c5 05 5b 11 	movzbl -0x7feea4fb(,%eax,8),%edx
80106bcb:	80 
80106bcc:	83 ca 80             	or     $0xffffff80,%edx
80106bcf:	88 14 c5 05 5b 11 80 	mov    %dl,-0x7feea4fb(,%eax,8)
80106bd6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bd9:	8b 04 85 b0 c0 10 80 	mov    -0x7fef3f50(,%eax,4),%eax
80106be0:	c1 e8 10             	shr    $0x10,%eax
80106be3:	89 c2                	mov    %eax,%edx
80106be5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106be8:	66 89 14 c5 06 5b 11 	mov    %dx,-0x7feea4fa(,%eax,8)
80106bef:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106bf0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106bf4:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106bfb:	0f 8e 30 ff ff ff    	jle    80106b31 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106c01:	a1 b0 c1 10 80       	mov    0x8010c1b0,%eax
80106c06:	66 a3 00 5d 11 80    	mov    %ax,0x80115d00
80106c0c:	66 c7 05 02 5d 11 80 	movw   $0x8,0x80115d02
80106c13:	08 00 
80106c15:	0f b6 05 04 5d 11 80 	movzbl 0x80115d04,%eax
80106c1c:	83 e0 e0             	and    $0xffffffe0,%eax
80106c1f:	a2 04 5d 11 80       	mov    %al,0x80115d04
80106c24:	0f b6 05 04 5d 11 80 	movzbl 0x80115d04,%eax
80106c2b:	83 e0 1f             	and    $0x1f,%eax
80106c2e:	a2 04 5d 11 80       	mov    %al,0x80115d04
80106c33:	0f b6 05 05 5d 11 80 	movzbl 0x80115d05,%eax
80106c3a:	83 c8 0f             	or     $0xf,%eax
80106c3d:	a2 05 5d 11 80       	mov    %al,0x80115d05
80106c42:	0f b6 05 05 5d 11 80 	movzbl 0x80115d05,%eax
80106c49:	83 e0 ef             	and    $0xffffffef,%eax
80106c4c:	a2 05 5d 11 80       	mov    %al,0x80115d05
80106c51:	0f b6 05 05 5d 11 80 	movzbl 0x80115d05,%eax
80106c58:	83 c8 60             	or     $0x60,%eax
80106c5b:	a2 05 5d 11 80       	mov    %al,0x80115d05
80106c60:	0f b6 05 05 5d 11 80 	movzbl 0x80115d05,%eax
80106c67:	83 c8 80             	or     $0xffffff80,%eax
80106c6a:	a2 05 5d 11 80       	mov    %al,0x80115d05
80106c6f:	a1 b0 c1 10 80       	mov    0x8010c1b0,%eax
80106c74:	c1 e8 10             	shr    $0x10,%eax
80106c77:	66 a3 06 5d 11 80    	mov    %ax,0x80115d06
  
  initlock(&tickslock, "time");
80106c7d:	c7 44 24 04 c4 8e 10 	movl   $0x80108ec4,0x4(%esp)
80106c84:	80 
80106c85:	c7 04 24 c0 5a 11 80 	movl   $0x80115ac0,(%esp)
80106c8c:	e8 5d e6 ff ff       	call   801052ee <initlock>
}
80106c91:	c9                   	leave  
80106c92:	c3                   	ret    
...
80106c96:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106c99:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106ca0:	00 
80106ca1:	c7 04 24 00 5b 11 80 	movl   $0x80115b00,(%esp)
80106ca8:	e8 33 fe ff ff       	call   80106ae0 <lidt>
}
80106cad:	c9                   	leave  
80106cae:	c3                   	ret    
...
80106cb2:	57                   	push   %edi
80106cb3:	56                   	push   %esi
80106cb4:	53                   	push   %ebx
80106cb5:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106cb8:	8b 45 08             	mov    0x8(%ebp),%eax
80106cbb:	8b 40 30             	mov    0x30(%eax),%eax
80106cbe:	83 f8 40             	cmp    $0x40,%eax
80106cc1:	75 3e                	jne    80106d01 <trap+0x52>
    if(proc->killed)
80106cc3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106cc9:	8b 40 24             	mov    0x24(%eax),%eax
80106ccc:	85 c0                	test   %eax,%eax
80106cce:	74 05                	je     80106cd5 <trap+0x26>
      exit();
80106cd0:	e8 98 dc ff ff       	call   8010496d <exit>
    proc->tf = tf;
80106cd5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106cdb:	8b 55 08             	mov    0x8(%ebp),%edx
80106cde:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106ce1:	e8 9b ec ff ff       	call   80105981 <syscall>
    if(proc->killed)
80106ce6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106cec:	8b 40 24             	mov    0x24(%eax),%eax
80106cef:	85 c0                	test   %eax,%eax
80106cf1:	0f 84 34 02 00 00    	je     80106f2b <trap+0x27c>
      exit();
80106cf7:	e8 71 dc ff ff       	call   8010496d <exit>
    return;
80106cfc:	e9 2a 02 00 00       	jmp    80106f2b <trap+0x27c>
  }

  switch(tf->trapno){
80106d01:	8b 45 08             	mov    0x8(%ebp),%eax
80106d04:	8b 40 30             	mov    0x30(%eax),%eax
80106d07:	83 e8 20             	sub    $0x20,%eax
80106d0a:	83 f8 1f             	cmp    $0x1f,%eax
80106d0d:	0f 87 bc 00 00 00    	ja     80106dcf <trap+0x120>
80106d13:	8b 04 85 6c 8f 10 80 	mov    -0x7fef7094(,%eax,4),%eax
80106d1a:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106d1c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106d22:	0f b6 00             	movzbl (%eax),%eax
80106d25:	84 c0                	test   %al,%al
80106d27:	75 31                	jne    80106d5a <trap+0xab>
      acquire(&tickslock);
80106d29:	c7 04 24 c0 5a 11 80 	movl   $0x80115ac0,(%esp)
80106d30:	e8 da e5 ff ff       	call   8010530f <acquire>
      ticks++;
80106d35:	a1 00 63 11 80       	mov    0x80116300,%eax
80106d3a:	83 c0 01             	add    $0x1,%eax
80106d3d:	a3 00 63 11 80       	mov    %eax,0x80116300
      wakeup(&ticks);
80106d42:	c7 04 24 00 63 11 80 	movl   $0x80116300,(%esp)
80106d49:	e8 b5 e3 ff ff       	call   80105103 <wakeup>
      release(&tickslock);
80106d4e:	c7 04 24 c0 5a 11 80 	movl   $0x80115ac0,(%esp)
80106d55:	e8 17 e6 ff ff       	call   80105371 <release>
    }
    lapiceoi();
80106d5a:	e8 c0 c1 ff ff       	call   80102f1f <lapiceoi>
    break;
80106d5f:	e9 41 01 00 00       	jmp    80106ea5 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106d64:	e8 94 b9 ff ff       	call   801026fd <ideintr>
    lapiceoi();
80106d69:	e8 b1 c1 ff ff       	call   80102f1f <lapiceoi>
    break;
80106d6e:	e9 32 01 00 00       	jmp    80106ea5 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106d73:	e8 5b bf ff ff       	call   80102cd3 <kbdintr>
    lapiceoi();
80106d78:	e8 a2 c1 ff ff       	call   80102f1f <lapiceoi>
    break;
80106d7d:	e9 23 01 00 00       	jmp    80106ea5 <trap+0x1f6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106d82:	e8 a9 03 00 00       	call   80107130 <uartintr>
    lapiceoi();
80106d87:	e8 93 c1 ff ff       	call   80102f1f <lapiceoi>
    break;
80106d8c:	e9 14 01 00 00       	jmp    80106ea5 <trap+0x1f6>
  case T_IRQ0 + 7:
...
80106d91:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106d94:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80106d97:	8b 45 08             	mov    0x8(%ebp),%eax
80106d9a:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106d9e:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
...
80106db9:	c7 04 24 cc 8e 10 80 	movl   $0x80108ecc,(%esp)
80106dc0:	e8 dc 95 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106dc5:	e8 55 c1 ff ff       	call   80102f1f <lapiceoi>
    break;
80106dca:	e9 d6 00 00 00       	jmp    80106ea5 <trap+0x1f6>
...
80106dd7:	74 11                	je     80106dea <trap+0x13b>
...
80106de8:	75 46                	jne    80106e30 <trap+0x181>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106dea:	e8 1a fd ff ff       	call   80106b09 <rcr2>
              tf->trapno, cpu->id, tf->eip, rcr2());
80106def:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106df2:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106df5:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106dfc:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106dff:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106e02:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106e05:	8b 52 30             	mov    0x30(%edx),%edx
80106e08:	89 44 24 10          	mov    %eax,0x10(%esp)
80106e0c:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106e10:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106e14:	89 54 24 04          	mov    %edx,0x4(%esp)
80106e18:	c7 04 24 f0 8e 10 80 	movl   $0x80108ef0,(%esp)
80106e1f:	e8 7d 95 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106e24:	c7 04 24 22 8f 10 80 	movl   $0x80108f22,(%esp)
80106e2b:	e8 0d 97 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e30:	e8 d4 fc ff ff       	call   80106b09 <rcr2>
...
80106e37:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e3a:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
...
80106e43:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e46:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106e49:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e4c:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106e4f:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e52:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106e55:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e5b:	83 c0 6c             	add    $0x6c,%eax
...
80106e6a:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106e6e:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106e72:	89 74 24 14          	mov    %esi,0x14(%esp)
80106e76:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106e7a:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106e7e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106e81:	89 54 24 08          	mov    %edx,0x8(%esp)
80106e85:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e89:	c7 04 24 28 8f 10 80 	movl   $0x80108f28,(%esp)
80106e90:	e8 0c 95 ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80106e95:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e9b:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106ea2:	eb 01                	jmp    80106ea5 <trap+0x1f6>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106ead:	74 24                	je     80106ed3 <trap+0x224>
80106eaf:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106eb5:	8b 40 24             	mov    0x24(%eax),%eax
80106eb8:	85 c0                	test   %eax,%eax
80106eba:	74 17                	je     80106ed3 <trap+0x224>
80106ebc:	8b 45 08             	mov    0x8(%ebp),%eax
80106ebf:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106ec3:	0f b7 c0             	movzwl %ax,%eax
80106ec6:	83 e0 03             	and    $0x3,%eax
80106ec9:	83 f8 03             	cmp    $0x3,%eax
80106ecc:	75 05                	jne    80106ed3 <trap+0x224>
    exit();
80106ece:	e8 9a da ff ff       	call   8010496d <exit>
...
80106edb:	74 1e                	je     80106efb <trap+0x24c>
80106edd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106ee3:	8b 40 0c             	mov    0xc(%eax),%eax
80106ee6:	83 f8 04             	cmp    $0x4,%eax
80106ee9:	75 10                	jne    80106efb <trap+0x24c>
80106eeb:	8b 45 08             	mov    0x8(%ebp),%eax
80106eee:	8b 40 30             	mov    0x30(%eax),%eax
80106ef1:	83 f8 20             	cmp    $0x20,%eax
80106ef4:	75 05                	jne    80106efb <trap+0x24c>
    yield();
80106ef6:	e8 ce e0 ff ff       	call   80104fc9 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106efb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f01:	85 c0                	test   %eax,%eax
80106f03:	74 27                	je     80106f2c <trap+0x27d>
80106f05:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f0b:	8b 40 24             	mov    0x24(%eax),%eax
80106f0e:	85 c0                	test   %eax,%eax
80106f10:	74 1a                	je     80106f2c <trap+0x27d>
...
80106f22:	75 08                	jne    80106f2c <trap+0x27d>
    exit();
80106f24:	e8 44 da ff ff       	call   8010496d <exit>
80106f29:	eb 01                	jmp    80106f2c <trap+0x27d>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80106f2c:	83 c4 3c             	add    $0x3c,%esp
80106f2f:	5b                   	pop    %ebx
80106f30:	5e                   	pop    %esi
80106f31:	5f                   	pop    %edi
80106f32:	5d                   	pop    %ebp
...
80106f38:	83 ec 14             	sub    $0x14,%esp
80106f3b:	8b 45 08             	mov    0x8(%ebp),%eax
80106f3e:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106f42:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80106f46:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80106f4a:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
80106f4e:	ec                   	in     (%dx),%al
80106f4f:	89 c3                	mov    %eax,%ebx
80106f51:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80106f54:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80106f58:	83 c4 14             	add    $0x14,%esp
80106f5b:	5b                   	pop    %ebx
80106f5c:	5d                   	pop    %ebp
80106f5d:	c3                   	ret    
...
80106f64:	8b 55 08             	mov    0x8(%ebp),%edx
80106f67:	8b 45 0c             	mov    0xc(%ebp),%eax
80106f6a:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106f6e:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106f71:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106f75:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106f79:	ee                   	out    %al,(%dx)
}
80106f7a:	c9                   	leave  
80106f7b:	c3                   	ret    
...
80106f7f:	83 ec 28             	sub    $0x28,%esp
  char *p;
...
80106f89:	00 
80106f8a:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106f91:	e8 c8 ff ff ff       	call   80106f5e <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106f96:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106f9d:	00 
80106f9e:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106fa5:	e8 b4 ff ff ff       	call   80106f5e <outb>
  outb(COM1+0, 115200/9600);
80106faa:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106fb1:	00 
80106fb2:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106fb9:	e8 a0 ff ff ff       	call   80106f5e <outb>
  outb(COM1+1, 0);
80106fbe:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106fc5:	00 
80106fc6:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106fcd:	e8 8c ff ff ff       	call   80106f5e <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106fd2:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106fd9:	00 
80106fda:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106fe1:	e8 78 ff ff ff       	call   80106f5e <outb>
  outb(COM1+4, 0);
80106fe6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106fed:	00 
80106fee:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106ff5:	e8 64 ff ff ff       	call   80106f5e <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106ffa:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107001:	00 
80107002:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107009:	e8 50 ff ff ff       	call   80106f5e <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
8010700e:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107015:	e8 1a ff ff ff       	call   80106f34 <inb>
8010701a:	3c ff                	cmp    $0xff,%al
8010701c:	74 6c                	je     8010708a <uartinit+0x10e>
    return;
  uart = 1;
8010701e:	c7 05 6c c6 10 80 01 	movl   $0x1,0x8010c66c
80107025:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107028:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010702f:	e8 00 ff ff ff       	call   80106f34 <inb>
  inb(COM1+0);
80107034:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010703b:	e8 f4 fe ff ff       	call   80106f34 <inb>
  picenable(IRQ_COM1);
80107040:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107047:	e8 b5 cd ff ff       	call   80103e01 <picenable>
  ioapicenable(IRQ_COM1, 0);
8010704c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107053:	00 
80107054:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010705b:	e8 22 b9 ff ff       	call   80102982 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107060:	c7 45 f4 ec 8f 10 80 	movl   $0x80108fec,-0xc(%ebp)
80107067:	eb 15                	jmp    8010707e <uartinit+0x102>
    uartputc(*p);
80107069:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010706c:	0f b6 00             	movzbl (%eax),%eax
8010706f:	0f be c0             	movsbl %al,%eax
80107072:	89 04 24             	mov    %eax,(%esp)
80107075:	e8 13 00 00 00       	call   8010708d <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80107081:	0f b6 00             	movzbl (%eax),%eax
80107084:	84 c0                	test   %al,%al
80107086:	75 e1                	jne    80107069 <uartinit+0xed>
80107088:	eb 01                	jmp    8010708b <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
80107090:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80107093:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
80107098:	85 c0                	test   %eax,%eax
8010709a:	74 4d                	je     801070e9 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010709c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801070a3:	eb 10                	jmp    801070b5 <uartputc+0x28>
    microdelay(10);
801070a5:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801070ac:	e8 93 be ff ff       	call   80102f44 <microdelay>
{
  int i;
...
801070b9:	7f 16                	jg     801070d1 <uartputc+0x44>
801070bb:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801070c2:	e8 6d fe ff ff       	call   80106f34 <inb>
801070c7:	0f b6 c0             	movzbl %al,%eax
801070ca:	83 e0 20             	and    $0x20,%eax
801070cd:	85 c0                	test   %eax,%eax
801070cf:	74 d4                	je     801070a5 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
801070d1:	8b 45 08             	mov    0x8(%ebp),%eax
801070d4:	0f b6 c0             	movzbl %al,%eax
801070d7:	89 44 24 04          	mov    %eax,0x4(%esp)
801070db:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801070e2:	e8 77 fe ff ff       	call   80106f5e <outb>
801070e7:	eb 01                	jmp    801070ea <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
uartgetc(void)
{
801070ec:	55                   	push   %ebp
801070ed:	89 e5                	mov    %esp,%ebp
801070ef:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
801070f2:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
801070f7:	85 c0                	test   %eax,%eax
801070f9:	75 07                	jne    80107102 <uartgetc+0x16>
    return -1;
801070fb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107100:	eb 2c                	jmp    8010712e <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80107102:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107109:	e8 26 fe ff ff       	call   80106f34 <inb>
8010710e:	0f b6 c0             	movzbl %al,%eax
80107111:	83 e0 01             	and    $0x1,%eax
80107114:	85 c0                	test   %eax,%eax
80107116:	75 07                	jne    8010711f <uartgetc+0x33>
    return -1;
80107118:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010711d:	eb 0f                	jmp    8010712e <uartgetc+0x42>
  return inb(COM1+0);
8010711f:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107126:	e8 09 fe ff ff       	call   80106f34 <inb>
8010712b:	0f b6 c0             	movzbl %al,%eax
}
8010712e:	c9                   	leave  
8010712f:	c3                   	ret    
...
80107136:	c7 04 24 ec 70 10 80 	movl   $0x801070ec,(%esp)
8010713d:	e8 6b 96 ff ff       	call   801007ad <consoleintr>
}
80107142:	c9                   	leave  
80107143:	c3                   	ret    
...
80107146:	6a 00                	push   $0x0
  jmp alltraps
80107148:	e9 67 f9 ff ff       	jmp    80106ab4 <alltraps>
...
8010714d:	6a 00                	push   $0x0
  pushl $1
8010714f:	6a 01                	push   $0x1
  jmp alltraps
80107151:	e9 5e f9 ff ff       	jmp    80106ab4 <alltraps>
...
80107156:	6a 00                	push   $0x0
  pushl $2
80107158:	6a 02                	push   $0x2
  jmp alltraps
8010715a:	e9 55 f9 ff ff       	jmp    80106ab4 <alltraps>
...
8010715f:	6a 00                	push   $0x0
  pushl $3
80107161:	6a 03                	push   $0x3
  jmp alltraps
80107163:	e9 4c f9 ff ff       	jmp    80106ab4 <alltraps>
...
80107168:	6a 00                	push   $0x0
  pushl $4
8010716a:	6a 04                	push   $0x4
  jmp alltraps
8010716c:	e9 43 f9 ff ff       	jmp    80106ab4 <alltraps>
...
80107171:	6a 00                	push   $0x0
  pushl $5
80107173:	6a 05                	push   $0x5
  jmp alltraps
80107175:	e9 3a f9 ff ff       	jmp    80106ab4 <alltraps>
...
8010717c:	6a 06                	push   $0x6
  jmp alltraps
8010717e:	e9 31 f9 ff ff       	jmp    80106ab4 <alltraps>
...
80107183:	6a 00                	push   $0x0
  pushl $7
80107185:	6a 07                	push   $0x7
  jmp alltraps
80107187:	e9 28 f9 ff ff       	jmp    80106ab4 <alltraps>

8010718c <vector8>:
.globl vector8
vector8:
  pushl $8
8010718c:	6a 08                	push   $0x8
  jmp alltraps
8010718e:	e9 21 f9 ff ff       	jmp    80106ab4 <alltraps>
...
80107193:	6a 00                	push   $0x0
  pushl $9
80107195:	6a 09                	push   $0x9
  jmp alltraps
80107197:	e9 18 f9 ff ff       	jmp    80106ab4 <alltraps>

8010719c <vector10>:
.globl vector10
vector10:
  pushl $10
8010719c:	6a 0a                	push   $0xa
  jmp alltraps
8010719e:	e9 11 f9 ff ff       	jmp    80106ab4 <alltraps>

801071a3 <vector11>:
.globl vector11
vector11:
  pushl $11
801071a3:	6a 0b                	push   $0xb
  jmp alltraps
801071a5:	e9 0a f9 ff ff       	jmp    80106ab4 <alltraps>

801071aa <vector12>:
.globl vector12
vector12:
  pushl $12
801071aa:	6a 0c                	push   $0xc
  jmp alltraps
801071ac:	e9 03 f9 ff ff       	jmp    80106ab4 <alltraps>

801071b1 <vector13>:
.globl vector13
vector13:
  pushl $13
801071b1:	6a 0d                	push   $0xd
  jmp alltraps
801071b3:	e9 fc f8 ff ff       	jmp    80106ab4 <alltraps>

801071b8 <vector14>:
.globl vector14
vector14:
  pushl $14
801071b8:	6a 0e                	push   $0xe
  jmp alltraps
801071ba:	e9 f5 f8 ff ff       	jmp    80106ab4 <alltraps>
...
801071bf:	6a 00                	push   $0x0
  pushl $15
801071c1:	6a 0f                	push   $0xf
  jmp alltraps
801071c3:	e9 ec f8 ff ff       	jmp    80106ab4 <alltraps>
...
801071c8:	6a 00                	push   $0x0
  pushl $16
801071ca:	6a 10                	push   $0x10
  jmp alltraps
801071cc:	e9 e3 f8 ff ff       	jmp    80106ab4 <alltraps>

801071d1 <vector17>:
.globl vector17
vector17:
  pushl $17
801071d1:	6a 11                	push   $0x11
  jmp alltraps
801071d3:	e9 dc f8 ff ff       	jmp    80106ab4 <alltraps>
...
801071d8:	6a 00                	push   $0x0
  pushl $18
801071da:	6a 12                	push   $0x12
  jmp alltraps
801071dc:	e9 d3 f8 ff ff       	jmp    80106ab4 <alltraps>
...
801071e1:	6a 00                	push   $0x0
  pushl $19
801071e3:	6a 13                	push   $0x13
  jmp alltraps
801071e5:	e9 ca f8 ff ff       	jmp    80106ab4 <alltraps>
...
801071ea:	6a 00                	push   $0x0
  pushl $20
801071ec:	6a 14                	push   $0x14
  jmp alltraps
801071ee:	e9 c1 f8 ff ff       	jmp    80106ab4 <alltraps>
...
801071f3:	6a 00                	push   $0x0
  pushl $21
801071f5:	6a 15                	push   $0x15
  jmp alltraps
801071f7:	e9 b8 f8 ff ff       	jmp    80106ab4 <alltraps>
...
801071fc:	6a 00                	push   $0x0
  pushl $22
801071fe:	6a 16                	push   $0x16
  jmp alltraps
80107200:	e9 af f8 ff ff       	jmp    80106ab4 <alltraps>
...
80107205:	6a 00                	push   $0x0
  pushl $23
80107207:	6a 17                	push   $0x17
  jmp alltraps
80107209:	e9 a6 f8 ff ff       	jmp    80106ab4 <alltraps>
...
8010720e:	6a 00                	push   $0x0
  pushl $24
80107210:	6a 18                	push   $0x18
  jmp alltraps
80107212:	e9 9d f8 ff ff       	jmp    80106ab4 <alltraps>
...
80107217:	6a 00                	push   $0x0
  pushl $25
80107219:	6a 19                	push   $0x19
  jmp alltraps
8010721b:	e9 94 f8 ff ff       	jmp    80106ab4 <alltraps>
...
80107220:	6a 00                	push   $0x0
  pushl $26
80107222:	6a 1a                	push   $0x1a
  jmp alltraps
80107224:	e9 8b f8 ff ff       	jmp    80106ab4 <alltraps>
...
80107229:	6a 00                	push   $0x0
  pushl $27
8010722b:	6a 1b                	push   $0x1b
  jmp alltraps
8010722d:	e9 82 f8 ff ff       	jmp    80106ab4 <alltraps>
...
80107232:	6a 00                	push   $0x0
  pushl $28
80107234:	6a 1c                	push   $0x1c
  jmp alltraps
80107236:	e9 79 f8 ff ff       	jmp    80106ab4 <alltraps>
...
8010723d:	6a 1d                	push   $0x1d
  jmp alltraps
8010723f:	e9 70 f8 ff ff       	jmp    80106ab4 <alltraps>
...
80107244:	6a 00                	push   $0x0
  pushl $30
80107246:	6a 1e                	push   $0x1e
  jmp alltraps
80107248:	e9 67 f8 ff ff       	jmp    80106ab4 <alltraps>
...
8010724d:	6a 00                	push   $0x0
  pushl $31
8010724f:	6a 1f                	push   $0x1f
  jmp alltraps
80107251:	e9 5e f8 ff ff       	jmp    80106ab4 <alltraps>
...
80107256:	6a 00                	push   $0x0
  pushl $32
80107258:	6a 20                	push   $0x20
  jmp alltraps
8010725a:	e9 55 f8 ff ff       	jmp    80106ab4 <alltraps>
...
8010725f:	6a 00                	push   $0x0
  pushl $33
80107261:	6a 21                	push   $0x21
  jmp alltraps
80107263:	e9 4c f8 ff ff       	jmp    80106ab4 <alltraps>
...
80107268:	6a 00                	push   $0x0
  pushl $34
8010726a:	6a 22                	push   $0x22
  jmp alltraps
8010726c:	e9 43 f8 ff ff       	jmp    80106ab4 <alltraps>
...
80107271:	6a 00                	push   $0x0
  pushl $35
80107273:	6a 23                	push   $0x23
  jmp alltraps
80107275:	e9 3a f8 ff ff       	jmp    80106ab4 <alltraps>
...
8010727a:	6a 00                	push   $0x0
  pushl $36
8010727c:	6a 24                	push   $0x24
  jmp alltraps
8010727e:	e9 31 f8 ff ff       	jmp    80106ab4 <alltraps>
...
80107283:	6a 00                	push   $0x0
  pushl $37
80107285:	6a 25                	push   $0x25
  jmp alltraps
80107287:	e9 28 f8 ff ff       	jmp    80106ab4 <alltraps>
...
8010728c:	6a 00                	push   $0x0
  pushl $38
8010728e:	6a 26                	push   $0x26
  jmp alltraps
80107290:	e9 1f f8 ff ff       	jmp    80106ab4 <alltraps>
...
80107295:	6a 00                	push   $0x0
  pushl $39
80107297:	6a 27                	push   $0x27
  jmp alltraps
80107299:	e9 16 f8 ff ff       	jmp    80106ab4 <alltraps>
...
8010729e:	6a 00                	push   $0x0
  pushl $40
801072a0:	6a 28                	push   $0x28
  jmp alltraps
801072a2:	e9 0d f8 ff ff       	jmp    80106ab4 <alltraps>
...
801072a7:	6a 00                	push   $0x0
  pushl $41
801072a9:	6a 29                	push   $0x29
  jmp alltraps
801072ab:	e9 04 f8 ff ff       	jmp    80106ab4 <alltraps>
...
801072b0:	6a 00                	push   $0x0
  pushl $42
801072b2:	6a 2a                	push   $0x2a
  jmp alltraps
801072b4:	e9 fb f7 ff ff       	jmp    80106ab4 <alltraps>
...
801072b9:	6a 00                	push   $0x0
  pushl $43
801072bb:	6a 2b                	push   $0x2b
  jmp alltraps
801072bd:	e9 f2 f7 ff ff       	jmp    80106ab4 <alltraps>
...
801072c2:	6a 00                	push   $0x0
  pushl $44
801072c4:	6a 2c                	push   $0x2c
  jmp alltraps
801072c6:	e9 e9 f7 ff ff       	jmp    80106ab4 <alltraps>
...
801072cb:	6a 00                	push   $0x0
  pushl $45
801072cd:	6a 2d                	push   $0x2d
  jmp alltraps
801072cf:	e9 e0 f7 ff ff       	jmp    80106ab4 <alltraps>
...
801072d4:	6a 00                	push   $0x0
  pushl $46
801072d6:	6a 2e                	push   $0x2e
  jmp alltraps
801072d8:	e9 d7 f7 ff ff       	jmp    80106ab4 <alltraps>
...
801072dd:	6a 00                	push   $0x0
  pushl $47
801072df:	6a 2f                	push   $0x2f
  jmp alltraps
801072e1:	e9 ce f7 ff ff       	jmp    80106ab4 <alltraps>
...
801072e6:	6a 00                	push   $0x0
  pushl $48
801072e8:	6a 30                	push   $0x30
  jmp alltraps
801072ea:	e9 c5 f7 ff ff       	jmp    80106ab4 <alltraps>
...
801072ef:	6a 00                	push   $0x0
  pushl $49
801072f1:	6a 31                	push   $0x31
  jmp alltraps
801072f3:	e9 bc f7 ff ff       	jmp    80106ab4 <alltraps>
...
801072f8:	6a 00                	push   $0x0
  pushl $50
801072fa:	6a 32                	push   $0x32
  jmp alltraps
801072fc:	e9 b3 f7 ff ff       	jmp    80106ab4 <alltraps>
...
80107301:	6a 00                	push   $0x0
  pushl $51
80107303:	6a 33                	push   $0x33
  jmp alltraps
80107305:	e9 aa f7 ff ff       	jmp    80106ab4 <alltraps>
...
8010730a:	6a 00                	push   $0x0
  pushl $52
8010730c:	6a 34                	push   $0x34
  jmp alltraps
8010730e:	e9 a1 f7 ff ff       	jmp    80106ab4 <alltraps>
...
80107313:	6a 00                	push   $0x0
  pushl $53
80107315:	6a 35                	push   $0x35
  jmp alltraps
80107317:	e9 98 f7 ff ff       	jmp    80106ab4 <alltraps>
...
8010731c:	6a 00                	push   $0x0
  pushl $54
8010731e:	6a 36                	push   $0x36
  jmp alltraps
80107320:	e9 8f f7 ff ff       	jmp    80106ab4 <alltraps>
...
80107325:	6a 00                	push   $0x0
  pushl $55
80107327:	6a 37                	push   $0x37
  jmp alltraps
80107329:	e9 86 f7 ff ff       	jmp    80106ab4 <alltraps>
...
8010732e:	6a 00                	push   $0x0
  pushl $56
80107330:	6a 38                	push   $0x38
  jmp alltraps
80107332:	e9 7d f7 ff ff       	jmp    80106ab4 <alltraps>
...
80107337:	6a 00                	push   $0x0
  pushl $57
80107339:	6a 39                	push   $0x39
  jmp alltraps
8010733b:	e9 74 f7 ff ff       	jmp    80106ab4 <alltraps>
...
80107340:	6a 00                	push   $0x0
  pushl $58
80107342:	6a 3a                	push   $0x3a
  jmp alltraps
80107344:	e9 6b f7 ff ff       	jmp    80106ab4 <alltraps>
...
80107349:	6a 00                	push   $0x0
  pushl $59
8010734b:	6a 3b                	push   $0x3b
  jmp alltraps
8010734d:	e9 62 f7 ff ff       	jmp    80106ab4 <alltraps>
...
80107352:	6a 00                	push   $0x0
  pushl $60
80107354:	6a 3c                	push   $0x3c
  jmp alltraps
80107356:	e9 59 f7 ff ff       	jmp    80106ab4 <alltraps>
...
8010735b:	6a 00                	push   $0x0
  pushl $61
8010735d:	6a 3d                	push   $0x3d
  jmp alltraps
8010735f:	e9 50 f7 ff ff       	jmp    80106ab4 <alltraps>
...
80107364:	6a 00                	push   $0x0
  pushl $62
80107366:	6a 3e                	push   $0x3e
  jmp alltraps
80107368:	e9 47 f7 ff ff       	jmp    80106ab4 <alltraps>
...
8010736d:	6a 00                	push   $0x0
  pushl $63
8010736f:	6a 3f                	push   $0x3f
  jmp alltraps
80107371:	e9 3e f7 ff ff       	jmp    80106ab4 <alltraps>
...
80107376:	6a 00                	push   $0x0
  pushl $64
80107378:	6a 40                	push   $0x40
  jmp alltraps
8010737a:	e9 35 f7 ff ff       	jmp    80106ab4 <alltraps>
...
8010737f:	6a 00                	push   $0x0
  pushl $65
80107381:	6a 41                	push   $0x41
  jmp alltraps
80107383:	e9 2c f7 ff ff       	jmp    80106ab4 <alltraps>
...
80107388:	6a 00                	push   $0x0
  pushl $66
8010738a:	6a 42                	push   $0x42
  jmp alltraps
8010738c:	e9 23 f7 ff ff       	jmp    80106ab4 <alltraps>
...
80107391:	6a 00                	push   $0x0
  pushl $67
80107393:	6a 43                	push   $0x43
  jmp alltraps
80107395:	e9 1a f7 ff ff       	jmp    80106ab4 <alltraps>
...
8010739a:	6a 00                	push   $0x0
  pushl $68
8010739c:	6a 44                	push   $0x44
  jmp alltraps
8010739e:	e9 11 f7 ff ff       	jmp    80106ab4 <alltraps>
...
801073a3:	6a 00                	push   $0x0
  pushl $69
801073a5:	6a 45                	push   $0x45
  jmp alltraps
801073a7:	e9 08 f7 ff ff       	jmp    80106ab4 <alltraps>
...
801073ac:	6a 00                	push   $0x0
  pushl $70
801073ae:	6a 46                	push   $0x46
  jmp alltraps
801073b0:	e9 ff f6 ff ff       	jmp    80106ab4 <alltraps>
...
801073b5:	6a 00                	push   $0x0
  pushl $71
801073b7:	6a 47                	push   $0x47
  jmp alltraps
801073b9:	e9 f6 f6 ff ff       	jmp    80106ab4 <alltraps>
...
801073be:	6a 00                	push   $0x0
  pushl $72
801073c0:	6a 48                	push   $0x48
  jmp alltraps
801073c2:	e9 ed f6 ff ff       	jmp    80106ab4 <alltraps>
...
801073c7:	6a 00                	push   $0x0
  pushl $73
801073c9:	6a 49                	push   $0x49
  jmp alltraps
801073cb:	e9 e4 f6 ff ff       	jmp    80106ab4 <alltraps>
...
801073d0:	6a 00                	push   $0x0
  pushl $74
801073d2:	6a 4a                	push   $0x4a
  jmp alltraps
801073d4:	e9 db f6 ff ff       	jmp    80106ab4 <alltraps>
...
801073d9:	6a 00                	push   $0x0
  pushl $75
801073db:	6a 4b                	push   $0x4b
  jmp alltraps
801073dd:	e9 d2 f6 ff ff       	jmp    80106ab4 <alltraps>
...
801073e2:	6a 00                	push   $0x0
  pushl $76
801073e4:	6a 4c                	push   $0x4c
  jmp alltraps
801073e6:	e9 c9 f6 ff ff       	jmp    80106ab4 <alltraps>
...
801073eb:	6a 00                	push   $0x0
  pushl $77
801073ed:	6a 4d                	push   $0x4d
  jmp alltraps
801073ef:	e9 c0 f6 ff ff       	jmp    80106ab4 <alltraps>
...
801073f4:	6a 00                	push   $0x0
  pushl $78
801073f6:	6a 4e                	push   $0x4e
  jmp alltraps
801073f8:	e9 b7 f6 ff ff       	jmp    80106ab4 <alltraps>
...
801073fd:	6a 00                	push   $0x0
  pushl $79
801073ff:	6a 4f                	push   $0x4f
  jmp alltraps
80107401:	e9 ae f6 ff ff       	jmp    80106ab4 <alltraps>
...
80107406:	6a 00                	push   $0x0
  pushl $80
80107408:	6a 50                	push   $0x50
  jmp alltraps
8010740a:	e9 a5 f6 ff ff       	jmp    80106ab4 <alltraps>
...
8010740f:	6a 00                	push   $0x0
  pushl $81
80107411:	6a 51                	push   $0x51
  jmp alltraps
80107413:	e9 9c f6 ff ff       	jmp    80106ab4 <alltraps>
...
80107418:	6a 00                	push   $0x0
  pushl $82
8010741a:	6a 52                	push   $0x52
  jmp alltraps
8010741c:	e9 93 f6 ff ff       	jmp    80106ab4 <alltraps>
...
80107421:	6a 00                	push   $0x0
  pushl $83
80107423:	6a 53                	push   $0x53
  jmp alltraps
80107425:	e9 8a f6 ff ff       	jmp    80106ab4 <alltraps>
...
8010742a:	6a 00                	push   $0x0
  pushl $84
8010742c:	6a 54                	push   $0x54
  jmp alltraps
8010742e:	e9 81 f6 ff ff       	jmp    80106ab4 <alltraps>
...
80107433:	6a 00                	push   $0x0
  pushl $85
80107435:	6a 55                	push   $0x55
  jmp alltraps
80107437:	e9 78 f6 ff ff       	jmp    80106ab4 <alltraps>
...
8010743c:	6a 00                	push   $0x0
  pushl $86
8010743e:	6a 56                	push   $0x56
  jmp alltraps
80107440:	e9 6f f6 ff ff       	jmp    80106ab4 <alltraps>
...
80107445:	6a 00                	push   $0x0
  pushl $87
80107447:	6a 57                	push   $0x57
  jmp alltraps
80107449:	e9 66 f6 ff ff       	jmp    80106ab4 <alltraps>
...
8010744e:	6a 00                	push   $0x0
  pushl $88
80107450:	6a 58                	push   $0x58
  jmp alltraps
80107452:	e9 5d f6 ff ff       	jmp    80106ab4 <alltraps>
...
80107457:	6a 00                	push   $0x0
  pushl $89
80107459:	6a 59                	push   $0x59
  jmp alltraps
8010745b:	e9 54 f6 ff ff       	jmp    80106ab4 <alltraps>
...
80107460:	6a 00                	push   $0x0
  pushl $90
80107462:	6a 5a                	push   $0x5a
  jmp alltraps
80107464:	e9 4b f6 ff ff       	jmp    80106ab4 <alltraps>
...
80107469:	6a 00                	push   $0x0
  pushl $91
8010746b:	6a 5b                	push   $0x5b
  jmp alltraps
8010746d:	e9 42 f6 ff ff       	jmp    80106ab4 <alltraps>
...
80107472:	6a 00                	push   $0x0
  pushl $92
80107474:	6a 5c                	push   $0x5c
  jmp alltraps
80107476:	e9 39 f6 ff ff       	jmp    80106ab4 <alltraps>
...
8010747b:	6a 00                	push   $0x0
  pushl $93
8010747d:	6a 5d                	push   $0x5d
  jmp alltraps
8010747f:	e9 30 f6 ff ff       	jmp    80106ab4 <alltraps>
...
80107484:	6a 00                	push   $0x0
  pushl $94
80107486:	6a 5e                	push   $0x5e
  jmp alltraps
80107488:	e9 27 f6 ff ff       	jmp    80106ab4 <alltraps>
...
8010748d:	6a 00                	push   $0x0
  pushl $95
8010748f:	6a 5f                	push   $0x5f
  jmp alltraps
80107491:	e9 1e f6 ff ff       	jmp    80106ab4 <alltraps>
...
80107496:	6a 00                	push   $0x0
  pushl $96
80107498:	6a 60                	push   $0x60
  jmp alltraps
8010749a:	e9 15 f6 ff ff       	jmp    80106ab4 <alltraps>
...
8010749f:	6a 00                	push   $0x0
  pushl $97
801074a1:	6a 61                	push   $0x61
  jmp alltraps
801074a3:	e9 0c f6 ff ff       	jmp    80106ab4 <alltraps>
...
801074a8:	6a 00                	push   $0x0
  pushl $98
801074aa:	6a 62                	push   $0x62
  jmp alltraps
801074ac:	e9 03 f6 ff ff       	jmp    80106ab4 <alltraps>
...
801074b1:	6a 00                	push   $0x0
  pushl $99
801074b3:	6a 63                	push   $0x63
  jmp alltraps
801074b5:	e9 fa f5 ff ff       	jmp    80106ab4 <alltraps>
...
801074ba:	6a 00                	push   $0x0
  pushl $100
801074bc:	6a 64                	push   $0x64
  jmp alltraps
801074be:	e9 f1 f5 ff ff       	jmp    80106ab4 <alltraps>
...
801074c3:	6a 00                	push   $0x0
  pushl $101
801074c5:	6a 65                	push   $0x65
  jmp alltraps
801074c7:	e9 e8 f5 ff ff       	jmp    80106ab4 <alltraps>
...
801074cc:	6a 00                	push   $0x0
  pushl $102
801074ce:	6a 66                	push   $0x66
  jmp alltraps
801074d0:	e9 df f5 ff ff       	jmp    80106ab4 <alltraps>
...
801074d5:	6a 00                	push   $0x0
  pushl $103
801074d7:	6a 67                	push   $0x67
  jmp alltraps
801074d9:	e9 d6 f5 ff ff       	jmp    80106ab4 <alltraps>
...
801074de:	6a 00                	push   $0x0
  pushl $104
801074e0:	6a 68                	push   $0x68
  jmp alltraps
801074e2:	e9 cd f5 ff ff       	jmp    80106ab4 <alltraps>
...
801074e7:	6a 00                	push   $0x0
  pushl $105
801074e9:	6a 69                	push   $0x69
  jmp alltraps
801074eb:	e9 c4 f5 ff ff       	jmp    80106ab4 <alltraps>
...
801074f0:	6a 00                	push   $0x0
  pushl $106
801074f2:	6a 6a                	push   $0x6a
  jmp alltraps
801074f4:	e9 bb f5 ff ff       	jmp    80106ab4 <alltraps>
...
801074f9:	6a 00                	push   $0x0
  pushl $107
801074fb:	6a 6b                	push   $0x6b
  jmp alltraps
801074fd:	e9 b2 f5 ff ff       	jmp    80106ab4 <alltraps>
...
80107502:	6a 00                	push   $0x0
  pushl $108
80107504:	6a 6c                	push   $0x6c
  jmp alltraps
80107506:	e9 a9 f5 ff ff       	jmp    80106ab4 <alltraps>
...
8010750b:	6a 00                	push   $0x0
  pushl $109
8010750d:	6a 6d                	push   $0x6d
  jmp alltraps
8010750f:	e9 a0 f5 ff ff       	jmp    80106ab4 <alltraps>
...
80107514:	6a 00                	push   $0x0
  pushl $110
80107516:	6a 6e                	push   $0x6e
  jmp alltraps
80107518:	e9 97 f5 ff ff       	jmp    80106ab4 <alltraps>
...
8010751d:	6a 00                	push   $0x0
  pushl $111
8010751f:	6a 6f                	push   $0x6f
  jmp alltraps
80107521:	e9 8e f5 ff ff       	jmp    80106ab4 <alltraps>
...
80107526:	6a 00                	push   $0x0
  pushl $112
80107528:	6a 70                	push   $0x70
  jmp alltraps
8010752a:	e9 85 f5 ff ff       	jmp    80106ab4 <alltraps>
...
8010752f:	6a 00                	push   $0x0
  pushl $113
80107531:	6a 71                	push   $0x71
  jmp alltraps
80107533:	e9 7c f5 ff ff       	jmp    80106ab4 <alltraps>
...
80107538:	6a 00                	push   $0x0
  pushl $114
8010753a:	6a 72                	push   $0x72
  jmp alltraps
8010753c:	e9 73 f5 ff ff       	jmp    80106ab4 <alltraps>
...
80107541:	6a 00                	push   $0x0
  pushl $115
80107543:	6a 73                	push   $0x73
  jmp alltraps
80107545:	e9 6a f5 ff ff       	jmp    80106ab4 <alltraps>
...
8010754a:	6a 00                	push   $0x0
  pushl $116
8010754c:	6a 74                	push   $0x74
  jmp alltraps
8010754e:	e9 61 f5 ff ff       	jmp    80106ab4 <alltraps>
...
80107553:	6a 00                	push   $0x0
  pushl $117
80107555:	6a 75                	push   $0x75
  jmp alltraps
80107557:	e9 58 f5 ff ff       	jmp    80106ab4 <alltraps>
...
8010755c:	6a 00                	push   $0x0
  pushl $118
8010755e:	6a 76                	push   $0x76
  jmp alltraps
80107560:	e9 4f f5 ff ff       	jmp    80106ab4 <alltraps>
...
80107565:	6a 00                	push   $0x0
  pushl $119
80107567:	6a 77                	push   $0x77
  jmp alltraps
80107569:	e9 46 f5 ff ff       	jmp    80106ab4 <alltraps>
...
8010756e:	6a 00                	push   $0x0
  pushl $120
80107570:	6a 78                	push   $0x78
  jmp alltraps
80107572:	e9 3d f5 ff ff       	jmp    80106ab4 <alltraps>
...
80107577:	6a 00                	push   $0x0
  pushl $121
80107579:	6a 79                	push   $0x79
  jmp alltraps
8010757b:	e9 34 f5 ff ff       	jmp    80106ab4 <alltraps>
...
80107580:	6a 00                	push   $0x0
  pushl $122
80107582:	6a 7a                	push   $0x7a
  jmp alltraps
80107584:	e9 2b f5 ff ff       	jmp    80106ab4 <alltraps>
...
80107589:	6a 00                	push   $0x0
  pushl $123
8010758b:	6a 7b                	push   $0x7b
  jmp alltraps
8010758d:	e9 22 f5 ff ff       	jmp    80106ab4 <alltraps>
...
80107592:	6a 00                	push   $0x0
  pushl $124
80107594:	6a 7c                	push   $0x7c
  jmp alltraps
80107596:	e9 19 f5 ff ff       	jmp    80106ab4 <alltraps>
...
8010759b:	6a 00                	push   $0x0
  pushl $125
8010759d:	6a 7d                	push   $0x7d
  jmp alltraps
8010759f:	e9 10 f5 ff ff       	jmp    80106ab4 <alltraps>
...
801075a4:	6a 00                	push   $0x0
  pushl $126
801075a6:	6a 7e                	push   $0x7e
  jmp alltraps
801075a8:	e9 07 f5 ff ff       	jmp    80106ab4 <alltraps>
...
801075ad:	6a 00                	push   $0x0
  pushl $127
801075af:	6a 7f                	push   $0x7f
  jmp alltraps
801075b1:	e9 fe f4 ff ff       	jmp    80106ab4 <alltraps>
...
801075b6:	6a 00                	push   $0x0
  pushl $128
801075b8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801075bd:	e9 f2 f4 ff ff       	jmp    80106ab4 <alltraps>
...
801075c2:	6a 00                	push   $0x0
  pushl $129
801075c4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801075c9:	e9 e6 f4 ff ff       	jmp    80106ab4 <alltraps>
...
801075ce:	6a 00                	push   $0x0
  pushl $130
801075d0:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801075d5:	e9 da f4 ff ff       	jmp    80106ab4 <alltraps>
...
801075da:	6a 00                	push   $0x0
  pushl $131
801075dc:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801075e1:	e9 ce f4 ff ff       	jmp    80106ab4 <alltraps>
...
801075e6:	6a 00                	push   $0x0
  pushl $132
801075e8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801075ed:	e9 c2 f4 ff ff       	jmp    80106ab4 <alltraps>
...
801075f2:	6a 00                	push   $0x0
  pushl $133
801075f4:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801075f9:	e9 b6 f4 ff ff       	jmp    80106ab4 <alltraps>
...
801075fe:	6a 00                	push   $0x0
  pushl $134
80107600:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107605:	e9 aa f4 ff ff       	jmp    80106ab4 <alltraps>
...
8010760a:	6a 00                	push   $0x0
  pushl $135
8010760c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107611:	e9 9e f4 ff ff       	jmp    80106ab4 <alltraps>
...
80107616:	6a 00                	push   $0x0
  pushl $136
80107618:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010761d:	e9 92 f4 ff ff       	jmp    80106ab4 <alltraps>
...
80107622:	6a 00                	push   $0x0
  pushl $137
80107624:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107629:	e9 86 f4 ff ff       	jmp    80106ab4 <alltraps>
...
8010762e:	6a 00                	push   $0x0
  pushl $138
80107630:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107635:	e9 7a f4 ff ff       	jmp    80106ab4 <alltraps>
...
8010763a:	6a 00                	push   $0x0
  pushl $139
8010763c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107641:	e9 6e f4 ff ff       	jmp    80106ab4 <alltraps>
...
80107646:	6a 00                	push   $0x0
  pushl $140
80107648:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010764d:	e9 62 f4 ff ff       	jmp    80106ab4 <alltraps>
...
80107652:	6a 00                	push   $0x0
  pushl $141
80107654:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107659:	e9 56 f4 ff ff       	jmp    80106ab4 <alltraps>
...
8010765e:	6a 00                	push   $0x0
  pushl $142
80107660:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107665:	e9 4a f4 ff ff       	jmp    80106ab4 <alltraps>
...
8010766a:	6a 00                	push   $0x0
  pushl $143
8010766c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107671:	e9 3e f4 ff ff       	jmp    80106ab4 <alltraps>
...
80107676:	6a 00                	push   $0x0
  pushl $144
80107678:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010767d:	e9 32 f4 ff ff       	jmp    80106ab4 <alltraps>
...
80107682:	6a 00                	push   $0x0
  pushl $145
80107684:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107689:	e9 26 f4 ff ff       	jmp    80106ab4 <alltraps>
...
8010768e:	6a 00                	push   $0x0
  pushl $146
80107690:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107695:	e9 1a f4 ff ff       	jmp    80106ab4 <alltraps>
...
8010769a:	6a 00                	push   $0x0
  pushl $147
8010769c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801076a1:	e9 0e f4 ff ff       	jmp    80106ab4 <alltraps>
...
801076a6:	6a 00                	push   $0x0
  pushl $148
801076a8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801076ad:	e9 02 f4 ff ff       	jmp    80106ab4 <alltraps>
...
801076b2:	6a 00                	push   $0x0
  pushl $149
801076b4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801076b9:	e9 f6 f3 ff ff       	jmp    80106ab4 <alltraps>
...
801076be:	6a 00                	push   $0x0
  pushl $150
801076c0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801076c5:	e9 ea f3 ff ff       	jmp    80106ab4 <alltraps>
...
801076ca:	6a 00                	push   $0x0
  pushl $151
801076cc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801076d1:	e9 de f3 ff ff       	jmp    80106ab4 <alltraps>
...
801076d6:	6a 00                	push   $0x0
  pushl $152
801076d8:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801076dd:	e9 d2 f3 ff ff       	jmp    80106ab4 <alltraps>
...
801076e2:	6a 00                	push   $0x0
  pushl $153
801076e4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801076e9:	e9 c6 f3 ff ff       	jmp    80106ab4 <alltraps>
...
801076ee:	6a 00                	push   $0x0
  pushl $154
801076f0:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801076f5:	e9 ba f3 ff ff       	jmp    80106ab4 <alltraps>
...
801076fa:	6a 00                	push   $0x0
  pushl $155
801076fc:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107701:	e9 ae f3 ff ff       	jmp    80106ab4 <alltraps>
...
80107706:	6a 00                	push   $0x0
  pushl $156
80107708:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010770d:	e9 a2 f3 ff ff       	jmp    80106ab4 <alltraps>
...
80107712:	6a 00                	push   $0x0
  pushl $157
80107714:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107719:	e9 96 f3 ff ff       	jmp    80106ab4 <alltraps>
...
8010771e:	6a 00                	push   $0x0
  pushl $158
80107720:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107725:	e9 8a f3 ff ff       	jmp    80106ab4 <alltraps>
...
8010772a:	6a 00                	push   $0x0
  pushl $159
8010772c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107731:	e9 7e f3 ff ff       	jmp    80106ab4 <alltraps>
...
80107736:	6a 00                	push   $0x0
  pushl $160
80107738:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010773d:	e9 72 f3 ff ff       	jmp    80106ab4 <alltraps>
...
80107742:	6a 00                	push   $0x0
  pushl $161
80107744:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107749:	e9 66 f3 ff ff       	jmp    80106ab4 <alltraps>
...
8010774e:	6a 00                	push   $0x0
  pushl $162
80107750:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107755:	e9 5a f3 ff ff       	jmp    80106ab4 <alltraps>
...
8010775a:	6a 00                	push   $0x0
  pushl $163
8010775c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107761:	e9 4e f3 ff ff       	jmp    80106ab4 <alltraps>
...
80107766:	6a 00                	push   $0x0
  pushl $164
80107768:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010776d:	e9 42 f3 ff ff       	jmp    80106ab4 <alltraps>
...
80107772:	6a 00                	push   $0x0
  pushl $165
80107774:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107779:	e9 36 f3 ff ff       	jmp    80106ab4 <alltraps>
...
8010777e:	6a 00                	push   $0x0
  pushl $166
80107780:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107785:	e9 2a f3 ff ff       	jmp    80106ab4 <alltraps>
...
8010778a:	6a 00                	push   $0x0
  pushl $167
8010778c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107791:	e9 1e f3 ff ff       	jmp    80106ab4 <alltraps>
...
80107796:	6a 00                	push   $0x0
  pushl $168
80107798:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010779d:	e9 12 f3 ff ff       	jmp    80106ab4 <alltraps>
...
801077a2:	6a 00                	push   $0x0
  pushl $169
801077a4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801077a9:	e9 06 f3 ff ff       	jmp    80106ab4 <alltraps>
...
801077ae:	6a 00                	push   $0x0
  pushl $170
801077b0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801077b5:	e9 fa f2 ff ff       	jmp    80106ab4 <alltraps>
...
801077ba:	6a 00                	push   $0x0
  pushl $171
801077bc:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801077c1:	e9 ee f2 ff ff       	jmp    80106ab4 <alltraps>
...
801077c6:	6a 00                	push   $0x0
  pushl $172
801077c8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801077cd:	e9 e2 f2 ff ff       	jmp    80106ab4 <alltraps>
...
801077d2:	6a 00                	push   $0x0
  pushl $173
801077d4:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801077d9:	e9 d6 f2 ff ff       	jmp    80106ab4 <alltraps>
...
801077de:	6a 00                	push   $0x0
  pushl $174
801077e0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801077e5:	e9 ca f2 ff ff       	jmp    80106ab4 <alltraps>
...
801077ea:	6a 00                	push   $0x0
  pushl $175
801077ec:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801077f1:	e9 be f2 ff ff       	jmp    80106ab4 <alltraps>
...
801077f6:	6a 00                	push   $0x0
  pushl $176
801077f8:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801077fd:	e9 b2 f2 ff ff       	jmp    80106ab4 <alltraps>
...
80107802:	6a 00                	push   $0x0
  pushl $177
80107804:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107809:	e9 a6 f2 ff ff       	jmp    80106ab4 <alltraps>
...
8010780e:	6a 00                	push   $0x0
  pushl $178
80107810:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107815:	e9 9a f2 ff ff       	jmp    80106ab4 <alltraps>
...
8010781a:	6a 00                	push   $0x0
  pushl $179
8010781c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107821:	e9 8e f2 ff ff       	jmp    80106ab4 <alltraps>
...
80107826:	6a 00                	push   $0x0
  pushl $180
80107828:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010782d:	e9 82 f2 ff ff       	jmp    80106ab4 <alltraps>
...
80107832:	6a 00                	push   $0x0
  pushl $181
80107834:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107839:	e9 76 f2 ff ff       	jmp    80106ab4 <alltraps>
...
8010783e:	6a 00                	push   $0x0
  pushl $182
80107840:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107845:	e9 6a f2 ff ff       	jmp    80106ab4 <alltraps>
...
8010784a:	6a 00                	push   $0x0
  pushl $183
8010784c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107851:	e9 5e f2 ff ff       	jmp    80106ab4 <alltraps>
...
80107856:	6a 00                	push   $0x0
  pushl $184
80107858:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010785d:	e9 52 f2 ff ff       	jmp    80106ab4 <alltraps>
...
80107862:	6a 00                	push   $0x0
  pushl $185
80107864:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107869:	e9 46 f2 ff ff       	jmp    80106ab4 <alltraps>
...
8010786e:	6a 00                	push   $0x0
  pushl $186
80107870:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107875:	e9 3a f2 ff ff       	jmp    80106ab4 <alltraps>
...
8010787a:	6a 00                	push   $0x0
  pushl $187
8010787c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107881:	e9 2e f2 ff ff       	jmp    80106ab4 <alltraps>
...
80107886:	6a 00                	push   $0x0
  pushl $188
80107888:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010788d:	e9 22 f2 ff ff       	jmp    80106ab4 <alltraps>
...
80107892:	6a 00                	push   $0x0
  pushl $189
80107894:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107899:	e9 16 f2 ff ff       	jmp    80106ab4 <alltraps>
...
8010789e:	6a 00                	push   $0x0
  pushl $190
801078a0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801078a5:	e9 0a f2 ff ff       	jmp    80106ab4 <alltraps>
...
801078aa:	6a 00                	push   $0x0
  pushl $191
801078ac:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801078b1:	e9 fe f1 ff ff       	jmp    80106ab4 <alltraps>
...
801078b6:	6a 00                	push   $0x0
  pushl $192
801078b8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801078bd:	e9 f2 f1 ff ff       	jmp    80106ab4 <alltraps>
...
801078c2:	6a 00                	push   $0x0
  pushl $193
801078c4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801078c9:	e9 e6 f1 ff ff       	jmp    80106ab4 <alltraps>
...
801078ce:	6a 00                	push   $0x0
  pushl $194
801078d0:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801078d5:	e9 da f1 ff ff       	jmp    80106ab4 <alltraps>
...
801078da:	6a 00                	push   $0x0
  pushl $195
801078dc:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801078e1:	e9 ce f1 ff ff       	jmp    80106ab4 <alltraps>
...
801078e6:	6a 00                	push   $0x0
  pushl $196
801078e8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801078ed:	e9 c2 f1 ff ff       	jmp    80106ab4 <alltraps>
...
801078f2:	6a 00                	push   $0x0
  pushl $197
801078f4:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801078f9:	e9 b6 f1 ff ff       	jmp    80106ab4 <alltraps>
...
801078fe:	6a 00                	push   $0x0
  pushl $198
80107900:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107905:	e9 aa f1 ff ff       	jmp    80106ab4 <alltraps>
...
8010790a:	6a 00                	push   $0x0
  pushl $199
8010790c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107911:	e9 9e f1 ff ff       	jmp    80106ab4 <alltraps>
...
80107916:	6a 00                	push   $0x0
  pushl $200
80107918:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010791d:	e9 92 f1 ff ff       	jmp    80106ab4 <alltraps>
...
80107922:	6a 00                	push   $0x0
  pushl $201
80107924:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107929:	e9 86 f1 ff ff       	jmp    80106ab4 <alltraps>
...
8010792e:	6a 00                	push   $0x0
  pushl $202
80107930:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107935:	e9 7a f1 ff ff       	jmp    80106ab4 <alltraps>
...
8010793a:	6a 00                	push   $0x0
  pushl $203
8010793c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107941:	e9 6e f1 ff ff       	jmp    80106ab4 <alltraps>
...
80107946:	6a 00                	push   $0x0
  pushl $204
80107948:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010794d:	e9 62 f1 ff ff       	jmp    80106ab4 <alltraps>
...
80107952:	6a 00                	push   $0x0
  pushl $205
80107954:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107959:	e9 56 f1 ff ff       	jmp    80106ab4 <alltraps>
...
8010795e:	6a 00                	push   $0x0
  pushl $206
80107960:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107965:	e9 4a f1 ff ff       	jmp    80106ab4 <alltraps>
...
8010796a:	6a 00                	push   $0x0
  pushl $207
8010796c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107971:	e9 3e f1 ff ff       	jmp    80106ab4 <alltraps>
...
80107976:	6a 00                	push   $0x0
  pushl $208
80107978:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010797d:	e9 32 f1 ff ff       	jmp    80106ab4 <alltraps>
...
80107982:	6a 00                	push   $0x0
  pushl $209
80107984:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107989:	e9 26 f1 ff ff       	jmp    80106ab4 <alltraps>
...
8010798e:	6a 00                	push   $0x0
  pushl $210
80107990:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107995:	e9 1a f1 ff ff       	jmp    80106ab4 <alltraps>
...
8010799a:	6a 00                	push   $0x0
  pushl $211
8010799c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801079a1:	e9 0e f1 ff ff       	jmp    80106ab4 <alltraps>
...
801079a6:	6a 00                	push   $0x0
  pushl $212
801079a8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801079ad:	e9 02 f1 ff ff       	jmp    80106ab4 <alltraps>
...
801079b2:	6a 00                	push   $0x0
  pushl $213
801079b4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801079b9:	e9 f6 f0 ff ff       	jmp    80106ab4 <alltraps>
...
801079be:	6a 00                	push   $0x0
  pushl $214
801079c0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801079c5:	e9 ea f0 ff ff       	jmp    80106ab4 <alltraps>
...
801079ca:	6a 00                	push   $0x0
  pushl $215
801079cc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801079d1:	e9 de f0 ff ff       	jmp    80106ab4 <alltraps>
...
801079d6:	6a 00                	push   $0x0
  pushl $216
801079d8:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801079dd:	e9 d2 f0 ff ff       	jmp    80106ab4 <alltraps>
...
801079e2:	6a 00                	push   $0x0
  pushl $217
801079e4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801079e9:	e9 c6 f0 ff ff       	jmp    80106ab4 <alltraps>
...
801079ee:	6a 00                	push   $0x0
  pushl $218
801079f0:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801079f5:	e9 ba f0 ff ff       	jmp    80106ab4 <alltraps>
...
801079fa:	6a 00                	push   $0x0
  pushl $219
801079fc:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107a01:	e9 ae f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a06:	6a 00                	push   $0x0
  pushl $220
80107a08:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107a0d:	e9 a2 f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a12:	6a 00                	push   $0x0
  pushl $221
80107a14:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107a19:	e9 96 f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a1e:	6a 00                	push   $0x0
  pushl $222
80107a20:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107a25:	e9 8a f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a2a:	6a 00                	push   $0x0
  pushl $223
80107a2c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107a31:	e9 7e f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a36:	6a 00                	push   $0x0
  pushl $224
80107a38:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107a3d:	e9 72 f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a42:	6a 00                	push   $0x0
  pushl $225
80107a44:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107a49:	e9 66 f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a4e:	6a 00                	push   $0x0
  pushl $226
80107a50:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107a55:	e9 5a f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a5a:	6a 00                	push   $0x0
  pushl $227
80107a5c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107a61:	e9 4e f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a66:	6a 00                	push   $0x0
  pushl $228
80107a68:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107a6d:	e9 42 f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a72:	6a 00                	push   $0x0
  pushl $229
80107a74:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107a79:	e9 36 f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a7e:	6a 00                	push   $0x0
  pushl $230
80107a80:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107a85:	e9 2a f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a8a:	6a 00                	push   $0x0
  pushl $231
80107a8c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107a91:	e9 1e f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107a96:	6a 00                	push   $0x0
  pushl $232
80107a98:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107a9d:	e9 12 f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107aa2:	6a 00                	push   $0x0
  pushl $233
80107aa4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107aa9:	e9 06 f0 ff ff       	jmp    80106ab4 <alltraps>
...
80107aae:	6a 00                	push   $0x0
  pushl $234
80107ab0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107ab5:	e9 fa ef ff ff       	jmp    80106ab4 <alltraps>
...
80107aba:	6a 00                	push   $0x0
  pushl $235
80107abc:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107ac1:	e9 ee ef ff ff       	jmp    80106ab4 <alltraps>
...
80107ac6:	6a 00                	push   $0x0
  pushl $236
80107ac8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107acd:	e9 e2 ef ff ff       	jmp    80106ab4 <alltraps>
...
80107ad2:	6a 00                	push   $0x0
  pushl $237
80107ad4:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107ad9:	e9 d6 ef ff ff       	jmp    80106ab4 <alltraps>
...
80107ade:	6a 00                	push   $0x0
  pushl $238
80107ae0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107ae5:	e9 ca ef ff ff       	jmp    80106ab4 <alltraps>
...
80107aea:	6a 00                	push   $0x0
  pushl $239
80107aec:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107af1:	e9 be ef ff ff       	jmp    80106ab4 <alltraps>
...
80107af6:	6a 00                	push   $0x0
  pushl $240
80107af8:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107afd:	e9 b2 ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b02:	6a 00                	push   $0x0
  pushl $241
80107b04:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107b09:	e9 a6 ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b0e:	6a 00                	push   $0x0
  pushl $242
80107b10:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107b15:	e9 9a ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b1a:	6a 00                	push   $0x0
  pushl $243
80107b1c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107b21:	e9 8e ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b26:	6a 00                	push   $0x0
  pushl $244
80107b28:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107b2d:	e9 82 ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b32:	6a 00                	push   $0x0
  pushl $245
80107b34:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107b39:	e9 76 ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b3e:	6a 00                	push   $0x0
  pushl $246
80107b40:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107b45:	e9 6a ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b4a:	6a 00                	push   $0x0
  pushl $247
80107b4c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107b51:	e9 5e ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b56:	6a 00                	push   $0x0
  pushl $248
80107b58:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107b5d:	e9 52 ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b62:	6a 00                	push   $0x0
  pushl $249
80107b64:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107b69:	e9 46 ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b6e:	6a 00                	push   $0x0
  pushl $250
80107b70:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107b75:	e9 3a ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b7a:	6a 00                	push   $0x0
  pushl $251
80107b7c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107b81:	e9 2e ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b86:	6a 00                	push   $0x0
  pushl $252
80107b88:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107b8d:	e9 22 ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b92:	6a 00                	push   $0x0
  pushl $253
80107b94:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107b99:	e9 16 ef ff ff       	jmp    80106ab4 <alltraps>
...
80107b9e:	6a 00                	push   $0x0
  pushl $254
80107ba0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107ba5:	e9 0a ef ff ff       	jmp    80106ab4 <alltraps>
...
80107baa:	6a 00                	push   $0x0
  pushl $255
80107bac:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107bb1:	e9 fe ee ff ff       	jmp    80106ab4 <alltraps>
	...
...
80107bea:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107bee:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107bf2:	0f 00 d8             	ltr    %ax
}
80107bf5:	c9                   	leave  
80107bf6:	c3                   	ret    
...
80107c00:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107c04:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107c08:	8e e8                	mov    %eax,%gs
}
80107c0a:	c9                   	leave  
80107c0b:	c3                   	ret    
...
80107c1d:	05 00 00 00 80       	add    $0x80000000,%eax
80107c22:	5d                   	pop    %ebp
80107c23:	c3                   	ret    
...
80107c35:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107c38:	e8 86 b2 ff ff       	call   80102ec3 <cpunum>
80107c3d:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107c43:	05 80 33 11 80       	add    $0x80113380,%eax
80107c48:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107c4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c4e:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107c54:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c57:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107c5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c60:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107c64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c67:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107c6b:	83 e2 f0             	and    $0xfffffff0,%edx
80107c6e:	83 ca 0a             	or     $0xa,%edx
...
80107c84:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
...
80107cdf:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107ce3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ce6:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107ced:	ff ff 
80107cef:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cf2:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107cf9:	00 00 
80107cfb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cfe:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107d05:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d08:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107d0f:	83 e2 f0             	and    $0xfffffff0,%edx
80107d12:	83 ca 02             	or     $0x2,%edx
80107d15:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107d1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d1e:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
...
80107d3b:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107d41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d44:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107d4b:	83 ca 80             	or     $0xffffff80,%edx
80107d4e:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107d54:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d57:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107d5e:	83 ca 0f             	or     $0xf,%edx
80107d61:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107d67:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d6a:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107d71:	83 e2 ef             	and    $0xffffffef,%edx
80107d74:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107d7a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d7d:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107d84:	83 e2 df             	and    $0xffffffdf,%edx
80107d87:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107d8d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d90:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107d97:	83 ca 40             	or     $0x40,%edx
80107d9a:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107da0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107da3:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107daa:	83 ca 80             	or     $0xffffff80,%edx
80107dad:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107db3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107db6:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107dbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc0:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107dc7:	ff ff 
80107dc9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dcc:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107dd3:	00 00 
80107dd5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dd8:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80107ddf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107de2:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107de9:	83 e2 f0             	and    $0xfffffff0,%edx
80107dec:	83 ca 0a             	or     $0xa,%edx
80107def:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107df5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107df8:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107dff:	83 ca 10             	or     $0x10,%edx
80107e02:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107e08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e0b:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107e12:	83 ca 60             	or     $0x60,%edx
80107e15:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107e1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e1e:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107e25:	83 ca 80             	or     $0xffffff80,%edx
80107e28:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107e2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e31:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e38:	83 ca 0f             	or     $0xf,%edx
80107e3b:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107e41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e44:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e4b:	83 e2 ef             	and    $0xffffffef,%edx
80107e4e:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107e54:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e57:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e5e:	83 e2 df             	and    $0xffffffdf,%edx
80107e61:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107e67:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e6a:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e71:	83 ca 40             	or     $0x40,%edx
80107e74:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
...
80107e90:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107e97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e9a:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80107ea1:	ff ff 
80107ea3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ea6:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107ead:	00 00 
80107eaf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eb2:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80107eb9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ebc:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107ec3:	83 e2 f0             	and    $0xfffffff0,%edx
80107ec6:	83 ca 02             	or     $0x2,%edx
80107ec9:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107ecf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ed2:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107ed9:	83 ca 10             	or     $0x10,%edx
80107edc:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107ee2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ee5:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107eec:	83 ca 60             	or     $0x60,%edx
80107eef:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107ef5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ef8:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107eff:	83 ca 80             	or     $0xffffff80,%edx
80107f02:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107f08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f0b:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f12:	83 ca 0f             	or     $0xf,%edx
80107f15:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107f1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f1e:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f25:	83 e2 ef             	and    $0xffffffef,%edx
80107f28:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107f2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f31:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f38:	83 e2 df             	and    $0xffffffdf,%edx
80107f3b:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107f41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f44:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f4b:	83 ca 40             	or     $0x40,%edx
80107f4e:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
...
80107f6a:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107f71:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f74:	05 b4 00 00 00       	add    $0xb4,%eax
80107f79:	89 c3                	mov    %eax,%ebx
80107f7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f7e:	05 b4 00 00 00       	add    $0xb4,%eax
80107f83:	c1 e8 10             	shr    $0x10,%eax
80107f86:	89 c1                	mov    %eax,%ecx
80107f88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f8b:	05 b4 00 00 00       	add    $0xb4,%eax
80107f90:	c1 e8 18             	shr    $0x18,%eax
80107f93:	89 c2                	mov    %eax,%edx
80107f95:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f98:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107f9f:	00 00 
80107fa1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fa4:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107fab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fae:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107fb4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb7:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107fbe:	83 e1 f0             	and    $0xfffffff0,%ecx
80107fc1:	83 c9 02             	or     $0x2,%ecx
80107fc4:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107fca:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fcd:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107fd4:	83 c9 10             	or     $0x10,%ecx
80107fd7:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107fdd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fe0:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107fe7:	83 e1 9f             	and    $0xffffff9f,%ecx
80107fea:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107ff0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ff3:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107ffa:	83 c9 80             	or     $0xffffff80,%ecx
80107ffd:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108003:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108006:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010800d:	83 e1 f0             	and    $0xfffffff0,%ecx
80108010:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108016:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108019:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108020:	83 e1 ef             	and    $0xffffffef,%ecx
80108023:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108029:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010802c:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108033:	83 e1 df             	and    $0xffffffdf,%ecx
80108036:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010803c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010803f:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108046:	83 c9 40             	or     $0x40,%ecx
80108049:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010804f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108052:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108059:	83 c9 80             	or     $0xffffff80,%ecx
8010805c:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108062:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108065:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
8010806b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010806e:	83 c0 70             	add    $0x70,%eax
80108071:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80108078:	00 
80108079:	89 04 24             	mov    %eax,(%esp)
8010807c:	e8 37 fb ff ff       	call   80107bb8 <lgdt>
  loadgs(SEG_KCPU << 3);
80108081:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80108088:	e8 6a fb ff ff       	call   80107bf7 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
8010808d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108090:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80108096:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
8010809d:	00 00 00 00 
}
801080a1:	83 c4 24             	add    $0x24,%esp
801080a4:	5b                   	pop    %ebx
801080a5:	5d                   	pop    %ebp
801080a6:	c3                   	ret    
...
801080aa:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801080ad:	8b 45 0c             	mov    0xc(%ebp),%eax
801080b0:	c1 e8 16             	shr    $0x16,%eax
801080b3:	c1 e0 02             	shl    $0x2,%eax
801080b6:	03 45 08             	add    0x8(%ebp),%eax
...
801080c4:	84 c0                	test   %al,%al
801080c6:	74 17                	je     801080df <walkpgdir+0x38>
...
801080d5:	e8 4a fb ff ff       	call   80107c24 <p2v>
801080da:	89 45 f4             	mov    %eax,-0xc(%ebp)
801080dd:	eb 4b                	jmp    8010812a <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801080df:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801080e3:	74 0e                	je     801080f3 <walkpgdir+0x4c>
801080e5:	e8 21 aa ff ff       	call   80102b0b <kalloc>
801080ea:	89 45 f4             	mov    %eax,-0xc(%ebp)
801080ed:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801080f1:	75 07                	jne    801080fa <walkpgdir+0x53>
      return 0;
801080f3:	b8 00 00 00 00       	mov    $0x0,%eax
801080f8:	eb 41                	jmp    8010813b <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
801080fa:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108101:	00 
80108102:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108109:	00 
8010810a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010810d:	89 04 24             	mov    %eax,(%esp)
80108110:	e8 49 d4 ff ff       	call   8010555e <memset>
...
8010811b:	e8 f7 fa ff ff       	call   80107c17 <v2p>
80108120:	89 c2                	mov    %eax,%edx
80108122:	83 ca 07             	or     $0x7,%edx
...
80108135:	c1 e0 02             	shl    $0x2,%eax
80108138:	03 45 f4             	add    -0xc(%ebp),%eax
}
8010813b:	c9                   	leave  
8010813c:	c3                   	ret    
...
80108151:	03 45 10             	add    0x10(%ebp),%eax
80108154:	83 e8 01             	sub    $0x1,%eax
80108157:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010815c:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010815f:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80108166:	00 
80108167:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010816a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010816e:	8b 45 08             	mov    0x8(%ebp),%eax
80108171:	89 04 24             	mov    %eax,(%esp)
80108174:	e8 2e ff ff ff       	call   801080a7 <walkpgdir>
80108179:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010817c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108180:	75 07                	jne    80108189 <mappages+0x4c>
      return -1;
80108182:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108187:	eb 46                	jmp    801081cf <mappages+0x92>
    if(*pte & PTE_P)
80108189:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010818c:	8b 00                	mov    (%eax),%eax
8010818e:	83 e0 01             	and    $0x1,%eax
80108191:	84 c0                	test   %al,%al
80108193:	74 0c                	je     801081a1 <mappages+0x64>
      panic("remap");
80108195:	c7 04 24 f4 8f 10 80 	movl   $0x80108ff4,(%esp)
8010819c:	e8 9c 83 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
801081a1:	8b 45 18             	mov    0x18(%ebp),%eax
801081a4:	0b 45 14             	or     0x14(%ebp),%eax
801081a7:	89 c2                	mov    %eax,%edx
801081a9:	83 ca 01             	or     $0x1,%edx
801081ac:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081af:	89 10                	mov    %edx,(%eax)
    if(a == last)
801081b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081b4:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801081b7:	74 10                	je     801081c9 <mappages+0x8c>
      break;
    a += PGSIZE;
801081b9:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
801081c0:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
801081c7:	eb 96                	jmp    8010815f <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
801081d5:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
801081d8:	e8 2e a9 ff ff       	call   80102b0b <kalloc>
801081dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
801081e0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801081e4:	75 0a                	jne    801081f0 <setupkvm+0x1f>
    return 0;
801081e6:	b8 00 00 00 00       	mov    $0x0,%eax
801081eb:	e9 98 00 00 00       	jmp    80108288 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
801081f0:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801081f7:	00 
801081f8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801081ff:	00 
80108200:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108203:	89 04 24             	mov    %eax,(%esp)
80108206:	e8 53 d3 ff ff       	call   8010555e <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
8010820b:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108212:	e8 0d fa ff ff       	call   80107c24 <p2v>
80108217:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
8010821c:	76 0c                	jbe    8010822a <setupkvm+0x59>
    panic("PHYSTOP too high");
8010821e:	c7 04 24 fa 8f 10 80 	movl   $0x80108ffa,(%esp)
80108225:	e8 13 83 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010822a:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
80108231:	eb 49                	jmp    8010827c <setupkvm+0xab>
...
80108252:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80108256:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010825a:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010825e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108262:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108265:	89 04 24             	mov    %eax,(%esp)
80108268:	e8 d0 fe ff ff       	call   8010813d <mappages>
8010826d:	85 c0                	test   %eax,%eax
8010826f:	79 07                	jns    80108278 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80108271:	b8 00 00 00 00       	mov    $0x0,%eax
80108276:	eb 10                	jmp    80108288 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108278:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
8010827c:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
80108283:	72 ae                	jb     80108233 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
80108285:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80108288:	83 c4 34             	add    $0x34,%esp
8010828b:	5b                   	pop    %ebx
8010828c:	5d                   	pop    %ebp
8010828d:	c3                   	ret    
...
80108291:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80108294:	e8 38 ff ff ff       	call   801081d1 <setupkvm>
80108299:	a3 58 63 11 80       	mov    %eax,0x80116358
  switchkvm();
8010829e:	e8 02 00 00 00       	call   801082a5 <switchkvm>
}
801082a3:	c9                   	leave  
801082a4:	c3                   	ret    
...
801082ab:	a1 58 63 11 80       	mov    0x80116358,%eax
801082b0:	89 04 24             	mov    %eax,(%esp)
801082b3:	e8 5f f9 ff ff       	call   80107c17 <v2p>
801082b8:	89 04 24             	mov    %eax,(%esp)
801082bb:	e8 4c f9 ff ff       	call   80107c0c <lcr3>
}
801082c0:	c9                   	leave  
801082c1:	c3                   	ret    
...
801082c6:	83 ec 14             	sub    $0x14,%esp
  pushcli();
801082c9:	e8 89 d1 ff ff       	call   80105457 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801082ce:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801082d4:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801082db:	83 c2 08             	add    $0x8,%edx
801082de:	89 d3                	mov    %edx,%ebx
801082e0:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801082e7:	83 c2 08             	add    $0x8,%edx
801082ea:	c1 ea 10             	shr    $0x10,%edx
801082ed:	89 d1                	mov    %edx,%ecx
801082ef:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801082f6:	83 c2 08             	add    $0x8,%edx
801082f9:	c1 ea 18             	shr    $0x18,%edx
801082fc:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80108303:	67 00 
80108305:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
8010830c:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80108312:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108319:	83 e1 f0             	and    $0xfffffff0,%ecx
8010831c:	83 c9 09             	or     $0x9,%ecx
8010831f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108325:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010832c:	83 c9 10             	or     $0x10,%ecx
8010832f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108335:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010833c:	83 e1 9f             	and    $0xffffff9f,%ecx
8010833f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108345:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010834c:	83 c9 80             	or     $0xffffff80,%ecx
8010834f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108355:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010835c:	83 e1 f0             	and    $0xfffffff0,%ecx
8010835f:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108365:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010836c:	83 e1 ef             	and    $0xffffffef,%ecx
...
8010838c:	83 c9 40             	or     $0x40,%ecx
8010838f:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108395:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010839c:	83 e1 7f             	and    $0x7f,%ecx
8010839f:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801083a5:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801083ab:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801083b1:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
801083b8:	83 e2 ef             	and    $0xffffffef,%edx
801083bb:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
801083c1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801083c7:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
801083cd:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801083d3:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801083da:	8b 52 08             	mov    0x8(%edx),%edx
801083dd:	81 c2 00 10 00 00    	add    $0x1000,%edx
801083e3:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
801083e6:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
801083ed:	e8 ef f7 ff ff       	call   80107be1 <ltr>
  if(p->pgdir == 0)
801083f2:	8b 45 08             	mov    0x8(%ebp),%eax
801083f5:	8b 40 04             	mov    0x4(%eax),%eax
801083f8:	85 c0                	test   %eax,%eax
801083fa:	75 0c                	jne    80108408 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
801083fc:	c7 04 24 0b 90 10 80 	movl   $0x8010900b,(%esp)
80108403:	e8 35 81 ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80108408:	8b 45 08             	mov    0x8(%ebp),%eax
8010840b:	8b 40 04             	mov    0x4(%eax),%eax
8010840e:	89 04 24             	mov    %eax,(%esp)
80108411:	e8 01 f8 ff ff       	call   80107c17 <v2p>
80108416:	89 04 24             	mov    %eax,(%esp)
80108419:	e8 ee f7 ff ff       	call   80107c0c <lcr3>
  popcli();
8010841e:	e8 7c d0 ff ff       	call   8010549f <popcli>
}
80108423:	83 c4 14             	add    $0x14,%esp
80108426:	5b                   	pop    %ebx
80108427:	5d                   	pop    %ebp
80108428:	c3                   	ret    
...
8010842c:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
8010842f:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80108436:	76 0c                	jbe    80108444 <inituvm+0x1b>
    panic("inituvm: more than a page");
80108438:	c7 04 24 1f 90 10 80 	movl   $0x8010901f,(%esp)
8010843f:	e8 f9 80 ff ff       	call   8010053d <panic>
  mem = kalloc();
80108444:	e8 c2 a6 ff ff       	call   80102b0b <kalloc>
80108449:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
8010844c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108453:	00 
80108454:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010845b:	00 
8010845c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010845f:	89 04 24             	mov    %eax,(%esp)
80108462:	e8 f7 d0 ff ff       	call   8010555e <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108467:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010846a:	89 04 24             	mov    %eax,(%esp)
8010846d:	e8 a5 f7 ff ff       	call   80107c17 <v2p>
80108472:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108479:	00 
8010847a:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010847e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108485:	00 
80108486:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010848d:	00 
8010848e:	8b 45 08             	mov    0x8(%ebp),%eax
80108491:	89 04 24             	mov    %eax,(%esp)
80108494:	e8 a4 fc ff ff       	call   8010813d <mappages>
  memmove(mem, init, sz);
80108499:	8b 45 10             	mov    0x10(%ebp),%eax
8010849c:	89 44 24 08          	mov    %eax,0x8(%esp)
801084a0:	8b 45 0c             	mov    0xc(%ebp),%eax
801084a3:	89 44 24 04          	mov    %eax,0x4(%esp)
801084a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084aa:	89 04 24             	mov    %eax,(%esp)
801084ad:	e8 7f d1 ff ff       	call   80105631 <memmove>
}
801084b2:	c9                   	leave  
801084b3:	c3                   	ret    
...
801084b8:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
801084bb:	8b 45 0c             	mov    0xc(%ebp),%eax
801084be:	25 ff 0f 00 00       	and    $0xfff,%eax
801084c3:	85 c0                	test   %eax,%eax
801084c5:	74 0c                	je     801084d3 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
801084c7:	c7 04 24 3c 90 10 80 	movl   $0x8010903c,(%esp)
801084ce:	e8 6a 80 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
801084d3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801084da:	e9 ad 00 00 00       	jmp    8010858c <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
801084df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084e2:	8b 55 0c             	mov    0xc(%ebp),%edx
801084e5:	01 d0                	add    %edx,%eax
801084e7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801084ee:	00 
801084ef:	89 44 24 04          	mov    %eax,0x4(%esp)
801084f3:	8b 45 08             	mov    0x8(%ebp),%eax
801084f6:	89 04 24             	mov    %eax,(%esp)
801084f9:	e8 a9 fb ff ff       	call   801080a7 <walkpgdir>
801084fe:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108501:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108505:	75 0c                	jne    80108513 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108507:	c7 04 24 5f 90 10 80 	movl   $0x8010905f,(%esp)
8010850e:	e8 2a 80 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
...
80108523:	8b 55 18             	mov    0x18(%ebp),%edx
80108526:	89 d1                	mov    %edx,%ecx
80108528:	29 c1                	sub    %eax,%ecx
8010852a:	89 c8                	mov    %ecx,%eax
8010852c:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108531:	77 11                	ja     80108544 <loaduvm+0x90>
      n = sz - i;
80108533:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108536:	8b 55 18             	mov    0x18(%ebp),%edx
80108539:	89 d1                	mov    %edx,%ecx
8010853b:	29 c1                	sub    %eax,%ecx
8010853d:	89 c8                	mov    %ecx,%eax
8010853f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108542:	eb 07                	jmp    8010854b <loaduvm+0x97>
    else
      n = PGSIZE;
80108544:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
8010854b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010854e:	8b 55 14             	mov    0x14(%ebp),%edx
80108551:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108554:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108557:	89 04 24             	mov    %eax,(%esp)
8010855a:	e8 c5 f6 ff ff       	call   80107c24 <p2v>
...
80108574:	e8 f1 97 ff ff       	call   80101d6a <readi>
80108579:	3b 45 f0             	cmp    -0x10(%ebp),%eax
8010857c:	74 07                	je     80108585 <loaduvm+0xd1>
      return -1;
8010857e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108583:	eb 18                	jmp    8010859d <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80108585:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010858c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010858f:	3b 45 18             	cmp    0x18(%ebp),%eax
80108592:	0f 82 47 ff ff ff    	jb     801084df <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
8010859d:	83 c4 24             	add    $0x24,%esp
801085a0:	5b                   	pop    %ebx
801085a1:	5d                   	pop    %ebp
801085a2:	c3                   	ret    
...
801085a6:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
801085ae:	79 0a                	jns    801085ba <allocuvm+0x17>
    return 0;
801085b0:	b8 00 00 00 00       	mov    $0x0,%eax
801085b5:	e9 c1 00 00 00       	jmp    8010867b <allocuvm+0xd8>
  if(newsz < oldsz)
801085ba:	8b 45 10             	mov    0x10(%ebp),%eax
801085bd:	3b 45 0c             	cmp    0xc(%ebp),%eax
801085c0:	73 08                	jae    801085ca <allocuvm+0x27>
    return oldsz;
801085c2:	8b 45 0c             	mov    0xc(%ebp),%eax
801085c5:	e9 b1 00 00 00       	jmp    8010867b <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
801085ca:	8b 45 0c             	mov    0xc(%ebp),%eax
801085cd:	05 ff 0f 00 00       	add    $0xfff,%eax
801085d2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801085d7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
801085da:	e9 8d 00 00 00       	jmp    8010866c <allocuvm+0xc9>
    mem = kalloc();
801085df:	e8 27 a5 ff ff       	call   80102b0b <kalloc>
801085e4:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
801085e7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801085eb:	75 2c                	jne    80108619 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
801085ed:	c7 04 24 7d 90 10 80 	movl   $0x8010907d,(%esp)
801085f4:	e8 a8 7d ff ff       	call   801003a1 <cprintf>
...
8010860d:	e8 6b 00 00 00       	call   8010867d <deallocuvm>
      return 0;
80108612:	b8 00 00 00 00       	mov    $0x0,%eax
80108617:	eb 62                	jmp    8010867b <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108619:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108620:	00 
80108621:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108628:	00 
80108629:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010862c:	89 04 24             	mov    %eax,(%esp)
8010862f:	e8 2a cf ff ff       	call   8010555e <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108634:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108637:	89 04 24             	mov    %eax,(%esp)
8010863a:	e8 d8 f5 ff ff       	call   80107c17 <v2p>
8010863f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108642:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108649:	00 
8010864a:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010864e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108655:	00 
80108656:	89 54 24 04          	mov    %edx,0x4(%esp)
8010865a:	8b 45 08             	mov    0x8(%ebp),%eax
8010865d:	89 04 24             	mov    %eax,(%esp)
80108660:	e8 d8 fa ff ff       	call   8010813d <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80108665:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010866c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010866f:	3b 45 10             	cmp    0x10(%ebp),%eax
80108672:	0f 82 67 ff ff ff    	jb     801085df <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
80108680:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
80108689:	72 08                	jb     80108693 <deallocuvm+0x16>
    return oldsz;
8010868b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010868e:	e9 a4 00 00 00       	jmp    80108737 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80108693:	8b 45 10             	mov    0x10(%ebp),%eax
80108696:	05 ff 0f 00 00       	add    $0xfff,%eax
8010869b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801086a0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801086a3:	e9 80 00 00 00       	jmp    80108728 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
801086a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086ab:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801086b2:	00 
801086b3:	89 44 24 04          	mov    %eax,0x4(%esp)
801086b7:	8b 45 08             	mov    0x8(%ebp),%eax
801086ba:	89 04 24             	mov    %eax,(%esp)
801086bd:	e8 e5 f9 ff ff       	call   801080a7 <walkpgdir>
801086c2:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801086c5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801086c9:	75 09                	jne    801086d4 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801086cb:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
801086d2:	eb 4d                	jmp    80108721 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
801086d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801086d7:	8b 00                	mov    (%eax),%eax
801086d9:	83 e0 01             	and    $0x1,%eax
801086dc:	84 c0                	test   %al,%al
801086de:	74 41                	je     80108721 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
...
801086ea:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
801086ed:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801086f1:	75 0c                	jne    801086ff <deallocuvm+0x82>
        panic("kfree");
801086f3:	c7 04 24 95 90 10 80 	movl   $0x80109095,(%esp)
801086fa:	e8 3e 7e ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
801086ff:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108702:	89 04 24             	mov    %eax,(%esp)
80108705:	e8 1a f5 ff ff       	call   80107c24 <p2v>
8010870a:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
8010870d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108710:	89 04 24             	mov    %eax,(%esp)
80108713:	e8 5a a3 ff ff       	call   80102a72 <kfree>
      *pte = 0;
80108718:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010871b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80108721:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108728:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010872b:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010872e:	0f 82 74 ff ff ff    	jb     801086a8 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
8010873c:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
8010873f:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108743:	75 0c                	jne    80108751 <freevm+0x18>
    panic("freevm: no pgdir");
80108745:	c7 04 24 9b 90 10 80 	movl   $0x8010909b,(%esp)
8010874c:	e8 ec 7d ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108751:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108758:	00 
80108759:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108760:	80 
80108761:	8b 45 08             	mov    0x8(%ebp),%eax
80108764:	89 04 24             	mov    %eax,(%esp)
80108767:	e8 11 ff ff ff       	call   8010867d <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
8010876c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108773:	eb 3c                	jmp    801087b1 <freevm+0x78>
    if(pgdir[i] & PTE_P){
80108775:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108778:	c1 e0 02             	shl    $0x2,%eax
8010877b:	03 45 08             	add    0x8(%ebp),%eax
8010877e:	8b 00                	mov    (%eax),%eax
80108780:	83 e0 01             	and    $0x1,%eax
80108783:	84 c0                	test   %al,%al
80108785:	74 26                	je     801087ad <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
80108787:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010878a:	c1 e0 02             	shl    $0x2,%eax
8010878d:	03 45 08             	add    0x8(%ebp),%eax
80108790:	8b 00                	mov    (%eax),%eax
80108792:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108797:	89 04 24             	mov    %eax,(%esp)
8010879a:	e8 85 f4 ff ff       	call   80107c24 <p2v>
8010879f:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
801087a2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801087a5:	89 04 24             	mov    %eax,(%esp)
801087a8:	e8 c5 a2 ff ff       	call   80102a72 <kfree>
  uint i;
...
801087b8:	76 bb                	jbe    80108775 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801087c0:	e8 ad a2 ff ff       	call   80102a72 <kfree>
}
801087c5:	c9                   	leave  
801087c6:	c3                   	ret    
...
80108803:	83 e2 fb             	and    $0xfffffffb,%edx
...
80108811:	83 ec 44             	sub    $0x44,%esp
  ...
  if((d = setupkvm()) == 0)
80108814:	e8 b8 f9 ff ff       	call   801081d1 <setupkvm>
...
80108833:	e9 cc 00 00 00       	jmp    80108904 <copyuvm+0xf7>
...
8010884d:	e8 55 f8 ff ff       	call   801080a7 <walkpgdir>
80108852:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108855:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108859:	75 0c                	jne    80108867 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
8010885b:	c7 04 24 b6 90 10 80 	movl   $0x801090b6,(%esp)
80108862:	e8 d6 7c ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
...
80108873:	c7 04 24 d0 90 10 80 	movl   $0x801090d0,(%esp)
...
801088f4:	e8 44 f8 ff ff       	call   8010813d <mappages>
801088f9:	85 c0                	test   %eax,%eax
801088fb:	78 1b                	js     80108918 <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
...
8010890a:	0f 82 28 ff ff ff    	jb     80108838 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108913:	eb 14                	jmp    80108929 <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108915:	90                   	nop
80108916:	eb 01                	jmp    80108919 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
80108918:	90                   	nop
...
8010891f:	e8 15 fe ff ff       	call   80108739 <freevm>
  return 0;
...
8010894a:	e8 58 f7 ff ff       	call   801080a7 <walkpgdir>
...
80108985:	e8 9a f2 ff ff       	call   80107c24 <p2v>
}
8010898a:	c9                   	leave  
8010898b:	c3                   	ret    
...
80108995:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108998:	e9 8b 00 00 00       	jmp    80108a28 <copyout+0x9c>
...
801089c8:	eb 6d                	jmp    80108a37 <copyout+0xab>
    n = PGSIZE - (va - va0);
801089ca:	8b 45 0c             	mov    0xc(%ebp),%eax
801089cd:	8b 55 ec             	mov    -0x14(%ebp),%edx
801089d0:	89 d1                	mov    %edx,%ecx
801089d2:	29 c1                	sub    %eax,%ecx
801089d4:	89 c8                	mov    %ecx,%eax
801089d6:	05 00 10 00 00       	add    $0x1000,%eax
801089db:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801089de:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089e1:	3b 45 14             	cmp    0x14(%ebp),%eax
801089e4:	76 06                	jbe    801089ec <copyout+0x60>
      n = len;
801089e6:	8b 45 14             	mov    0x14(%ebp),%eax
801089e9:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
801089ec:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089ef:	8b 55 0c             	mov    0xc(%ebp),%edx
801089f2:	89 d1                	mov    %edx,%ecx
801089f4:	29 c1                	sub    %eax,%ecx
801089f6:	89 c8                	mov    %ecx,%eax
801089f8:	03 45 e8             	add    -0x18(%ebp),%eax
801089fb:	8b 55 f0             	mov    -0x10(%ebp),%edx
801089fe:	89 54 24 08          	mov    %edx,0x8(%esp)
80108a02:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108a05:	89 54 24 04          	mov    %edx,0x4(%esp)
80108a09:	89 04 24             	mov    %eax,(%esp)
80108a0c:	e8 20 cc ff ff       	call   80105631 <memmove>
    len -= n;
80108a11:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a14:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108a17:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a1a:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108a1d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a20:	05 00 10 00 00       	add    $0x1000,%eax
80108a25:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108a28:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108a2c:	0f 85 6b ff ff ff    	jne    8010899d <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
