...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 6c 09 00 	movl   $0x96c,0x4(%esp)
  16:	00 
  ...
  5a:	c7 44 24 04 83 09 00 	movl   $0x983,0x4(%esp)
  61:	00 
...
000003a8 <mutex_init>:
SYSCALL(mutex_init)
 3a8:	b8 1c 00 00 00       	mov    $0x1c,%eax
 3ad:	cd 40                	int    $0x40
 3af:	c3                   	ret    

000003b0 <mutex_destroy>:
SYSCALL(mutex_destroy)
 3b0:	b8 1d 00 00 00       	mov    $0x1d,%eax
 3b5:	cd 40                	int    $0x40
 3b7:	c3                   	ret    

000003b8 <mutex_lock>:
SYSCALL(mutex_lock)
 3b8:	b8 1e 00 00 00       	mov    $0x1e,%eax
 3bd:	cd 40                	int    $0x40
 3bf:	c3                   	ret    

000003c0 <mutex_unlock>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 436:	0f b6 90 c4 0c 00 00 	movzbl 0xcc4(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 595:	75 27                	jne    5be <printf+0x11f>
          s = "(null)";
 597:	c7 45 f4 9f 09 00 00 	movl   $0x99f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 663:	a1 e0 0c 00 00       	mov    0xce0,%eax
...
free(void *ap)
{
 ...
 724:	a3 e0 0c 00 00       	mov    %eax,0xce0
}
 729:	c9                   	leave  
 72a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 777:	e8 d8 fe ff ff       	call   654 <free>
  return freep;
 77c:	a1 e0 0c 00 00       	mov    0xce0,%eax
}
 781:	c9                   	leave  
 782:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 795:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 798:	a1 e0 0c 00 00       	mov    0xce0,%eax
 79d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7a4:	75 23                	jne    7c9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7a6:	c7 45 f0 d8 0c 00 00 	movl   $0xcd8,-0x10(%ebp)
 7ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b0:	a3 e0 0c 00 00       	mov    %eax,0xce0
 7b5:	a1 e0 0c 00 00       	mov    0xce0,%eax
 7ba:	a3 d8 0c 00 00       	mov    %eax,0xcd8
    base.s.size = 0;
 7bf:	c7 05 dc 0c 00 00 00 	movl   $0x0,0xcdc
 7c6:	00 00 00 
  }
 ...
 81c:	a3 e0 0c 00 00       	mov    %eax,0xce0
      return (void*)(p + 1);
 ...
 827:	eb 38                	jmp    861 <malloc+0xde>
    ...
    if(p == freep)
 829:	a1 e0 0c 00 00       	mov    0xce0,%eax
...
int pthread_join(pthread_t thread, void **retval){
 ...
 8cf:	8d 55 f4             	lea    -0xc(%ebp),%edx
 8d2:	89 54 24 04          	mov    %edx,0x4(%esp)
 8d6:	89 04 24             	mov    %eax,(%esp)
 8d9:	e8 ba fa ff ff       	call   398 <join>
...
int pthread_exit(void *retval){
 ...
 8fc:	e8 9f fa ff ff       	call   3a0 <texit>
...
00000908 <pthread_mutex_init>:


int pthread_mutex_init(pthread_mutex_t *mutex, const pthread_mutex_attr_t *attr){
 908:	55                   	push   %ebp
 909:	89 e5                	mov    %esp,%ebp
 90b:	83 ec 18             	sub    $0x18,%esp

	int mid = mutex_init();
 90e:	e8 95 fa ff ff       	call   3a8 <mutex_init>
...
0000091b <pthread_mutex_destroy>:
...
int pthread_mutex_destroy(pthread_mutex_t *mutex){
 ...
 92a:	e8 81 fa ff ff       	call   3b0 <mutex_destroy>
	return 0;
...
int pthread_mutex_lock(pthread_mutex_t *mutex){
 ...
 945:	e8 6e fa ff ff       	call   3b8 <mutex_lock>
	return 0;
...
int pthread_mutex_unlock(pthread_mutex_t *mutex){
 ...
 960:	e8 5b fa ff ff       	call   3c0 <mutex_unlock>
	return 0;
