...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 e8 64 00 00       	mov    0x64e8,%eax
       b:	c7 44 24 04 5e 45 00 	movl   $0x455e,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 60 40 00 00       	call   407b <printf>
  ...
  if(mkdir("iputdir") < 0){
    ...
    printf(stdout, "mkdir failed\n");
      2b:	a1 e8 64 00 00       	mov    0x64e8,%eax
      30:	c7 44 24 04 71 45 00 	movl   $0x4571,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 3b 40 00 00       	call   407b <printf>
    exit();
  ...
  if(chdir("iputdir") < 0){
    ...
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 e8 64 00 00       	mov    0x64e8,%eax
      5a:	c7 44 24 04 7f 45 00 	movl   $0x457f,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 11 40 00 00       	call   407b <printf>
    exit();
  ...
  if(unlink("../iputdir") < 0){
    ...
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 e8 64 00 00       	mov    0x64e8,%eax
      84:	c7 44 24 04 a0 45 00 	movl   $0x45a0,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 e7 3f 00 00       	call   407b <printf>
    exit();
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 e8 64 00 00       	mov    0x64e8,%eax
      e5:	c7 44 24 04 da 45 00 	movl   $0x45da,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 86 3f 00 00       	call   407b <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 e8 64 00 00       	mov    0x64e8,%eax
     108:	c7 44 24 04 e9 45 00 	movl   $0x45e9,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 63 3f 00 00       	call   407b <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 e8 64 00 00       	mov    0x64e8,%eax
     13c:	c7 44 24 04 71 45 00 	movl   $0x4571,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 2f 3f 00 00       	call   407b <printf>
      exit();
    ...
    if(chdir("iputdir") < 0){
     ...
     161:	a1 e8 64 00 00       	mov    0x64e8,%eax
     166:	c7 44 24 04 f6 45 00 	movl   $0x45f6,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 05 3f 00 00       	call   407b <printf>
      exit();
    ...
    if(unlink("../iputdir") < 0){
     ...
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 e8 64 00 00       	mov    0x64e8,%eax
     190:	c7 44 24 04 a0 45 00 	movl   $0x45a0,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 db 3e 00 00       	call   407b <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 e8 64 00 00       	mov    0x64e8,%eax
     1b4:	c7 44 24 04 0a 46 00 	movl   $0x460a,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 b7 3e 00 00       	call   407b <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 e8 64 00 00       	mov    0x64e8,%eax
     1d1:	c7 44 24 04 1c 46 00 	movl   $0x461c,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 9a 3e 00 00       	call   407b <printf>
  if(mkdir("oidir") < 0){
    ...
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 e8 64 00 00       	mov    0x64e8,%eax
     1f6:	c7 44 24 04 31 46 00 	movl   $0x4631,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 75 3e 00 00       	call   407b <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 e8 64 00 00       	mov    0x64e8,%eax
     21e:	c7 44 24 04 e9 45 00 	movl   $0x45e9,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 4d 3e 00 00       	call   407b <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     256:	a1 e8 64 00 00       	mov    0x64e8,%eax
     25b:	c7 44 24 04 48 46 00 	movl   $0x4648,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 10 3e 00 00       	call   407b <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
    ...
    printf(stdout, "unlink failed\n");
     291:	a1 e8 64 00 00       	mov    0x64e8,%eax
     296:	c7 44 24 04 6c 46 00 	movl   $0x466c,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 d5 3d 00 00       	call   407b <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 e8 64 00 00       	mov    0x64e8,%eax
     2b5:	c7 44 24 04 7b 46 00 	movl   $0x467b,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 b6 3d 00 00       	call   407b <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 e8 64 00 00       	mov    0x64e8,%eax
     2d2:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 99 3d 00 00       	call   407b <printf>
  fd = open("echo", 0);
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 e8 64 00 00       	mov    0x64e8,%eax
     304:	c7 44 24 04 98 46 00 	movl   $0x4698,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 67 3d 00 00       	call   407b <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 e8 64 00 00       	mov    0x64e8,%eax
     37d:	c7 44 24 04 e4 46 00 	movl   $0x46e4,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 ee 3c 00 00       	call   407b <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 e8 64 00 00       	mov    0x64e8,%eax
     3af:	c7 44 24 04 fb 46 00 	movl   $0x46fb,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 bc 3c 00 00       	call   407b <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 e8 64 00 00       	mov    0x64e8,%eax
     3d0:	c7 44 24 04 16 47 00 	movl   $0x4716,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 9b 3c 00 00       	call   407b <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     405:	a1 e8 64 00 00       	mov    0x64e8,%eax
     ...
     41c:	e8 5a 3c 00 00       	call   407b <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     446:	a1 e8 64 00 00       	mov    0x64e8,%eax
     ...
     45d:	e8 19 3c 00 00       	call   407b <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     475:	a1 e8 64 00 00       	mov    0x64e8,%eax
     47a:	c7 44 24 04 94 47 00 	movl   $0x4794,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 f1 3b 00 00       	call   407b <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b2:	a1 e8 64 00 00       	mov    0x64e8,%eax
     4b7:	c7 44 24 04 9f 47 00 	movl   $0x479f,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 b4 3b 00 00       	call   407b <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     4ce:	00 
     4cf:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
     4d6:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     4f0:	a1 e8 64 00 00       	mov    0x64e8,%eax
     4f5:	c7 44 24 04 b8 47 00 	movl   $0x47b8,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 76 3b 00 00       	call   407b <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     50a:	a1 e8 64 00 00       	mov    0x64e8,%eax
     50f:	c7 44 24 04 d3 47 00 	movl   $0x47d3,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 5c 3b 00 00       	call   407b <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     53c:	a1 e8 64 00 00       	mov    0x64e8,%eax
     541:	c7 44 24 04 e6 47 00 	movl   $0x47e6,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 2a 3b 00 00       	call   407b <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58d:	a1 e8 64 00 00       	mov    0x64e8,%eax
     592:	c7 44 24 04 1c 48 00 	movl   $0x481c,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 d9 3a 00 00       	call   407b <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5bf:	a1 e8 64 00 00       	mov    0x64e8,%eax
     5c4:	c7 44 24 04 30 48 00 	movl   $0x4830,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 a7 3a 00 00       	call   407b <printf>
    exit();
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     665:	a1 e8 64 00 00       	mov    0x64e8,%eax
     66a:	c7 44 24 04 68 48 00 	movl   $0x4868,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 01 3a 00 00       	call   407b <printf>
    exit();
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     68d:	00 
     68e:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
     695:	00 
    ...
    if(i == 0){
     ...
     6b7:	a1 e8 64 00 00       	mov    0x64e8,%eax
     6bc:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bf:	89 54 24 08          	mov    %edx,0x8(%esp)
     6c3:	c7 44 24 04 81 48 00 	movl   $0x4881,0x4(%esp)
     6ca:	00 
     6cb:	89 04 24             	mov    %eax,(%esp)
     6ce:	e8 a8 39 00 00       	call   407b <printf>
        exit();
  ...
  if(unlink("big") < 0){
     74f:	c7 04 24 2c 48 00 00 	movl   $0x482c,(%esp)
     756:	e8 b9 37 00 00       	call   3f14 <unlink>
     75b:	85 c0                	test   %eax,%eax
     75d:	79 1a                	jns    779 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     75f:	a1 e8 64 00 00       	mov    0x64e8,%eax
     764:	c7 44 24 04 d0 48 00 	movl   $0x48d0,0x4(%esp)
     76b:	00 
     76c:	89 04 24             	mov    %eax,(%esp)
     76f:	e8 07 39 00 00       	call   407b <printf>
    exit();
     774:	e8 4b 37 00 00       	call   3ec4 <exit>
  }
  printf(stdout, "big files ok\n");
     779:	a1 e8 64 00 00       	mov    0x64e8,%eax
     77e:	c7 44 24 04 e3 48 00 	movl   $0x48e3,0x4(%esp)
     785:	00 
     786:	89 04 24             	mov    %eax,(%esp)
     789:	e8 ed 38 00 00       	call   407b <printf>
}
     78e:	c9                   	leave  
     78f:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     796:	a1 e8 64 00 00       	mov    0x64e8,%eax
     79b:	c7 44 24 04 f4 48 00 	movl   $0x48f4,0x4(%esp)
     7a2:	00 
     7a3:	89 04 24             	mov    %eax,(%esp)
     7a6:	e8 d0 38 00 00       	call   407b <printf>

  name[0] = 'a';
     7ab:	c6 05 e0 ac 00 00 61 	movb   $0x61,0xace0
  name[2] = '\0';
     7b2:	c6 05 e2 ac 00 00 00 	movb   $0x0,0xace2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     7c8:	a2 e1 ac 00 00       	mov    %al,0xace1
    fd = open(name, O_CREATE|O_RDWR);
     7cd:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     7d4:	00 
     7d5:	c7 04 24 e0 ac 00 00 	movl   $0xace0,(%esp)
  ...
  name[0] = 'a';
     7f9:	c6 05 e0 ac 00 00 61 	movb   $0x61,0xace0
  name[2] = '\0';
     800:	c6 05 e2 ac 00 00 00 	movb   $0x0,0xace2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     816:	a2 e1 ac 00 00       	mov    %al,0xace1
    unlink(name);
     81b:	c7 04 24 e0 ac 00 00 	movl   $0xace0,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     831:	a1 e8 64 00 00       	mov    0x64e8,%eax
     836:	c7 44 24 04 1c 49 00 	movl   $0x491c,0x4(%esp)
     83d:	00 
     83e:	89 04 24             	mov    %eax,(%esp)
     841:	e8 35 38 00 00       	call   407b <printf>
}
     846:	c9                   	leave  
     847:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     84e:	a1 e8 64 00 00       	mov    0x64e8,%eax
     853:	c7 44 24 04 42 49 00 	movl   $0x4942,0x4(%esp)
     85a:	00 
     85b:	89 04 24             	mov    %eax,(%esp)
     85e:	e8 18 38 00 00       	call   407b <printf>

  if(mkdir("dir0") < 0){
     863:	c7 04 24 4e 49 00 00 	movl   $0x494e,(%esp)
     86a:	e8 bd 36 00 00       	call   3f2c <mkdir>
     86f:	85 c0                	test   %eax,%eax
     871:	79 1a                	jns    88d <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     873:	a1 e8 64 00 00       	mov    0x64e8,%eax
     878:	c7 44 24 04 71 45 00 	movl   $0x4571,0x4(%esp)
     87f:	00 
     880:	89 04 24             	mov    %eax,(%esp)
     883:	e8 f3 37 00 00       	call   407b <printf>
    exit();
     888:	e8 37 36 00 00       	call   3ec4 <exit>
  }

  if(chdir("dir0") < 0){
     88d:	c7 04 24 4e 49 00 00 	movl   $0x494e,(%esp)
     894:	e8 9b 36 00 00       	call   3f34 <chdir>
     899:	85 c0                	test   %eax,%eax
     89b:	79 1a                	jns    8b7 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89d:	a1 e8 64 00 00       	mov    0x64e8,%eax
     8a2:	c7 44 24 04 53 49 00 	movl   $0x4953,0x4(%esp)
     8a9:	00 
     8aa:	89 04 24             	mov    %eax,(%esp)
     8ad:	e8 c9 37 00 00       	call   407b <printf>
    exit();
     8b2:	e8 0d 36 00 00       	call   3ec4 <exit>
  }

  if(chdir("..") < 0){
     8b7:	c7 04 24 66 49 00 00 	movl   $0x4966,(%esp)
     8be:	e8 71 36 00 00       	call   3f34 <chdir>
     8c3:	85 c0                	test   %eax,%eax
     8c5:	79 1a                	jns    8e1 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c7:	a1 e8 64 00 00       	mov    0x64e8,%eax
     8cc:	c7 44 24 04 69 49 00 	movl   $0x4969,0x4(%esp)
     8d3:	00 
     8d4:	89 04 24             	mov    %eax,(%esp)
     8d7:	e8 9f 37 00 00       	call   407b <printf>
    exit();
     8dc:	e8 e3 35 00 00       	call   3ec4 <exit>
  }

  if(unlink("dir0") < 0){
     8e1:	c7 04 24 4e 49 00 00 	movl   $0x494e,(%esp)
     8e8:	e8 27 36 00 00       	call   3f14 <unlink>
     8ed:	85 c0                	test   %eax,%eax
     8ef:	79 1a                	jns    90b <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f1:	a1 e8 64 00 00       	mov    0x64e8,%eax
     8f6:	c7 44 24 04 7a 49 00 	movl   $0x497a,0x4(%esp)
     8fd:	00 
     8fe:	89 04 24             	mov    %eax,(%esp)
     901:	e8 75 37 00 00       	call   407b <printf>
    exit();
     906:	e8 b9 35 00 00       	call   3ec4 <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90b:	a1 e8 64 00 00       	mov    0x64e8,%eax
     910:	c7 44 24 04 8e 49 00 	movl   $0x498e,0x4(%esp)
     917:	00 
     918:	89 04 24             	mov    %eax,(%esp)
     91b:	e8 5b 37 00 00       	call   407b <printf>
}
     920:	c9                   	leave  
     921:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     928:	a1 e8 64 00 00       	mov    0x64e8,%eax
     92d:	c7 44 24 04 9d 49 00 	movl   $0x499d,0x4(%esp)
     934:	00 
     935:	89 04 24             	mov    %eax,(%esp)
     938:	e8 3e 37 00 00       	call   407b <printf>
  if(exec("echo", echoargv) < 0){
     93d:	c7 44 24 04 d4 64 00 	movl   $0x64d4,0x4(%esp)
     944:	00 
     945:	c7 04 24 48 45 00 00 	movl   $0x4548,(%esp)
     94c:	e8 ab 35 00 00       	call   3efc <exec>
     951:	85 c0                	test   %eax,%eax
     953:	79 1a                	jns    96f <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     955:	a1 e8 64 00 00       	mov    0x64e8,%eax
     95a:	c7 44 24 04 a8 49 00 	movl   $0x49a8,0x4(%esp)
     961:	00 
     962:	89 04 24             	mov    %eax,(%esp)
     965:	e8 11 37 00 00       	call   407b <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     986:	c7 44 24 04 ba 49 00 	movl   $0x49ba,0x4(%esp)
     98d:	00 
     98e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     995:	e8 e1 36 00 00       	call   407b <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     9db:	81 c2 e0 8c 00 00    	add    $0x8ce0,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     9fe:	00 
     9ff:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
     a06:	00 
     ...
     a16:	c7 44 24 04 c9 49 00 	movl   $0x49c9,0x4(%esp)
     a1d:	00 
     a1e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a25:	e8 51 36 00 00       	call   407b <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a6f:	05 e0 8c 00 00       	add    $0x8ce0,%eax
     ...
     a8f:	c7 44 24 04 d7 49 00 	movl   $0x49d7,0x4(%esp)
     a96:	00 
     a97:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9e:	e8 d8 35 00 00       	call   407b <printf>
          return;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ad8:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
     adf:	00 
    ...
    if(total != 5 * 1033){
     ...
     b05:	c7 44 24 04 e5 49 00 	movl   $0x49e5,0x4(%esp)
     b0c:	00 
     b0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b14:	e8 62 35 00 00       	call   407b <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2e:	c7 44 24 04 fc 49 00 	movl   $0x49fc,0x4(%esp)
     b35:	00 
     b36:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3d:	e8 39 35 00 00       	call   407b <printf>
    ...
    printf(1, "fork() failed\n");
     b44:	c7 44 24 04 06 4a 00 	movl   $0x4a06,0x4(%esp)
     b4b:	00 
     b4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b53:	e8 23 35 00 00       	call   407b <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b65:	c7 44 24 04 15 4a 00 	movl   $0x4a15,0x4(%esp)
     b6c:	00 
     b6d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b74:	e8 02 35 00 00       	call   407b <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc7:	00 
     bc8:	c7 44 24 04 1f 4a 00 	movl   $0x4a1f,0x4(%esp)
     bcf:	00 
     ...
     bdd:	c7 44 24 04 21 4a 00 	movl   $0x4a21,0x4(%esp)
     be4:	00 
     be5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bec:	e8 8a 34 00 00       	call   407b <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c13:	00 
     c14:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
     c1b:	00 
    ...
    printf(1, "preempt read error");
     c29:	c7 44 24 04 35 4a 00 	movl   $0x4a35,0x4(%esp)
     c30:	00 
     c31:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c38:	e8 3e 34 00 00       	call   407b <printf>
    return;
  ...
  printf(1, "kill... ");
     c4a:	c7 44 24 04 48 4a 00 	movl   $0x4a48,0x4(%esp)
     c51:	00 
     c52:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c59:	e8 1d 34 00 00       	call   407b <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c7f:	c7 44 24 04 51 4a 00 	movl   $0x4a51,0x4(%esp)
     c86:	00 
     c87:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8e:	e8 e8 33 00 00       	call   407b <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ca2:	c7 44 24 04 5a 4a 00 	movl   $0x4a5a,0x4(%esp)
     ca9:	00 
     caa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb1:	e8 c5 33 00 00       	call   407b <printf>
}
     cb6:	c9                   	leave  
     cb7:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd3:	79 16                	jns    ceb <exitwait+0x33>
      printf(1, "fork failed\n");
     cd5:	c7 44 24 04 e9 45 00 	movl   $0x45e9,0x4(%esp)
     cdc:	00 
     cdd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce4:	e8 92 33 00 00       	call   407b <printf>
      return;
    ...
    if(pid){
     ...
     cfb:	c7 44 24 04 66 4a 00 	movl   $0x4a66,0x4(%esp)
     d02:	00 
     d03:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0a:	e8 6c 33 00 00       	call   407b <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d20:	c7 44 24 04 76 4a 00 	movl   $0x4a76,0x4(%esp)
     d27:	00 
     d28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d2f:	e8 47 33 00 00       	call   407b <printf>
}
     d34:	c9                   	leave  
     d35:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3c:	c7 44 24 04 83 4a 00 	movl   $0x4a83,0x4(%esp)
     d43:	00 
     d44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4b:	e8 2b 33 00 00       	call   407b <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d88:	e8 d2 35 00 00       	call   435f <malloc>
    ...
    while(m1){
     ...
     da6:	e8 85 34 00 00       	call   4230 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df6:	e8 35 34 00 00       	call   4230 <free>
    printf(1, "mem ok\n");
     dfb:	c7 44 24 04 a7 4a 00 	movl   $0x4aa7,0x4(%esp)
     e02:	00 
     e03:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0a:	e8 6c 32 00 00       	call   407b <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e21:	c7 44 24 04 af 4a 00 	movl   $0x4aaf,0x4(%esp)
     e28:	00 
     e29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e30:	e8 46 32 00 00       	call   407b <printf>

  unlink("sharedfd");
     e35:	c7 04 24 be 4a 00 00 	movl   $0x4abe,(%esp)
     e3c:	e8 d3 30 00 00       	call   3f14 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e41:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e48:	00 
     e49:	c7 04 24 be 4a 00 00 	movl   $0x4abe,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5e:	c7 44 24 04 c8 4a 00 	movl   $0x4ac8,0x4(%esp)
     e65:	00 
     e66:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6d:	e8 09 32 00 00       	call   407b <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed0:	c7 44 24 04 f4 4a 00 	movl   $0x4af4,0x4(%esp)
     ed7:	00 
     ed8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     edf:	e8 97 31 00 00       	call   407b <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f15:	00 
     f16:	c7 04 24 be 4a 00 00 	movl   $0x4abe,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2b:	c7 44 24 04 14 4b 00 	movl   $0x4b14,0x4(%esp)
     f32:	00 
     f33:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3a:	e8 3c 31 00 00       	call   407b <printf>
    return;
  ...
  unlink("sharedfd");
     fb8:	c7 04 24 be 4a 00 00 	movl   $0x4abe,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fd6:	c7 44 24 04 3f 4b 00 	movl   $0x4b3f,0x4(%esp)
     fdd:	00 
     fde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fe5:	e8 91 30 00 00       	call   407b <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     ffa:	c7 44 24 04 4c 4b 00 	movl   $0x4b4c,0x4(%esp)
    1001:	00 
    1002:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1009:	e8 6d 30 00 00       	call   407b <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    101b:	c7 45 c8 61 4b 00 00 	movl   $0x4b61,-0x38(%ebp)
    1022:	c7 45 cc 64 4b 00 00 	movl   $0x4b64,-0x34(%ebp)
    1029:	c7 45 d0 67 4b 00 00 	movl   $0x4b67,-0x30(%ebp)
    1030:	c7 45 d4 6a 4b 00 00 	movl   $0x4b6a,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    1037:	c7 44 24 04 6d 4b 00 	movl   $0x4b6d,0x4(%esp)
    103e:	00 
    103f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1046:	e8 30 30 00 00       	call   407b <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1078:	79 19                	jns    1093 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107a:	c7 44 24 04 e9 45 00 	movl   $0x45e9,0x4(%esp)
    1081:	00 
    1082:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1089:	e8 ed 2f 00 00       	call   407b <printf>
      exit();
    ...
    10b9:	c7 44 24 04 7d 4b 00 	movl   $0x4b7d,0x4(%esp)
    10c0:	00 
    10c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10c8:	e8 ae 2f 00 00       	call   407b <printf>
        exit();
    ...
    10e4:	c7 04 24 e0 8c 00 00 	movl   $0x8ce0,(%esp)
    ...
    1100:	00 
    1101:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
    1108:	00 
    ...
    1127:	c7 44 24 04 8c 4b 00 	movl   $0x4b8c,0x4(%esp)
    112e:	00 
    112f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1136:	e8 40 2f 00 00       	call   407b <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11b6:	05 e0 8c 00 00       	add    $0x8ce0,%eax
    ...
    11c9:	74 19                	je     11e4 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11cb:	c7 44 24 04 9d 4b 00 	movl   $0x4b9d,0x4(%esp)
    11d2:	00 
    11d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11da:	e8 9c 2e 00 00       	call   407b <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11fd:	00 
    11fe:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
    1205:	00 
    ...
    1235:	c7 44 24 04 a9 4b 00 	movl   $0x4ba9,0x4(%esp)
    123c:	00 
    123d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1244:	e8 32 2e 00 00       	call   407b <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    1267:	c7 44 24 04 ba 4b 00 	movl   $0x4bba,0x4(%esp)
    126e:	00 
    126f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1276:	e8 00 2e 00 00       	call   407b <printf>
}
    127b:	c9                   	leave  
    127c:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1283:	c7 44 24 04 c8 4b 00 	movl   $0x4bc8,0x4(%esp)
    128a:	00 
    128b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1292:	e8 e4 2d 00 00       	call   407b <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12af:	79 19                	jns    12ca <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b1:	c7 44 24 04 e9 45 00 	movl   $0x45e9,0x4(%esp)
    12b8:	00 
    12b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12c0:	e8 b6 2d 00 00       	call   407b <printf>
      exit();
    ...
    1310:	79 19                	jns    132b <createdelete+0xae>
          printf(1, "create failed\n");
    1312:	c7 44 24 04 7d 4b 00 	movl   $0x4b7d,0x4(%esp)
    1319:	00 
    131a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1321:	e8 55 2d 00 00       	call   407b <printf>
          exit();
    ...
    1367:	c7 44 24 04 6c 46 00 	movl   $0x466c,0x4(%esp)
    136e:	00 
    136f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1376:	e8 00 2d 00 00       	call   407b <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1424:	c7 44 24 04 dc 4b 00 	movl   $0x4bdc,0x4(%esp)
    142b:	00 
    142c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1433:	e8 43 2c 00 00       	call   407b <printf>
        exit();
    ...
    1456:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    145d:	00 
    145e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1465:	e8 11 2c 00 00       	call   407b <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14df:	c7 44 24 04 20 4c 00 	movl   $0x4c20,0x4(%esp)
    14e6:	00 
    14e7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14ee:	e8 88 2b 00 00       	call   407b <printf>
}
    14f3:	c9                   	leave  
    14f4:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    14fb:	c7 44 24 04 31 4c 00 	movl   $0x4c31,0x4(%esp)
    1502:	00 
    1503:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150a:	e8 6c 2b 00 00       	call   407b <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    150f:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1516:	00 
    1517:	c7 04 24 42 4c 00 00 	movl   $0x4c42,(%esp)
  ...
  if(fd < 0){
    ...
    152c:	c7 44 24 04 4d 4c 00 	movl   $0x4c4d,0x4(%esp)
    1533:	00 
    1534:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    153b:	e8 3b 2b 00 00       	call   407b <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    154c:	00 
    154d:	c7 44 24 04 67 4c 00 	movl   $0x4c67,0x4(%esp)
    1554:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1572:	00 
    1573:	c7 04 24 42 4c 00 00 	movl   $0x4c42,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    160e:	00 
    160f:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
    1616:	00 
    ...
    1627:	c7 44 24 04 a3 4c 00 	movl   $0x4ca3,0x4(%esp)
    162e:	00 
    162f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1636:	e8 40 2a 00 00       	call   407b <printf>
    exit();
    163b:	e8 84 28 00 00       	call   3ec4 <exit>
  }
  if(buf[0] != 'h'){
    1640:	0f b6 05 e0 8c 00 00 	movzbl 0x8ce0,%eax
    1647:	3c 68                	cmp    $0x68,%al
    1649:	74 19                	je     1664 <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    164b:	c7 44 24 04 ba 4c 00 	movl   $0x4cba,0x4(%esp)
    1652:	00 
    1653:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165a:	e8 1c 2a 00 00       	call   407b <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    166b:	00 
    166c:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
    1673:	00 
    ...
    1684:	c7 44 24 04 d1 4c 00 	movl   $0x4cd1,0x4(%esp)
    168b:	00 
    168c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1693:	e8 e3 29 00 00       	call   407b <printf>
    exit();
  ...
  unlink("unlinkread");
    16a8:	c7 04 24 42 4c 00 00 	movl   $0x4c42,(%esp)
    16af:	e8 60 28 00 00       	call   3f14 <unlink>
  printf(1, "unlinkread ok\n");
    16b4:	c7 44 24 04 ea 4c 00 	movl   $0x4cea,0x4(%esp)
    16bb:	00 
    16bc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c3:	e8 b3 29 00 00       	call   407b <printf>
}
    16c8:	c9                   	leave  
    16c9:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d0:	c7 44 24 04 f9 4c 00 	movl   $0x4cf9,0x4(%esp)
    16d7:	00 
    16d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16df:	e8 97 29 00 00       	call   407b <printf>

  unlink("lf1");
    16e4:	c7 04 24 03 4d 00 00 	movl   $0x4d03,(%esp)
    16eb:	e8 24 28 00 00       	call   3f14 <unlink>
  unlink("lf2");
    16f0:	c7 04 24 07 4d 00 00 	movl   $0x4d07,(%esp)
    16f7:	e8 18 28 00 00       	call   3f14 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    16fc:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1703:	00 
    1704:	c7 04 24 03 4d 00 00 	movl   $0x4d03,(%esp)
  ...
  if(fd < 0){
    ...
    1719:	c7 44 24 04 0b 4d 00 	movl   $0x4d0b,0x4(%esp)
    1720:	00 
    1721:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1728:	e8 4e 29 00 00       	call   407b <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1739:	00 
    173a:	c7 44 24 04 67 4c 00 	movl   $0x4c67,0x4(%esp)
    1741:	00 
    ...
    1752:	c7 44 24 04 1e 4d 00 	movl   $0x4d1e,0x4(%esp)
    1759:	00 
    175a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1761:	e8 15 29 00 00       	call   407b <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17eb:	00 
    17ec:	c7 04 24 07 4d 00 00 	movl   $0x4d07,(%esp)
  ...
  if(fd < 0){
    ...
    1801:	c7 44 24 04 6d 4d 00 	movl   $0x4d6d,0x4(%esp)
    1808:	00 
    1809:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1810:	e8 66 28 00 00       	call   407b <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1821:	00 
    1822:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
    1829:	00 
    ...
    183a:	c7 44 24 04 7e 4d 00 	movl   $0x4d7e,0x4(%esp)
    1841:	00 
    1842:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1849:	e8 2d 28 00 00       	call   407b <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    185e:	c7 44 24 04 07 4d 00 	movl   $0x4d07,0x4(%esp)
    1865:	00 
    1866:	c7 04 24 07 4d 00 00 	movl   $0x4d07,(%esp)
    186d:	e8 b2 26 00 00       	call   3f24 <link>
    1872:	85 c0                	test   %eax,%eax
    1874:	78 19                	js     188f <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1876:	c7 44 24 04 8f 4d 00 	movl   $0x4d8f,0x4(%esp)
    187d:	00 
    187e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1885:	e8 f1 27 00 00       	call   407b <printf>
    exit();
    188a:	e8 35 26 00 00       	call   3ec4 <exit>
  }

  unlink("lf2");
    188f:	c7 04 24 07 4d 00 00 	movl   $0x4d07,(%esp)
    1896:	e8 79 26 00 00       	call   3f14 <unlink>
  if(link("lf2", "lf1") >= 0){
    189b:	c7 44 24 04 03 4d 00 	movl   $0x4d03,0x4(%esp)
    18a2:	00 
    18a3:	c7 04 24 07 4d 00 00 	movl   $0x4d07,(%esp)
    18aa:	e8 75 26 00 00       	call   3f24 <link>
    18af:	85 c0                	test   %eax,%eax
    18b1:	78 19                	js     18cc <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b3:	c7 44 24 04 b0 4d 00 	movl   $0x4db0,0x4(%esp)
    18ba:	00 
    18bb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c2:	e8 b4 27 00 00       	call   407b <printf>
    exit();
    18c7:	e8 f8 25 00 00       	call   3ec4 <exit>
  }

  if(link(".", "lf1") >= 0){
    18cc:	c7 44 24 04 03 4d 00 	movl   $0x4d03,0x4(%esp)
    18d3:	00 
    18d4:	c7 04 24 d3 4d 00 00 	movl   $0x4dd3,(%esp)
    18db:	e8 44 26 00 00       	call   3f24 <link>
    18e0:	85 c0                	test   %eax,%eax
    18e2:	78 19                	js     18fd <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e4:	c7 44 24 04 d5 4d 00 	movl   $0x4dd5,0x4(%esp)
    18eb:	00 
    18ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f3:	e8 83 27 00 00       	call   407b <printf>
    exit();
    18f8:	e8 c7 25 00 00       	call   3ec4 <exit>
  }

  printf(1, "linktest ok\n");
    18fd:	c7 44 24 04 f1 4d 00 	movl   $0x4df1,0x4(%esp)
    1904:	00 
    1905:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    190c:	e8 6a 27 00 00       	call   407b <printf>
}
    1911:	c9                   	leave  
    1912:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1919:	c7 44 24 04 fe 4d 00 	movl   $0x4dfe,0x4(%esp)
    1920:	00 
    1921:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1928:	e8 4e 27 00 00       	call   407b <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    198c:	c7 04 24 0e 4e 00 00 	movl   $0x4e0e,(%esp)
    ...
    19cf:	c7 04 24 0e 4e 00 00 	movl   $0x4e0e,(%esp)
    ...
    1a00:	c7 44 24 04 11 4e 00 	movl   $0x4e11,0x4(%esp)
    1a07:	00 
    1a08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a0f:	e8 67 26 00 00       	call   407b <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a64:	00 
    1a65:	c7 04 24 d3 4d 00 00 	movl   $0x4dd3,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1ac6:	c7 44 24 04 2d 4e 00 	movl   $0x4e2d,0x4(%esp)
    1acd:	00 
    1ace:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ad5:	e8 a1 25 00 00       	call   407b <printf>
        exit();
    ...
    1af6:	c7 44 24 04 46 4e 00 	movl   $0x4e46,0x4(%esp)
    1afd:	00 
    1afe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b05:	e8 71 25 00 00       	call   407b <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b52:	c7 44 24 04 64 4e 00 	movl   $0x4e64,0x4(%esp)
    1b59:	00 
    1b5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b61:	e8 15 25 00 00       	call   407b <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b8c:	79 19                	jns    1ba7 <concreate+0x294>
      printf(1, "fork failed\n");
    1b8e:	c7 44 24 04 e9 45 00 	movl   $0x45e9,0x4(%esp)
    1b95:	00 
    1b96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b9d:	e8 d9 24 00 00       	call   407b <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1cae:	c7 44 24 04 95 4e 00 	movl   $0x4e95,0x4(%esp)
    1cb5:	00 
    1cb6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cbd:	e8 b9 23 00 00       	call   407b <printf>
}
    1cc2:	c9                   	leave  
    1cc3:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cca:	c7 44 24 04 a3 4e 00 	movl   $0x4ea3,0x4(%esp)
    1cd1:	00 
    1cd2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd9:	e8 9d 23 00 00       	call   407b <printf>

  unlink("x");
    1cde:	c7 04 24 1f 4a 00 00 	movl   $0x4a1f,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cf8:	c7 44 24 04 e9 45 00 	movl   $0x45e9,0x4(%esp)
    1cff:	00 
    1d00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d07:	e8 6f 23 00 00       	call   407b <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d66:	00 
    1d67:	c7 04 24 1f 4a 00 00 	movl   $0x4a1f,(%esp)
    ...
    1d98:	75 16                	jne    1db0 <linkunlink+0xec>
      link("cat", "x");
    1d9a:	c7 44 24 04 1f 4a 00 	movl   $0x4a1f,0x4(%esp)
    1da1:	00 
    1da2:	c7 04 24 b4 4e 00 00 	movl   $0x4eb4,(%esp)
    1da9:	e8 76 21 00 00       	call   3f24 <link>
    1dae:	eb 0c                	jmp    1dbc <linkunlink+0xf8>
    } else {
      unlink("x");
    1db0:	c7 04 24 1f 4a 00 00 	movl   $0x4a1f,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1dd5:	c7 44 24 04 b8 4e 00 	movl   $0x4eb8,0x4(%esp)
    1ddc:	00 
    1ddd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1de4:	e8 92 22 00 00       	call   407b <printf>
}
    1de9:	c9                   	leave  
    1dea:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1df6:	c7 44 24 04 c7 4e 00 	movl   $0x4ec7,0x4(%esp)
    1dfd:	00 
    1dfe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e05:	e8 71 22 00 00       	call   407b <printf>
  unlink("bd");
    1e0a:	c7 04 24 d4 4e 00 00 	movl   $0x4ed4,(%esp)
    1e11:	e8 fe 20 00 00       	call   3f14 <unlink>

  fd = open("bd", O_CREATE);
    1e16:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e1d:	00 
    1e1e:	c7 04 24 d4 4e 00 00 	movl   $0x4ed4,(%esp)
  ...
  if(fd < 0){
    ...
    1e33:	c7 44 24 04 d7 4e 00 	movl   $0x4ed7,0x4(%esp)
    1e3a:	00 
    1e3b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e42:	e8 34 22 00 00       	call   407b <printf>
    exit();
  ...
  unlink("bd");
    1ed1:	c7 04 24 d4 4e 00 00 	movl   $0x4ed4,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f29:	c7 44 24 04 01 4f 00 	movl   $0x4f01,0x4(%esp)
    1f30:	00 
    1f31:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f38:	e8 3e 21 00 00       	call   407b <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f4f:	c7 44 24 04 16 4f 00 	movl   $0x4f16,0x4(%esp)
    1f56:	00 
    1f57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5e:	e8 18 21 00 00       	call   407b <printf>
}
    1f63:	c9                   	leave  
    1f64:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6b:	c7 44 24 04 21 4f 00 	movl   $0x4f21,0x4(%esp)
    1f72:	00 
    1f73:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7a:	e8 fc 20 00 00       	call   407b <printf>

  unlink("ff");
    1f7f:	c7 04 24 2e 4f 00 00 	movl   $0x4f2e,(%esp)
    1f86:	e8 89 1f 00 00       	call   3f14 <unlink>
  if(mkdir("dd") != 0){
    1f8b:	c7 04 24 31 4f 00 00 	movl   $0x4f31,(%esp)
    1f92:	e8 95 1f 00 00       	call   3f2c <mkdir>
    1f97:	85 c0                	test   %eax,%eax
    1f99:	74 19                	je     1fb4 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9b:	c7 44 24 04 34 4f 00 	movl   $0x4f34,0x4(%esp)
    1fa2:	00 
    1fa3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1faa:	e8 cc 20 00 00       	call   407b <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbb:	00 
    1fbc:	c7 04 24 4c 4f 00 00 	movl   $0x4f4c,(%esp)
  ...
  if(fd < 0){
    ...
    1fd1:	c7 44 24 04 52 4f 00 	movl   $0x4f52,0x4(%esp)
    1fd8:	00 
    1fd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe0:	e8 96 20 00 00       	call   407b <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1ff1:	00 
    1ff2:	c7 44 24 04 2e 4f 00 	movl   $0x4f2e,0x4(%esp)
    1ff9:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2069:	00 
    206a:	c7 04 24 b0 4f 00 00 	movl   $0x4fb0,(%esp)
  ...
  if(fd < 0){
    ...
    207f:	c7 44 24 04 b9 4f 00 	movl   $0x4fb9,0x4(%esp)
    2086:	00 
    2087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208e:	e8 e8 1f 00 00       	call   407b <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    209f:	00 
    20a0:	c7 44 24 04 d1 4f 00 	movl   $0x4fd1,0x4(%esp)
    20a7:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c5:	00 
    20c6:	c7 04 24 d4 4f 00 00 	movl   $0x4fd4,(%esp)
  ...
  if(fd < 0){
    ...
    20db:	c7 44 24 04 e0 4f 00 	movl   $0x4fe0,0x4(%esp)
    20e2:	00 
    20e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20ea:	e8 8c 1f 00 00       	call   407b <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    20fb:	00 
    20fc:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
    2103:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2118:	0f b6 05 e0 8c 00 00 	movzbl 0x8ce0,%eax
    211f:	3c 66                	cmp    $0x66,%al
    2121:	74 19                	je     213c <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    2123:	c7 44 24 04 f9 4f 00 	movl   $0x4ff9,0x4(%esp)
    212a:	00 
    212b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2132:	e8 44 1f 00 00       	call   407b <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227d:	00 
    227e:	c7 04 24 14 50 00 00 	movl   $0x5014,(%esp)
  ...
  if(fd < 0){
    ...
    2293:	c7 44 24 04 de 50 00 	movl   $0x50de,0x4(%esp)
    229a:	00 
    229b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a2:	e8 d4 1d 00 00       	call   407b <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22b3:	00 
    22b4:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
    22bb:	00 
    ...
    22cc:	c7 44 24 04 f6 50 00 	movl   $0x50f6,0x4(%esp)
    22d3:	00 
    22d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22db:	e8 9b 1d 00 00       	call   407b <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b1:	c7 44 24 04 70 53 00 	movl   $0x5370,0x4(%esp)
    26b8:	00 
    26b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c0:	e8 b6 19 00 00       	call   407b <printf>

  unlink("bigwrite");
    26c5:	c7 04 24 7f 53 00 00 	movl   $0x537f,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e4:	00 
    26e5:	c7 04 24 7f 53 00 00 	movl   $0x537f,(%esp)
    ...
    26fa:	c7 44 24 04 88 53 00 	movl   $0x5388,0x4(%esp)
    2701:	00 
    2702:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2709:	e8 6d 19 00 00       	call   407b <printf>
      exit();
    ...
    2723:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
    272a:	00 
    ...
    274f:	c7 44 24 04 a0 53 00 	movl   $0x53a0,0x4(%esp)
    2756:	00 
    2757:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275e:	e8 18 19 00 00       	call   407b <printf>
        exit();
    ...
    unlink("bigwrite");
    277d:	c7 04 24 7f 53 00 00 	movl   $0x537f,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279d:	c7 44 24 04 b2 53 00 	movl   $0x53b2,0x4(%esp)
    27a4:	00 
    27a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ac:	e8 ca 18 00 00       	call   407b <printf>
}
    27b1:	c9                   	leave  
    27b2:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27b9:	c7 44 24 04 bf 53 00 	movl   $0x53bf,0x4(%esp)
    27c0:	00 
    27c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c8:	e8 ae 18 00 00       	call   407b <printf>

  unlink("bigfile");
    27cd:	c7 04 24 cd 53 00 00 	movl   $0x53cd,(%esp)
    27d4:	e8 3b 17 00 00       	call   3f14 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27d9:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e0:	00 
    27e1:	c7 04 24 cd 53 00 00 	movl   $0x53cd,(%esp)
  ...
  if(fd < 0){
    ...
    27f6:	c7 44 24 04 d5 53 00 	movl   $0x53d5,0x4(%esp)
    27fd:	00 
    27fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2805:	e8 71 18 00 00       	call   407b <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2827:	c7 04 24 e0 8c 00 00 	movl   $0x8ce0,(%esp)
    282e:	e8 ec 14 00 00       	call   3d1f <memset>
    if(write(fd, buf, 600) != 600){
    2833:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    283a:	00 
    283b:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
    2842:	00 
    ...
    2855:	c7 44 24 04 eb 53 00 	movl   $0x53eb,0x4(%esp)
    285c:	00 
    285d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2864:	e8 12 18 00 00       	call   407b <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    288a:	00 
    288b:	c7 04 24 cd 53 00 00 	movl   $0x53cd,(%esp)
  ...
  if(fd < 0){
    ...
    28a0:	c7 44 24 04 01 54 00 	movl   $0x5401,0x4(%esp)
    28a7:	00 
    28a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28af:	e8 c7 17 00 00       	call   407b <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28ce:	00 
    28cf:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
    28d6:	00 
    ...
    28eb:	c7 44 24 04 16 54 00 	movl   $0x5416,0x4(%esp)
    28f2:	00 
    28f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fa:	e8 7c 17 00 00       	call   407b <printf>
      exit();
    ...
    2913:	c7 44 24 04 2b 54 00 	movl   $0x542b,0x4(%esp)
    291a:	00 
    291b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2922:	e8 54 17 00 00       	call   407b <printf>
      exit();
    2927:	e8 98 15 00 00       	call   3ec4 <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    292c:	0f b6 05 e0 8c 00 00 	movzbl 0x8ce0,%eax
    ...
    2946:	0f b6 05 0b 8e 00 00 	movzbl 0x8e0b,%eax
    ...
    2960:	c7 44 24 04 3f 54 00 	movl   $0x543f,0x4(%esp)
    2967:	00 
    2968:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    296f:	e8 07 17 00 00       	call   407b <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    299d:	c7 44 24 04 58 54 00 	movl   $0x5458,0x4(%esp)
    29a4:	00 
    29a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29ac:	e8 ca 16 00 00       	call   407b <printf>
    exit();
    29b1:	e8 0e 15 00 00       	call   3ec4 <exit>
  }
  unlink("bigfile");
    29b6:	c7 04 24 cd 53 00 00 	movl   $0x53cd,(%esp)
    29bd:	e8 52 15 00 00       	call   3f14 <unlink>

  printf(1, "bigfile test ok\n");
    29c2:	c7 44 24 04 72 54 00 	movl   $0x5472,0x4(%esp)
    29c9:	00 
    29ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d1:	e8 a5 16 00 00       	call   407b <printf>
}
    29d6:	c9                   	leave  
    29d7:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a4b:	00 
    2a4c:	c7 04 24 10 55 00 00 	movl   $0x5510,(%esp)
  ...
  if(fd < 0){
    ...
    2a61:	c7 44 24 04 40 55 00 	movl   $0x5540,0x4(%esp)
    2a68:	00 
    2a69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a70:	e8 06 16 00 00       	call   407b <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a8c:	00 
    2a8d:	c7 04 24 80 55 00 00 	movl   $0x5580,(%esp)
  ...
  if(fd < 0){
    ...
    2aa2:	c7 44 24 04 b0 55 00 	movl   $0x55b0,0x4(%esp)
    2aa9:	00 
    2aaa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab1:	e8 c5 15 00 00       	call   407b <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cac:	c7 44 24 04 47 57 00 	movl   $0x5747,0x4(%esp)
    2cb3:	00 
    2cb4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cbb:	e8 bb 13 00 00       	call   407b <printf>

  fd = open("dirfile", O_CREATE);
    2cc0:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cc7:	00 
    2cc8:	c7 04 24 54 57 00 00 	movl   $0x5754,(%esp)
  ...
  if(fd < 0){
    ...
    2cdd:	c7 44 24 04 5c 57 00 	movl   $0x575c,0x4(%esp)
    2ce4:	00 
    2ce5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cec:	e8 8a 13 00 00       	call   407b <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d31:	00 
    2d32:	c7 04 24 8d 57 00 00 	movl   $0x578d,(%esp)
  ...
  if(fd >= 0){
    ...
    2d47:	c7 44 24 04 98 57 00 	movl   $0x5798,0x4(%esp)
    2d4e:	00 
    2d4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d56:	e8 20 13 00 00       	call   407b <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d67:	00 
    2d68:	c7 04 24 8d 57 00 00 	movl   $0x578d,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2e49:	00 
    2e4a:	c7 04 24 d3 4d 00 00 	movl   $0x4dd3,(%esp)
  ...
  if(fd >= 0){
    ...
    2e5f:	c7 44 24 04 30 58 00 	movl   $0x5830,0x4(%esp)
    2e66:	00 
    2e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e6e:	e8 08 12 00 00       	call   407b <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eae:	c7 44 24 04 4f 58 00 	movl   $0x584f,0x4(%esp)
    2eb5:	00 
    2eb6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ebd:	e8 b9 11 00 00       	call   407b <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2ed2:	c7 44 24 04 63 58 00 	movl   $0x5863,0x4(%esp)
    2ed9:	00 
    2eda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee1:	e8 95 11 00 00       	call   407b <printf>
}
    2ee6:	c9                   	leave  
    2ee7:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2eee:	c7 44 24 04 73 58 00 	movl   $0x5873,0x4(%esp)
    2ef5:	00 
    2ef6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2efd:	e8 79 11 00 00       	call   407b <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2faf:	00 
    2fb0:	c7 04 24 b3 58 00 00 	movl   $0x58b3,(%esp)
    ...
    unlink("xx");
    2fd0:	c7 04 24 b3 58 00 00 	movl   $0x58b3,(%esp)
  ...
  chdir("/");
    2fea:	c7 04 24 ba 45 00 00 	movl   $0x45ba,(%esp)
    2ff1:	e8 3e 0f 00 00       	call   3f34 <chdir>
  printf(1, "empty file name OK\n");
    2ff6:	c7 44 24 04 b6 58 00 	movl   $0x58b6,0x4(%esp)
    2ffd:	00 
    2ffe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3005:	e8 71 10 00 00       	call   407b <printf>
}
    300a:	c9                   	leave  
    300b:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3012:	c7 44 24 04 ca 58 00 	movl   $0x58ca,0x4(%esp)
    3019:	00 
    301a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3021:	e8 55 10 00 00       	call   407b <printf>
    ...
    3043:	e8 7c 0e 00 00       	call   3ec4 <exit>
{
  ...
  if(n == 1000){
    ...
    3061:	c7 44 24 04 d8 58 00 	movl   $0x58d8,0x4(%esp)
    3068:	00 
    3069:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3070:	e8 06 10 00 00       	call   407b <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    3083:	c7 44 24 04 fa 58 00 	movl   $0x58fa,0x4(%esp)
    308a:	00 
    308b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3092:	e8 e4 0f 00 00       	call   407b <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30b0:	c7 44 24 04 0e 59 00 	movl   $0x590e,0x4(%esp)
    30b7:	00 
    30b8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30bf:	e8 b7 0f 00 00       	call   407b <printf>
    exit();
    30c4:	e8 fb 0d 00 00       	call   3ec4 <exit>
  }
  
  printf(1, "fork test OK\n");
    30c9:	c7 44 24 04 21 59 00 	movl   $0x5921,0x4(%esp)
    30d0:	00 
    30d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30d8:	e8 9e 0f 00 00       	call   407b <printf>
}
    30dd:	c9                   	leave  
    30de:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30e9:	a1 e8 64 00 00       	mov    0x64e8,%eax
    30ee:	c7 44 24 04 2f 59 00 	movl   $0x592f,0x4(%esp)
    30f5:	00 
    30f6:	89 04 24             	mov    %eax,(%esp)
    30f9:	e8 7d 0f 00 00       	call   407b <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    313c:	a1 e8 64 00 00       	mov    0x64e8,%eax
    ...
    3156:	c7 44 24 04 3a 59 00 	movl   $0x593a,0x4(%esp)
    315d:	00 
    315e:	89 04 24             	mov    %eax,(%esp)
    3161:	e8 15 0f 00 00       	call   407b <printf>
      exit();
  ...
  if(pid < 0){
    ...
    3195:	a1 e8 64 00 00       	mov    0x64e8,%eax
    319a:	c7 44 24 04 55 59 00 	movl   $0x5955,0x4(%esp)
    31a1:	00 
    31a2:	89 04 24             	mov    %eax,(%esp)
    31a5:	e8 d1 0e 00 00       	call   407b <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31d8:	a1 e8 64 00 00       	mov    0x64e8,%eax
    31dd:	c7 44 24 04 6c 59 00 	movl   $0x596c,0x4(%esp)
    31e4:	00 
    31e5:	89 04 24             	mov    %eax,(%esp)
    31e8:	e8 8e 0e 00 00       	call   407b <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    3238:	a1 e8 64 00 00       	mov    0x64e8,%eax
    323d:	c7 44 24 04 88 59 00 	movl   $0x5988,0x4(%esp)
    3244:	00 
    3245:	89 04 24             	mov    %eax,(%esp)
    3248:	e8 2e 0e 00 00       	call   407b <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3283:	a1 e8 64 00 00       	mov    0x64e8,%eax
    3288:	c7 44 24 04 c6 59 00 	movl   $0x59c6,0x4(%esp)
    328f:	00 
    3290:	89 04 24             	mov    %eax,(%esp)
    3293:	e8 e3 0d 00 00       	call   407b <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32b9:	a1 e8 64 00 00       	mov    0x64e8,%eax
    ...
    32cc:	c7 44 24 04 e4 59 00 	movl   $0x59e4,0x4(%esp)
    32d3:	00 
    32d4:	89 04 24             	mov    %eax,(%esp)
    32d7:	e8 9f 0d 00 00       	call   407b <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3320:	a1 e8 64 00 00       	mov    0x64e8,%eax
    ...
    3333:	c7 44 24 04 1c 5a 00 	movl   $0x5a1c,0x4(%esp)
    333a:	00 
    333b:	89 04 24             	mov    %eax,(%esp)
    333e:	e8 38 0d 00 00       	call   407b <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3352:	a1 e8 64 00 00       	mov    0x64e8,%eax
    3357:	c7 44 24 04 44 5a 00 	movl   $0x5a44,0x4(%esp)
    335e:	00 
    335f:	89 04 24             	mov    %eax,(%esp)
    3362:	e8 14 0d 00 00       	call   407b <printf>
    exit();
  ...
  if(c != a){
    ...
    33a3:	a1 e8 64 00 00       	mov    0x64e8,%eax
    ...
    33b6:	c7 44 24 04 74 5a 00 	movl   $0x5a74,0x4(%esp)
    33bd:	00 
    33be:	89 04 24             	mov    %eax,(%esp)
    33c1:	e8 b5 0c 00 00       	call   407b <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33e8:	79 1a                	jns    3404 <sbrktest+0x325>
      printf(stdout, "fork failed\n");
    33ea:	a1 e8 64 00 00       	mov    0x64e8,%eax
    33ef:	c7 44 24 04 e9 45 00 	movl   $0x45e9,0x4(%esp)
    33f6:	00 
    33f7:	89 04 24             	mov    %eax,(%esp)
    33fa:	e8 7c 0c 00 00       	call   407b <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346b:	c7 44 24 04 ba 49 00 	movl   $0x49ba,0x4(%esp)
    3472:	00 
    3473:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    347a:	e8 fc 0b 00 00       	call   407b <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d0:	00 
    34d1:	c7 44 24 04 1f 4a 00 	movl   $0x4a1f,0x4(%esp)
    34d8:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    3572:	a1 e8 64 00 00       	mov    0x64e8,%eax
    3577:	c7 44 24 04 ae 5a 00 	movl   $0x5aae,0x4(%esp)
    357e:	00 
    357f:	89 04 24             	mov    %eax,(%esp)
    3582:	e8 f4 0a 00 00       	call   407b <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    35ba:	a1 e8 64 00 00       	mov    0x64e8,%eax
    35bf:	c7 44 24 04 c9 5a 00 	movl   $0x5ac9,0x4(%esp)
    35c6:	00 
    35c7:	89 04 24             	mov    %eax,(%esp)
    35ca:	e8 ac 0a 00 00       	call   407b <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3609:	a1 e8 64 00 00       	mov    0x64e8,%eax
    360e:	c7 44 24 04 d7 5a 00 	movl   $0x5ad7,0x4(%esp)
    3615:	00 
    3616:	89 04 24             	mov    %eax,(%esp)
    3619:	e8 5d 0a 00 00       	call   407b <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    367b:	c7 04 24 e6 5a 00 00 	movl   $0x5ae6,(%esp)
    3682:	e8 9d 08 00 00       	call   3f24 <link>
    3687:	83 f8 ff             	cmp    $0xffffffff,%eax
    368a:	74 1a                	je     36a6 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    368c:	a1 e8 64 00 00       	mov    0x64e8,%eax
    3691:	c7 44 24 04 f1 5a 00 	movl   $0x5af1,0x4(%esp)
    3698:	00 
    3699:	89 04 24             	mov    %eax,(%esp)
    369c:	e8 da 09 00 00       	call   407b <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    36b9:	a1 e8 64 00 00       	mov    0x64e8,%eax
    36be:	c7 44 24 04 0a 5b 00 	movl   $0x5b0a,0x4(%esp)
    36c5:	00 
    36c6:	89 04 24             	mov    %eax,(%esp)
    36c9:	e8 ad 09 00 00       	call   407b <printf>
}
    36ce:	c9                   	leave  
    36cf:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36d6:	a1 e8 64 00 00       	mov    0x64e8,%eax
    36db:	c7 44 24 04 17 5b 00 	movl   $0x5b17,0x4(%esp)
    36e2:	00 
    36e3:	89 04 24             	mov    %eax,(%esp)
    36e6:	e8 90 09 00 00       	call   407b <printf>
  for(i = 0; i < sizeof(uninit); i++){
    36eb:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    36f2:	eb 2d                	jmp    3721 <bsstest+0x51>
    if(uninit[i] != '\0'){
    36f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    36f7:	05 c0 65 00 00       	add    $0x65c0,%eax
    36fc:	0f b6 00             	movzbl (%eax),%eax
    36ff:	84 c0                	test   %al,%al
    3701:	74 1a                	je     371d <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    3703:	a1 e8 64 00 00       	mov    0x64e8,%eax
    3708:	c7 44 24 04 21 5b 00 	movl   $0x5b21,0x4(%esp)
    370f:	00 
    3710:	89 04 24             	mov    %eax,(%esp)
    3713:	e8 63 09 00 00       	call   407b <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    372b:	a1 e8 64 00 00       	mov    0x64e8,%eax
    3730:	c7 44 24 04 32 5b 00 	movl   $0x5b32,0x4(%esp)
    3737:	00 
    3738:	89 04 24             	mov    %eax,(%esp)
    373b:	e8 3b 09 00 00       	call   407b <printf>
}
    3740:	c9                   	leave  
    3741:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    3748:	c7 04 24 3f 5b 00 00 	movl   $0x5b3f,(%esp)
  ...
  if(pid == 0){
    ...
    3772:	c7 04 85 20 65 00 00 	movl   $0x5b4c,0x6520(,%eax,4)
    3779:	4c 5b 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3785:	7e e8                	jle    376f <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    3787:	c7 05 9c 65 00 00 00 	movl   $0x0,0x659c
    378e:	00 00 00 
    printf(stdout, "bigarg test\n");
    3791:	a1 e8 64 00 00       	mov    0x64e8,%eax
    3796:	c7 44 24 04 29 5c 00 	movl   $0x5c29,0x4(%esp)
    379d:	00 
    379e:	89 04 24             	mov    %eax,(%esp)
    37a1:	e8 d5 08 00 00       	call   407b <printf>
    exec("echo", args);
    37a6:	c7 44 24 04 20 65 00 	movl   $0x6520,0x4(%esp)
    37ad:	00 
    37ae:	c7 04 24 48 45 00 00 	movl   $0x4548,(%esp)
    37b5:	e8 42 07 00 00       	call   3efc <exec>
    printf(stdout, "bigarg test ok\n");
    37ba:	a1 e8 64 00 00       	mov    0x64e8,%eax
    37bf:	c7 44 24 04 36 5c 00 	movl   $0x5c36,0x4(%esp)
    37c6:	00 
    37c7:	89 04 24             	mov    %eax,(%esp)
    37ca:	e8 ac 08 00 00       	call   407b <printf>
    fd = open("bigarg-ok", O_CREATE);
    37cf:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37d6:	00 
    37d7:	c7 04 24 3f 5b 00 00 	movl   $0x5b3f,(%esp)
    ...
    37fc:	a1 e8 64 00 00       	mov    0x64e8,%eax
    3801:	c7 44 24 04 46 5c 00 	movl   $0x5c46,0x4(%esp)
    3808:	00 
    3809:	89 04 24             	mov    %eax,(%esp)
    380c:	e8 6a 08 00 00       	call   407b <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3822:	00 
    3823:	c7 04 24 3f 5b 00 00 	movl   $0x5b3f,(%esp)
  ...
  if(fd < 0){
    ...
    3838:	a1 e8 64 00 00       	mov    0x64e8,%eax
    383d:	c7 44 24 04 5f 5c 00 	movl   $0x5c5f,0x4(%esp)
    3844:	00 
    3845:	89 04 24             	mov    %eax,(%esp)
    3848:	e8 2e 08 00 00       	call   407b <printf>
    exit();
  ...
  unlink("bigarg-ok");
    385d:	c7 04 24 3f 5b 00 00 	movl   $0x5b3f,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    3879:	c7 44 24 04 74 5c 00 	movl   $0x5c74,0x4(%esp)
    3880:	00 
    3881:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3888:	e8 ee 07 00 00       	call   407b <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3969:	c7 44 24 04 81 5c 00 	movl   $0x5c81,0x4(%esp)
    3970:	00 
    3971:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3978:	e8 fe 06 00 00       	call   407b <printf>
    ...
    39a0:	c7 44 24 04 8d 5c 00 	movl   $0x5c8d,0x4(%esp)
    39a7:	00 
    39a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39af:	e8 c7 06 00 00       	call   407b <printf>
      break;
    ...
    39c4:	00 
    39c5:	c7 44 24 04 e0 8c 00 	movl   $0x8ce0,0x4(%esp)
    39cc:	00 
    ...
    39f8:	c7 44 24 04 9d 5c 00 	movl   $0x5c9d,0x4(%esp)
    39ff:	00 
    3a00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3a07:	e8 6f 06 00 00       	call   407b <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3b13:	c7 44 24 04 ad 5c 00 	movl   $0x5cad,0x4(%esp)
    3b1a:	00 
    3b1b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b22:	e8 54 05 00 00       	call   407b <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3b30:	a1 ec 64 00 00       	mov    0x64ec,%eax
    3b35:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3b3b:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3b40:	a3 ec 64 00 00       	mov    %eax,0x64ec
  return randstate;
    3b45:	a1 ec 64 00 00       	mov    0x64ec,%eax
}
    3b4a:	5d                   	pop    %ebp
    3b4b:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3ba1:	00 
    3ba2:	c7 04 24 d7 5c 00 00 	movl   $0x5cd7,(%esp)
...
SYSCALL(clone)
    3f6c:	b8 19 00 00 00       	mov    $0x19,%eax
    3f71:	cd 40                	int    $0x40
    3f73:	c3                   	ret    

00003f74 <join>:
SYSCALL(join)
    3f74:	b8 1a 00 00 00       	mov    $0x1a,%eax
    3f79:	cd 40                	int    $0x40
    3f7b:	c3                   	ret    

00003f7c <texit>:
SYSCALL(texit)
    3f7c:	b8 1b 00 00 00       	mov    $0x1b,%eax
    3f81:	cd 40                	int    $0x40
    3f83:	c3                   	ret    

00003f84 <mutex_init>:
SYSCALL(mutex_init)
    3f84:	b8 1c 00 00 00       	mov    $0x1c,%eax
    3f89:	cd 40                	int    $0x40
    3f8b:	c3                   	ret    

00003f8c <mutex_destroy>:
SYSCALL(mutex_destroy)
    3f8c:	b8 1d 00 00 00       	mov    $0x1d,%eax
    3f91:	cd 40                	int    $0x40
    3f93:	c3                   	ret    

00003f94 <mutex_lock>:
SYSCALL(mutex_lock)
    3f94:	b8 1e 00 00 00       	mov    $0x1e,%eax
    3f99:	cd 40                	int    $0x40
    3f9b:	c3                   	ret    

00003f9c <mutex_unlock>:
    3f9c:	b8 1f 00 00 00       	mov    $0x1f,%eax
    3fa1:	cd 40                	int    $0x40
    3fa3:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    3fc5:	e8 1a ff ff ff       	call   3ee4 <write>
}
    3fca:	c9                   	leave  
    3fcb:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    4012:	0f b6 90 f0 64 00 00 	movzbl 0x64f0(%eax),%edx
    4019:	8d 45 dc             	lea    -0x24(%ebp),%eax
    401c:	03 45 f4             	add    -0xc(%ebp),%eax
    401f:	88 10                	mov    %dl,(%eax)
    4021:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    4025:	8b 55 10             	mov    0x10(%ebp),%edx
    4028:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    402b:	8b 45 ec             	mov    -0x14(%ebp),%eax
    402e:	ba 00 00 00 00       	mov    $0x0,%edx
    4033:	f7 75 d4             	divl   -0x2c(%ebp)
    4036:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4039:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    403d:	75 c4                	jne    4003 <printint+0x37>
  if(neg)
    403f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4043:	74 2a                	je     406f <printint+0xa3>
    buf[i++] = '-';
    4045:	8d 45 dc             	lea    -0x24(%ebp),%eax
    4048:	03 45 f4             	add    -0xc(%ebp),%eax
    404b:	c6 00 2d             	movb   $0x2d,(%eax)
    404e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    4052:	eb 1b                	jmp    406f <printint+0xa3>
    putc(fd, buf[i]);
    4054:	8d 45 dc             	lea    -0x24(%ebp),%eax
    4057:	03 45 f4             	add    -0xc(%ebp),%eax
    405a:	0f b6 00             	movzbl (%eax),%eax
    405d:	0f be c0             	movsbl %al,%eax
    4060:	89 44 24 04          	mov    %eax,0x4(%esp)
    4064:	8b 45 08             	mov    0x8(%ebp),%eax
    4067:	89 04 24             	mov    %eax,(%esp)
    406a:	e8 35 ff ff ff       	call   3fa4 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    406f:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    4073:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4077:	79 db                	jns    4054 <printint+0x88>
    putc(fd, buf[i]);
}
    4079:	c9                   	leave  
    407a:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    407e:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    4081:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    4088:	8d 45 0c             	lea    0xc(%ebp),%eax
    408b:	83 c0 04             	add    $0x4,%eax
    408e:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    4091:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    4098:	e9 7d 01 00 00       	jmp    421a <printf+0x19f>
    c = fmt[i] & 0xff;
    409d:	8b 55 0c             	mov    0xc(%ebp),%edx
    40a0:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40a3:	01 d0                	add    %edx,%eax
    40a5:	0f b6 00             	movzbl (%eax),%eax
    40a8:	0f be c0             	movsbl %al,%eax
    40ab:	25 ff 00 00 00       	and    $0xff,%eax
    40b0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    40b3:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    40b7:	75 2c                	jne    40e5 <printf+0x6a>
      if(c == '%'){
    40b9:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    40bd:	75 0c                	jne    40cb <printf+0x50>
        state = '%';
    40bf:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    40c6:	e9 4b 01 00 00       	jmp    4216 <printf+0x19b>
      } else {
        putc(fd, c);
    40cb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    40ce:	0f be c0             	movsbl %al,%eax
    40d1:	89 44 24 04          	mov    %eax,0x4(%esp)
    40d5:	8b 45 08             	mov    0x8(%ebp),%eax
    40d8:	89 04 24             	mov    %eax,(%esp)
    40db:	e8 c4 fe ff ff       	call   3fa4 <putc>
    40e0:	e9 31 01 00 00       	jmp    4216 <printf+0x19b>
      }
    } else if(state == '%'){
    40e5:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    40e9:	0f 85 27 01 00 00    	jne    4216 <printf+0x19b>
      if(c == 'd'){
    40ef:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    40f3:	75 2d                	jne    4122 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    40f5:	8b 45 e8             	mov    -0x18(%ebp),%eax
    40f8:	8b 00                	mov    (%eax),%eax
    40fa:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    4101:	00 
    4102:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    4109:	00 
    410a:	89 44 24 04          	mov    %eax,0x4(%esp)
    410e:	8b 45 08             	mov    0x8(%ebp),%eax
    4111:	89 04 24             	mov    %eax,(%esp)
    4114:	e8 b3 fe ff ff       	call   3fcc <printint>
        ap++;
    4119:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    411d:	e9 ed 00 00 00       	jmp    420f <printf+0x194>
      } else if(c == 'x' || c == 'p'){
    4122:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    4126:	74 06                	je     412e <printf+0xb3>
    4128:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    412c:	75 2d                	jne    415b <printf+0xe0>
        printint(fd, *ap, 16, 0);
    412e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4131:	8b 00                	mov    (%eax),%eax
    4133:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    413a:	00 
    413b:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4142:	00 
    4143:	89 44 24 04          	mov    %eax,0x4(%esp)
    4147:	8b 45 08             	mov    0x8(%ebp),%eax
    414a:	89 04 24             	mov    %eax,(%esp)
    414d:	e8 7a fe ff ff       	call   3fcc <printint>
        ap++;
    4152:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4156:	e9 b4 00 00 00       	jmp    420f <printf+0x194>
      } else if(c == 's'){
    415b:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    415f:	75 46                	jne    41a7 <printf+0x12c>
        s = (char*)*ap;
    4161:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4164:	8b 00                	mov    (%eax),%eax
    4166:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    4169:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    416d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4171:	75 27                	jne    419a <printf+0x11f>
          s = "(null)";
    4173:	c7 45 f4 12 5d 00 00 	movl   $0x5d12,-0xc(%ebp)
        while(*s != 0){
    417a:	eb 1e                	jmp    419a <printf+0x11f>
          putc(fd, *s);
    ...
    418f:	e8 10 fe ff ff       	call   3fa4 <putc>
          s++;
    4194:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    4198:	eb 01                	jmp    419b <printf+0x120>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    419e:	0f b6 00             	movzbl (%eax),%eax
    41a1:	84 c0                	test   %al,%al
    41a3:	75 d7                	jne    417c <printf+0x101>
    41a5:	eb 68                	jmp    420f <printf+0x194>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    41a7:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    41ab:	75 1d                	jne    41ca <printf+0x14f>
        putc(fd, *ap);
    41ad:	8b 45 e8             	mov    -0x18(%ebp),%eax
    ...
    41bf:	e8 e0 fd ff ff       	call   3fa4 <putc>
        ap++;
    41c4:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    41c8:	eb 45                	jmp    420f <printf+0x194>
      } else if(c == '%'){
    41ca:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    41ce:	75 17                	jne    41e7 <printf+0x16c>
        putc(fd, c);
    41d0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    41d3:	0f be c0             	movsbl %al,%eax
    41d6:	89 44 24 04          	mov    %eax,0x4(%esp)
    41da:	8b 45 08             	mov    0x8(%ebp),%eax
    41dd:	89 04 24             	mov    %eax,(%esp)
    41e0:	e8 bf fd ff ff       	call   3fa4 <putc>
    41e5:	eb 28                	jmp    420f <printf+0x194>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    41e7:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    41ee:	00 
    41ef:	8b 45 08             	mov    0x8(%ebp),%eax
    41f2:	89 04 24             	mov    %eax,(%esp)
    41f5:	e8 aa fd ff ff       	call   3fa4 <putc>
        putc(fd, c);
    ...
    420a:	e8 95 fd ff ff       	call   3fa4 <putc>
      }
      state = 0;
    420f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    4216:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    421a:	8b 55 0c             	mov    0xc(%ebp),%edx
    421d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4220:	01 d0                	add    %edx,%eax
    4222:	0f b6 00             	movzbl (%eax),%eax
    4225:	84 c0                	test   %al,%al
    4227:	0f 85 70 fe ff ff    	jne    409d <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    423f:	a1 a8 65 00 00       	mov    0x65a8,%eax
...
free(void *ap)
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    4288:	89 c2                	mov    %eax,%edx
    428a:	03 55 f8             	add    -0x8(%ebp),%edx
    428d:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4290:	8b 00                	mov    (%eax),%eax
    4292:	39 c2                	cmp    %eax,%edx
    4294:	75 24                	jne    42ba <free+0x8a>
  ...
  if(p + p->s.size == bp){
    ...
    42cd:	03 45 fc             	add    -0x4(%ebp),%eax
    42d0:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    42d3:	75 20                	jne    42f5 <free+0xc5>
    p->s.size += bp->s.size;
    42d5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42d8:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    42ec:	8b 10                	mov    (%eax),%edx
    42ee:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42f1:	89 10                	mov    %edx,(%eax)
    42f3:	eb 08                	jmp    42fd <free+0xcd>
  } else
    p->s.ptr = bp;
    42f5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42f8:	8b 55 f8             	mov    -0x8(%ebp),%edx
    42fb:	89 10                	mov    %edx,(%eax)
  freep = p;
    42fd:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4300:	a3 a8 65 00 00       	mov    %eax,0x65a8
}
    4305:	c9                   	leave  
    4306:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    430a:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    430d:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4314:	77 07                	ja     431d <morecore+0x16>
    nu = 4096;
    4316:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    431d:	8b 45 08             	mov    0x8(%ebp),%eax
    4320:	c1 e0 03             	shl    $0x3,%eax
    4323:	89 04 24             	mov    %eax,(%esp)
    4326:	e8 21 fc ff ff       	call   3f4c <sbrk>
    432b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    432e:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4332:	75 07                	jne    433b <morecore+0x34>
    return 0;
    4334:	b8 00 00 00 00       	mov    $0x0,%eax
    4339:	eb 22                	jmp    435d <morecore+0x56>
  hp = (Header*)p;
    433b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    433e:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    4341:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4344:	8b 55 08             	mov    0x8(%ebp),%edx
    4347:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    434a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    434d:	83 c0 08             	add    $0x8,%eax
    4350:	89 04 24             	mov    %eax,(%esp)
    4353:	e8 d8 fe ff ff       	call   4230 <free>
  return freep;
    4358:	a1 a8 65 00 00       	mov    0x65a8,%eax
}
    435d:	c9                   	leave  
    435e:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    4362:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4365:	8b 45 08             	mov    0x8(%ebp),%eax
    4368:	83 c0 07             	add    $0x7,%eax
    436b:	c1 e8 03             	shr    $0x3,%eax
    436e:	83 c0 01             	add    $0x1,%eax
    4371:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    4374:	a1 a8 65 00 00       	mov    0x65a8,%eax
    4379:	89 45 f0             	mov    %eax,-0x10(%ebp)
    437c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4380:	75 23                	jne    43a5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    4382:	c7 45 f0 a0 65 00 00 	movl   $0x65a0,-0x10(%ebp)
    4389:	8b 45 f0             	mov    -0x10(%ebp),%eax
    438c:	a3 a8 65 00 00       	mov    %eax,0x65a8
    4391:	a1 a8 65 00 00       	mov    0x65a8,%eax
    4396:	a3 a0 65 00 00       	mov    %eax,0x65a0
    base.s.size = 0;
    439b:	c7 05 a4 65 00 00 00 	movl   $0x0,0x65a4
    43a2:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    43b0:	8b 40 04             	mov    0x4(%eax),%eax
    43b3:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    43b6:	72 4d                	jb     4405 <malloc+0xa6>
      if(p->s.size == nunits)
    43b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43bb:	8b 40 04             	mov    0x4(%eax),%eax
    43be:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    43c1:	75 0c                	jne    43cf <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    43c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43c6:	8b 10                	mov    (%eax),%edx
    43c8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    43cb:	89 10                	mov    %edx,(%eax)
    43cd:	eb 26                	jmp    43f5 <malloc+0x96>
      else {
        p->s.size -= nunits;
    43cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43d2:	8b 40 04             	mov    0x4(%eax),%eax
    43d5:	89 c2                	mov    %eax,%edx
    43d7:	2b 55 ec             	sub    -0x14(%ebp),%edx
    43da:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43dd:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    43e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43e3:	8b 40 04             	mov    0x4(%eax),%eax
    43e6:	c1 e0 03             	shl    $0x3,%eax
    43e9:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    43ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43ef:	8b 55 ec             	mov    -0x14(%ebp),%edx
    43f2:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    43f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    43f8:	a3 a8 65 00 00       	mov    %eax,0x65a8
      return (void*)(p + 1);
    43fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4400:	83 c0 08             	add    $0x8,%eax
    4403:	eb 38                	jmp    443d <malloc+0xde>
    }
    if(p == freep)
    4405:	a1 a8 65 00 00       	mov    0x65a8,%eax
    440a:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    440d:	75 1b                	jne    442a <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    440f:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4412:	89 04 24             	mov    %eax,(%esp)
    4415:	e8 ed fe ff ff       	call   4307 <morecore>
    441a:	89 45 f4             	mov    %eax,-0xc(%ebp)
    441d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4421:	75 07                	jne    442a <malloc+0xcb>
        return 0;
    4423:	b8 00 00 00 00       	mov    $0x0,%eax
    4428:	eb 13                	jmp    443d <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4438:	e9 70 ff ff ff       	jmp    43ad <malloc+0x4e>
}
    443d:	c9                   	leave  
    443e:	c3                   	ret    
    443f:	90                   	nop

00004440 <pthread_create>:
...
int pthread_create(pthread_t *thread, const pthread_attr_t *attr, void *(*start_routine) (void*), void *arg){
    ...
    4443:	83 ec 28             	sub    $0x28,%esp

	void *mystek = malloc((uint)PAGESIZE*2); //Why do we need the *2?
    4446:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
    444d:	e8 0d ff ff ff       	call   435f <malloc>
    4452:	89 45 f4             	mov    %eax,-0xc(%ebp)
//zzddhhtjzz/xv6/blob/master
	if((uint)mystek % PAGESIZE){
    4455:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4458:	25 ff 0f 00 00       	and    $0xfff,%eax
    445d:	85 c0                	test   %eax,%eax
    445f:	74 15                	je     4476 <pthread_create+0x36>
		mystek += 4096 - ((uint)mystek % PAGESIZE);
    4461:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4464:	89 c2                	mov    %eax,%edx
    4466:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
    446c:	b8 00 10 00 00       	mov    $0x1000,%eax
    4471:	29 d0                	sub    %edx,%eax
    4473:	01 45 f4             	add    %eax,-0xc(%ebp)
	}
	thread->pid = clone(start_routine, arg, mystek);
    4476:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4479:	89 44 24 08          	mov    %eax,0x8(%esp)
    447d:	8b 45 14             	mov    0x14(%ebp),%eax
    4480:	89 44 24 04          	mov    %eax,0x4(%esp)
    4484:	8b 45 10             	mov    0x10(%ebp),%eax
    4487:	89 04 24             	mov    %eax,(%esp)
    448a:	e8 dd fa ff ff       	call   3f6c <clone>
    448f:	8b 55 08             	mov    0x8(%ebp),%edx
    4492:	89 02                	mov    %eax,(%edx)
	return thread->pid;
    4494:	8b 45 08             	mov    0x8(%ebp),%eax
    4497:	8b 00                	mov    (%eax),%eax
}
    4499:	c9                   	leave  
    449a:	c3                   	ret    

0000449b <pthread_join>:

int pthread_join(pthread_t thread, void **retval){
    449b:	55                   	push   %ebp
    449c:	89 e5                	mov    %esp,%ebp
    449e:	83 ec 28             	sub    $0x28,%esp

	void *stek;

	join((int)thread.pid, &stek, (void*)retval);
    44a1:	8b 45 08             	mov    0x8(%ebp),%eax
    44a4:	8b 55 0c             	mov    0xc(%ebp),%edx
    44a7:	89 54 24 08          	mov    %edx,0x8(%esp)
    44ab:	8d 55 f4             	lea    -0xc(%ebp),%edx
    44ae:	89 54 24 04          	mov    %edx,0x4(%esp)
    44b2:	89 04 24             	mov    %eax,(%esp)
    44b5:	e8 ba fa ff ff       	call   3f74 <join>

	free(stek);
    44ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44bd:	89 04 24             	mov    %eax,(%esp)
    44c0:	e8 6b fd ff ff       	call   4230 <free>

	return 0;
    44c5:	b8 00 00 00 00       	mov    $0x0,%eax
}
    44ca:	c9                   	leave  
    44cb:	c3                   	ret    

000044cc <pthread_exit>:

int pthread_exit(void *retval){
    44cc:	55                   	push   %ebp
    44cd:	89 e5                	mov    %esp,%ebp
    44cf:	83 ec 18             	sub    $0x18,%esp

	texit(retval);
    44d2:	8b 45 08             	mov    0x8(%ebp),%eax
    44d5:	89 04 24             	mov    %eax,(%esp)
    44d8:	e8 9f fa ff ff       	call   3f7c <texit>

	return 0;
    44dd:	b8 00 00 00 00       	mov    $0x0,%eax
}
    44e2:	c9                   	leave  
    44e3:	c3                   	ret    

000044e4 <pthread_mutex_init>:


int pthread_mutex_init(pthread_mutex_t *mutex, const pthread_mutex_attr_t *attr){
    44e4:	55                   	push   %ebp
    44e5:	89 e5                	mov    %esp,%ebp
    44e7:	83 ec 18             	sub    $0x18,%esp

	int mid = mutex_init();
    44ea:	e8 95 fa ff ff       	call   3f84 <mutex_init>
...
00004512 <pthread_mutex_lock>:


int pthread_mutex_lock(pthread_mutex_t *mutex){
    4512:	55                   	push   %ebp
    4513:	89 e5                	mov    %esp,%ebp
    4515:	83 ec 18             	sub    $0x18,%esp

	mutex_lock(mutex->mid);
    4518:	8b 45 08             	mov    0x8(%ebp),%eax
    451b:	8b 40 04             	mov    0x4(%eax),%eax
    451e:	89 04 24             	mov    %eax,(%esp)
    4521:	e8 6e fa ff ff       	call   3f94 <mutex_lock>
	return 0;
    4526:	b8 00 00 00 00       	mov    $0x0,%eax
}
    452b:	c9                   	leave  
    452c:	c3                   	ret    

0000452d <pthread_mutex_unlock>:


int pthread_mutex_unlock(pthread_mutex_t *mutex){
    452d:	55                   	push   %ebp
    452e:	89 e5                	mov    %esp,%ebp
    4530:	83 ec 18             	sub    $0x18,%esp

	mutex_unlock(mutex->mid);
    4533:	8b 45 08             	mov    0x8(%ebp),%eax
    4536:	8b 40 04             	mov    0x4(%eax),%eax
    4539:	89 04 24             	mov    %eax,(%esp)
    453c:	e8 5b fa ff ff       	call   3f9c <mutex_unlock>
	return 0;
    4541:	b8 00 00 00 00       	mov    $0x0,%eax
    4546:	c9                   	leave  
    4547:	c3                   	ret    
