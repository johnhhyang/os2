...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 e0 62 00 00       	mov    0x62e0,%eax
       b:	c7 44 24 04 36 44 00 	movl   $0x4436,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 40 40 00 00       	call   405b <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 41 44 00 00 	movl   $0x4441,(%esp)
      22:	e8 05 3f 00 00       	call   3f2c <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 e0 62 00 00       	mov    0x62e0,%eax
      30:	c7 44 24 04 49 44 00 	movl   $0x4449,0x4(%esp)
      37:	00 
  ...
  if(chdir("iputdir") < 0){
      45:	c7 04 24 41 44 00 00 	movl   $0x4441,(%esp)
      4c:	e8 e3 3e 00 00       	call   3f34 <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 e0 62 00 00       	mov    0x62e0,%eax
      5a:	c7 44 24 04 57 44 00 	movl   $0x4457,0x4(%esp)
      61:	00 
  ...
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 6d 44 00 00 	movl   $0x446d,(%esp)
      76:	e8 99 3e 00 00       	call   3f14 <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 e0 62 00 00       	mov    0x62e0,%eax
      84:	c7 44 24 04 78 44 00 	movl   $0x4478,0x4(%esp)
      8b:	00 
  ...
  if(chdir("/") < 0){
      99:	c7 04 24 92 44 00 00 	movl   $0x4492,(%esp)
      a0:	e8 8f 3e 00 00       	call   3f34 <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 e0 62 00 00       	mov    0x62e0,%eax
      ae:	c7 44 24 04 94 44 00 	movl   $0x4494,0x4(%esp)
      b5:	00 
  ...
  printf(stdout, "iput test ok\n");
      c3:	a1 e0 62 00 00       	mov    0x62e0,%eax
      c8:	c7 44 24 04 a4 44 00 	movl   $0x44a4,0x4(%esp)
      cf:	00 
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 e0 62 00 00       	mov    0x62e0,%eax
      e5:	c7 44 24 04 b2 44 00 	movl   $0x44b2,0x4(%esp)
      ec:	00 
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 e0 62 00 00       	mov    0x62e0,%eax
     108:	c7 44 24 04 c1 44 00 	movl   $0x44c1,0x4(%esp)
     10f:	00 
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 41 44 00 00 	movl   $0x4441,(%esp)
     12e:	e8 f9 3d 00 00       	call   3f2c <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 e0 62 00 00       	mov    0x62e0,%eax
     13c:	c7 44 24 04 49 44 00 	movl   $0x4449,0x4(%esp)
     143:	00 
    ...
    if(chdir("iputdir") < 0){
     151:	c7 04 24 41 44 00 00 	movl   $0x4441,(%esp)
     158:	e8 d7 3d 00 00       	call   3f34 <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 e0 62 00 00       	mov    0x62e0,%eax
     166:	c7 44 24 04 ce 44 00 	movl   $0x44ce,0x4(%esp)
     16d:	00 
    ...
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 6d 44 00 00 	movl   $0x446d,(%esp)
     182:	e8 8d 3d 00 00       	call   3f14 <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 e0 62 00 00       	mov    0x62e0,%eax
     190:	c7 44 24 04 78 44 00 	movl   $0x4478,0x4(%esp)
     197:	00 
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 e0 62 00 00       	mov    0x62e0,%eax
     1b4:	c7 44 24 04 e2 44 00 	movl   $0x44e2,0x4(%esp)
     1bb:	00 
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 e0 62 00 00       	mov    0x62e0,%eax
     1d1:	c7 44 24 04 f4 44 00 	movl   $0x44f4,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 7a 3e 00 00       	call   405b <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 03 45 00 00 	movl   $0x4503,(%esp)
     1e8:	e8 3f 3d 00 00       	call   3f2c <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 e0 62 00 00       	mov    0x62e0,%eax
     1f6:	c7 44 24 04 09 45 00 	movl   $0x4509,0x4(%esp)
     1fd:	00 
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 e0 62 00 00       	mov    0x62e0,%eax
     21e:	c7 44 24 04 c1 44 00 	movl   $0x44c1,0x4(%esp)
     225:	00 
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 03 45 00 00 	movl   $0x4503,(%esp)
    ...
    if(fd >= 0){
     ...
     256:	a1 e0 62 00 00       	mov    0x62e0,%eax
     25b:	c7 44 24 04 20 45 00 	movl   $0x4520,0x4(%esp)
     262:	00 
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 03 45 00 00 	movl   $0x4503,(%esp)
     288:	e8 87 3c 00 00       	call   3f14 <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 e0 62 00 00       	mov    0x62e0,%eax
     296:	c7 44 24 04 44 45 00 	movl   $0x4544,0x4(%esp)
     29d:	00 
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 e0 62 00 00       	mov    0x62e0,%eax
     2b5:	c7 44 24 04 53 45 00 	movl   $0x4553,0x4(%esp)
     2bc:	00 
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 e0 62 00 00       	mov    0x62e0,%eax
     2d2:	c7 44 24 04 65 45 00 	movl   $0x4565,0x4(%esp)
     2d9:	00 
  ...
  fd = open("echo", 0);
     ...
     2e9:	00 
     2ea:	c7 04 24 20 44 00 00 	movl   $0x4420,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 e0 62 00 00       	mov    0x62e0,%eax
     304:	c7 44 24 04 70 45 00 	movl   $0x4570,0x4(%esp)
     30b:	00 
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 83 45 00 00 	movl   $0x4583,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 e0 62 00 00       	mov    0x62e0,%eax
     346:	c7 44 24 04 90 45 00 	movl   $0x4590,0x4(%esp)
     34d:	00 
  ...
  printf(stdout, "open test ok\n");
     35b:	a1 e0 62 00 00       	mov    0x62e0,%eax
     360:	c7 44 24 04 ae 45 00 	movl   $0x45ae,0x4(%esp)
     367:	00 
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 e0 62 00 00       	mov    0x62e0,%eax
     37d:	c7 44 24 04 bc 45 00 	movl   $0x45bc,0x4(%esp)
     384:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     394:	00 
     395:	c7 04 24 cd 45 00 00 	movl   $0x45cd,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 e0 62 00 00       	mov    0x62e0,%eax
     3af:	c7 44 24 04 d3 45 00 	movl   $0x45d3,0x4(%esp)
     3b6:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 e0 62 00 00       	mov    0x62e0,%eax
     3d0:	c7 44 24 04 ee 45 00 	movl   $0x45ee,0x4(%esp)
     3d7:	00 
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3ec:	00 
     3ed:	c7 44 24 04 0a 46 00 	movl   $0x460a,0x4(%esp)
     3f4:	00 
     ...
     405:	a1 e0 62 00 00       	mov    0x62e0,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 18 46 00 	movl   $0x4618,0x4(%esp)
     418:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 3c 46 00 	movl   $0x463c,0x4(%esp)
     435:	00 
     ...
     446:	a1 e0 62 00 00       	mov    0x62e0,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 48 46 00 	movl   $0x4648,0x4(%esp)
     459:	00 
  ...
  printf(stdout, "writes ok\n");
     475:	a1 e0 62 00 00       	mov    0x62e0,%eax
     47a:	c7 44 24 04 6c 46 00 	movl   $0x466c,0x4(%esp)
     481:	00 
  ...
  fd = open("small", O_RDONLY);
     ...
     49c:	00 
     49d:	c7 04 24 cd 45 00 00 	movl   $0x45cd,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b2:	a1 e0 62 00 00       	mov    0x62e0,%eax
     4b7:	c7 44 24 04 77 46 00 	movl   $0x4677,0x4(%esp)
     4be:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     4f0:	a1 e0 62 00 00       	mov    0x62e0,%eax
     4f5:	c7 44 24 04 90 46 00 	movl   $0x4690,0x4(%esp)
     4fc:	00 
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     50a:	a1 e0 62 00 00       	mov    0x62e0,%eax
     50f:	c7 44 24 04 ab 46 00 	movl   $0x46ab,0x4(%esp)
     516:	00 
  ...
  if(unlink("small") < 0){
     52a:	c7 04 24 cd 45 00 00 	movl   $0x45cd,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     53c:	a1 e0 62 00 00       	mov    0x62e0,%eax
     541:	c7 44 24 04 be 46 00 	movl   $0x46be,0x4(%esp)
     548:	00 
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     556:	a1 e0 62 00 00       	mov    0x62e0,%eax
     55b:	c7 44 24 04 cb 46 00 	movl   $0x46cb,0x4(%esp)
     562:	00 
  ...
  printf(stdout, "small file test ok\n");
     570:	a1 e0 62 00 00       	mov    0x62e0,%eax
     575:	c7 44 24 04 e0 46 00 	movl   $0x46e0,0x4(%esp)
     57c:	00 
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58d:	a1 e0 62 00 00       	mov    0x62e0,%eax
     592:	c7 44 24 04 f4 46 00 	movl   $0x46f4,0x4(%esp)
     599:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     5a9:	00 
     5aa:	c7 04 24 04 47 00 00 	movl   $0x4704,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5bf:	a1 e0 62 00 00       	mov    0x62e0,%eax
     5c4:	c7 44 24 04 08 47 00 	movl   $0x4708,0x4(%esp)
     5cb:	00 
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60e:	a1 e0 62 00 00       	mov    0x62e0,%eax
     613:	8b 55 f4             	mov    -0xc(%ebp),%edx
     616:	89 54 24 08          	mov    %edx,0x8(%esp)
     61a:	c7 44 24 04 22 47 00 	movl   $0x4722,0x4(%esp)
     621:	00 
  ...
  fd = open("big", O_RDONLY);
     ...
     64f:	00 
     650:	c7 04 24 04 47 00 00 	movl   $0x4704,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     665:	a1 e0 62 00 00       	mov    0x62e0,%eax
     66a:	c7 44 24 04 40 47 00 	movl   $0x4740,0x4(%esp)
     671:	00 
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6b7:	a1 e0 62 00 00       	mov    0x62e0,%eax
     6bc:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bf:	89 54 24 08          	mov    %edx,0x8(%esp)
     6c3:	c7 44 24 04 59 47 00 	movl   $0x4759,0x4(%esp)
     6ca:	00 
     ...
     6e1:	a1 e0 62 00 00       	mov    0x62e0,%eax
     6e6:	8b 55 f4             	mov    -0xc(%ebp),%edx
     6e9:	89 54 24 08          	mov    %edx,0x8(%esp)
     6ed:	c7 44 24 04 76 47 00 	movl   $0x4776,0x4(%esp)
     6f4:	00 
  ...
  if(unlink("big") < 0){
     74f:	c7 04 24 04 47 00 00 	movl   $0x4704,(%esp)
     756:	e8 b9 37 00 00       	call   3f14 <unlink>
     75b:	85 c0                	test   %eax,%eax
     75d:	79 1a                	jns    779 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     75f:	a1 e0 62 00 00       	mov    0x62e0,%eax
     764:	c7 44 24 04 a8 47 00 	movl   $0x47a8,0x4(%esp)
     76b:	00 
  ...
  printf(stdout, "big files ok\n");
     779:	a1 e0 62 00 00       	mov    0x62e0,%eax
     77e:	c7 44 24 04 bb 47 00 	movl   $0x47bb,0x4(%esp)
     785:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     796:	a1 e0 62 00 00       	mov    0x62e0,%eax
     79b:	c7 44 24 04 cc 47 00 	movl   $0x47cc,0x4(%esp)
     7a2:	00 
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     831:	a1 e0 62 00 00       	mov    0x62e0,%eax
     836:	c7 44 24 04 f4 47 00 	movl   $0x47f4,0x4(%esp)
     83d:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     84e:	a1 e0 62 00 00       	mov    0x62e0,%eax
     853:	c7 44 24 04 1a 48 00 	movl   $0x481a,0x4(%esp)
     85a:	00 
     85b:	89 04 24             	mov    %eax,(%esp)
     85e:	e8 f8 37 00 00       	call   405b <printf>

  if(mkdir("dir0") < 0){
     863:	c7 04 24 26 48 00 00 	movl   $0x4826,(%esp)
     86a:	e8 bd 36 00 00       	call   3f2c <mkdir>
     86f:	85 c0                	test   %eax,%eax
     871:	79 1a                	jns    88d <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     873:	a1 e0 62 00 00       	mov    0x62e0,%eax
     878:	c7 44 24 04 49 44 00 	movl   $0x4449,0x4(%esp)
     87f:	00 
  ...
  if(chdir("dir0") < 0){
     88d:	c7 04 24 26 48 00 00 	movl   $0x4826,(%esp)
     894:	e8 9b 36 00 00       	call   3f34 <chdir>
     899:	85 c0                	test   %eax,%eax
     89b:	79 1a                	jns    8b7 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89d:	a1 e0 62 00 00       	mov    0x62e0,%eax
     8a2:	c7 44 24 04 2b 48 00 	movl   $0x482b,0x4(%esp)
     8a9:	00 
  ...
  if(chdir("..") < 0){
     8b7:	c7 04 24 3e 48 00 00 	movl   $0x483e,(%esp)
     8be:	e8 71 36 00 00       	call   3f34 <chdir>
     8c3:	85 c0                	test   %eax,%eax
     8c5:	79 1a                	jns    8e1 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c7:	a1 e0 62 00 00       	mov    0x62e0,%eax
     8cc:	c7 44 24 04 41 48 00 	movl   $0x4841,0x4(%esp)
     8d3:	00 
  ...
  if(unlink("dir0") < 0){
     8e1:	c7 04 24 26 48 00 00 	movl   $0x4826,(%esp)
     8e8:	e8 27 36 00 00       	call   3f14 <unlink>
     8ed:	85 c0                	test   %eax,%eax
     8ef:	79 1a                	jns    90b <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f1:	a1 e0 62 00 00       	mov    0x62e0,%eax
     8f6:	c7 44 24 04 52 48 00 	movl   $0x4852,0x4(%esp)
     8fd:	00 
  ...
  printf(stdout, "mkdir test ok\n");
     90b:	a1 e0 62 00 00       	mov    0x62e0,%eax
     910:	c7 44 24 04 66 48 00 	movl   $0x4866,0x4(%esp)
     917:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     928:	a1 e0 62 00 00       	mov    0x62e0,%eax
     92d:	c7 44 24 04 75 48 00 	movl   $0x4875,0x4(%esp)
     934:	00 
     935:	89 04 24             	mov    %eax,(%esp)
     938:	e8 1e 37 00 00       	call   405b <printf>
  if(exec("echo", echoargv) < 0){
     93d:	c7 44 24 04 cc 62 00 	movl   $0x62cc,0x4(%esp)
     944:	00 
     945:	c7 04 24 20 44 00 00 	movl   $0x4420,(%esp)
     94c:	e8 ab 35 00 00       	call   3efc <exec>
     951:	85 c0                	test   %eax,%eax
     953:	79 1a                	jns    96f <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     955:	a1 e0 62 00 00       	mov    0x62e0,%eax
     95a:	c7 44 24 04 80 48 00 	movl   $0x4880,0x4(%esp)
     961:	00 
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     986:	c7 44 24 04 92 48 00 	movl   $0x4892,0x4(%esp)
     98d:	00 
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a16:	c7 44 24 04 a1 48 00 	movl   $0x48a1,0x4(%esp)
     a1d:	00 
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a8f:	c7 44 24 04 af 48 00 	movl   $0x48af,0x4(%esp)
     a96:	00 
    ...
    if(total != 5 * 1033){
     ...
     b05:	c7 44 24 04 bd 48 00 	movl   $0x48bd,0x4(%esp)
     b0c:	00 
  ...
  printf(1, "pipe1 ok\n");
     b2e:	c7 44 24 04 d4 48 00 	movl   $0x48d4,0x4(%esp)
     b35:	00 
    ...
    printf(1, "fork() failed\n");
     b44:	c7 44 24 04 de 48 00 	movl   $0x48de,0x4(%esp)
     b4b:	00 
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b65:	c7 44 24 04 ed 48 00 	movl   $0x48ed,0x4(%esp)
     b6c:	00 
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc7:	00 
     bc8:	c7 44 24 04 f7 48 00 	movl   $0x48f7,0x4(%esp)
     bcf:	00 
     ...
     bdd:	c7 44 24 04 f9 48 00 	movl   $0x48f9,0x4(%esp)
     be4:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     c29:	c7 44 24 04 0d 49 00 	movl   $0x490d,0x4(%esp)
     c30:	00 
  ...
  printf(1, "kill... ");
     c4a:	c7 44 24 04 20 49 00 	movl   $0x4920,0x4(%esp)
     c51:	00 
  ...
  printf(1, "wait... ");
     c7f:	c7 44 24 04 29 49 00 	movl   $0x4929,0x4(%esp)
     c86:	00 
  ...
  printf(1, "preempt ok\n");
     ca2:	c7 44 24 04 32 49 00 	movl   $0x4932,0x4(%esp)
     ca9:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd3:	79 16                	jns    ceb <exitwait+0x33>
      printf(1, "fork failed\n");
     cd5:	c7 44 24 04 c1 44 00 	movl   $0x44c1,0x4(%esp)
     cdc:	00 
    ...
    if(pid){
     ...
     cfb:	c7 44 24 04 3e 49 00 	movl   $0x493e,0x4(%esp)
     d02:	00 
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d20:	c7 44 24 04 4e 49 00 	movl   $0x494e,0x4(%esp)
     d27:	00 
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3c:	c7 44 24 04 5b 49 00 	movl   $0x495b,0x4(%esp)
     d43:	00 
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d88:	e8 b2 35 00 00       	call   433f <malloc>
    ...
    printf(1, "mem ok\n");
     dfb:	c7 44 24 04 7f 49 00 	movl   $0x497f,0x4(%esp)
     e02:	00 
...
sharedfd(void)
{
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5e:	c7 44 24 04 a0 49 00 	movl   $0x49a0,0x4(%esp)
     e65:	00 
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed0:	c7 44 24 04 cc 49 00 	movl   $0x49cc,0x4(%esp)
     ed7:	00 
  ...
  fd = open("sharedfd", 0);
     ...
     f15:	00 
     f16:	c7 04 24 96 49 00 00 	movl   $0x4996,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2b:	c7 44 24 04 ec 49 00 	movl   $0x49ec,0x4(%esp)
     f32:	00 
  ...
  unlink("sharedfd");
     fb8:	c7 04 24 96 49 00 00 	movl   $0x4996,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fd6:	c7 44 24 04 17 4a 00 	movl   $0x4a17,0x4(%esp)
     fdd:	00 
     fde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fe5:	e8 71 30 00 00       	call   405b <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     ffa:	c7 44 24 04 24 4a 00 	movl   $0x4a24,0x4(%esp)
    1001:	00 
    1002:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1009:	e8 4d 30 00 00       	call   405b <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    101b:	c7 45 c8 39 4a 00 00 	movl   $0x4a39,-0x38(%ebp)
    1022:	c7 45 cc 3c 4a 00 00 	movl   $0x4a3c,-0x34(%ebp)
    1029:	c7 45 d0 3f 4a 00 00 	movl   $0x4a3f,-0x30(%ebp)
    1030:	c7 45 d4 42 4a 00 00 	movl   $0x4a42,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    1037:	c7 44 24 04 45 4a 00 	movl   $0x4a45,0x4(%esp)
    103e:	00 
    103f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1046:	e8 10 30 00 00       	call   405b <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1078:	79 19                	jns    1093 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107a:	c7 44 24 04 c1 44 00 	movl   $0x44c1,0x4(%esp)
    1081:	00 
    1082:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1089:	e8 cd 2f 00 00       	call   405b <printf>
      exit();
    ...
    10b9:	c7 44 24 04 55 4a 00 	movl   $0x4a55,0x4(%esp)
    10c0:	00 
    10c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10c8:	e8 8e 2f 00 00       	call   405b <printf>
        exit();
    ...
    1127:	c7 44 24 04 64 4a 00 	movl   $0x4a64,0x4(%esp)
    112e:	00 
    112f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1136:	e8 20 2f 00 00       	call   405b <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11c9:	74 19                	je     11e4 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11cb:	c7 44 24 04 75 4a 00 	movl   $0x4a75,0x4(%esp)
    11d2:	00 
    11d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11da:	e8 7c 2e 00 00       	call   405b <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    1235:	c7 44 24 04 81 4a 00 	movl   $0x4a81,0x4(%esp)
    123c:	00 
    123d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1244:	e8 12 2e 00 00       	call   405b <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    1267:	c7 44 24 04 92 4a 00 	movl   $0x4a92,0x4(%esp)
    126e:	00 
    126f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1276:	e8 e0 2d 00 00       	call   405b <printf>
}
    127b:	c9                   	leave  
    127c:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1283:	c7 44 24 04 a0 4a 00 	movl   $0x4aa0,0x4(%esp)
    128a:	00 
    128b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1292:	e8 c4 2d 00 00       	call   405b <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12af:	79 19                	jns    12ca <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b1:	c7 44 24 04 c1 44 00 	movl   $0x44c1,0x4(%esp)
    12b8:	00 
    12b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12c0:	e8 96 2d 00 00       	call   405b <printf>
      exit();
    ...
    1310:	79 19                	jns    132b <createdelete+0xae>
          printf(1, "create failed\n");
    1312:	c7 44 24 04 55 4a 00 	movl   $0x4a55,0x4(%esp)
    1319:	00 
    131a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1321:	e8 35 2d 00 00       	call   405b <printf>
          exit();
    ...
    1367:	c7 44 24 04 44 45 00 	movl   $0x4544,0x4(%esp)
    136e:	00 
    136f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1376:	e8 e0 2c 00 00       	call   405b <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1424:	c7 44 24 04 b4 4a 00 	movl   $0x4ab4,0x4(%esp)
    142b:	00 
    142c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1433:	e8 23 2c 00 00       	call   405b <printf>
        exit();
    ...
    1456:	c7 44 24 04 d8 4a 00 	movl   $0x4ad8,0x4(%esp)
    145d:	00 
    145e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1465:	e8 f1 2b 00 00       	call   405b <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14df:	c7 44 24 04 f8 4a 00 	movl   $0x4af8,0x4(%esp)
    14e6:	00 
    14e7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14ee:	e8 68 2b 00 00       	call   405b <printf>
}
    14f3:	c9                   	leave  
    14f4:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    14fb:	c7 44 24 04 09 4b 00 	movl   $0x4b09,0x4(%esp)
    1502:	00 
    1503:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150a:	e8 4c 2b 00 00       	call   405b <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    150f:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1516:	00 
    1517:	c7 04 24 1a 4b 00 00 	movl   $0x4b1a,(%esp)
  ...
  if(fd < 0){
    ...
    152c:	c7 44 24 04 25 4b 00 	movl   $0x4b25,0x4(%esp)
    1533:	00 
    1534:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    153b:	e8 1b 2b 00 00       	call   405b <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    154c:	00 
    154d:	c7 44 24 04 3f 4b 00 	movl   $0x4b3f,0x4(%esp)
    1554:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1572:	00 
    1573:	c7 04 24 1a 4b 00 00 	movl   $0x4b1a,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1627:	c7 44 24 04 7b 4b 00 	movl   $0x4b7b,0x4(%esp)
    162e:	00 
    162f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1636:	e8 20 2a 00 00       	call   405b <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    164b:	c7 44 24 04 92 4b 00 	movl   $0x4b92,0x4(%esp)
    1652:	00 
    1653:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165a:	e8 fc 29 00 00       	call   405b <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1684:	c7 44 24 04 a9 4b 00 	movl   $0x4ba9,0x4(%esp)
    168b:	00 
    168c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1693:	e8 c3 29 00 00       	call   405b <printf>
    exit();
  ...
  unlink("unlinkread");
    16a8:	c7 04 24 1a 4b 00 00 	movl   $0x4b1a,(%esp)
    16af:	e8 60 28 00 00       	call   3f14 <unlink>
  printf(1, "unlinkread ok\n");
    16b4:	c7 44 24 04 c2 4b 00 	movl   $0x4bc2,0x4(%esp)
    16bb:	00 
    16bc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c3:	e8 93 29 00 00       	call   405b <printf>
}
    16c8:	c9                   	leave  
    16c9:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d0:	c7 44 24 04 d1 4b 00 	movl   $0x4bd1,0x4(%esp)
    16d7:	00 
    16d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16df:	e8 77 29 00 00       	call   405b <printf>

  unlink("lf1");
    16e4:	c7 04 24 db 4b 00 00 	movl   $0x4bdb,(%esp)
    16eb:	e8 24 28 00 00       	call   3f14 <unlink>
  unlink("lf2");
    16f0:	c7 04 24 df 4b 00 00 	movl   $0x4bdf,(%esp)
    16f7:	e8 18 28 00 00       	call   3f14 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    16fc:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1703:	00 
    1704:	c7 04 24 db 4b 00 00 	movl   $0x4bdb,(%esp)
  ...
  if(fd < 0){
    ...
    1719:	c7 44 24 04 e3 4b 00 	movl   $0x4be3,0x4(%esp)
    1720:	00 
    1721:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1728:	e8 2e 29 00 00       	call   405b <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1739:	00 
    173a:	c7 44 24 04 3f 4b 00 	movl   $0x4b3f,0x4(%esp)
    1741:	00 
    ...
    1752:	c7 44 24 04 f6 4b 00 	movl   $0x4bf6,0x4(%esp)
    1759:	00 
    175a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1761:	e8 f5 28 00 00       	call   405b <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17eb:	00 
    17ec:	c7 04 24 df 4b 00 00 	movl   $0x4bdf,(%esp)
  ...
  if(fd < 0){
    ...
    1801:	c7 44 24 04 45 4c 00 	movl   $0x4c45,0x4(%esp)
    1808:	00 
    1809:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1810:	e8 46 28 00 00       	call   405b <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    183a:	c7 44 24 04 56 4c 00 	movl   $0x4c56,0x4(%esp)
    1841:	00 
    1842:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1849:	e8 0d 28 00 00       	call   405b <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    185e:	c7 44 24 04 df 4b 00 	movl   $0x4bdf,0x4(%esp)
    1865:	00 
    1866:	c7 04 24 df 4b 00 00 	movl   $0x4bdf,(%esp)
    186d:	e8 b2 26 00 00       	call   3f24 <link>
    1872:	85 c0                	test   %eax,%eax
    1874:	78 19                	js     188f <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1876:	c7 44 24 04 67 4c 00 	movl   $0x4c67,0x4(%esp)
    187d:	00 
    187e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1885:	e8 d1 27 00 00       	call   405b <printf>
    exit();
    188a:	e8 35 26 00 00       	call   3ec4 <exit>
  }

  unlink("lf2");
    188f:	c7 04 24 df 4b 00 00 	movl   $0x4bdf,(%esp)
    1896:	e8 79 26 00 00       	call   3f14 <unlink>
  if(link("lf2", "lf1") >= 0){
    189b:	c7 44 24 04 db 4b 00 	movl   $0x4bdb,0x4(%esp)
    18a2:	00 
    18a3:	c7 04 24 df 4b 00 00 	movl   $0x4bdf,(%esp)
    18aa:	e8 75 26 00 00       	call   3f24 <link>
    18af:	85 c0                	test   %eax,%eax
    18b1:	78 19                	js     18cc <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b3:	c7 44 24 04 88 4c 00 	movl   $0x4c88,0x4(%esp)
    18ba:	00 
    18bb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c2:	e8 94 27 00 00       	call   405b <printf>
    exit();
    18c7:	e8 f8 25 00 00       	call   3ec4 <exit>
  }

  if(link(".", "lf1") >= 0){
    18cc:	c7 44 24 04 db 4b 00 	movl   $0x4bdb,0x4(%esp)
    18d3:	00 
    18d4:	c7 04 24 ab 4c 00 00 	movl   $0x4cab,(%esp)
    18db:	e8 44 26 00 00       	call   3f24 <link>
    18e0:	85 c0                	test   %eax,%eax
    18e2:	78 19                	js     18fd <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e4:	c7 44 24 04 ad 4c 00 	movl   $0x4cad,0x4(%esp)
    18eb:	00 
    18ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f3:	e8 63 27 00 00       	call   405b <printf>
    exit();
    18f8:	e8 c7 25 00 00       	call   3ec4 <exit>
  }

  printf(1, "linktest ok\n");
    18fd:	c7 44 24 04 c9 4c 00 	movl   $0x4cc9,0x4(%esp)
    1904:	00 
    1905:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    190c:	e8 4a 27 00 00       	call   405b <printf>
}
    1911:	c9                   	leave  
    1912:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1919:	c7 44 24 04 d6 4c 00 	movl   $0x4cd6,0x4(%esp)
    1920:	00 
    1921:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1928:	e8 2e 27 00 00       	call   405b <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    198c:	c7 04 24 e6 4c 00 00 	movl   $0x4ce6,(%esp)
    ...
    19cf:	c7 04 24 e6 4c 00 00 	movl   $0x4ce6,(%esp)
    ...
    1a00:	c7 44 24 04 e9 4c 00 	movl   $0x4ce9,0x4(%esp)
    1a07:	00 
    1a08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a0f:	e8 47 26 00 00       	call   405b <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a64:	00 
    1a65:	c7 04 24 ab 4c 00 00 	movl   $0x4cab,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1ac6:	c7 44 24 04 05 4d 00 	movl   $0x4d05,0x4(%esp)
    1acd:	00 
    1ace:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ad5:	e8 81 25 00 00       	call   405b <printf>
        exit();
    ...
    1af6:	c7 44 24 04 1e 4d 00 	movl   $0x4d1e,0x4(%esp)
    1afd:	00 
    1afe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b05:	e8 51 25 00 00       	call   405b <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b52:	c7 44 24 04 3c 4d 00 	movl   $0x4d3c,0x4(%esp)
    1b59:	00 
    1b5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b61:	e8 f5 24 00 00       	call   405b <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b8c:	79 19                	jns    1ba7 <concreate+0x294>
      printf(1, "fork failed\n");
    1b8e:	c7 44 24 04 c1 44 00 	movl   $0x44c1,0x4(%esp)
    1b95:	00 
    1b96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b9d:	e8 b9 24 00 00       	call   405b <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1cae:	c7 44 24 04 6d 4d 00 	movl   $0x4d6d,0x4(%esp)
    1cb5:	00 
    1cb6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cbd:	e8 99 23 00 00       	call   405b <printf>
}
    1cc2:	c9                   	leave  
    1cc3:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cca:	c7 44 24 04 7b 4d 00 	movl   $0x4d7b,0x4(%esp)
    1cd1:	00 
    1cd2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd9:	e8 7d 23 00 00       	call   405b <printf>

  unlink("x");
    1cde:	c7 04 24 f7 48 00 00 	movl   $0x48f7,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cf8:	c7 44 24 04 c1 44 00 	movl   $0x44c1,0x4(%esp)
    1cff:	00 
    1d00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d07:	e8 4f 23 00 00       	call   405b <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d66:	00 
    1d67:	c7 04 24 f7 48 00 00 	movl   $0x48f7,(%esp)
    ...
    1d98:	75 16                	jne    1db0 <linkunlink+0xec>
      link("cat", "x");
    1d9a:	c7 44 24 04 f7 48 00 	movl   $0x48f7,0x4(%esp)
    1da1:	00 
    1da2:	c7 04 24 8c 4d 00 00 	movl   $0x4d8c,(%esp)
    1da9:	e8 76 21 00 00       	call   3f24 <link>
    1dae:	eb 0c                	jmp    1dbc <linkunlink+0xf8>
    } else {
      unlink("x");
    1db0:	c7 04 24 f7 48 00 00 	movl   $0x48f7,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1dd5:	c7 44 24 04 90 4d 00 	movl   $0x4d90,0x4(%esp)
    1ddc:	00 
    1ddd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1de4:	e8 72 22 00 00       	call   405b <printf>
}
    1de9:	c9                   	leave  
    1dea:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1df6:	c7 44 24 04 9f 4d 00 	movl   $0x4d9f,0x4(%esp)
    1dfd:	00 
    1dfe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e05:	e8 51 22 00 00       	call   405b <printf>
  unlink("bd");
    1e0a:	c7 04 24 ac 4d 00 00 	movl   $0x4dac,(%esp)
    1e11:	e8 fe 20 00 00       	call   3f14 <unlink>

  fd = open("bd", O_CREATE);
    1e16:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e1d:	00 
    1e1e:	c7 04 24 ac 4d 00 00 	movl   $0x4dac,(%esp)
  ...
  if(fd < 0){
    ...
    1e33:	c7 44 24 04 af 4d 00 	movl   $0x4daf,0x4(%esp)
    1e3a:	00 
    1e3b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e42:	e8 14 22 00 00       	call   405b <printf>
    exit();
  ...
  unlink("bd");
    1ed1:	c7 04 24 ac 4d 00 00 	movl   $0x4dac,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f29:	c7 44 24 04 d9 4d 00 	movl   $0x4dd9,0x4(%esp)
    1f30:	00 
    1f31:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f38:	e8 1e 21 00 00       	call   405b <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f4f:	c7 44 24 04 ee 4d 00 	movl   $0x4dee,0x4(%esp)
    1f56:	00 
    1f57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5e:	e8 f8 20 00 00       	call   405b <printf>
}
    1f63:	c9                   	leave  
    1f64:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6b:	c7 44 24 04 f9 4d 00 	movl   $0x4df9,0x4(%esp)
    1f72:	00 
    1f73:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7a:	e8 dc 20 00 00       	call   405b <printf>

  unlink("ff");
    1f7f:	c7 04 24 06 4e 00 00 	movl   $0x4e06,(%esp)
    1f86:	e8 89 1f 00 00       	call   3f14 <unlink>
  if(mkdir("dd") != 0){
    1f8b:	c7 04 24 09 4e 00 00 	movl   $0x4e09,(%esp)
    1f92:	e8 95 1f 00 00       	call   3f2c <mkdir>
    1f97:	85 c0                	test   %eax,%eax
    1f99:	74 19                	je     1fb4 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9b:	c7 44 24 04 0c 4e 00 	movl   $0x4e0c,0x4(%esp)
    1fa2:	00 
    1fa3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1faa:	e8 ac 20 00 00       	call   405b <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbb:	00 
    1fbc:	c7 04 24 24 4e 00 00 	movl   $0x4e24,(%esp)
  ...
  if(fd < 0){
    ...
    1fd1:	c7 44 24 04 2a 4e 00 	movl   $0x4e2a,0x4(%esp)
    1fd8:	00 
    1fd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe0:	e8 76 20 00 00       	call   405b <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1ff1:	00 
    1ff2:	c7 44 24 04 06 4e 00 	movl   $0x4e06,0x4(%esp)
    1ff9:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2069:	00 
    206a:	c7 04 24 88 4e 00 00 	movl   $0x4e88,(%esp)
  ...
  if(fd < 0){
    ...
    207f:	c7 44 24 04 91 4e 00 	movl   $0x4e91,0x4(%esp)
    2086:	00 
    2087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208e:	e8 c8 1f 00 00       	call   405b <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    209f:	00 
    20a0:	c7 44 24 04 a9 4e 00 	movl   $0x4ea9,0x4(%esp)
    20a7:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c5:	00 
    20c6:	c7 04 24 ac 4e 00 00 	movl   $0x4eac,(%esp)
  ...
  if(fd < 0){
    ...
    20db:	c7 44 24 04 b8 4e 00 	movl   $0x4eb8,0x4(%esp)
    20e2:	00 
    20e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20ea:	e8 6c 1f 00 00       	call   405b <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2123:	c7 44 24 04 d1 4e 00 	movl   $0x4ed1,0x4(%esp)
    212a:	00 
    212b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2132:	e8 24 1f 00 00       	call   405b <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227d:	00 
    227e:	c7 04 24 ec 4e 00 00 	movl   $0x4eec,(%esp)
  ...
  if(fd < 0){
    ...
    2293:	c7 44 24 04 b6 4f 00 	movl   $0x4fb6,0x4(%esp)
    229a:	00 
    229b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a2:	e8 b4 1d 00 00       	call   405b <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22cc:	c7 44 24 04 ce 4f 00 	movl   $0x4fce,0x4(%esp)
    22d3:	00 
    22d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22db:	e8 7b 1d 00 00       	call   405b <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b1:	c7 44 24 04 48 52 00 	movl   $0x5248,0x4(%esp)
    26b8:	00 
    26b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c0:	e8 96 19 00 00       	call   405b <printf>

  unlink("bigwrite");
    26c5:	c7 04 24 57 52 00 00 	movl   $0x5257,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e4:	00 
    26e5:	c7 04 24 57 52 00 00 	movl   $0x5257,(%esp)
    ...
    26fa:	c7 44 24 04 60 52 00 	movl   $0x5260,0x4(%esp)
    2701:	00 
    2702:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2709:	e8 4d 19 00 00       	call   405b <printf>
      exit();
    ...
    274f:	c7 44 24 04 78 52 00 	movl   $0x5278,0x4(%esp)
    2756:	00 
    2757:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275e:	e8 f8 18 00 00       	call   405b <printf>
        exit();
    ...
    unlink("bigwrite");
    277d:	c7 04 24 57 52 00 00 	movl   $0x5257,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279d:	c7 44 24 04 8a 52 00 	movl   $0x528a,0x4(%esp)
    27a4:	00 
    27a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ac:	e8 aa 18 00 00       	call   405b <printf>
}
    27b1:	c9                   	leave  
    27b2:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27b9:	c7 44 24 04 97 52 00 	movl   $0x5297,0x4(%esp)
    27c0:	00 
    27c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c8:	e8 8e 18 00 00       	call   405b <printf>

  unlink("bigfile");
    27cd:	c7 04 24 a5 52 00 00 	movl   $0x52a5,(%esp)
    27d4:	e8 3b 17 00 00       	call   3f14 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27d9:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e0:	00 
    27e1:	c7 04 24 a5 52 00 00 	movl   $0x52a5,(%esp)
  ...
  if(fd < 0){
    ...
    27f6:	c7 44 24 04 ad 52 00 	movl   $0x52ad,0x4(%esp)
    27fd:	00 
    27fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2805:	e8 51 18 00 00       	call   405b <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2855:	c7 44 24 04 c3 52 00 	movl   $0x52c3,0x4(%esp)
    285c:	00 
    285d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2864:	e8 f2 17 00 00       	call   405b <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    288a:	00 
    288b:	c7 04 24 a5 52 00 00 	movl   $0x52a5,(%esp)
  ...
  if(fd < 0){
    ...
    28a0:	c7 44 24 04 d9 52 00 	movl   $0x52d9,0x4(%esp)
    28a7:	00 
    28a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28af:	e8 a7 17 00 00       	call   405b <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28eb:	c7 44 24 04 ee 52 00 	movl   $0x52ee,0x4(%esp)
    28f2:	00 
    28f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fa:	e8 5c 17 00 00       	call   405b <printf>
      exit();
    ...
    2913:	c7 44 24 04 03 53 00 	movl   $0x5303,0x4(%esp)
    291a:	00 
    291b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2922:	e8 34 17 00 00       	call   405b <printf>
      exit();
    ...
    2960:	c7 44 24 04 17 53 00 	movl   $0x5317,0x4(%esp)
    2967:	00 
    2968:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    296f:	e8 e7 16 00 00       	call   405b <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    299d:	c7 44 24 04 30 53 00 	movl   $0x5330,0x4(%esp)
    29a4:	00 
    29a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29ac:	e8 aa 16 00 00       	call   405b <printf>
    exit();
    29b1:	e8 0e 15 00 00       	call   3ec4 <exit>
  }
  unlink("bigfile");
    29b6:	c7 04 24 a5 52 00 00 	movl   $0x52a5,(%esp)
    29bd:	e8 52 15 00 00       	call   3f14 <unlink>

  printf(1, "bigfile test ok\n");
    29c2:	c7 44 24 04 4a 53 00 	movl   $0x534a,0x4(%esp)
    29c9:	00 
    29ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d1:	e8 85 16 00 00       	call   405b <printf>
}
    29d6:	c9                   	leave  
    29d7:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a4b:	00 
    2a4c:	c7 04 24 e8 53 00 00 	movl   $0x53e8,(%esp)
  ...
  if(fd < 0){
    ...
    2a61:	c7 44 24 04 18 54 00 	movl   $0x5418,0x4(%esp)
    2a68:	00 
    2a69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a70:	e8 e6 15 00 00       	call   405b <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a8c:	00 
    2a8d:	c7 04 24 58 54 00 00 	movl   $0x5458,(%esp)
  ...
  if(fd < 0){
    ...
    2aa2:	c7 44 24 04 88 54 00 	movl   $0x5488,0x4(%esp)
    2aa9:	00 
    2aaa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab1:	e8 a5 15 00 00       	call   405b <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cac:	c7 44 24 04 1f 56 00 	movl   $0x561f,0x4(%esp)
    2cb3:	00 
    2cb4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cbb:	e8 9b 13 00 00       	call   405b <printf>

  fd = open("dirfile", O_CREATE);
    2cc0:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cc7:	00 
    2cc8:	c7 04 24 2c 56 00 00 	movl   $0x562c,(%esp)
  ...
  if(fd < 0){
    ...
    2cdd:	c7 44 24 04 34 56 00 	movl   $0x5634,0x4(%esp)
    2ce4:	00 
    2ce5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cec:	e8 6a 13 00 00       	call   405b <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d31:	00 
    2d32:	c7 04 24 65 56 00 00 	movl   $0x5665,(%esp)
  ...
  if(fd >= 0){
    ...
    2d47:	c7 44 24 04 70 56 00 	movl   $0x5670,0x4(%esp)
    2d4e:	00 
    2d4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d56:	e8 00 13 00 00       	call   405b <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d67:	00 
    2d68:	c7 04 24 65 56 00 00 	movl   $0x5665,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2e49:	00 
    2e4a:	c7 04 24 ab 4c 00 00 	movl   $0x4cab,(%esp)
  ...
  if(fd >= 0){
    ...
    2e5f:	c7 44 24 04 08 57 00 	movl   $0x5708,0x4(%esp)
    2e66:	00 
    2e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e6e:	e8 e8 11 00 00       	call   405b <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eae:	c7 44 24 04 27 57 00 	movl   $0x5727,0x4(%esp)
    2eb5:	00 
    2eb6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ebd:	e8 99 11 00 00       	call   405b <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2ed2:	c7 44 24 04 3b 57 00 	movl   $0x573b,0x4(%esp)
    2ed9:	00 
    2eda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee1:	e8 75 11 00 00       	call   405b <printf>
}
    2ee6:	c9                   	leave  
    2ee7:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2eee:	c7 44 24 04 4b 57 00 	movl   $0x574b,0x4(%esp)
    2ef5:	00 
    2ef6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2efd:	e8 59 11 00 00       	call   405b <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2faf:	00 
    2fb0:	c7 04 24 8b 57 00 00 	movl   $0x578b,(%esp)
    ...
    unlink("xx");
    2fd0:	c7 04 24 8b 57 00 00 	movl   $0x578b,(%esp)
  ...
  chdir("/");
    2fea:	c7 04 24 92 44 00 00 	movl   $0x4492,(%esp)
    2ff1:	e8 3e 0f 00 00       	call   3f34 <chdir>
  printf(1, "empty file name OK\n");
    2ff6:	c7 44 24 04 8e 57 00 	movl   $0x578e,0x4(%esp)
    2ffd:	00 
    2ffe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3005:	e8 51 10 00 00       	call   405b <printf>
}
    300a:	c9                   	leave  
    300b:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3012:	c7 44 24 04 a2 57 00 	movl   $0x57a2,0x4(%esp)
    3019:	00 
    301a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3021:	e8 35 10 00 00       	call   405b <printf>
    ...
    3043:	e8 7c 0e 00 00       	call   3ec4 <exit>
{
  ...
  if(n == 1000){
    ...
    3061:	c7 44 24 04 b0 57 00 	movl   $0x57b0,0x4(%esp)
    3068:	00 
    3069:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3070:	e8 e6 0f 00 00       	call   405b <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    3083:	c7 44 24 04 d2 57 00 	movl   $0x57d2,0x4(%esp)
    308a:	00 
    308b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3092:	e8 c4 0f 00 00       	call   405b <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30b0:	c7 44 24 04 e6 57 00 	movl   $0x57e6,0x4(%esp)
    30b7:	00 
    30b8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30bf:	e8 97 0f 00 00       	call   405b <printf>
    exit();
    30c4:	e8 fb 0d 00 00       	call   3ec4 <exit>
  }
  
  printf(1, "fork test OK\n");
    30c9:	c7 44 24 04 f9 57 00 	movl   $0x57f9,0x4(%esp)
    30d0:	00 
    30d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30d8:	e8 7e 0f 00 00       	call   405b <printf>
}
    30dd:	c9                   	leave  
    30de:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30e9:	a1 e0 62 00 00       	mov    0x62e0,%eax
    30ee:	c7 44 24 04 07 58 00 	movl   $0x5807,0x4(%esp)
    30f5:	00 
    30f6:	89 04 24             	mov    %eax,(%esp)
    30f9:	e8 5d 0f 00 00       	call   405b <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    313c:	a1 e0 62 00 00       	mov    0x62e0,%eax
    ...
    3156:	c7 44 24 04 12 58 00 	movl   $0x5812,0x4(%esp)
    315d:	00 
    315e:	89 04 24             	mov    %eax,(%esp)
    3161:	e8 f5 0e 00 00       	call   405b <printf>
      exit();
  ...
  if(pid < 0){
    ...
    3195:	a1 e0 62 00 00       	mov    0x62e0,%eax
    319a:	c7 44 24 04 2d 58 00 	movl   $0x582d,0x4(%esp)
    31a1:	00 
    31a2:	89 04 24             	mov    %eax,(%esp)
    31a5:	e8 b1 0e 00 00       	call   405b <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31d8:	a1 e0 62 00 00       	mov    0x62e0,%eax
    31dd:	c7 44 24 04 44 58 00 	movl   $0x5844,0x4(%esp)
    31e4:	00 
    31e5:	89 04 24             	mov    %eax,(%esp)
    31e8:	e8 6e 0e 00 00       	call   405b <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    3238:	a1 e0 62 00 00       	mov    0x62e0,%eax
    323d:	c7 44 24 04 60 58 00 	movl   $0x5860,0x4(%esp)
    3244:	00 
    3245:	89 04 24             	mov    %eax,(%esp)
    3248:	e8 0e 0e 00 00       	call   405b <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3283:	a1 e0 62 00 00       	mov    0x62e0,%eax
    3288:	c7 44 24 04 9e 58 00 	movl   $0x589e,0x4(%esp)
    328f:	00 
    3290:	89 04 24             	mov    %eax,(%esp)
    3293:	e8 c3 0d 00 00       	call   405b <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32b9:	a1 e0 62 00 00       	mov    0x62e0,%eax
    ...
    32cc:	c7 44 24 04 bc 58 00 	movl   $0x58bc,0x4(%esp)
    32d3:	00 
    32d4:	89 04 24             	mov    %eax,(%esp)
    32d7:	e8 7f 0d 00 00       	call   405b <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3320:	a1 e0 62 00 00       	mov    0x62e0,%eax
    ...
    3333:	c7 44 24 04 f4 58 00 	movl   $0x58f4,0x4(%esp)
    333a:	00 
    333b:	89 04 24             	mov    %eax,(%esp)
    333e:	e8 18 0d 00 00       	call   405b <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3352:	a1 e0 62 00 00       	mov    0x62e0,%eax
    3357:	c7 44 24 04 1c 59 00 	movl   $0x591c,0x4(%esp)
    335e:	00 
    335f:	89 04 24             	mov    %eax,(%esp)
    3362:	e8 f4 0c 00 00       	call   405b <printf>
    exit();
  ...
  if(c != a){
    ...
    33a3:	a1 e0 62 00 00       	mov    0x62e0,%eax
    ...
    33b6:	c7 44 24 04 4c 59 00 	movl   $0x594c,0x4(%esp)
    33bd:	00 
    33be:	89 04 24             	mov    %eax,(%esp)
    33c1:	e8 95 0c 00 00       	call   405b <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33e8:	79 1a                	jns    3404 <sbrktest+0x325>
      printf(stdout, "fork failed\n");
    33ea:	a1 e0 62 00 00       	mov    0x62e0,%eax
    33ef:	c7 44 24 04 c1 44 00 	movl   $0x44c1,0x4(%esp)
    33f6:	00 
    33f7:	89 04 24             	mov    %eax,(%esp)
    33fa:	e8 5c 0c 00 00       	call   405b <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346b:	c7 44 24 04 92 48 00 	movl   $0x4892,0x4(%esp)
    3472:	00 
    3473:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    347a:	e8 dc 0b 00 00       	call   405b <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d0:	00 
    34d1:	c7 44 24 04 f7 48 00 	movl   $0x48f7,0x4(%esp)
    34d8:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    3572:	a1 e0 62 00 00       	mov    0x62e0,%eax
    3577:	c7 44 24 04 86 59 00 	movl   $0x5986,0x4(%esp)
    357e:	00 
    357f:	89 04 24             	mov    %eax,(%esp)
    3582:	e8 d4 0a 00 00       	call   405b <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    35ba:	a1 e0 62 00 00       	mov    0x62e0,%eax
    35bf:	c7 44 24 04 a1 59 00 	movl   $0x59a1,0x4(%esp)
    35c6:	00 
    35c7:	89 04 24             	mov    %eax,(%esp)
    35ca:	e8 8c 0a 00 00       	call   405b <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3609:	a1 e0 62 00 00       	mov    0x62e0,%eax
    360e:	c7 44 24 04 af 59 00 	movl   $0x59af,0x4(%esp)
    3615:	00 
    3616:	89 04 24             	mov    %eax,(%esp)
    3619:	e8 3d 0a 00 00       	call   405b <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    367b:	c7 04 24 be 59 00 00 	movl   $0x59be,(%esp)
    3682:	e8 9d 08 00 00       	call   3f24 <link>
    3687:	83 f8 ff             	cmp    $0xffffffff,%eax
    368a:	74 1a                	je     36a6 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    368c:	a1 e0 62 00 00       	mov    0x62e0,%eax
    3691:	c7 44 24 04 c9 59 00 	movl   $0x59c9,0x4(%esp)
    3698:	00 
    3699:	89 04 24             	mov    %eax,(%esp)
    369c:	e8 ba 09 00 00       	call   405b <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    36b9:	a1 e0 62 00 00       	mov    0x62e0,%eax
    36be:	c7 44 24 04 e2 59 00 	movl   $0x59e2,0x4(%esp)
    36c5:	00 
    36c6:	89 04 24             	mov    %eax,(%esp)
    36c9:	e8 8d 09 00 00       	call   405b <printf>
}
    36ce:	c9                   	leave  
    36cf:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36d6:	a1 e0 62 00 00       	mov    0x62e0,%eax
    36db:	c7 44 24 04 ef 59 00 	movl   $0x59ef,0x4(%esp)
    36e2:	00 
    36e3:	89 04 24             	mov    %eax,(%esp)
    36e6:	e8 70 09 00 00       	call   405b <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3703:	a1 e0 62 00 00       	mov    0x62e0,%eax
    3708:	c7 44 24 04 f9 59 00 	movl   $0x59f9,0x4(%esp)
    370f:	00 
    3710:	89 04 24             	mov    %eax,(%esp)
    3713:	e8 43 09 00 00       	call   405b <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    372b:	a1 e0 62 00 00       	mov    0x62e0,%eax
    3730:	c7 44 24 04 0a 5a 00 	movl   $0x5a0a,0x4(%esp)
    3737:	00 
    3738:	89 04 24             	mov    %eax,(%esp)
    373b:	e8 1b 09 00 00       	call   405b <printf>
}
    3740:	c9                   	leave  
    3741:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    3748:	c7 04 24 17 5a 00 00 	movl   $0x5a17,(%esp)
  ...
  if(pid == 0){
    ...
    3772:	c7 04 85 00 63 00 00 	movl   $0x5a24,0x6300(,%eax,4)
    3779:	24 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3791:	a1 e0 62 00 00       	mov    0x62e0,%eax
    3796:	c7 44 24 04 01 5b 00 	movl   $0x5b01,0x4(%esp)
    379d:	00 
    379e:	89 04 24             	mov    %eax,(%esp)
    37a1:	e8 b5 08 00 00       	call   405b <printf>
    exec("echo", args);
    37a6:	c7 44 24 04 00 63 00 	movl   $0x6300,0x4(%esp)
    37ad:	00 
    37ae:	c7 04 24 20 44 00 00 	movl   $0x4420,(%esp)
    37b5:	e8 42 07 00 00       	call   3efc <exec>
    printf(stdout, "bigarg test ok\n");
    37ba:	a1 e0 62 00 00       	mov    0x62e0,%eax
    37bf:	c7 44 24 04 0e 5b 00 	movl   $0x5b0e,0x4(%esp)
    37c6:	00 
    37c7:	89 04 24             	mov    %eax,(%esp)
    37ca:	e8 8c 08 00 00       	call   405b <printf>
    fd = open("bigarg-ok", O_CREATE);
    37cf:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37d6:	00 
    37d7:	c7 04 24 17 5a 00 00 	movl   $0x5a17,(%esp)
    ...
    37fc:	a1 e0 62 00 00       	mov    0x62e0,%eax
    3801:	c7 44 24 04 1e 5b 00 	movl   $0x5b1e,0x4(%esp)
    3808:	00 
    3809:	89 04 24             	mov    %eax,(%esp)
    380c:	e8 4a 08 00 00       	call   405b <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3822:	00 
    3823:	c7 04 24 17 5a 00 00 	movl   $0x5a17,(%esp)
  ...
  if(fd < 0){
    ...
    3838:	a1 e0 62 00 00       	mov    0x62e0,%eax
    383d:	c7 44 24 04 37 5b 00 	movl   $0x5b37,0x4(%esp)
    3844:	00 
    3845:	89 04 24             	mov    %eax,(%esp)
    3848:	e8 0e 08 00 00       	call   405b <printf>
    exit();
  ...
  unlink("bigarg-ok");
    385d:	c7 04 24 17 5a 00 00 	movl   $0x5a17,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    3879:	c7 44 24 04 4c 5b 00 	movl   $0x5b4c,0x4(%esp)
    3880:	00 
    3881:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3888:	e8 ce 07 00 00       	call   405b <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3969:	c7 44 24 04 59 5b 00 	movl   $0x5b59,0x4(%esp)
    3970:	00 
    3971:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3978:	e8 de 06 00 00       	call   405b <printf>
    ...
    39a0:	c7 44 24 04 65 5b 00 	movl   $0x5b65,0x4(%esp)
    39a7:	00 
    39a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39af:	e8 a7 06 00 00       	call   405b <printf>
      break;
    ...
    39f8:	c7 44 24 04 75 5b 00 	movl   $0x5b75,0x4(%esp)
    39ff:	00 
    3a00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3a07:	e8 4f 06 00 00       	call   405b <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3b13:	c7 44 24 04 85 5b 00 	movl   $0x5b85,0x4(%esp)
    3b1a:	00 
    3b1b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b22:	e8 34 05 00 00       	call   405b <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3b30:	a1 e4 62 00 00       	mov    0x62e4,%eax
    3b35:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3b3b:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3b40:	a3 e4 62 00 00       	mov    %eax,0x62e4
  return randstate;
    3b45:	a1 e4 62 00 00       	mov    0x62e4,%eax
}
    3b4a:	5d                   	pop    %ebp
    3b4b:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3ba1:	00 
    3ba2:	c7 04 24 af 5b 00 00 	movl   $0x5baf,(%esp)
...
putc(int fd, char c)
{
    ...
    3f87:	83 ec 28             	sub    $0x28,%esp
    3f8a:	8b 45 0c             	mov    0xc(%ebp),%eax
    3f8d:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3f90:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3f97:	00 
    3f98:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3f9b:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f9f:	8b 45 08             	mov    0x8(%ebp),%eax
    3fa2:	89 04 24             	mov    %eax,(%esp)
    3fa5:	e8 3a ff ff ff       	call   3ee4 <write>
}
    3faa:	c9                   	leave  
    3fab:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3fb2:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3fb9:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3fbd:	74 17                	je     3fd6 <printint+0x2a>
    3fbf:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3fc3:	79 11                	jns    3fd6 <printint+0x2a>
    neg = 1;
    3fc5:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3fcc:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fcf:	f7 d8                	neg    %eax
    3fd1:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3fd4:	eb 06                	jmp    3fdc <printint+0x30>
  } else {
    x = xx;
  ...
  i = 0;
    3fdc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3fe3:	8b 4d 10             	mov    0x10(%ebp),%ecx
    3fe6:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3fe9:	ba 00 00 00 00       	mov    $0x0,%edx
    3fee:	f7 f1                	div    %ecx
    3ff0:	89 d0                	mov    %edx,%eax
    3ff2:	0f b6 90 e8 62 00 00 	movzbl 0x62e8(%eax),%edx
    3ff9:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3ffc:	03 45 f4             	add    -0xc(%ebp),%eax
    3fff:	88 10                	mov    %dl,(%eax)
    4001:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    4005:	8b 55 10             	mov    0x10(%ebp),%edx
    4008:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    400b:	8b 45 ec             	mov    -0x14(%ebp),%eax
    400e:	ba 00 00 00 00       	mov    $0x0,%edx
    4013:	f7 75 d4             	divl   -0x2c(%ebp)
    4016:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4019:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    401d:	75 c4                	jne    3fe3 <printint+0x37>
  if(neg)
    401f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4023:	74 2a                	je     404f <printint+0xa3>
    buf[i++] = '-';
    4025:	8d 45 dc             	lea    -0x24(%ebp),%eax
    4028:	03 45 f4             	add    -0xc(%ebp),%eax
    402b:	c6 00 2d             	movb   $0x2d,(%eax)
    402e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    4032:	eb 1b                	jmp    404f <printint+0xa3>
    putc(fd, buf[i]);
    4034:	8d 45 dc             	lea    -0x24(%ebp),%eax
    4037:	03 45 f4             	add    -0xc(%ebp),%eax
    ...
    404a:	e8 35 ff ff ff       	call   3f84 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    ...
    4057:	79 db                	jns    4034 <printint+0x88>
    putc(fd, buf[i]);
}
    4059:	c9                   	leave  
    405a:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    40bb:	e8 c4 fe ff ff       	call   3f84 <putc>
    ...
    40f4:	e8 b3 fe ff ff       	call   3fac <printint>
        ap++;
    ...
    412d:	e8 7a fe ff ff       	call   3fac <printint>
        ap++;
    ...
    4151:	75 27                	jne    417a <printf+0x11f>
          s = "(null)";
    4153:	c7 45 f4 ea 5b 00 00 	movl   $0x5bea,-0xc(%ebp)
        while(*s != 0){
    ...
    416f:	e8 10 fe ff ff       	call   3f84 <putc>
          s++;
    ...
    419f:	e8 e0 fd ff ff       	call   3f84 <putc>
        ap++;
    ...
    41c0:	e8 bf fd ff ff       	call   3f84 <putc>
    ...
    41d5:	e8 aa fd ff ff       	call   3f84 <putc>
        putc(fd, c);
    ...
    41ea:	e8 95 fd ff ff       	call   3f84 <putc>
      }
      state = 0;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    421f:	a1 88 63 00 00       	mov    0x6388,%eax
...
free(void *ap)
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    4265:	c1 e0 03             	shl    $0x3,%eax
    4268:	89 c2                	mov    %eax,%edx
    426a:	03 55 f8             	add    -0x8(%ebp),%edx
    426d:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4270:	8b 00                	mov    (%eax),%eax
    4272:	39 c2                	cmp    %eax,%edx
    4274:	75 24                	jne    429a <free+0x8a>
    bp->s.size += p->s.ptr->s.size;
    4276:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4279:	8b 50 04             	mov    0x4(%eax),%edx
    427c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    427f:	8b 00                	mov    (%eax),%eax
    4281:	8b 40 04             	mov    0x4(%eax),%eax
    4284:	01 c2                	add    %eax,%edx
    4286:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4289:	89 50 04             	mov    %edx,0x4(%eax)
  ...
  if(p + p->s.size == bp){
    ...
    42ad:	03 45 fc             	add    -0x4(%ebp),%eax
    42b0:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    42b3:	75 20                	jne    42d5 <free+0xc5>
    p->s.size += bp->s.size;
    42b5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42b8:	8b 50 04             	mov    0x4(%eax),%edx
    42bb:	8b 45 f8             	mov    -0x8(%ebp),%eax
    42be:	8b 40 04             	mov    0x4(%eax),%eax
    42c1:	01 c2                	add    %eax,%edx
    42c3:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42c6:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    42c9:	8b 45 f8             	mov    -0x8(%ebp),%eax
    42cc:	8b 10                	mov    (%eax),%edx
    42ce:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42d1:	89 10                	mov    %edx,(%eax)
    42d3:	eb 08                	jmp    42dd <free+0xcd>
  } else
    p->s.ptr = bp;
    42d5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42d8:	8b 55 f8             	mov    -0x8(%ebp),%edx
    42db:	89 10                	mov    %edx,(%eax)
  freep = p;
    42dd:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42e0:	a3 88 63 00 00       	mov    %eax,0x6388
}
    42e5:	c9                   	leave  
    42e6:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    42ea:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    42ed:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    42f4:	77 07                	ja     42fd <morecore+0x16>
    nu = 4096;
    42f6:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    42fd:	8b 45 08             	mov    0x8(%ebp),%eax
    4300:	c1 e0 03             	shl    $0x3,%eax
    4303:	89 04 24             	mov    %eax,(%esp)
    4306:	e8 41 fc ff ff       	call   3f4c <sbrk>
    430b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    430e:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4312:	75 07                	jne    431b <morecore+0x34>
    return 0;
    4314:	b8 00 00 00 00       	mov    $0x0,%eax
    4319:	eb 22                	jmp    433d <morecore+0x56>
  hp = (Header*)p;
    431b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    431e:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    4321:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4324:	8b 55 08             	mov    0x8(%ebp),%edx
    4327:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    432a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    432d:	83 c0 08             	add    $0x8,%eax
    4330:	89 04 24             	mov    %eax,(%esp)
    4333:	e8 d8 fe ff ff       	call   4210 <free>
  return freep;
    4338:	a1 88 63 00 00       	mov    0x6388,%eax
}
    433d:	c9                   	leave  
    433e:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    4342:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4345:	8b 45 08             	mov    0x8(%ebp),%eax
    4348:	83 c0 07             	add    $0x7,%eax
    434b:	c1 e8 03             	shr    $0x3,%eax
    434e:	83 c0 01             	add    $0x1,%eax
    4351:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    4354:	a1 88 63 00 00       	mov    0x6388,%eax
    4359:	89 45 f0             	mov    %eax,-0x10(%ebp)
    435c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4360:	75 23                	jne    4385 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    4362:	c7 45 f0 80 63 00 00 	movl   $0x6380,-0x10(%ebp)
    4369:	8b 45 f0             	mov    -0x10(%ebp),%eax
    436c:	a3 88 63 00 00       	mov    %eax,0x6388
    4371:	a1 88 63 00 00       	mov    0x6388,%eax
    4376:	a3 80 63 00 00       	mov    %eax,0x6380
    base.s.size = 0;
    437b:	c7 05 84 63 00 00 00 	movl   $0x0,0x6384
    4382:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4393:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4396:	72 4d                	jb     43e5 <malloc+0xa6>
      if(p->s.size == nunits)
    4398:	8b 45 f4             	mov    -0xc(%ebp),%eax
    439b:	8b 40 04             	mov    0x4(%eax),%eax
    439e:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    43a1:	75 0c                	jne    43af <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    43a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43a6:	8b 10                	mov    (%eax),%edx
    43a8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    43ab:	89 10                	mov    %edx,(%eax)
    43ad:	eb 26                	jmp    43d5 <malloc+0x96>
      else {
        p->s.size -= nunits;
    43af:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43b2:	8b 40 04             	mov    0x4(%eax),%eax
    43b5:	89 c2                	mov    %eax,%edx
    43b7:	2b 55 ec             	sub    -0x14(%ebp),%edx
    43ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43bd:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    43c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43c3:	8b 40 04             	mov    0x4(%eax),%eax
    43c6:	c1 e0 03             	shl    $0x3,%eax
    43c9:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    43cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43cf:	8b 55 ec             	mov    -0x14(%ebp),%edx
    43d2:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    43d5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    43d8:	a3 88 63 00 00       	mov    %eax,0x6388
      return (void*)(p + 1);
    43dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43e0:	83 c0 08             	add    $0x8,%eax
    43e3:	eb 38                	jmp    441d <malloc+0xde>
    }
    if(p == freep)
    43e5:	a1 88 63 00 00       	mov    0x6388,%eax
    43ea:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    43ed:	75 1b                	jne    440a <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    43ef:	8b 45 ec             	mov    -0x14(%ebp),%eax
    43f2:	89 04 24             	mov    %eax,(%esp)
    43f5:	e8 ed fe ff ff       	call   42e7 <morecore>
    43fa:	89 45 f4             	mov    %eax,-0xc(%ebp)
    43fd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4401:	75 07                	jne    440a <malloc+0xcb>
        return 0;
    4403:	b8 00 00 00 00       	mov    $0x0,%eax
    4408:	eb 13                	jmp    441d <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    440d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4410:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4413:	8b 00                	mov    (%eax),%eax
    4415:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    4418:	e9 70 ff ff ff       	jmp    438d <malloc+0x4e>
}
    441d:	c9                   	leave  
    441e:	c3                   	ret    
    441f:	90                   	nop
